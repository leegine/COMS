...
// Source File Name:   EqTypeContractOpenOrderUnitImpl.java
...
public class EqTypeContractOpenOrderUnitImpl extends EqTypeMarketTradedOrderUnitImpl
    implements EqTypeContractOpenOrderUnit
{

    EqTypeContractOpenOrderUnitImpl(PersistenceManagerImpl pm, long order_unit_id)
        throws DataQueryException, DataNetworkException
    {
        super(pm, order_unit_id);
    }

    EqTypeContractOpenOrderUnitImpl(PersistenceManagerImpl pm, EqtypeOrderUnitRow row)
    {
        super(pm, row);
    }
