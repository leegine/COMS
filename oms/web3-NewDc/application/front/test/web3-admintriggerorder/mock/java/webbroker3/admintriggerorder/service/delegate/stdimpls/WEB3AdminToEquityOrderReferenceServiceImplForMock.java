...
1.1
date	2011.04.07.02.35.26;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminToEquityOrderReferenceServiceImplForMock.java;
...
public class WEB3AdminToEquityOrderReferenceServiceImplForMock extends WEB3AdminToEquityOrderReferenceServiceImpl
{

    public WEB3AdminToEquityOrderReferenceServiceImplForMock()
    {
        super();
    ...
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
            WEB3AdminToEquityOrderReferenceServiceImplForMock.class);
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log.debug("webbroker3.dirsec.WEB3AdminToEquityOrderReferenceServiceImpl.execute(WEB3GenRequest)");
