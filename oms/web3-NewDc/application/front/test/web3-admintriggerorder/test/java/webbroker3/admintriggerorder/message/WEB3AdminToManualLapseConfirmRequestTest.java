...
1.1
date	2011.04.07.01.43.35;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminToManualLapseConfirmRequestTest.java;
...
public class WEB3AdminToManualLapseConfirmRequestTest extends TestBaseForMock
{

    WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminToManualLapseConfirmRequestTest.class); // ///////////

    WEB3AdminToManualLapseConfirmRequest l_request = null; // ///////////////

    public WEB3AdminToManualLapseConfirmRequestTest(String name)
    {
        super(name);
    ...
    protected void setUp() throws Exception
    {
        ...
        l_request = new WEB3AdminToManualLapseConfirmRequest(); // ////////////////
    }
