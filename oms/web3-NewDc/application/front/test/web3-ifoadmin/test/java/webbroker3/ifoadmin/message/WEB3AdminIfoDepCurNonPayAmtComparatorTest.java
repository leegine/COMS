...
File Name        : ｘｘｘｘ(WEB3AdminIfoDepCurNonPayAmtComparatorTest.java.java)
...
public class WEB3AdminIfoDepCurNonPayAmtComparatorTest extends TestBaseForMock
{
     ...
     */
    //昇順指定の場合、 
    //　@　@明細1の現在未入金額が、明細2の現在未入金額より小さい場合、負の整数（-1）を返却する。
    ...
    //昇順指定の場合、 
    //　@　@明細1の現在未入金額が、明細2の現在未入金額より大きい場合、正の整数（1）を返却する。
    ...
    //降順指定の場合、 
    //　@　@明細1の現在未入金額が、明細2の現在未入金額より小さい場合、正の整数（1）を返却する。
    ...
    //降順指定の場合、 
    //　@　@明細1の現在未入金額が、明細2の現在未入金額より大きい場合、負の整数（-1）を返却する。
