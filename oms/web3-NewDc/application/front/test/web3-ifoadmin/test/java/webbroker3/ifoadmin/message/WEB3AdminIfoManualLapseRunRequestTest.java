...
1.1
date	2011.04.07.01.14.33;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminIfoManualLapseRunRequestTest.java;
 ...
 * @@version 1.0
 */
public class WEB3AdminIfoManualLapseRunRequestTest extends TestBaseForMock
{
    /**
     * Log Variable.<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminIfoManualLapseRunRequestTest.class);

    public WEB3AdminIfoManualLapseRunRequestTest(String arg0)
    {
        super(arg0);
    }
