...
1.1
date	2011.04.07.02.33.13;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminIfoDepShortageDownloadHandlerTest.java;
...
File Name        : WEB3AdminIfoDepShortageDownloadHandlerTest.java
...
public class WEB3AdminIfoDepShortageDownloadHandlerTest extends TestBaseForMock
{
    public WEB3AdminIfoDepShortageDownloadHandlerTest(String name)
    {
        super(name);
        // TODO Auto-generated constructor stub
    }

    private WEB3AdminIfoDepShortageDownloadService l_service = null;
    private WEB3AdminIfoDepShortageDownloadHandler l_handler = null;

    protected void setUp() throws Exception
    {
        super.setUp();
        l_handler = new WEB3AdminIfoDepShortageDownloadHandler();
    }
    ...
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
            WEB3AdminIfoDepShortageDownloadHandlerTest.class);

    /**
     * 管理者・証拠金不足状況ダウンロードサービスを取得に失敗しました。
     * WEB3ErrorCatalog.SYSTEM_ERROR_80002
     */
    public void testGetDownloadFile_C0001()
    {
        final String STR_METHOD_NAME = "testGetDownloadFile_C0001()";
        log.entering(STR_METHOD_NAME);

        try
        {
            WEB3AdminIfoDepShortageDownloadRequest l_request = new WEB3AdminIfoDepShortageDownloadRequest();
            l_service =
                (WEB3AdminIfoDepShortageDownloadService)Services.getService(
                    WEB3AdminIfoDepShortageDownloadService.class);
            Services.unregisterService(WEB3AdminIfoDepShortageDownloadService.class);

            WEB3AdminIfoDepShortageDownloadResponse l_response = l_handler.getDownloadFile(l_request);
        ...
        {
            Services.registerService(WEB3AdminIfoDepShortageDownloadService.class, l_service);
        }
     ...
     */
    public void testGetDownloadFile_C0002()
    {
        final String STR_METHOD_NAME = "testGetDownloadFile_C0002()";
        log.entering(STR_METHOD_NAME);
     ...
     * normal case
     */
    public void testGetDownloadFile_C0003()
    {
        final String STR_METHOD_NAME = "testGetDownloadFile_C0003()";
        log.entering(STR_METHOD_NAME);
