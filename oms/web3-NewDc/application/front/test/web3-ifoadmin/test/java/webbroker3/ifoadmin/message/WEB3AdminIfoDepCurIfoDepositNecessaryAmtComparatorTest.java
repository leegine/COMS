...
File Name        : ｘｘｘｘ(WEB3AdminIfoDepCurIfoDepositNecessaryAmtComparatorTest.java.java)
...
public class WEB3AdminIfoDepCurIfoDepositNecessaryAmtComparatorTest extends TestBaseForMock
{
     ...
     */
    //昇順指定の場合、 
    //　@　@明細1の現在証拠金所要額が、明細2の現在証拠金所要額より小さい場合、負の整数（-1）を返却する。
    ...
    //昇順指定の場合、 
    //　@　@明細1の現在証拠金所要額が、明細2の現在証拠金所要額より大きい場合、正の整数（1）を返却する。
    ...
    //降順指定の場合、 
    //　@　@明細1の現在証拠金所要額が、明細2の現在証拠金所要額より小さい場合、正の整数（1）を返却する。
    ...
    //降順指定の場合、 
    //　@　@明細1の現在証拠金所要額が、明細2の現在証拠金所要額より大きい場合、負の整数（-1）を返却する。
