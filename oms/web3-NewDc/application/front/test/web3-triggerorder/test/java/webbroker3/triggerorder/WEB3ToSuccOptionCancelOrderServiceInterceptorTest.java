...
1.1
date	2011.04.07.00.41.36;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionCancelOrderServiceInterceptorTest.java;
...
public class WEB3ToSuccOptionCancelOrderServiceInterceptorTest extends TestBaseForMock
{

    public WEB3ToSuccOptionCancelOrderServiceInterceptorTest(String name)
    {
        super(name);
    }
    /**
    ...
    private static WEB3LogUtility log =
         WEB3LogUtility.getInstance(
                 WEB3ToSuccOptionCancelOrderServiceInterceptorTest.class);

    WEB3ToSuccOptionCancelOrderServiceInterceptor l_interceptor =
