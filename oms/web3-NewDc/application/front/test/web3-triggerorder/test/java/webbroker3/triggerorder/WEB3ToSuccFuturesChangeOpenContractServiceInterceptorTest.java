...
1.1
date	2011.04.07.00.42.41;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesChangeOpenContractServiceInterceptorTest.java;
...
File Name        : WEB3ToSuccFuturesChangeOpenContractServiceInterceptorTest.java
...
public class WEB3ToSuccFuturesChangeOpenContractServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccFuturesChangeOpenContractServiceInterceptorTest.class);

    public WEB3ToSuccFuturesChangeOpenContractServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
     ...
     * 正常終了
     * 
     * WEB3SuccFuturesOpenChangeConfirmRequest
     */
    public void testOnCall_C0001()
    {
        ...
        WEB3ToSuccFuturesChangeOpenContractServiceInterceptor l_interceptor =
     ...
     * 正常終了
     * 
     * WEB3SuccFuturesOpenChangeCompleteRequest
     */
    ...
    public void testOnCall_C0004()
    {
        ...
        WEB3SuccAdditionalContentSelectRequest[] l_requests =
            new WEB3SuccAdditionalContentSelectRequest[1];
        l_requests[0] = new WEB3SuccAdditionalContentSelectRequest();
    ...
    public void testOnReturnOnThrowable_C0001()
    {
        ...
        TestSpecialClassUtility.testServiceInterceptor(new WEB3ToSuccFuturesChangeOpenContractServiceInterceptor());
