...
1.1
date	2011.04.07.00.42.33;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionChangeOpenContractServiceInterceptorTest.java;
...
File Name        : WEB3ToSuccOptionChangeOpenContractServiceInterceptorTest.java
...
public class WEB3ToSuccOptionChangeOpenContractServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccOptionChangeOpenContractServiceInterceptorTest.class);

    public WEB3ToSuccOptionChangeOpenContractServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
     ...
     * 正常終了
     * 
     * WEB3SuccOptionsOpenChangeConfirmRequest
     */
    public void testOnCall_C0001()
    {
        ...
        WEB3ToSuccOptionChangeOpenContractServiceInterceptor l_interceptor =
            new WEB3ToSuccOptionChangeOpenContractServiceInterceptor();
        
        WEB3SuccOptionsOpenChangeConfirmRequest[] l_requests =
            new WEB3SuccOptionsOpenChangeConfirmRequest[1];
        l_requests[0] = new WEB3SuccOptionsOpenChangeConfirmRequest();
    ...
    public void testOnCall_C0002()
    {
        ...
        WEB3SuccOptionsOpenChangeCompleteRequest[] l_requests =
            new WEB3SuccOptionsOpenChangeCompleteRequest[1];
        l_requests[0] = new WEB3SuccOptionsOpenChangeCompleteRequest();
        l_requests[0].id = "1001";
    ...
    public void testOnCall_C0003()
    {
        ...
        WEB3SuccFuturesOpenChangeCompleteRequest[] l_requests =
            new WEB3SuccFuturesOpenChangeCompleteRequest[1];
        l_requests[0] = new WEB3SuccFuturesOpenChangeCompleteRequest();
        l_requests[0].id = "1001";
    ...
    public void testOnReturnOnThrowable_C0001()
    {
        ...
        TestSpecialClassUtility.testServiceInterceptor(new WEB3ToSuccOptionChangeOpenContractServiceInterceptor());
