...
1.1
date	2011.04.07.00.41.58;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesChangeClosingContractServiceInterceptorTest.java;
...
File Name        : WEB3ToSuccFuturesChangeClosingContractServiceInterceptorTest.java
...
public class WEB3ToSuccFuturesChangeClosingContractServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
     private static WEB3LogUtility log =
         WEB3LogUtility.getInstance(WEB3ToSuccFuturesChangeClosingContractServiceInterceptorTest.class);


    public WEB3ToSuccFuturesChangeClosingContractServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
     ...
     * 正常終了
     * 
     * WEB3SuccFuturesCloseChangeCompleteRequest
     */
    public void testOnCall_C0001()
    {
        ...
        WEB3ToSuccFuturesChangeClosingContractServiceInterceptor l_interceptor =
            new WEB3ToSuccFuturesChangeClosingContractServiceInterceptor();
        
        WEB3SuccFuturesCloseChangeCompleteRequest[] l_requests =
            new WEB3SuccFuturesCloseChangeCompleteRequest[1];
        
        l_requests[0] = new WEB3SuccFuturesCloseChangeCompleteRequest();
     ...
     * 正常終了
     * 
     * WEB3SuccFuturesCloseChangeConfirmRequest
     */
    public void testOnCall_C0002()
    {
        ...
        WEB3SuccFuturesCloseChangeConfirmRequest[] l_requests =
            new WEB3SuccFuturesCloseChangeConfirmRequest[1];
        
        l_requests[0] = new WEB3SuccFuturesCloseChangeConfirmRequest();
        l_requests[0].id = "1001";
    ...
    public void testOnReturnOnThrowable_C0001()
    {
        ...
        TestSpecialClassUtility.testServiceInterceptor(new WEB3ToSuccFuturesChangeClosingContractServiceInterceptor());
