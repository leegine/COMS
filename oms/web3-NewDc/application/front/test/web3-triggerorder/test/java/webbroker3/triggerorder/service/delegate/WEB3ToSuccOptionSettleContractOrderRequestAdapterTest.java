...
1.1
date	2011.04.07.02.33.53;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionSettleContractOrderRequestAdapterTest.java;
...
File Name        : （WEB3ToSuccOptionSettleContractOrderRequestAdapterTest.java）
...
public class WEB3ToSuccOptionSettleContractOrderRequestAdapterTest extends TestBaseForMock
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccOptionSettleContractOrderRequestAdapterTest.class);

    private WEB3ToSuccOptionSettleContractOrderRequestAdapter l_requestAdapter = null;

    public WEB3ToSuccOptionSettleContractOrderRequestAdapterTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testCreate_0001()
    {
        ...
        try
        {
            ...
            WEB3ToSuccOptionSettleContractOrderRequestAdapter l_requestAdapter =
                (WEB3ToSuccOptionSettleContractOrderRequestAdapter)
                    WEB3ToSuccOptionSettleContractOrderRequestAdapter.create(l_request);

            assertEquals("0", ((WEB3SuccOptionsCloseConfirmRequest)l_requestAdapter.request).closingOrder);
    ...
    public void testCreate_0002()
    {
        ...
        try
        {
            ...
            assertEquals("0", ((WEB3SuccOptionsCloseCompleteRequest)l_requestAdapter.request).closingOrder);
            assertEquals("22.3", "" + l_requestAdapter.parentOrderUnit.getConfirmedPrice());
            assertEquals("0.0", "" + l_requestAdapter.price);
        }
        catch (Exception l_ex)
