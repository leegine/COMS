...
1.1
date	2011.04.07.01.19.43;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionChangeClosingContractInputServiceImplTest.java;
...
File Name        : ÅiWEB3ToSuccOptionChangeClosingContractInputServiceImplTest.javaÅj
Author Name      : Daiwa Institute of Research
Revision History : 2008/04/22 ÉgÉEñNç| (íÜêu) êVãKçÏê¨
*/
...
public class WEB3ToSuccOptionChangeClosingContractInputServiceImplTest extends TestBaseForMock
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccOptionChangeClosingContractInputServiceImplTest.class);

    public WEB3ToSuccOptionChangeClosingContractInputServiceImplTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testExecute_0001()
    {
        ...
        WEB3ToSuccOptionChangeClosingContractInputServiceImpl l_serviceImpl =
    ...
    public void testExecute_0002()
    {
        ...
        WEB3ToSuccOptionChangeClosingContractInputServiceImpl l_serviceImpl =
            new WEB3ToSuccOptionChangeClosingContractInputServiceImplForTest();
        ...
        try
        {
            WEB3SuccOptionsCloseChangeInputResponse l_response =
                (WEB3SuccOptionsCloseChangeInputResponse)l_serviceImpl.execute(l_request);
    ...
    public void testgetChangeClosingContractInputScreen_0001()
    {
        final String STR_METHOD_NAME = "testgetChangeClosingContractInputScreen_0001()";
        log.entering(TEST_START + STR_METHOD_NAME);
        ...
        try
        {
            l_serviceImpl.getChangeClosingContractInputScreen(l_request);
            fail();
        }
        catch (WEB3BaseException l_ex)
        {
    ...
    public void testgetChangeClosingContractInputScreen_0002()
    {
        final String STR_METHOD_NAME = "testgetChangeClosingContractInputScreen_0002()";
        log.entering(TEST_START + STR_METHOD_NAME);
    ...
    public void testgetChangeClosingContractInputScreen_0003()
    {
        final String STR_METHOD_NAME = "testgetChangeClosingContractInputScreen_0003()";
        log.entering(TEST_START + STR_METHOD_NAME);
        
        WEB3ToSuccOptionChangeClosingContractInputServiceImpl l_serviceImpl =
            new WEB3ToSuccOptionChangeClosingContractInputServiceImplForTest1();
    ...
    public void testgetChangeClosingContractInputScreen_0004()
    {
        final String STR_METHOD_NAME = "testgetChangeClosingContractInputScreen_0004()";
        log.entering(TEST_START + STR_METHOD_NAME);
        ...
        try
        {
            ...
            WEB3GentradeTradingTimeManagementForMock.mockGetBizDateType(new Timestamp(WEB3DateUtility.getDate("20080422", "yyyyMMdd").getTime()), "1");
            WEB3GentradeTradingTimeManagementForMock.mockGetOrderBizDate(WEB3DateUtility.getDate("20080422", "yyyyMMdd"));
    ...
    private class WEB3ToSuccOptionChangeClosingContractInputServiceImplForTest
        extends WEB3ToSuccOptionChangeClosingContractInputServiceImpl
    {
        ...
        {
            WEB3SuccOptionsCloseChangeInputResponse l_response = new WEB3SuccOptionsCloseChangeInputResponse();
    ...
    private class WEB3ToSuccOptionChangeClosingContractInputServiceImplForTest1
    extends WEB3ToSuccOptionChangeClosingContractInputServiceImpl
    {
