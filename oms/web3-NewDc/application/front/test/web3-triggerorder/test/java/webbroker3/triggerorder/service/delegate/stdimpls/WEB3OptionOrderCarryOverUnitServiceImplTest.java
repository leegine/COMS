...
1.1
date	2011.04.07.01.20.25;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionOrderCarryOverUnitServiceImplTest.java;
...
File Name        : OP注文繰越UnitServiceImpl
Author Name      : Daiwa Institute of Research
Revesion History : 2007/06/22 孟亜南
*/
...
/**
 * OP注文繰越UnitServiceImpl
 * @@author 孟亜南
 *
 */
public class WEB3OptionOrderCarryOverUnitServiceImplTest extends TestBaseForMock
{
    ...
    public WEB3OptionOrderCarryOverUnitServiceImplTest(String name)
    {
        super(name);
    }
    ...
    {           
        try
        {
            ...
            WEB3OptionOrderCarryOverUnitServiceImpl l_impl = new WEB3OptionOrderCarryOverUnitServiceImpl();
    ...
    {           
        ...
        try
        {
            ...
            TestBaseForMock.MOCK_MANAGER.setMethodReturnValue(
                    ...
                    new Class[]{ SubAccount.class, IfoSettleContractOrderSpec.class, long.class, String.class, boolean.class },
                    l_result1);
...
//            l_ifoOrderUnitParams.setSessionType("1");
    ...
    public class WEB3OptionOrderCarryOverUnitServiceImplForTest extends WEB3OptionOrderCarryOverUnitServiceImpl
    {
    ...
    {
        final String STR_METHOD_NAME = "testExpireCarryOverOriginOrderC001()";
        log.entering(TEST_START + STR_METHOD_NAME);
