...
1.1
date	2011.04.07.02.33.57;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesOpenContractRequestAdapterTest.java;
...
Revision History : 2008/03/26 孟亞南(中訊) 新規作成モデル257 モデル294
*/
...
public class WEB3ToSuccFuturesOpenContractRequestAdapterTest extends TestBaseForMock
{
    /**
     * (ログ出力ユーティリティ。)<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccFuturesOpenContractRequestAdapterTest.class);
    
    
    WEB3ToSuccFuturesOpenContractRequestAdapter l_adapter = null;
    
    public WEB3ToSuccFuturesOpenContractRequestAdapterTest(String name)
    {
        super(name);
    }
    ...
    {
        l_adapter = new WEB3ToSuccFuturesOpenContractRequestAdapter();
    ...
    public void test_create_0001()
    {
        ...
        try
        {
            ...
            WEB3ToSuccFuturesOpenContractRequestAdapter l_adapter1 =
                (WEB3ToSuccFuturesOpenContractRequestAdapter)l_adapter.create(l_request);
            
            assertEquals("101001010010", "" + ((IfoOrderUnit)l_adapter1.parentOrderUnit).getAccountId());
            
            assertEquals("0.0", "" + l_adapter1.price);
            assertEquals("1001", ((WEB3SuccFuturesOpenConfirmRequest)l_adapter1.request).succCommonInfo.parentOrderId);
        }
    ...
    public void test_create_0002()
    {
        ...
        try
        {
            ...
            assertEquals("0.0", "" + l_adapter1.price);
            assertEquals("2", ((WEB3SuccFuturesOpenCompleteRequest)l_adapter1.request).succCommonInfo.succTradingType);
        }
        catch (WEB3BaseException e)
        {
            log.exiting(STR_METHOD_NAME);
