...
1.1
date	2011.04.07.00.41.49;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesChangeClosingContractInputServiceInterceptorTest.java;
...
File Name        : （WEB3ToSuccFuturesChangeClosingContractInputServiceInterceptorTest.java）
...
public class WEB3ToSuccFuturesChangeClosingContractInputServiceInterceptorTest extends TestBaseForMock
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccFuturesChangeClosingContractInputServiceInterceptorTest.class);

    public WEB3ToSuccFuturesChangeClosingContractInputServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_0001()
    {
        ...
        try
        {
            WEB3ToSuccFuturesChangeClosingContractInputServiceInterceptor l_interceptor =
