...
1.1
date	2011.04.07.00.41.19;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccIfoChangeSettleContractOrderSpecTest.java;
...
File Name        : 先物OP予約返済注文訂正内容テスト(WEB3ToSuccIfoChangeSettleContractOrderSpecTest.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/03/27 崔遠鵬 (中訊) 新規作成
*/
...
/**
 * （先物OP予約返済注文訂正内容テスト）<BR>
 * @@author 崔遠鵬
 * @@version 1.0
 */
public class WEB3ToSuccIfoChangeSettleContractOrderSpecTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccIfoChangeSettleContractOrderSpecTest.class);

    public WEB3ToSuccIfoChangeSettleContractOrderSpecTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testCreateIfoChangeSettleContractOrderSpec_C001()
    {
        ...
        try
        {
            ...
            WEB3ToSuccIfoChangeSettleContractOrderSpec l_spec =
            ...
            assertEquals(l_spec.getModifiedEstimatedPrice(), 3.0, 0);
            assertEquals(l_spec.getModifiedCalcUnitPrice(), 4.0, 0);
            ...
            assertEquals(l_spec.getModifiedPriceAdjustValue().doubleValue(), 5.0d, 0);
