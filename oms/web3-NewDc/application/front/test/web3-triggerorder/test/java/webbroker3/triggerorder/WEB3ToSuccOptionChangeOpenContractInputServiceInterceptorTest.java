...
1.1
date	2011.04.07.00.42.11;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionChangeOpenContractInputServiceInterceptorTest.java;
...
File Name        : WEB3ToSuccOptionChangeOpenContractInputServiceInterceptorTest.java
...
public class WEB3ToSuccOptionChangeOpenContractInputServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccOptionChangeOpenContractInputServiceInterceptorTest.class);


    public WEB3ToSuccOptionChangeOpenContractInputServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
     ...
     * 正常終了
     * 
     * WEB3SuccOptionsOpenChangeInputRequest
     */
    public void testOnCall_C0001()
    {
        ...
        WEB3ToSuccOptionChangeOpenContractInputServiceInterceptor l_interceptor =
            new WEB3ToSuccOptionChangeOpenContractInputServiceInterceptor();
        
        WEB3SuccOptionsOpenChangeInputRequest[] l_requests =
            new WEB3SuccOptionsOpenChangeInputRequest[1];
    ...
    public void testOnReturnOnThrowable_C0001()
    {
        ...
        TestSpecialClassUtility.testServiceInterceptor(new WEB3ToSuccOptionChangeOpenContractInputServiceInterceptor());
