...
1.1
date	2011.04.07.01.05.59;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionCancelOrderServiceImplForMock.java;
...
public class WEB3ToSuccOptionCancelOrderServiceImplForMock extends WEB3ToSuccOptionCancelOrderServiceImpl
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
            WEB3ToSuccOptionCancelOrderServiceImplForMock.class);
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log
                    .debug("webbroker3.triggerorder.service.delegate.stdimpls.WEB3ToSuccOptionCancelOrderServiceImplForMock.execute()");
