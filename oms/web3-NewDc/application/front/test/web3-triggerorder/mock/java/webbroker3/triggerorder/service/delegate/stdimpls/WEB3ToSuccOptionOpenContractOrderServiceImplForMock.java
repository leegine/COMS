...
1.1
date	2011.04.07.01.04.08;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionOpenContractOrderServiceImplForMock.java;
...
public class WEB3ToSuccOptionOpenContractOrderServiceImplForMock extends WEB3ToSuccOptionOpenContractOrderServiceImpl
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
            WEB3ToSuccOptionOpenContractOrderServiceImplForMock.class);
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log
                    .debug("webbroker3.triggerorder.service.delegate.stdimpls.WEB3ToSuccOptionOpenContractOrderServiceImplForMock.execute()");
