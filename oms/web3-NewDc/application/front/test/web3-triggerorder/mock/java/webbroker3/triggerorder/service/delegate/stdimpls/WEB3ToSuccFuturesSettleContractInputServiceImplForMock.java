...
1.1
date	2011.04.07.01.04.51;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesSettleContractInputServiceImplForMock.java;
...
File Name        : （WEB3ToSuccFuturesSettleContractInputServiceImplForMock.java）
...
public class WEB3ToSuccFuturesSettleContractInputServiceImplForMock
    extends WEB3ToSuccFuturesSettleContractInputServiceImpl
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccFuturesSettleContractInputServiceImplForMock.class);
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log.debug("webbroker3.triggerorder.service.delegate.stdimpls.WEB3ToSuccFuturesSettleContractInputServiceImplForMock.execute()");
