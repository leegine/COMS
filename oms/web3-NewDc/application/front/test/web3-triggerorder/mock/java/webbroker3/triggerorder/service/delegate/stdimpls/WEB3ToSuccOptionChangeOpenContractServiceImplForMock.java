...
1.1
date	2011.04.07.01.06.47;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccOptionChangeOpenContractServiceImplForMock.java;
...
@/**
 ...
 File Name        : WEB3ToSuccOptionChangeOpenContractServiceImplForMock.java
...
public class WEB3ToSuccOptionChangeOpenContractServiceImplForMock extends WEB3ToSuccOptionChangeOpenContractServiceImpl
{
    /**
     * ログユーティリティ。
     */
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log
                    .debug("webbroker3.triggerorder.service.delegate.stdimpls.WEB3ToSuccOptionChangeOpenContractServiceImplForMock.execute()");
