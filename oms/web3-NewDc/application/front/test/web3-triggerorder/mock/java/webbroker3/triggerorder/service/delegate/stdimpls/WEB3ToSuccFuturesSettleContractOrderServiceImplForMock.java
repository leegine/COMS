...
1.1
date	2011.04.07.01.06.22;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesSettleContractOrderServiceImplForMock.java;
...
File Name        : （WEB3ToSuccFuturesSettleContractOrderServiceImplForMock.java）
...
public class WEB3ToSuccFuturesSettleContractOrderServiceImplForMock
    extends WEB3ToSuccFuturesSettleContractOrderServiceImpl
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccFuturesSettleContractOrderServiceImplForMock.class);
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log.debug("webbroker3.triggerorder.service.delegate.stdimpls.WEB3ToSuccFuturesSettleContractOrderServiceImpl.execute()");
