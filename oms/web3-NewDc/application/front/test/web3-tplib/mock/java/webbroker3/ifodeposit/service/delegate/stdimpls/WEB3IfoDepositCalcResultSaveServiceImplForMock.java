...
1.1
date	2011.04.07.02.41.19;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3IfoDepositCalcResultSaveServiceImplForMock.java;
...
File Name        : WEB3IfoDepositCalcResultSaveServiceImplForMock
...
public class WEB3IfoDepositCalcResultSaveServiceImplForMock extends WEB3IfoDepositCalcResultSaveServiceImpl
{
    /**
     * ログ出力ユーティリティ
     */
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue(
                "webbroker3.ifodeposit.service.delegate.stdimpls.WEB3IfoDepositCalcResultSaveServiceImpl", "execute",
                new Class[]
        ...
        {
            log.debug("webbroker3.ifodeposit.service.delegate.stdimpls.WEB3IfoDepositCalcResultSaveServiceImplForMock.execute()");
