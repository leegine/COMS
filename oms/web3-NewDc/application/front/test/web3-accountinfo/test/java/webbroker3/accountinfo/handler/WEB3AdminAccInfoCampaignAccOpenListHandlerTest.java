...
1.1
date	2011.04.06.08.40.37;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoCampaignAccOpenListHandlerTest.java;
...
File Name        : 口座開設条件指定一覧ハンドラテスト (WEB3AdminAccInfoCampaignAccOpenListHandlerTest.java)
...
/**
 * (口座開設条件指定一覧ハンドラテスト)<BR>
 * 口座開設条件指定一覧ハンドラテスト<BR>
 * <BR>
 * @@author 李木子<BR>
 * @@version 1.0<BR>
 */
public class WEB3AdminAccInfoCampaignAccOpenListHandlerTest extends
        TestBaseForMock {
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoCampaignAccOpenListHandlerTest.class);

    public WEB3AdminAccInfoCampaignAccOpenListHandlerTest(String arg0) {
        super(arg0);
    }
    ...
    public void test_getListScreen_0001()
    {
        ...
        WEB3AdminAccInfoCampaignAccOpenListHandler l_adminAccInfoCampaignAccOpenListHandler =
            new WEB3AdminAccInfoCampaignAccOpenListHandler();
        ...
        WEB3AccInfoSortKey[] l_WEB3AccInfoSortKeyList = {l_accInfoSortKey1};

        l_request.campaignSearchItem = l_campainSearchItem;
        l_request.pageSize = "2";
        l_request.sortKeys = l_WEB3AccInfoSortKeyList;
        l_request.campaignSearchItem = l_campainSearchItem;
        ...
        try
        {
            WEB3AdminAccInfoCampaignAccOpenListResponse l_response =
                l_adminAccInfoCampaignAccOpenListHandler.getListScreen(l_request);
    ...
    public void test_getListScreen_0002()
    {
        ...
        try
        {
            ...
            assertEquals(WEB3ErrorCatalog.BUSINESS_ERROR_02082, l_response.errorInfo);
        }
        catch (Exception l_ex)
        {
            log.error(l_ex.getMessage(), l_ex);
