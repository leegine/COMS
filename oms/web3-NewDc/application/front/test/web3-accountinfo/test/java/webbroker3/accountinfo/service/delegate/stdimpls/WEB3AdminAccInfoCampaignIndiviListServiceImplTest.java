...
1.1
date	2011.04.06.08.31.52;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoCampaignIndiviListServiceImplTest.java;
...
File Name        : 個別顧客指定一覧サービスImplテスト (WEB3AdminAccInfoCampaignIndiviListServiceImplTest.java)
...
/**
 * (個別顧客指定一覧サービスImplテスト)<BR>
 * 個別顧客指定一覧サービスImplテスト<BR>
 * <BR>
 * @@author 李木子<BR>
 * @@version 1.0<BR>
 */
public class WEB3AdminAccInfoCampaignIndiviListServiceImplTest extends TestBaseForMock {

    /**
     * Log Variable
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoCampaignIndiviListServiceImplTest.class);

    public WEB3AdminAccInfoCampaignIndiviListServiceImplTest(String arg0) {
        super(arg0);
    }
    ...
    public void test_execute_0001()
    {
        ...
        WEB3AdminAccInfoCampaignIndiviListServiceImpl l_adminAccInfoCampaignIndiviListServiceImpl =
        ...
        try
        {
            l_adminAccInfoCampaignIndiviListServiceImpl.execute(l_request);
            fail();
        }
    ...
    public void test_execute_0002()
    {
        ...
        try
        {
            WEB3AdminAccInfoCampaignIndiviListResponse l_response = (WEB3AdminAccInfoCampaignIndiviListResponse)
                l_adminAccInfoCampaignIndiviListServiceImpl.execute(l_request);
    ...
    public void test_getListScreen_0001()
    {
        ...
        try
        {
            l_adminAccInfoCampaignIndiviListServiceImpl.getListScreen(l_request);
            fail();
        }
