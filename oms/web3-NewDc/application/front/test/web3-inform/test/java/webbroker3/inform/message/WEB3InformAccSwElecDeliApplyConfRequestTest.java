...
1.1
date	2011.04.07.01.32.11;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3InformAccSwElecDeliApplyConfRequestTest.java;
...
File Name        : 口座切替・電子交付申込確認リクエスト(WEB3InformAccSwElecDeliApplyConfRequestTest.java)
...
public class WEB3InformAccSwElecDeliApplyConfRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3InformAccSwElecDeliApplyConfRequestTest.class);

    public WEB3InformAccSwElecDeliApplyConfRequestTest(String arg0)
    {
        super(arg0);
    }
