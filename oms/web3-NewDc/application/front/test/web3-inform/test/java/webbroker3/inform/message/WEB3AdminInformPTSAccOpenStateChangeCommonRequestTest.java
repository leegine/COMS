...
1.1
date	2011.04.07.01.32.20;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformPTSAccOpenStateChangeCommonRequestTest.java;
...
public class WEB3AdminInformPTSAccOpenStateChangeCommonRequestTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminInformPTSAccOpenStateChangeCommonRequestTest.class);
    WEB3AdminInformPTSAccOpenStateChangeCommonRequest l_request =
        new WEB3AdminInformPTSAccOpenStateChangeCommonRequest();

    public WEB3AdminInformPTSAccOpenStateChangeCommonRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testValidate_T08()
    {
        ...
        try
        {
            ...
            l_request.afterPtsAccOpenDiv = null;
            l_request.validate();
            fail();
        }
        catch(WEB3BusinessLayerException l_ex)
        {
            assertEquals(WEB3ErrorCatalog.BUSINESS_ERROR_03045, l_ex.getErrorInfo());   
        }
        catch(Exception l_ex)
        {
            log.exiting(STR_METHOD_NAME);
