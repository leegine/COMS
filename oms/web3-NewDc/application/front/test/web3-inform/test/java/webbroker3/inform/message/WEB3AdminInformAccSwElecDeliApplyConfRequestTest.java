...
1.1
date	2011.04.07.01.32.01;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliApplyConfRequestTest.java;
...
File Name        : 管理者・口座切替・電子交付申込確認リクエストクラス(WEB3AdminInformAccSwElecDeliApplyConfRequestTest.java)
...
public class WEB3AdminInformAccSwElecDeliApplyConfRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3AdminInformAccSwElecDeliApplyConfRequestTest.class);

    public WEB3AdminInformAccSwElecDeliApplyConfRequestTest(String arg0)
    {
        super(arg0);
    }
