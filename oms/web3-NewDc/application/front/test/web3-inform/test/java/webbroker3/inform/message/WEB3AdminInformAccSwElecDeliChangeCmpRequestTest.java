...
1.1
date	2011.04.07.01.31.51;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliChangeCmpRequestTest.java;
...
@/**
 ...
 File Name        : （WEB3AdminInformAccSwElecDeliChangeCmpRequestTest.java）
...
public class WEB3AdminInformAccSwElecDeliChangeCmpRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3AdminInformAccSwElecDeliChangeCmpRequestTest.class);

    WEB3AdminInformAccSwElecDeliChangeCmpRequest l_request = null;

    public WEB3AdminInformAccSwElecDeliChangeCmpRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    {
        super.setUp();
        l_request = new WEB3AdminInformAccSwElecDeliChangeCmpRequest();
    }
