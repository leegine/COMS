...
1.1
date	2011.04.07.01.31.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliApplyInpRequestTest.java;
...
@/**
 ...
 File Name        : 管理者・口座切替・電子交付申込入力リクエストクラス(WEB3AdminInformAccSwElecDeliApplyInpRequestTest.java)
...
public class WEB3AdminInformAccSwElecDeliApplyInpRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3AdminInformAccSwElecDeliApplyInpRequestTest.class);

    public WEB3AdminInformAccSwElecDeliApplyInpRequestTest(String arg0)
    {
        super(arg0);
    }
