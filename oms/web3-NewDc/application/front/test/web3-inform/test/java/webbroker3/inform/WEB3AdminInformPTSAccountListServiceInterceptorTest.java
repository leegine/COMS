...
1.1
date	2011.04.07.00.53.09;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformPTSAccountListServiceInterceptorTest.java;
...
public class WEB3AdminInformPTSAccountListServiceInterceptorTest extends TestBaseForMock
{
    /**
     * (ログ出力ユーティリティ)
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminInformPTSAccountListServiceInterceptorTest.class);

    public WEB3AdminInformPTSAccountListServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_0001()
    {
        ...
        WEB3AdminInformPTSAccountListServiceInterceptor l_inter =
