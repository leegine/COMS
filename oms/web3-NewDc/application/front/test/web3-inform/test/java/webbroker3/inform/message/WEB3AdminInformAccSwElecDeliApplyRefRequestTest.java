...
1.1
date	2011.04.07.01.32.30;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliApplyRefRequestTest.java;
...
File Name        : 管理者・口座切替・電子交付申込参照リクエスト(WEB3AdminInformAccSwElecDeliApplyRefRequestTest.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/09/21 孫洪江 (中訊) 新規作成 仕様変更モデル110
*/
...
public class WEB3AdminInformAccSwElecDeliApplyRefRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3AdminInformAccSwElecDeliApplyRefRequestTest.class);

    public WEB3AdminInformAccSwElecDeliApplyRefRequestTest(String arg0)
    {
        super(arg0);
    }
