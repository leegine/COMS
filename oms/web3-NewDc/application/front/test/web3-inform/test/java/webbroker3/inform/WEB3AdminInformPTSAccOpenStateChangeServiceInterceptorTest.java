...
1.1
date	2011.04.07.00.53.49;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformPTSAccOpenStateChangeServiceInterceptorTest.java;
...
public class WEB3AdminInformPTSAccOpenStateChangeServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminInformPTSAccOpenStateChangeServiceInterceptorTest.class);
    WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor l_interceptor =
        new WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor();
    
    public WEB3AdminInformPTSAccOpenStateChangeServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
