...
1.1
date	2011.04.07.01.30.06;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3InformPTSAccOpenApplyCommonRequestTest.java;
...
public class WEB3InformPTSAccOpenApplyCommonRequestTest extends TestBaseForMock
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3InformPTSAccOpenApplyCommonRequestTest.class);
    
    public WEB3InformPTSAccOpenApplyCommonRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testValidate_T01()
    {
        ...
        try
        {
            WEB3InformPTSAccOpenApplyCommonRequest l_request =
                new WEB3InformPTSAccOpenApplyCommonRequest();
    ...
    public void testValidate_T02()
    {
        ...
        try
        {
            ...
            l_request.ptsAccOpenDiv = null;
            l_request.validate();
            fail();
        }
        catch(WEB3BusinessLayerException l_ex)
        {
            assertEquals(WEB3ErrorCatalog.BUSINESS_ERROR_03020, l_ex.getErrorInfo());
        }
        catch(Exception l_ex)
        {
            log.error(l_ex.getMessage(), l_ex);
    ...
    public void testValidate_T03()
    {
        ...
        try
        {
            ...
            l_request.ptsTradeAgreementList = null;
            l_request.validate();
        }
        catch(Exception l_ex)
        {
    ...
    public void testValidate_T04()
    {
        ...
        try
        {
            ...
            ptsTradeAgreementList[0].questionNumber = null;
        ...
        {
            assertEquals(WEB3ErrorCatalog.BUSINESS_ERROR_03021, l_ex.getErrorInfo());
        }
        catch(Exception l_ex)
        {
            log.error(l_ex.getMessage(), l_ex);
    ...
    public void testValidate_T05()
    {
        ...
        try
        {
            ...
            ptsTradeAgreementList[1].questionAnswer = null;
            l_request.ptsTradeAgreementList = ptsTradeAgreementList;
            l_request.validate();
            fail();
        }
        ...
        {
            assertEquals(WEB3ErrorCatalog.BUSINESS_ERROR_03022, l_ex.getErrorInfo());
        }
        catch(Exception l_ex)
        {
            log.error(l_ex.getMessage(), l_ex);
