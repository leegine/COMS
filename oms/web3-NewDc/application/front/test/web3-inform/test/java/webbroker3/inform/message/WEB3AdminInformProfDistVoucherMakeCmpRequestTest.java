...
1.1
date	2011.04.07.01.30.30;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformProfDistVoucherMakeCmpRequestTest.java;
...
File Name           : (管理者・口座伝票作成完了リクエスト(WEB3AdminInformProfDistVoucherMakeCmpRequestTest.java)
 ...
 *
 */
public class WEB3AdminInformProfDistVoucherMakeCmpRequestTest extends
        TestBaseForMock
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
                WEB3AdminInformProfDistVoucherMakeCmpRequestTest.class);

    /**
     *
     * @@param arg0
     */
    public WEB3AdminInformProfDistVoucherMakeCmpRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testValidate_0001()
    {
        ...
        WEB3AdminInformProfDistVoucherMakeCmpRequest l_adminInformProfDistVoucherMakeCmpRequest =
        ...
        l_adminInformProfDistVoucherMakeCmpRequest.informInfoUnit = l_informDetailInfoUnit;

        try
        {
            l_adminInformProfDistVoucherMakeCmpRequest.validate();
