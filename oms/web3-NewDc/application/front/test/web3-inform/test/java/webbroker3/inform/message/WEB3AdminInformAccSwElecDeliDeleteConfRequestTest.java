...
1.1
date	2011.04.07.01.30.40;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliDeleteConfRequestTest.java;
...
File Name        : 管理者・口座切替・電子交付申込取消確認リクエスト(WEB3AdminInformAccSwElecDeliDeleteConfRequestTest.java)
...
public class WEB3AdminInformAccSwElecDeliDeleteConfRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminInformAccSwElecDeliDeleteConfRequestTest.class);

    public WEB3AdminInformAccSwElecDeliDeleteConfRequestTest(String arg0)
    {
        super(arg0);
    }
