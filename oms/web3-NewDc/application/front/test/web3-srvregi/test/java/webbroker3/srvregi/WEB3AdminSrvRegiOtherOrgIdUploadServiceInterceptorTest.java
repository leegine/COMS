...
1.1
date	2011.04.07.00.42.50;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiOtherOrgIdUploadServiceInterceptorTest.java;
...
public class WEB3AdminSrvRegiOtherOrgIdUploadServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminSrvRegiOtherOrgIdUploadServiceInterceptorTest.class);
    WEB3AdminSrvRegiOtherOrgIdUploadServiceInterceptor l_interceptor =
        new WEB3AdminSrvRegiOtherOrgIdUploadServiceInterceptor();

    public WEB3AdminSrvRegiOtherOrgIdUploadServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
