...
1.1
date	2011.04.07.00.43.25;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiOtherOrgIdDownloadServiceInterceptorTest.java;
...
public class WEB3AdminSrvRegiOtherOrgIdDownloadServiceInterceptorTest extends TestBaseForMock
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
                WEB3AdminSrvRegiOtherOrgIdDownloadServiceInterceptorTest.class);

    WEB3AdminSrvRegiOtherOrgIdDownloadServiceInterceptor l_interceptor=
        new WEB3AdminSrvRegiOtherOrgIdDownloadServiceInterceptor();
    
    public WEB3AdminSrvRegiOtherOrgIdDownloadServiceInterceptorTest(String name)
    {
        super(name);
    ...
    public void testOnCall_C0002()
    {
        ...
        try
        {
            ...
            assertEquals(l_clendarContext.getTradingTimeType(), "27");
