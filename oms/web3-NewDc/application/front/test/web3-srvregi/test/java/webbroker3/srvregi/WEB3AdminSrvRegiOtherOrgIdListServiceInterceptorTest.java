...
1.1
date	2011.04.07.00.44.00;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiOtherOrgIdListServiceInterceptorTest.java;
...
public class WEB3AdminSrvRegiOtherOrgIdListServiceInterceptorTest extends TestBaseForMock
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminSrvRegiOtherOrgIdListServiceInterceptorTest.class);
    WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor l_interceptor =
        new WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor();

    public WEB3AdminSrvRegiOtherOrgIdListServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
