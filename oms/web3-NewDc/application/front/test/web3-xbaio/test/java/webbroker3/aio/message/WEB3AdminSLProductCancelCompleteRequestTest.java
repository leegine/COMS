...
1.1
date	2011.04.07.02.21.46;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSLProductCancelCompleteRequestTest.java;
...
File Name        : 担保銘柄登録取消完了リクエスト(WEB3AdminSLProductCancelCompleteRequestTest.java)
...
public class WEB3AdminSLProductCancelCompleteRequestTest extends TestBaseForMock
{
    private WEB3AdminSLProductCancelCompleteRequest l_request = null;
    ...
    private static WEB3LogUtility log =
         WEB3LogUtility.getInstance(
                 WEB3AdminSLProductCancelCompleteRequestTest.class);

    public WEB3AdminSLProductCancelCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    {
        super.setUp();
        this.l_request = new WEB3AdminSLProductCancelCompleteRequest();
    }
