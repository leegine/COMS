...
1.1
date	2011.04.07.02.22.21;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSLProductChangeCompleteRequestTest.java;
...
File Name        : （WEB3AdminSLProductChangeCompleteRequestTest.java）
...
public class WEB3AdminSLProductChangeCompleteRequestTest extends TestBaseForMock
{
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
        WEB3AdminSLProductChangeCompleteRequestTest.class);

    WEB3AdminSLProductChangeCompleteRequest l_request = null;
    public WEB3AdminSLProductChangeCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    {
        super.setUp();
        l_request = new WEB3AdminSLProductChangeCompleteRequest();
    }
