...
1.1
date	2011.04.07.01.34.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FXTransToFXServiceInterceptorTest.java;
...
public class WEB3FXTransToFXServiceInterceptorTest extends TestBaseForMock {

    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3FXTransToFXServiceInterceptorTest.class);
    
    
    public WEB3FXTransToFXServiceInterceptorTest(String arg0) {
        super(arg0);
    }
    ...
    WEB3FXTransToFXServiceInterceptor l_interceptor = new WEB3FXTransToFXServiceInterceptor();
    
    /*
     * Test method for 'webbroker3.aio.WEB3FXTransToFXServiceInterceptor.onCall(Method, Object[])'
     */
    ...
    public void testOnCall_T05()
    {
        ...
        Method l_method = null;
        WEB3FXTransToFXAskingRequest l_request = new WEB3FXTransToFXAskingRequest();
        l_request.fxSystemCode = "1";
    ...
    public void testOnCall_T06()
    {
        ...
        try
        {
            ...
            l_tradingTimeParams.setProductCode("02");
    ...
    public void testOnCall_T07()
    {
        ...
        try
        {
            ...
            l_compFxConditionParams.setTradingTimeType("23");
            TestDBUtility.insertWithDel(l_compFxConditionParams);
            ...
            WEB3GentradeTradingClendarContext l_context =
                (WEB3GentradeTradingClendarContext)ThreadLocalSystemAttributesRegistry.getAttribute(
                    WEB3GentradeTradingTimeManagement.TRADING_CAL_CONTEXT_PATH);
            assertEquals(l_context.getTradingTimeType(),"23");
            assertEquals(l_context.getOrderAcceptProduct(),"23");
