...
1.1
date	2011.04.07.01.34.18;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioSLAccountOpenServiceInterceptorTest.java;
...
public class WEB3AioSLAccountOpenServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioSLAccountOpenServiceInterceptorTest.class);

    public WEB3AioSLAccountOpenServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
...
//        try
//        {
//            WEB3AioSLAccountOpenServiceInterceptor l_inter =
...
//    }
    ...
    public void testOnCall_0003()
    {
        ...
        try
        {
            ...
            Object[] l_objs = {new WEB3SLAccountOpenApplyRequest()};
   ...
   public void testOnReturn_case0001()
   {
       ...
       WEB3AioSLAccountOpenServiceInterceptor l_interceptor =
           new WEB3AioSLAccountOpenServiceInterceptor();
