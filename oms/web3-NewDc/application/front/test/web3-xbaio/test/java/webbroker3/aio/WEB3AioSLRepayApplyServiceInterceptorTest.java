...
1.1
date	2011.04.07.01.35.02;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioSLRepayApplyServiceInterceptorTest.java;
...
public class WEB3AioSLRepayApplyServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioSLRepayApplyServiceInterceptorTest.class);

    public WEB3AioSLRepayApplyServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_0001()
    {
        try
        {
            WEB3AioSLRepayApplyServiceInterceptor l_inter =
    ...
    public void testOnCall_0003()
    {
        ...
        try
        {
            ...
            Object[] l_objs = {new WEB3SLRepayApplyConfirmRequest()};
   ...
   public void testOnReturn_case0001()
   {
       ...
       WEB3AioSLRepayApplyServiceInterceptor l_interceptor =
           new WEB3AioSLRepayApplyServiceInterceptor();
