...
1.1
date	2011.04.07.01.35.11;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FXTransToFXInputServiceInterceptorTest.java;
...
public class WEB3FXTransToFXInputServiceInterceptorTest extends TestBaseForMock {

    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3FXTransToFXInputServiceInterceptorTest.class);
    
    public WEB3FXTransToFXInputServiceInterceptorTest(String arg0) {
        super(arg0);
    }
    ...
    WEB3FXTransToFXInputServiceInterceptor l_interceptor = new WEB3FXTransToFXInputServiceInterceptor();
    
    /*
     * Test method for 'webbroker3.aio.WEB3FXTransToFXInputServiceInterceptor.onCall(Method, Object[])'
     */
    ...
    public void testOnCall_T03()
    {
        ...
        try
        {
            ...
            assertEquals("02", l_context.getProductCode());
