...
1.1
date	2011.04.07.01.00.59;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesChangeOpenContractServiceInterceptorTest.java;
...
File Name        : (WEB3FuturesChangeOpenContractServiceInterceptorTest)
 ...
 * @@version 1.0
 */
public class WEB3FuturesChangeOpenContractServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    ...
    WEB3FuturesChangeOpenContractServiceInterceptor l_equityMarginInterceptor = 
        new WEB3FuturesChangeOpenContractServiceInterceptor();
    
    public WEB3FuturesChangeOpenContractServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_002()
    {
        ...
        try
        {
            ...
            WEB3FuturesOpenMarginChangeConfirmRequest[] l_serviceParams = new WEB3FuturesOpenMarginChangeConfirmRequest[1];
            l_serviceParams[0] = new WEB3FuturesOpenMarginChangeConfirmRequest();
    ...
    public void testOnCall_003()
    {
        ...
        try
        {
            ...
            WEB3FuturesOpenMarginChangeCompleteRequest[] l_serviceParams = new WEB3FuturesOpenMarginChangeCompleteRequest[1];
            l_serviceParams[0] = new WEB3FuturesOpenMarginChangeCompleteRequest();
            l_serviceParams[0].id = "33381";
