...
1.1
date	2011.04.07.00.59.00;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionCancelOrderServiceInterceptorTest.java;
 ...
 * @@version 1.0
 */
public class WEB3OptionCancelOrderServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    ...
    WEB3OptionCancelOrderServiceInterceptor l_equityMarginInterceptor = 
        new WEB3OptionCancelOrderServiceInterceptor();
    


    public WEB3OptionCancelOrderServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_002()
    {
        ...
        try
        {
            ...
            WEB3OptionsCancelConfirmRequest[] l_serviceParams = new WEB3OptionsCancelConfirmRequest[1];
            l_serviceParams[0] = new WEB3OptionsCancelConfirmRequest();
    ...
    public void testOnCall_003()
    {
        ...
        try
        {
            ...
            WEB3OptionsCancelCompleteRequest[] l_serviceParams = new WEB3OptionsCancelCompleteRequest[1];
            l_serviceParams[0] = new WEB3OptionsCancelCompleteRequest();
            l_serviceParams[0].id = "33381";
