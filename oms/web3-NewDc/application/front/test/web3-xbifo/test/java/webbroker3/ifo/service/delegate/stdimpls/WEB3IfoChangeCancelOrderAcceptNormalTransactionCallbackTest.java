...
1.1
date	2011.04.07.00.47.38;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3IfoChangeCancelOrderAcceptNormalTransactionCallbackTest.java;
...
File Name        : 先物OP訂正取消受付正常処理一件TransactionCallbackテスト(WEB3IfoChangeCancelOrderAcceptNormalTransactionCallbackTest.java)
...
/**
 * （先物OP訂正取消受付正常処理一件TransactionCallbackテスト）<BR>
 *
 * @@author 周捷
 * @@version 1.0
 */
public class WEB3IfoChangeCancelOrderAcceptNormalTransactionCallbackTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    ...
    public WEB3IfoChangeCancelOrderAcceptNormalTransactionCallbackTest(String arg0)
    {
        super(arg0);
    }
    ...
    WEB3IfoChangeCancelOrderAcceptUnitServiceImpl impl =
        new WEB3IfoChangeCancelOrderAcceptUnitServiceImplForMock();
    WEB3IfoChangeCancelOrderAcceptNormalTransactionCallback callback = null;
    /*
     * Test method for 'webbroker3.ifo.service.delegate.stdimpls.WEB3IfoChangeCancelOrderAcceptNormalTransactionCallback.process()'
     */
    public void testProcess_1()
    {
        ...
        TestBaseForMock.MOCK_MANAGER.setMethodReturnValue(
            ...
            "notifyChangeCancelOrderAccept", new Class[] {HostFotypeOrderAcceptParams.class},
        ...
        try
        {
            ...
            callback = new WEB3IfoChangeCancelOrderAcceptNormalTransactionCallback(l_params);
            callback.process();
    ...
    public void testProcess_3()
    {
        ...
        TestBaseForMock.MOCK_MANAGER.setMethodReturnValue(
            "webbroker3.ifo.service.delegate.stdimpls.WEB3IfoChangeCancelOrderAcceptUnitServiceImpl",
            "notifyChangeCancelOrderAcceptOvertime", new Class[] {HostFotypeOrderAcceptParams.class},
            new WEB3SystemLayerException(
