...
1.1
date	2011.04.07.00.59.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionChangeClosingContractServiceInterceptorTest.java;
...
public class WEB3OptionChangeClosingContractServiceInterceptorTest extends TestBaseForMock
{
    ...
    WEB3OptionChangeClosingContractServiceInterceptor l_equityMarginInterceptor = 
        new WEB3OptionChangeClosingContractServiceInterceptor();
    


    public WEB3OptionChangeClosingContractServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_002()
    {
        ...
        try
        {
            ...
            WEB3OptionsCloseMarginChangeConfirmRequest[] l_serviceParams = new WEB3OptionsCloseMarginChangeConfirmRequest[1];
            l_serviceParams[0] = new WEB3OptionsCloseMarginChangeConfirmRequest();
    ...
    public void testOnCall_003()
    {
        ...
        try
        {
            ...
            WEB3OptionsCloseMarginChangeCompleteRequest[] l_serviceParams = new WEB3OptionsCloseMarginChangeCompleteRequest[1];
            l_serviceParams[0] = new WEB3OptionsCloseMarginChangeCompleteRequest();
            l_serviceParams[0].id = "33381";
