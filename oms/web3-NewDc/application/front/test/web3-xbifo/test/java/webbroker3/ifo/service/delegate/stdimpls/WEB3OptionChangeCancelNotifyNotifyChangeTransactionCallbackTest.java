...
1.1
date	2011.04.07.00.45.49;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallbackTest.java;
...
@/**
 ...
 File Name        : WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallbackテスト
...
/**
 * （OP訂正取消通知訂正通知一件TransactionCallbackテスト）<BR>
 * 
 * @@author 金傑
 * @@version 1.0
 */
public class WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallbackTest extends TestBaseForMock
{
    private WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback l_callBack = null;
    
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallbackTest.class);
    
    public WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallbackTest(String name)
    {
        super(name);
    }
    ...
    protected void setUp() throws Exception
    {
        ...
        this.l_callBack = new WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback(l_ifoChangeCancelNotifyUpdateInterceptor,
...
//    }
    ...
    public void testProcess_C0003()
    {
        ...
        try
        {
            ...
            l_callBack = new WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback(
