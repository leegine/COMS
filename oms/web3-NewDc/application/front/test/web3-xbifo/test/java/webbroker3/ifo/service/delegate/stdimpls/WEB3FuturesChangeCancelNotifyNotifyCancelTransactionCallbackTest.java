...
1.1
date	2011.04.07.00.47.13;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallbackTest.java;
...
@/**
 ...
 File Name        : WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallbackテスト
...
/**
 * （先物訂正取消通知取消通知一件TransactionCallbackテスト）<BR>
 * 
 * @@author 金傑
 * @@version 1.0
 */
public class WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallbackTest extends TestBaseForMock
{
    private WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback l_callBack = null;
    
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallbackTest.class);
    
    public WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallbackTest(String name)
    {
        super(name);
    ...
    protected void setUp() throws Exception
    {
        ...
        this.l_callBack = new WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback(l_ifoChangeCancelNotifyUpdateInterceptor,
...
//    }
    ...
    public void testProcess_C0003()
    {
        ...
        try
        {
            ...
            l_callBack = new WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback(
