...
1.1
date	2011.04.07.00.46.02;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallbackTest.java;
...
@/**
 ...
 File Name        : WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallbackテスト
...
/**
 * （先物訂正取消通知訂正通知一件TransactionCallbackテスト）<BR>
 * 
 * @@author 金傑
 * @@version 1.0
 */
public class WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallbackTest extends TestBaseForMock
{
    private WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallback l_callBack = null;
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility
            .getInstance(WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallbackTest.class);
    
    public WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallbackTest(String name)
    {
        super(name);
    }
    ...
    protected void setUp() throws Exception
    {
        ...
        WEB3IfoChangeCancelNotifyUpdateInterceptor l_ifoChangeCancelNotifyUpdateInterceptor = new WEB3IfoChangeCancelNotifyUpdateInterceptor();
        this.l_callBack = new WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallback(l_ifoChangeCancelNotifyUpdateInterceptor,
...
//    }
    ...
    private void getMockData()
    {
        try
        {
            ...
            TestBaseForMock.MOCK_MANAGER.setMethodReturnValue(
                    "webbroker3.ifo.service.delegate.stdimpls.WEB3FuturesChangeCancelNotifyUnitServiceImpl",
                    "notifyChange", new Class[] { OrderUnit.class, WEB3IfoChangeCancelNotifyUpdateInterceptor.class },
    ...
    public void testProcess_C0003()
    {
        ...
        try
        {
            ...
            l_callBack = new WEB3FuturesChangeCancelNotifyNotifyChangeTransactionCallback(
