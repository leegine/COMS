...
1.1
date	2011.04.07.00.47.08;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesOrderNotifyUnitServiceImplTest.java;
...
Revision History : 2007/06/24 金傑 (中訊) 新規作成 仕様変更モデル715
*/
...
public class WEB3FuturesOrderNotifyUnitServiceImplTest extends TestBaseForMock
{

    private WEB3FuturesOrderNotifyUnitServiceImpl l_serviceImpl = null;
    ...
    public WEB3FuturesOrderNotifyUnitServiceImplTest(String name)
    {
        super(name);
    }
    ...
    protected void setUp() throws Exception
    {
        ...
        this.l_serviceImpl = new WEB3FuturesOrderNotifyUnitServiceImpl();
        this.initData();
        this.setMockMethod();
    }
    ...
    {  
        ...
        catch (WEB3MockObjectRuntimeException l_web3MockObjectRuntimeException)
        {
            ...
            WEB3MockObjectParamsValue l_paramsValue7 = TestBaseForMock.MOCK_MANAGER.getMethodParamsValue(
                    ...
                    "setThreadLocalPersistenceEventInterceptor", 
                    new Class[] {IfoOrderManagerPersistenceEventInterceptor.class});
            assertEquals("1",((WEB3IfoOpenContractOrderNotifyUpdateInterceptor)l_paramsValue7.getFirstCalled()[0]).getSessionType());
            assertEquals(0,WEB3DateUtility.compareToDay(new Date(),((WEB3IfoOpenContractOrderNotifyUpdateInterceptor)l_paramsValue7.getFirstCalled()[0]).getDeliveryDate()));
