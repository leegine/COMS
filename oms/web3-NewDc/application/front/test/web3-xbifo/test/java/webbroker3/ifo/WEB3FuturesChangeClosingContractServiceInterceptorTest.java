...
1.1
date	2011.04.07.01.00.19;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesChangeClosingContractServiceInterceptorTest.java;
...
File Name        : (WEB3FuturesChangeClosingContractServiceInterceptorTest)
 ...
 * @@version 1.0
 */
public class WEB3FuturesChangeClosingContractServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    ...
    WEB3FuturesChangeClosingContractServiceInterceptor l_equityMarginInterceptor = 
        new WEB3FuturesChangeClosingContractServiceInterceptor();
    
    public WEB3FuturesChangeClosingContractServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_002()
    {
        ...
        try
        {
            ...
            WEB3FuturesCloseMarginChangeConfirmRequest[] l_serviceParams = new WEB3FuturesCloseMarginChangeConfirmRequest[1];
            l_serviceParams[0] = new WEB3FuturesCloseMarginChangeConfirmRequest();
