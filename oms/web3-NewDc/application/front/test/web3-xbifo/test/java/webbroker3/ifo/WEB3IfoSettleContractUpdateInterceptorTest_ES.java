...
1.1
date	2011.04.07.01.00.45;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3IfoSettleContractUpdateInterceptorTest_ES.java;
 ...
 * @@author 孟亜南
 */
public class WEB3IfoSettleContractUpdateInterceptorTest_ES extends TestBaseForMock
{

    public WEB3IfoSettleContractUpdateInterceptorTest_ES(String name)
    {
        super(name);
    }
