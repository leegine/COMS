...
1.1
date	2011.04.07.00.44.49;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AsynOptionChangeCancelNotifyServiceImplTest.java;
...
File Name        : (WEB3AsynOptionChangeCancelNotifyServiceImplTest.java)
...
import webbroker3.ifo.service.delegate.stdimpls.WEB3AsynOptionChangeCancelNotifyServiceImpl.WEB3OptionChangeCancelNotifyTransactionCallback;
 ...
 *
 */
public class WEB3AsynOptionChangeCancelNotifyServiceImplTest extends TestBaseForMock
{

    WEB3OptionsChangeCancelNotifyRequest l_request = new WEB3OptionsChangeCancelNotifyRequest();
    WEB3AsynOptionChangeCancelNotifyServiceImpl l_impl = 
        new WEB3AsynOptionChangeCancelNotifyServiceImpl(l_request);
    WEB3OptionChangeCancelNotifyTransactionCallback l_callBack =
        l_impl.new WEB3OptionChangeCancelNotifyTransactionCallback();
    ...
    public WEB3AsynOptionChangeCancelNotifyServiceImplTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testProcess1()
    {
        ...
        try
        {
            ...
            l_hostFotypeOrderClmdNotifyParams.setRequestCode("EI812");
    ...
    public void testProcess8()
    {
        ...
        try
        {
            ...
            l_hostFotypeOrderClmdNotifyParams.setBranchCode("381");
            l_hostFotypeOrderClmdNotifyParams.setAccountCode("2512246");
            l_hostFotypeOrderClmdNotifyParams.setCanmodReceiptType("4");
            l_hostFotypeOrderClmdNotifyParams.setModifiedExecutionType("7");
            l_hostFotypeOrderClmdNotifyParams.setRequestCode("EI812");
            l_hostFotypeOrderClmdNotifyParams.setStatus("0");
            TestDBUtility.insertWithDelAndCommit(l_hostFotypeOrderClmdNotifyParams);
