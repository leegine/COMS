...
1.1
date	2011.04.07.01.00.50;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3IfoOpenContractOrderNotifyUpdateInterceptorTest_ES.java;
...
File Name        : 先物OP新規建注文通知更新インタセプタクラス
...
/**
 * 先物OP新規建注文通知更新インタセプタクラス
 * @@author 孟亜南
 */
public class WEB3IfoOpenContractOrderNotifyUpdateInterceptorTest_ES extends TestBaseForMock
{

    public WEB3IfoOpenContractOrderNotifyUpdateInterceptorTest_ES(String name)
    {
        super(name);
    }
    ...
    private static WEB3LogUtility log =
         WEB3LogUtility.getInstance(
                 WEB3IfoOpenContractOrderNotifyUpdateInterceptorTest_ES.class);
    ...
    public void test_mutate_0001()
    {
        ...
        WEB3IfoOpenContractOrderNotifyUpdateInterceptor l_interceptor =
            new WEB3IfoOpenContractOrderNotifyUpdateInterceptor(l_openContractOrderSpec);
