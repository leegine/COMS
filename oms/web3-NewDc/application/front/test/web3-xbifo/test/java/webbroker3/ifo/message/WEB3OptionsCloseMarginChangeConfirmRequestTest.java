...
1.1
date	2011.04.07.01.23.21;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionsCloseMarginChangeConfirmRequestTest.java;
...
File Name        : 株価指数オプション訂正返済確認リクエストTest(WEB3OptionsCloseMarginChangeConfirmRequestTest.java)
...
public class WEB3OptionsCloseMarginChangeConfirmRequestTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3OptionsCloseMarginChangeConfirmRequestTest.class);
    
    WEB3OptionsCloseMarginChangeConfirmRequest l_request = new WEB3OptionsCloseMarginChangeConfirmRequest();

    public WEB3OptionsCloseMarginChangeConfirmRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    /*
     * Test method for 'webbroker3.ifo.message.WEB3OptionsCloseMarginChangeConfirmRequest.validateATReserveOrder()'
     */
    //連続注文対応
