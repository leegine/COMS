...
1.1
date	2011.04.07.01.00.15;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesChangeClosingContractInputServiceInterceptorTest.java;
...
Revision History : 2008/07/08 劉剣（中訊）新規作成
*/
...
public class WEB3FuturesChangeClosingContractInputServiceInterceptorTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3FuturesChangeClosingContractInputServiceInterceptorTest.class);
    
    private WEB3FuturesChangeClosingContractInputServiceInterceptor l_interceptor = null;

    public WEB3FuturesChangeClosingContractInputServiceInterceptorTest(String arg0)
    {
        super(arg0);
    ...
    protected void setUp() throws Exception
    {
        ...
        this.l_interceptor = new WEB3FuturesChangeClosingContractInputServiceInterceptor();
    }
    ...
    public void testOnCall_C0001()
    {
        ...
        try
        {
            ...
            WEB3OptionsCloseMarginChangeInputRequest[] l_serviceParam = new WEB3OptionsCloseMarginChangeInputRequest[1];
            l_serviceParam[0] = new WEB3OptionsCloseMarginChangeInputRequest();
    ...
    public void testOnCall_C0002()
    {
        ...
        try
        {
            ...
            WEB3FuturesCloseMarginChangeInputRequest[] l_serviceParam = new WEB3FuturesCloseMarginChangeInputRequest[1];
            l_serviceParam[0] = new WEB3FuturesCloseMarginChangeInputRequest();
