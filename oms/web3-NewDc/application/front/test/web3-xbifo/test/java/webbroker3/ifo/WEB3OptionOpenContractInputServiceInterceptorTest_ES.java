...
1.1
date	2011.04.07.00.58.16;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionOpenContractInputServiceInterceptorTest_ES.java;
...
/**
 * OP新規建入力サービスインタセプタ
 * @@author 2007/07/03 孟亜南 
 *
 */
public class WEB3OptionOpenContractInputServiceInterceptorTest_ES extends TestBaseForMock
{

    public WEB3OptionOpenContractInputServiceInterceptorTest_ES(String name)
    {
        super(name);
    }
    ...
    public void test_onCall_0001()
    {
        ...
        try
        {
            ...
            WEB3OptionOpenContractInputServiceInterceptor l_interceptor = new WEB3OptionOpenContractInputServiceInterceptor();
