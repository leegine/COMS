...
1.1
date	2011.04.07.01.27.44;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3EquityChangeOrderServiceImplForMock.java;
...
@/**
 ...
 File Name        : WEB3EquityChangeOrderServiceImplForMock.java
...
public class WEB3EquityChangeOrderServiceImplForMock extends WEB3EquityChangeOrderServiceImpl
{
    /**
     * (ログ出力ユーティリティ。)<BR>
     */
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue(
                "webbroker3.equity.service.delegate.stdimpls.WEB3EquityChangeOrderServiceImpl", "execute", new Class[]
        ...
        {
            log.debug("webbroker3.equity.service.delegate.stdimpls.WEB3EquityChangeOrderServiceImplForMock.execute()");
