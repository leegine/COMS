...
1.1
date	2011.04.07.02.01.55;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3EquityPTSOrderManagerForMock.java;
...
File Name        : WEB3EquityPTSOrderManagerForMock.java
Author Name      : Daiwa Institute of Research
Revision History : 2007/12/25 金傑（中訊）新規作成
*/
...
public class WEB3EquityPTSOrderManagerForMock extends WEB3EquityPTSOrderManager
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3EquityPTSOrderManagerForMock.class);
    ...
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                "getOrderUnit", new Class[]
                { long.class }, new Object[]
                { new Long(l_lngOrderUnitId) });
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager", "getOrderUnit",
                new Class[]
                { long.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.getOrderUnit()");
            return (OrderUnit) TestBaseForMock.MOCK_MANAGER.getMethodReturnValue(
                    "webbroker3.equity.WEB3EquityPTSOrderManager", "getOrderUnit", new Class[]
                    { long.class }).asObject();
        }
        return super.getOrderUnit(l_lngOrderUnitId);
    }
    
    public EqTypeOrderSubmissionResult submitCancelOrder(SubAccount subAccount, EqTypeCancelOrderSpec spec,
            String tradingPassword, boolean skipOrderValidation)
    {
        ...
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager", "submitCancelOrder",
                new Class[]
                { SubAccount.class, EqTypeCancelOrderSpec.class, String.class, boolean.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.submitCancelOrder()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "submitCancelOrder", new Class[]
                    {SubAccount.class, EqTypeCancelOrderSpec.class, String.class, boolean.class}).asWEB3BaseRuntimeException();

            return (EqTypeOrderSubmissionResult) TestBaseForMock.MOCK_MANAGER.getMethodReturnValue(
                    "webbroker3.equity.WEB3EquityPTSOrderManager", "submitCancelOrder", new Class[]
            ...
            OrderTypeEnum l_orderType) throws WEB3BaseException
    {
        ...
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager",
                "validatePTSAccountProductOrderStop", new Class[]
                { SubAccount.class, long.class, OrderTypeEnum.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.validatePTSAccountProductOrderStop()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "validatePTSAccountProductOrderStop", new Class[]
    ...
    public void validatePTSOrderForChangeability(Order l_order) throws WEB3BaseException
    {
        ...
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager",
                ...
                { Order.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.validatePTSOrderForChangeability()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "validatePTSOrderForChangeability", new Class[]
    ...
    public EqTypeNewOrderValidationResult validatePTSOrder(SubAccount l_subAccount,
            WEB3EquityNewCashBasedOrderSpec l_orderSpec) throws WEB3BaseException
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                "validatePTSOrder", new Class[]
                { SubAccount.class, WEB3EquityNewCashBasedOrderSpec.class }, new Object[]
                { l_subAccount, l_orderSpec });
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager", "validatePTSOrder",
                new Class[]
                { SubAccount.class, WEB3EquityNewCashBasedOrderSpec.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.validatePTSOrder()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "validatePTSOrder", new Class[]
                    { SubAccount.class, WEB3EquityNewCashBasedOrderSpec.class }).asWEB3BaseException();
            return (EqTypeNewOrderValidationResult) TestBaseForMock.MOCK_MANAGER.getMethodReturnValue(
                    "webbroker3.equity.WEB3EquityPTSOrderManager", "validatePTSOrder", new Class[]
                    { SubAccount.class, WEB3EquityNewCashBasedOrderSpec.class }).asObject();
        }
        return super.validatePTSOrder(l_subAccount, l_orderSpec);
    }
    
    public boolean isInsiderMessageSuspension(SubAccount l_subAccount, long l_productId) throws WEB3BaseException
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                "isInsiderMessageSuspension", new Class[]
                { SubAccount.class, long.class }, new Object[]
                { l_subAccount, new Long(l_productId) });
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager",
                "isInsiderMessageSuspension", new Class[]
                { SubAccount.class, long.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.isInsiderMessageSuspension()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "isInsiderMessageSuspension", new Class[]
                    { SubAccount.class, long.class }).asWEB3BaseException();
            return TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "isInsiderMessageSuspension", new Class[]
                    { SubAccount.class, long.class }).asBoolean();
        }
        return super.isInsiderMessageSuspension(l_subAccount, l_productId);
    }
    ...
    public long createNewOrderId()
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                ...
                {}, new Object[]
                {});
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager", "createNewOrderId",
                new Class[]
                {}))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.createNewOrderId()");
            return TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "createNewOrderId", new Class[]
                    {}).asLong();
        }
    ...
    public EqTypeOrderSubmissionResult submitNewCashBasedOrder(SubAccount l_subAccount,
            EqTypeNewCashBasedOrderSpec l_orderSpec, long l_lngOrderId, String l_strPassward, boolean l_blnFlag)
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                "submitNewCashBasedOrder", new Class[]
                { SubAccount.class, EqTypeNewCashBasedOrderSpec.class, long.class, String.class, boolean.class },
                new Object[]
                { l_subAccount, l_orderSpec, new Long(l_lngOrderId), l_strPassward, new Boolean(l_blnFlag) });
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager",
                "submitNewCashBasedOrder", new Class[]
                { SubAccount.class, EqTypeNewCashBasedOrderSpec.class, long.class, String.class, boolean.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.submitNewCashBasedOrder()");
            return (EqTypeOrderSubmissionResult) TestBaseForMock.MOCK_MANAGER.getMethodReturnValue(
                    "webbroker3.equity.WEB3EquityPTSOrderManager", "submitNewCashBasedOrder", new Class[]
                    { SubAccount.class, EqTypeNewCashBasedOrderSpec.class, long.class, String.class, boolean.class })
                    .asObject();
        }
        return super.submitNewCashBasedOrder(l_subAccount, l_orderSpec, l_lngOrderId, l_strPassward, l_blnFlag);
    }
    
    public void insertEquityHostOrder(long l_lngOrderId) throws WEB3BaseException
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityOrderManager",
        ...
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityOrderManager",
                ...
                { long.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.insertEquityHostOrder()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityOrderManager",
                    "insertEquityHostOrder", new Class[]
        ...
        super.insertEquityHostOrder(l_lngOrderId);
    }
    
    public Market validateMarket(String l_strMarketCode, String l_strInstitutionCode) throws WEB3BaseException
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                "validateMarket", new Class[]
                { String.class, String.class }, new Object[]
                { l_strMarketCode, l_strInstitutionCode });
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed("webbroker3.equity.WEB3EquityPTSOrderManager", "validateMarket",
                new Class[]
                { String.class, String.class }))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.validateMarket()");
            TestBaseForMock.MOCK_MANAGER.getMethodReturnValue("webbroker3.equity.WEB3EquityPTSOrderManager",
                    "validateMarket", new Class[]
                    { String.class, String.class }).asWEB3BaseException();
            return (Market) TestBaseForMock.MOCK_MANAGER.getMethodReturnValue(
                    "webbroker3.equity.WEB3EquityPTSOrderManager", "validateMarket", new Class[]
                    { String.class, String.class }).asObject();
        }
        return super.validateMarket(l_strMarketCode, l_strInstitutionCode);
    }
    
    public ProcessingResult expireOrder(long l_lngOrderId)
    {
        TestBaseForMock.MOCK_MANAGER.setMethodParamsValue(
        ...
        if (TestBaseForMock.MOCK_MANAGER.isMockUsed(
                ...
                new Class[]{long.class}))
        {
            log.debug("webbroker3.equity.WEB3EquityPTSOrderManagerForMock.expireOrder()");
        ...
        return super.expireOrder(l_lngOrderId);
    }
