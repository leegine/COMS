...
1.1
date	2011.04.07.01.50.54;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3EquitySellCompleteRequestTest.java;
...
File Name        : WEB3EquitySellCompleteRequestTest.java
...
public class WEB3EquitySellCompleteRequestTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
        WEB3EquitySellCompleteRequestTest.class);

    public WEB3EquitySellCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    private void superValidatePassData(WEB3EquitySellCompleteRequest l_request)
    {
