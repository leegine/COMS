...
1.1
date	2011.04.07.01.50.36;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3EquityBuyConfirmRequestTest.java;
...
File Name        : WEB3EquityBuyConfirmRequestTest.java
Author Name      : Daiwa Institute of Research
Revision History : 2007/12/21 于瀟（中訊）新規作成
*/
...
public class WEB3EquityBuyConfirmRequestTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
        WEB3EquityBuyConfirmRequestTest.class);

    public WEB3EquityBuyConfirmRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    private void superValidatePassData(WEB3EquityBuyConfirmRequest l_request)
    {
