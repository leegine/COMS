...
1.1
date	2011.04.07.01.51.29;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MarginCloseMarginCompleteRequestTest.java;
 ...
 * @@version 1.0
 */
public class WEB3MarginCloseMarginCompleteRequestTest extends TestBaseForMock
{
    ...
    public WEB3MarginCloseMarginCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
