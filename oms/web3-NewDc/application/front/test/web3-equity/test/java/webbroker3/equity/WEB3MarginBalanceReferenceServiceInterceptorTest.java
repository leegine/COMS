...
1.1
date	2011.04.07.01.11.30;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MarginBalanceReferenceServiceInterceptorTest.java;
...
File Name        : （WEB3MarginBalanceReferenceServiceInterceptorTest.java）
...
public class WEB3MarginBalanceReferenceServiceInterceptorTest extends TestBaseForMock
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MarginBalanceReferenceServiceInterceptorTest.class);

    public WEB3MarginBalanceReferenceServiceInterceptorTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testOnCall_0001()
    {
        ...
        try
        {
            ...
            WEB3MarginBalanceReferenceServiceInterceptor l_interceptor =
