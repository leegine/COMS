...
1.1
date	2011.04.07.01.12.18;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3EquitySellOrderInputServiceInterceptorTest.java;
...
File Name        : 現物株式売付注文入力サービスインタセプタ(WEB3EquitySellOrderInputServiceInterceptorTest)
...
public class WEB3EquitySellOrderInputServiceInterceptorTest extends TestBaseForMock
{

    public WEB3EquitySellOrderInputServiceInterceptorTest(String name)
    {
        super(name);
    }

    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3EquitySellOrderInputServiceInterceptorTest.class);
...
//            TestDBUtility.insertWithDel(l_calendarParams);
            ...
            WEB3EquitySellOrderInputServiceInterceptor l_interceptor = new WEB3EquitySellOrderInputServiceInterceptor();
