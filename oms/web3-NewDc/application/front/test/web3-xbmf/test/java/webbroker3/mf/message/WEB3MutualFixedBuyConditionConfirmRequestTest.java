...
1.1
date	2011.04.07.01.57.53;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualFixedBuyConditionConfirmRequestTest.java;
...
File Name        : (WEB3MutualFixedBuyConditionConfirmRequestTest.java)
...
public class WEB3MutualFixedBuyConditionConfirmRequestTest extends TestBaseForMock
{
    /**
     * Logger
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualFixedBuyConditionConfirmRequestTest.class);
    
    private WEB3MutualFixedBuyConditionConfirmRequest l_request = null;

    public WEB3MutualFixedBuyConditionConfirmRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    {
        super.setUp();
        l_request = new WEB3MutualFixedBuyConditionConfirmRequest();
    }
    ...
    /*
     * Test method for 'webbroker3.mf.message.WEB3MutualFixedBuyConditionConfirmRequest.validate()'
     */
    ...
    public void testValidate_C0008()
    {
        ...
        try
        {
            ...
            l_request.conditionList[0].mutualProductCode = "300100";
            l_request.conditionList[0].monthlyBuyAmount = null;
            l_request.conditionList[0].increaseBuyAmount = "99999999";
    ...
    public void testValidate_C0018()
    {
        ...
        try
        {
            ...
            l_request.addConditionList[0].mutualProductCode = "300100";
            l_request.addConditionList[0].monthlyBuyAmount = "5000";
            l_request.addConditionList[0].increaseBuyAmount = "99999999";
