...
1.1
date	2011.04.07.02.10.12;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualRecruitOrderServiceImplTest.java;
...
public class WEB3MutualRecruitOrderServiceImplTest extends TestBaseForMock
{
    WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualRecruitOrderServiceImplTest.class);

    public WEB3MutualRecruitOrderServiceImplTest(String arg0)
    {
        super(arg0);
    }
    ...
    public class WEB3MutualApplyConfirmRequestForMock 
    extends WEB3MutualApplyConfirmRequest
    {
        public void validate() throws WEB3BaseException 
        {
            final String STR_METHOD_NAME = "WEB3MutualApplyConfirmRequestForMock + validate()";
    ...
    public class WEB3MutualApplyCompleteRequestForMock 
    extends WEB3MutualApplyCompleteRequest
    {
        public void validate() throws WEB3BaseException 
        {
            final String STR_METHOD_NAME = "WEB3MutualApplyCompleteRequestForMock + validate()";
            log.entering(STR_METHOD_NAME);
    ...
    /*
     * Test method for 'webbroker3.mf.service.delegate.stdimpls.WEB3MutualRecruitOrderServiceImpl.validateOrder(WEB3MutualApplyConfirmRequest)'
     */
    public void testValidateOrderC1()
    {
        final String STR_METHOD_NAME = "testValidateOrderC1";
        log.entering(STR_METHOD_NAME);
        ...
        try
        {
            WEB3MutualApplyConfirmRequestForMock l_request = new WEB3MutualApplyConfirmRequestForMock();
            ...
            l_request.settleDiv = WEB3SettlementDivDef.NORMAL;
            l_request.taxType = WEB3TaxTypeSpecialDef.NORMAL;
            
            WEB3MutualRecruitOrderServiceImpl l_impl = new WEB3MutualRecruitOrderServiceImpl();
    ...
    public void testValidateOrderC2()
    {
        final String STR_METHOD_NAME = "testValidateOrderC2";
        log.entering(STR_METHOD_NAME);
        ...
        l_mfProductParams.setBuyEndDate(WEB3DateUtility.getDate("20080916","yyyyMMdd"));
        l_mfProductParams.setPlowbackProductDiv(WEB3MFPlowbackProductDivDef.PLOWBACK_PRODUCT);
        l_mfProductParams.setRecruitStartDate(WEB3DateUtility.getDate("20040516","yyyyMMdd"));
        l_mfProductParams.setRecruitEndDate(WEB3DateUtility.getDate("20080516","yyyyMMdd"));
        l_mfProductParams.setRecruitMinAmt(123);
        l_mfProductParams.setRecruitMinQty(123);
        l_mfProductParams.setRecruitUnitQty(123);
        l_mfProductParams.setRecruitUnitAmt(123);
    ...
    /*
     * Test method for 'webbroker3.mf.service.delegate.stdimpls.WEB3MutualRecruitOrderServiceImpl.submitOrder(WEB3MutualApplyCompleteRequest)'
     */
    public void testSubmitOrderC1()
    {
        final String STR_METHOD_NAME = "testSubmitOrderC1";
        log.entering(STR_METHOD_NAME);
        ...
        try
        {
            WEB3MutualApplyCompleteRequestForMock l_request = new WEB3MutualApplyCompleteRequestForMock();
            l_request.mutualProductCode = "0";
            l_request.orderedDate = WEB3GentradeTradingTimeManagement.getOrderBizDate();
            l_request.id = "1001";
            l_request.mutualOrderQuantity = "123";       
    ...
    public void testSubmitOrderC2()
    {
        final String STR_METHOD_NAME = "testSubmitOrderC2";
        log.entering(STR_METHOD_NAME);
