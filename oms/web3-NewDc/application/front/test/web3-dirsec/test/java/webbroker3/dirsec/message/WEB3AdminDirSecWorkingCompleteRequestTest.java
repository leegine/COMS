...
1.1
date	2011.04.07.02.00.01;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminDirSecWorkingCompleteRequestTest.java;
...
public class WEB3AdminDirSecWorkingCompleteRequestTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminDirSecWorkingCompleteRequestTest.class);

    public WEB3AdminDirSecWorkingCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testValidate_Case004()
    {
        ...
        try
        {
            ...
            WEB3AdminDirSecBatoPreferenceRecordDetail[] l_batoPreferenceRecord =
                new WEB3AdminDirSecBatoPreferenceRecordDetail[1];
            l_batoPreferenceRecord[0] = new WEB3AdminDirSecBatoPreferenceRecordDetail();
            l_batoPreferenceRecord[0].branchCode = "jid２";
            l_request.batoPreferenceRecord = l_batoPreferenceRecord;
            l_request.validate();
            fail();
        }
    ...
    public void testValidate_Case005()
    {
        ...
        try
        {
            ...
            WEB3AdminDirSecBatoPreferenceRecordDetail[] l_batoPreferenceRecord =
                new WEB3AdminDirSecBatoPreferenceRecordDetail[1];
            l_batoPreferenceRecord[0] = new WEB3AdminDirSecBatoPreferenceRecordDetail();
            l_batoPreferenceRecord[0].branchCode = "１２３";
            l_request.batoPreferenceRecord = l_batoPreferenceRecord;
            l_request.validate();
            fail();
        }
    ...
    public void testValidate_Case009()
    {
        ...
        try
        {
            ...
            l_batoPreferenceRecord[0] = new WEB3AdminDirSecBatoPreferenceRecordDetail();
            l_batoPreferenceRecord[0].branchCode = "123";
            l_batoPreferenceRecord[0].systemTroubleDiv = "１";
    ...
    public void testValidate_Case011()
    {
        ...
        {
            assertEquals(WEB3ErrorCatalog.BUSINESS_ERROR_02510, l_ex.getErrorInfo());
        }
        catch (Exception l_ex)
        {
            log.error(l_ex.getMessage(), l_ex);
