...
1.1
date	2011.04.07.02.33.00;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminDirSecAccRegVoucherStatUpdHandlerTest.java;
...
public class WEB3AdminDirSecAccRegVoucherStatUpdHandlerTest extends TestBaseForMock
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    ...
    WEB3AdminDirSecAccRegVoucherStatUpdHandler l_handler;
    
    public WEB3AdminDirSecAccRegVoucherStatUpdHandlerTest(String arg0)
    {
        super(arg0);
    }
    ...
    {
        l_handler = new WEB3AdminDirSecAccRegVoucherStatUpdHandler();
        super.setUp();
    }
    ...
    public void testGetSearchScreen_T03()
    {
        final String STR_METHOD_NAME = "testGetSearchScreen_T03()";
        log.entering(STR_METHOD_NAME);
        try
        {
            WEB3AdminDirSecAccRegVoucherSearchInpRequest l_request =
    ...
    public void testGetSearchResultScreen_T01()
    {
        ...
        try
        {
            ...
            WEB3AdminDirSecAccRegVoucherSearchResResponse l_response =
                l_handler.getSearchResultScreen(l_request);
            assertEquals(WEB3ErrorCatalog.SYSTEM_ERROR_80002, l_response.errorInfo);
            log.debug(STR_METHOD_NAME + "---------------------->ok");
        }
        catch(Exception l_exc)
    ...
    public void testGetUpdateConfirmScreen_T01()
    {
        ...
        try
        {
            ...
            WEB3AdminDirSecAccRegVoucherStatUpdConfResponse l_response =
                l_handler.getUpdateConfirmScreen(l_request);
            assertEquals(WEB3ErrorCatalog.SYSTEM_ERROR_80002, l_response.errorInfo);
            log.debug(STR_METHOD_NAME + "---------------------->ok");
        }
        catch(Exception l_exc)
    ...
    public void testGetUpdateConfirmScreen_T03()
    {
        final String STR_METHOD_NAME = "testGetUpdateConfirmScreen_T03()";
        log.entering(STR_METHOD_NAME);
        try
        {
            WEB3AdminDirSecAccRegVoucherStatUpdConfRequest l_request =
    ...
    public void testGetUpdateCompleteScreen_T01()
    {
        ...
        try
        {
            ...
            WEB3AdminDirSecAccRegVoucherStatUpdCompResponse l_response =
                l_handler.getUpdateCompleteScreen(l_request);
            assertEquals(WEB3ErrorCatalog.SYSTEM_ERROR_80002, l_response.errorInfo);
            log.debug(STR_METHOD_NAME + "---------------------->ok");
        }
        catch(Exception l_exc)
    ...
    public void testGetUpdateCompleteScreen_T03()
    {
        final String STR_METHOD_NAME = "testGetUpdateCompleteScreen_T03()";
        log.entering(STR_METHOD_NAME);
        try
        {
            //VariousInformParams
