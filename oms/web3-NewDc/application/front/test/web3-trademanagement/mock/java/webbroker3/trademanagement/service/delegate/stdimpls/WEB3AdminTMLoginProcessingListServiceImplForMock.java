...
1.1
date	2011.04.07.01.59.07;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminTMLoginProcessingListServiceImplForMock.java;
...
@/**
 ...
 Revision History : 2008/09/24 張少傑(中訊) 新規作成 モデル 005
*/
...
public class WEB3AdminTMLoginProcessingListServiceImplForMock extends WEB3AdminTMLoginProcessingListServiceImpl
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
            WEB3AdminTMLoginProcessingListServiceImplForMock.class);
    ...
    public WEB3GenResponse execute(WEB3GenRequest l_request) throws WEB3BaseException
    {
        ...
        {
            log.debug("webbroker3.trademanagement.service.delegate.stdimpls.WEB3AdminTMLoginProcessingListServiceImpl.execute(WEB3GenRequest)");
