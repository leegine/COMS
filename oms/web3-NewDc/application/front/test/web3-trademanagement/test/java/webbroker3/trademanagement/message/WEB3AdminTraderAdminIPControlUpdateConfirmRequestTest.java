...
1.1
date	2011.04.07.02.08.09;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminTraderAdminIPControlUpdateConfirmRequestTest.java;
...
File Name        : 管理者・ログイン拒否IP登録情報変更確認リクエスト(WEB3AdminTraderAdminIPControlUpdateConfirmRequestTest.java)
...
public class WEB3AdminTraderAdminIPControlUpdateConfirmRequestTest extends TestBaseForMock 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminTraderAdminIPControlUpdateConfirmRequestTest.class);
    
    WEB3AdminTraderAdminIPControlUpdateConfirmRequest l_request = new WEB3AdminTraderAdminIPControlUpdateConfirmRequest();
    
    public WEB3AdminTraderAdminIPControlUpdateConfirmRequestTest(String name)
    {
        super(name);
    }
