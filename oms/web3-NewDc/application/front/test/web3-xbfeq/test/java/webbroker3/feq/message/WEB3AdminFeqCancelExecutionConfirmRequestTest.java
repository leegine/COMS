...
1.1
date	2011.04.07.02.02.30;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFeqCancelExecutionConfirmRequestTest.java;
...
File Name        : （WEB3AdminFeqCancelExecutionConfirmRequestTest.java）
...
public class WEB3AdminFeqCancelExecutionConfirmRequestTest extends TestBaseForMock
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFeqCancelExecutionConfirmRequestTest.class);
    public WEB3AdminFeqCancelExecutionConfirmRequestTest(String arg0)
    {
        super(arg0);
    }
