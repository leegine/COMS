...
1.1
date	2011.04.07.02.12.16;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFPTDeleteCompleteRequestTest.java;
...
public class WEB3AdminFPTDeleteCompleteRequestTest extends TestBaseForMock
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFPTDeleteCompleteRequestTest.class);

    public WEB3AdminFPTDeleteCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
