...
1.1
date	2011.04.07.02.12.24;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFPTUploadCompleteRequestTest.java;
...
public class WEB3AdminFPTUploadCompleteRequestTest extends TestBaseForMock
{

    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFPTUploadCompleteRequestTest.class);

    public WEB3AdminFPTUploadCompleteRequestTest(String arg0)
    {
        super(arg0);
    }
