...
1.1
date	2011.04.07.02.12.11;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFPTRegistConfirmRequestTest.java;
...
File Name           : 管理者金商法@交付閲覧登録確認リクエストのテストクラス(WEB3AdminFPTRegistConfirmRequestTest.java)
 ...
 * 管理者金商法@交付閲覧登録確認リクエストのテストクラス<BR>
 *
 * @@author 周墨洋
 * @@version 1.0
 */
public class WEB3AdminFPTRegistConfirmRequestTest extends TestBaseForMock
{
     ...
     */
    WEB3AdminFPTRegistConfirmRequest l_request = null;

    /**
     * @@param arg0
     */
    public WEB3AdminFPTRegistConfirmRequestTest(String arg0)
    {
        super(arg0);
    }
    ...
    public void testValidate_case0001()
    {
        ...
        this.l_request = new WEB3AdminFPTRegistConfirmRequest();
