...
filename	WEB3AdminFPTForceLogoutConfirmRequest.java;
...
File Name        : 管理者・書面未承諾 強制ログアウト確認リクエスト(WEB3AdminFPTForceLogoutConfirmRequest.java)
...
/**
 * 管理者 書面未承諾 強制ログアウト確認リクエスト
 * <BR>
 * @@author Kyo
 * @@version 1.0
 */
public class WEB3AdminFPTForceLogoutConfirmRequest extends WEB3GenRequest 
{
    /**
     * PTYPE<BR>
     */
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFPTForceLogoutConfirmRequest.class);
    ...
    /**
     * @@roseuid 47DF46780027
     */
    public WEB3AdminFPTForceLogoutConfirmRequest() 
    {
    ...
    {
        return new WEB3AdminFPTForceLogoutConfirmResponse(this);
    }
}
@
