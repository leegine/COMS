...
filename	WEB3AdminFPTDeleteCompleteRequest.java;
...
File Name        : 管理者金商法@交付閲覧削除完了リクエスト(WEB3AdminFPTDeleteCompleteRequest.java)
...
/**
 * (管理者金商法@交付閲覧削除完了リクエスト)<BR>
 * 管理者金商法@交付閲覧削除完了リクエストクラス<BR>
 *
 * @@author 武波
 * @@version 1.0
 */
public class WEB3AdminFPTDeleteCompleteRequest extends WEB3GenRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFPTDeleteCompleteRequest.class);
     ...
     * SerialVersionUID<BR>
     */
    private static final long serialVersionUID = 200711061015L;
    ...
    /**
     * @@roseuid 472FC5B503C0
     */
    public WEB3AdminFPTDeleteCompleteRequest()
    {
    ...
    {
        return new WEB3AdminFPTDeleteCompleteResponse(this);
    }
