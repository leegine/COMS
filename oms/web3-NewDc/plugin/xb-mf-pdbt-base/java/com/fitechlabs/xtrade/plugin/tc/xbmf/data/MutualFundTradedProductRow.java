...
1.1
date	2011.03.22.09.12.57;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	MutualFundTradedProductRow.java;
...
/** 
 * MutualFundTradedProductRowインタフェースは変更不可でリードオンリーである<em>mutual_fund_traded_product</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link MutualFundTradedProductRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface MutualFundTradedProductRow extends Row {


  /** 
   * この{@@link MutualFundTradedProductRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "mutual_fund_traded_product", "master" );
   ...
   * @@return Stringの値 
   */
  public String getBuyPossibleDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBuyPossibleDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBuyPossibleDivIsModified();
   ...
   * @@return Stringの値 
   */
  public String getSellPossibleDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSellPossibleDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSellPossibleDivIsModified();
   ...
   * @@return Stringの値 
   */
  public String getSwtPossibleDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSwtPossibleDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSwtPossibleDivIsModified();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getExecDateShiftdaysIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getExecDateShiftdaysIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getExecDateShiftdaysIsModified();
   ...
   * @@return intの値 
   */
  public int getBuyUndeliveringTerm();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getBuyUndeliveringTermIsNull();
   ...
   * @@return intの値 
   */
  public int getSellUndeliveringTerm();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getSellUndeliveringTermIsNull();
   ...
   */
  public java.sql.Timestamp getScramBizDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getScramBizDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getScramBizDateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getRecruitPossibleDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRecruitPossibleDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRecruitPossibleDivIsModified();
