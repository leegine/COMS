...
1.1
date	2011.03.22.09.13.35;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	MfTradedProductUpdqRow.java;
...
/** 
 * MfTradedProductUpdqRowインタフェースは変更不可でリードオンリーである<em>mf_traded_product_updq</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link MfTradedProductUpdqRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface MfTradedProductUpdqRow extends Row {


  /** 
   * この{@@link MfTradedProductUpdqRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "mf_traded_product_updq", "master" );
