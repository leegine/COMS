...
File Name        : 累積投資解約一覧ハンドラ(WEB3RuitoSellPossibleListReferenceHandler)
...
public class WEB3RuitoSellPossibleListReferenceHandler implements MessageHandler
{
    ...
    /**
     * 累積投資の解約一覧画面表示処理を行う。<BR>
     * <BR>
     * 累積投資解約一覧サービスを取得し、<BR>
     * execute()メソッドをコールする。<BR>
     * @@param l_request - 累積投資解約一覧リクエストオブジェクト<BR>
            ...
            WEB3RuitoSellListRequest l_request)
    {
        ...
        catch (WEB3BaseException e)
        {
            ...
            log.error(l_request, "累積投資の解約一覧画面表示処理が失敗しました。", e.getErrorInfo(), e);
        }
