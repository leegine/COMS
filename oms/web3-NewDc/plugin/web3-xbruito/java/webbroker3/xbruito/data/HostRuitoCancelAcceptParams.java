...
filename	HostRuitoCancelAcceptParams.java;
...
/** 
 * host_ruito_cancel_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostRuitoCancelAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostRuitoCancelAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostRuitoCancelAcceptParams}が{@@link HostRuitoCancelAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostRuitoCancelAcceptParams extends Params implements HostRuitoCancelAcceptRow {
  ...
  public static final String PTYPE = "host_ruito_cancel_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostRuitoCancelAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostRuitoCancelAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostRuitoCancelAcceptParamsオブジェクトを作成します。 
   */
  public HostRuitoCancelAcceptParams() {
  }
  ...
  /** 
   * 指定のHostRuitoCancelAcceptRowオブジェクトの値を利用してHostRuitoCancelAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostRuitoCancelAcceptRowオブジェクト 
   */
  public HostRuitoCancelAcceptParams( HostRuitoCancelAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostRuitoCancelAcceptRow ) )
       return false;
    return fieldsEqual( (HostRuitoCancelAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostRuitoCancelAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostRuitoCancelAcceptRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table host_ruito_cancel_accept has no primary key.");
  }
