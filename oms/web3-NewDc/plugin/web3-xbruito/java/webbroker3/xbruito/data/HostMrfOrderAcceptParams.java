...
filename	HostMrfOrderAcceptParams.java;
...
/** 
 * host_mrf_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostMrfOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostMrfOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostMrfOrderAcceptParams}が{@@link HostMrfOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostMrfOrderAcceptParams extends Params implements HostMrfOrderAcceptRow {
  ...
  public static final String PTYPE = "host_mrf_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostMrfOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostMrfOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostMrfOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostMrfOrderAcceptParams() {
  }
  ...
  /** 
   * 指定のHostMrfOrderAcceptRowオブジェクトの値を利用してHostMrfOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostMrfOrderAcceptRowオブジェクト 
   */
  public HostMrfOrderAcceptParams( HostMrfOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostMrfOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostMrfOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostMrfOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostMrfOrderAcceptRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table host_mrf_order_accept has no primary key.");
  }
