...
filename	HostRuitoOrderCancelParams.java;
...
/** 
 * host_ruito_order_cancelテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostRuitoOrderCancelRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostRuitoOrderCancelParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostRuitoOrderCancelParams}が{@@link HostRuitoOrderCancelRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostRuitoOrderCancelParams extends Params implements HostRuitoOrderCancelRow {
  ...
  public static final String PTYPE = "host_ruito_order_cancel";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostRuitoOrderCancelRow.TYPE;
  ...
  public RowType getRowType() {
    return HostRuitoOrderCancelRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostRuitoOrderCancelParamsオブジェクトを作成します。 
   */
  public HostRuitoOrderCancelParams() {
  }
  ...
  /** 
   * 指定のHostRuitoOrderCancelRowオブジェクトの値を利用してHostRuitoOrderCancelParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostRuitoOrderCancelRowオブジェクト 
   */
  public HostRuitoOrderCancelParams( HostRuitoOrderCancelRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostRuitoOrderCancelRow ) )
       return false;
    return fieldsEqual( (HostRuitoOrderCancelRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostRuitoOrderCancelRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostRuitoOrderCancelRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table host_ruito_order_cancel has no primary key.");
  }
