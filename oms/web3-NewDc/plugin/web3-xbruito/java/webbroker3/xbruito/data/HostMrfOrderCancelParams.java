...
filename	HostMrfOrderCancelParams.java;
...
/** 
 * host_mrf_order_cancelテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostMrfOrderCancelRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostMrfOrderCancelParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostMrfOrderCancelParams}が{@@link HostMrfOrderCancelRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostMrfOrderCancelParams extends Params implements HostMrfOrderCancelRow {
  ...
  public static final String PTYPE = "host_mrf_order_cancel";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostMrfOrderCancelRow.TYPE;
  ...
  public RowType getRowType() {
    return HostMrfOrderCancelRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostMrfOrderCancelParamsオブジェクトを作成します。 
   */
  public HostMrfOrderCancelParams() {
  }
  ...
  /** 
   * 指定のHostMrfOrderCancelRowオブジェクトの値を利用してHostMrfOrderCancelParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostMrfOrderCancelRowオブジェクト 
   */
  public HostMrfOrderCancelParams( HostMrfOrderCancelRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostMrfOrderCancelRow ) )
       return false;
    return fieldsEqual( (HostMrfOrderCancelRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostMrfOrderCancelRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostMrfOrderCancelRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table host_mrf_order_cancel has no primary key.");
  }
