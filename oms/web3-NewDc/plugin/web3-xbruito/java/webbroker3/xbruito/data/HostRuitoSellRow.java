...
filename	HostRuitoSellRow.java;
...
/** 
 * HostRuitoSellRowインタフェースは変更不可でリードオンリーである<em>host_ruito_sell</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostRuitoSellRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see HostRuitoSellPK 
 */
public interface HostRuitoSellRow extends Row {


  /** 
   * この{@@link HostRuitoSellRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_ruito_sell", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMortgageSellIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMortgageSellIsModified();
