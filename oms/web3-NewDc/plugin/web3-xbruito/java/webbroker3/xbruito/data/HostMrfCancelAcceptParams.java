...
filename	HostMrfCancelAcceptParams.java;
...
/** 
 * host_mrf_cancel_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostMrfCancelAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostMrfCancelAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostMrfCancelAcceptParams}が{@@link HostMrfCancelAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostMrfCancelAcceptParams extends Params implements HostMrfCancelAcceptRow {
  ...
  public static final String PTYPE = "host_mrf_cancel_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostMrfCancelAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostMrfCancelAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostMrfCancelAcceptParamsオブジェクトを作成します。 
   */
  public HostMrfCancelAcceptParams() {
  }
  ...
  /** 
   * 指定のHostMrfCancelAcceptRowオブジェクトの値を利用してHostMrfCancelAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostMrfCancelAcceptRowオブジェクト 
   */
  public HostMrfCancelAcceptParams( HostMrfCancelAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostMrfCancelAcceptRow ) )
       return false;
    return fieldsEqual( (HostMrfCancelAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostMrfCancelAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostMrfCancelAcceptRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table host_mrf_cancel_accept has no primary key.");
  }
