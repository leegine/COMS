...
filename	HostRuitoOrderCancelRow.java;
...
/** 
 * HostRuitoOrderCancelRowインタフェースは変更不可でリードオンリーである<em>host_ruito_order_cancel</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostRuitoOrderCancelRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostRuitoOrderCancelRow extends Row {


  /** 
   * この{@@link HostRuitoOrderCancelRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_ruito_order_cancel", "session" );
