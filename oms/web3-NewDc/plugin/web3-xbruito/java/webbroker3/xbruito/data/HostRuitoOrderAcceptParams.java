...
filename	HostRuitoOrderAcceptParams.java;
...
/** 
 * host_ruito_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostRuitoOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostRuitoOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostRuitoOrderAcceptParams}が{@@link HostRuitoOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostRuitoOrderAcceptParams extends Params implements HostRuitoOrderAcceptRow {
  ...
  public static final String PTYPE = "host_ruito_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostRuitoOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostRuitoOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostRuitoOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostRuitoOrderAcceptParams() {
  }
  ...
  /** 
   * 指定のHostRuitoOrderAcceptRowオブジェクトの値を利用してHostRuitoOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostRuitoOrderAcceptRowオブジェクト 
   */
  public HostRuitoOrderAcceptParams( HostRuitoOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostRuitoOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostRuitoOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostRuitoOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostRuitoOrderAcceptRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table host_ruito_order_accept has no primary key.");
  }
