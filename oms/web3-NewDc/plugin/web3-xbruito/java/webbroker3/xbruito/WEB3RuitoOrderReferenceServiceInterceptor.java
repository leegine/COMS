...
filename	WEB3RuitoOrderReferenceServiceInterceptor.java;
...
File Name        : 累積投資注文照会サービスインタセプタ(WEB3RuitoOrderReferenceServiceInterceptor)
...
/**
 * 累積投資注文照会サービスインタセプタ<BR>
 */
public class WEB3RuitoOrderReferenceServiceInterceptor implements Interceptor
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3RuitoOrderReferenceServiceInterceptor.class);
     ...
     * 取引カレンダコンテキストクリア処理。<BR>
     * <BR>
     * １）　@ThreadLocalSystemAttributesRegistryの以下<BR>
     *       の内容をクリアする。<BR>
     * <BR>
     * 　@取引時間管理.TIMESTAMP_TAG<BR>
     * 　@取引時間管理.OFFSET_TAG<BR>
