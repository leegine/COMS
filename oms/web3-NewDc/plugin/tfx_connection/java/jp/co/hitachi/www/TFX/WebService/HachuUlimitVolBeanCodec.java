...
1.1
date	2011.03.15.02.37.44;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HachuUlimitVolBeanCodec.java;
...
public final class HachuUlimitVolBeanCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "HachuUlimitVolBean" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean";
  ...
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:hachuUlimitVol
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:decimal
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","hachuUlimitVol",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://www.w3.org/2001/XMLSchema","decimal",null),
                                                            "hachuUlimitVol",
  ...
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:shouhinCd
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","shouhinCd",null),
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean typed_obj = (jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = my_obj.getHachuUlimitVol();
      break;
    case 1:
      obj = my_obj.getShouhinCd();
      break;
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setHachuUlimitVol((java.math.BigDecimal)setter_arg);
      break;
    case 1:
      my_obj.setShouhinCd((java.lang.String)setter_arg);
      break;
