...
1.1
date	2011.03.15.02.38.34;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	DeleteOshiraseInCodec.java;
...
public final class DeleteOshiraseInCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "DeleteOshiraseIn" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn";
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn typed_obj = (jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
