...
1.1
date	2011.03.15.02.38.59;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	DeleteOshiraseOut.java;
...
public  class DeleteOshiraseOut 
  
  implements java.io.Serializable
{

  public DeleteOshiraseOut() {}

  public DeleteOshiraseOut(int p_returnCd) 
  {
  ...
  */
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof DeleteOshiraseOut) {
      
      DeleteOshiraseOut __obj__ =  (DeleteOshiraseOut) __other__;
