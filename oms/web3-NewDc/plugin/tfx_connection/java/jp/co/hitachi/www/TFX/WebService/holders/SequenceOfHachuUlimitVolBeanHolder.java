...
1.1
date	2011.03.15.03.04.31;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	SequenceOfHachuUlimitVolBeanHolder.java;
...
public final class SequenceOfHachuUlimitVolBeanHolder 
  implements weblogic.xml.schema.binding.Holder
{

  public jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean[] value;

  public SequenceOfHachuUlimitVolBeanHolder() {}

  public SequenceOfHachuUlimitVolBeanHolder(jp.co.hitachi.www.TFX.WebService.HachuUlimitVolBean[] value) {
    this.value = value;
  } 
