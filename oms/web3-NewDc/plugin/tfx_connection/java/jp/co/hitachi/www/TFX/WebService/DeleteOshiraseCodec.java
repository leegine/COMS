...
1.1
date	2011.03.15.02.38.55;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	DeleteOshiraseCodec.java;
...
// original type: ['http://www.hitachi.co.jp/TFX/WebService']:DeleteOshirase


public final class DeleteOshiraseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "DeleteOshirase" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.DeleteOshirase";
  ...
  //class   name = DeleteOshiraseIn
  //java    type = jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:in0
  //schema  type = ['http://www.hitachi.co.jp/TFX/WebService']:DeleteOshiraseIn
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","in0",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","DeleteOshiraseIn",null),
                                                            "in0",
                                                            jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.DeleteOshirase();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.DeleteOshirase typed_obj = (jp.co.hitachi.www.TFX.WebService.DeleteOshirase) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.DeleteOshirase my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.DeleteOshirase my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setIn0((jp.co.hitachi.www.TFX.WebService.DeleteOshiraseIn)setter_arg);
      break;
