...
1.1
date	2011.03.15.02.38.00;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EntryReceiptOutCodec.java;
...
public final class EntryReceiptOutCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "EntryReceiptOut" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.EntryReceiptOut";
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.EntryReceiptOut();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.EntryReceiptOut typed_obj = (jp.co.hitachi.www.TFX.WebService.EntryReceiptOut) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.EntryReceiptOut my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.EntryReceiptOut my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
