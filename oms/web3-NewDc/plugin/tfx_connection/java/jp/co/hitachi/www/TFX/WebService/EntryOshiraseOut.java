...
1.1
date	2011.03.15.02.36.20;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EntryOshiraseOut.java;
...
public  class EntryOshiraseOut 
  
  implements java.io.Serializable
{

  public EntryOshiraseOut() {}

  public EntryOshiraseOut(int p_ntcNo
,     int p_returnCd) 
  {
     this.ntcNo = p_ntcNo;
  ...
  */
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof EntryOshiraseOut) {
      
      EntryOshiraseOut __obj__ =  (EntryOshiraseOut) __other__;
