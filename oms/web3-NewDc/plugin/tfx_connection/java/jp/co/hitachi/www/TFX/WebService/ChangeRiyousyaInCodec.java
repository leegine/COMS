...
1.1
date	2011.03.15.02.36.07;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	ChangeRiyousyaInCodec.java;
...
// original type: ['http://www.hitachi.co.jp/TFX/WebService']:ChangeRiyousyaIn


public final class ChangeRiyousyaInCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "ChangeRiyousyaIn" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.ChangeRiyousyaIn";
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.ChangeRiyousyaIn();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.ChangeRiyousyaIn typed_obj = (jp.co.hitachi.www.TFX.WebService.ChangeRiyousyaIn) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.ChangeRiyousyaIn my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.ChangeRiyousyaIn my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
