...
1.1
date	2011.03.15.02.39.16;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EntryRiyousyaResponseCodec.java;
...
public final class EntryRiyousyaResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "EntryRiyousyaResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.EntryRiyousyaResponse";
  ...
  //class   name = EntryRiyousyaOut
  //java    type = jp.co.hitachi.www.TFX.WebService.EntryRiyousyaOut
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:EntryRiyousyaReturn
  //schema  type = ['http://www.hitachi.co.jp/TFX/WebService']:EntryRiyousyaOut
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","EntryRiyousyaReturn",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","EntryRiyousyaOut",null),
                                                            "entryRiyousyaReturn",
                                                            jp.co.hitachi.www.TFX.WebService.EntryRiyousyaOut.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.EntryRiyousyaResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.EntryRiyousyaResponse typed_obj = (jp.co.hitachi.www.TFX.WebService.EntryRiyousyaResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.EntryRiyousyaResponse my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = my_obj.getEntryRiyousyaReturn();
      break;
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.EntryRiyousyaResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setEntryRiyousyaReturn((jp.co.hitachi.www.TFX.WebService.EntryRiyousyaOut)setter_arg);
      break;
