...
1.1
date	2011.03.15.02.37.14;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	InquirySyoriKekkaOutCodec.java;
...
public final class InquirySyoriKekkaOutCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "InquirySyoriKekkaOut" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.InquirySyoriKekkaOut";
  ...
  //class   name = int
  //java    type = int
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:ntcNo
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:int
  //array: false primitive: true  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","ntcNo",null),
  ...
  //class   name = int
  //java    type = int
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:refReturnCd
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:int
  //array: false primitive: true  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","refReturnCd",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://www.w3.org/2001/XMLSchema","int",null),
                                                            "refReturnCd",
                                                            int.class,
                                                            false,
  ...
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:webServDiv
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","webServDiv",null),
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.InquirySyoriKekkaOut();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.InquirySyoriKekkaOut typed_obj = (jp.co.hitachi.www.TFX.WebService.InquirySyoriKekkaOut) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.InquirySyoriKekkaOut my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = new java.lang.Integer(my_obj.getNtcNo());
      break;
    case 1:
      obj = new java.lang.Integer(my_obj.getRefReturnCd());
      break;
    case 2:
      obj = new java.lang.Integer(my_obj.getReturnCd());
      break;
    case 3:
      obj = my_obj.getWebServDiv();
      break;
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.InquirySyoriKekkaOut my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setNtcNo(((java.lang.Number)setter_arg).intValue());
      break;
    case 1:
      my_obj.setRefReturnCd(((java.lang.Number)setter_arg).intValue());
      break;
    case 2:
      my_obj.setReturnCd(((java.lang.Number)setter_arg).intValue());
      break;
    case 3:
      my_obj.setWebServDiv((java.lang.String)setter_arg);
      break;
