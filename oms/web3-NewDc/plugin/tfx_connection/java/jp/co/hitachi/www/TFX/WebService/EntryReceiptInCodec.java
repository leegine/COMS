...
1.1
date	2011.03.15.02.39.20;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EntryReceiptInCodec.java;
...
public final class EntryReceiptInCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://www.hitachi.co.jp/TFX/WebService" , "EntryReceiptIn" );

  private static final java.lang.String JAVA_TYPE = 
     "jp.co.hitachi.www.TFX.WebService.EntryReceiptIn";
  ...
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:kamokuCd
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","kamokuCd",null),
  ...
  //schema  name = ['http://www.hitachi.co.jp/TFX/WebService']:reptAmt
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:decimal
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://www.hitachi.co.jp/TFX/WebService","reptAmt",null),
  ...
  protected java.lang.Object createObject() {
    return new jp.co.hitachi.www.TFX.WebService.EntryReceiptIn();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    jp.co.hitachi.www.TFX.WebService.EntryReceiptIn typed_obj = (jp.co.hitachi.www.TFX.WebService.EntryReceiptIn) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(jp.co.hitachi.www.TFX.WebService.EntryReceiptIn my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = my_obj.getKamokuCd();
      break;
    case 1:
      obj = my_obj.getReptAmt();
      break;
    case 2:
      obj = my_obj.getRysCd();
      break;
  ...
  private static void typedInvokeSetter(jp.co.hitachi.www.TFX.WebService.EntryReceiptIn my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setKamokuCd((java.lang.String)setter_arg);
      break;
    case 1:
      my_obj.setReptAmt((java.math.BigDecimal)setter_arg);
      break;
    case 2:
