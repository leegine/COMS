...
/** 
 * <b>DepositAutotransferStop</b>データベーステーブルで一意である1つのレコードをあらわす<b>DepositAutotransferStop</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>DepositAutotransferStop</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
...
public class DepositAutotransferStopPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: DepositAutotransferStopRow. 
   */
  ...
  /**
   * <em>deposit_autotransfer_stop_id</em>カラムの値をあらわす18桁以下のlong値 
   */
