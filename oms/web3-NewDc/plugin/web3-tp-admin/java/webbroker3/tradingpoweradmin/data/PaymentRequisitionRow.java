...
1.1
date	2011.03.15.00.58.44;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	PaymentRequisitionRow.java;
...
/** 
 * PaymentRequisitionRowインタフェースは変更不可でリードオンリーである<em>payment_requisition</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link PaymentRequisitionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface PaymentRequisitionRow extends Row {


  /** 
   * この{@@link PaymentRequisitionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "payment_requisition", "session" );
   ...
   */
  public  boolean  getPaymentRequisitionIdIsSet();
   ...
   */
  public  boolean  getPaymentRequisitionIdIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOccurredDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOccurredDateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getPaymentRequisitionDivision();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPaymentRequisitionDivisionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPaymentRequisitionDivisionIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRequisitionStatusIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRequisitionStatusIsModified();
   ...
   * @@return doubleの値 
   */
  public double getPaymentRequisitionAmount();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPaymentRequisitionAmountIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPaymentRequisitionAmountIsModified();
   ...
   * @@return doubleの値 
   */
  public double getMarginCollateralRate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMarginCollateralRateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMarginCollateralRateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getCalclationSource();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCalclationSourceIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCalclationSourceIsModified();
