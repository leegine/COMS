...
1.1
date	2011.03.15.00.58.49;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	DepositAutotransferStopRow.java;
...
/** 
 * DepositAutotransferStopRowインタフェースは変更不可でリードオンリーである<em>deposit_autotransfer_stop</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link DepositAutotransferStopRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface DepositAutotransferStopRow extends Row {


  /** 
   * この{@@link DepositAutotransferStopRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "deposit_autotransfer_stop", "account" );
   ...
   * @@return longの値 
   */
  public long getDepositAutotransferStopId();
   ...
   */
  public  boolean  getDepositAutotransferStopIdIsSet();
   ...
   */
  public  boolean  getDepositAutotransferStopIdIsModified();
   ...
   */
  public java.sql.Timestamp getAutotransferStopStart();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAutotransferStopStartIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAutotransferStopStartIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getAutotransferStopEnd();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAutotransferStopEndIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAutotransferStopEndIsModified();
