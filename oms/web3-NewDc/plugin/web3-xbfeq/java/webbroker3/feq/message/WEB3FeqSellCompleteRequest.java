...
1.1
date	2011.03.16.03.33.52;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FeqSellCompleteRequest.java;
...
File Name        : 外国株式売付完了リクエスト(WEB3FeqSellCompleteRequest)
...
public class WEB3FeqSellCompleteRequest extends WEB3FeqSellCommonRequest 
{    
    /**
     * PTYPE<BR>
     */
    ...
    /**
     * @@roseuid 42CE3A0A01B5
     */
    public WEB3FeqSellCompleteRequest() 
    {
    ...
    */    
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3FeqSellCompleteRequest.class);
     ...
     *    this.確認時発注日 == null<BR>
     * <BR>
     *    の場合、「確認時発注日がnull」の例外をスローする。<BR>
     * 　@class: WEB3BusinessLayerException<BR>
     * 　@tag:   BUSINESS_ERROR_00078<BR>
     * 
     * @@throws WEB3BaseException
     * @@roseuid 429479A9035B
     */
    ...
    {
        return new WEB3FeqSellCompleteResponse(this);
    }
}
@
