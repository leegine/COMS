...
1.1
date	2011.03.16.03.38.14;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFeqExchangeRegistConfirmRequest.java;
...
File Name        : 管理者外国株式為替登録確認リクエスト(WEB3AdminFeqExchangeRegistConfirmRequest.java)
...
/**
 * (管理者外国株式為替登録確認リクエスト)<BR>
 * 管理者外国株式為替登録確認リクエストクラス
 *   
 * @@author 戴義波
 * @@version 1.0
 */
public class WEB3AdminFeqExchangeRegistConfirmRequest extends WEB3GenRequest 
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AdminFeqExchangeRegistConfirmRequest.class);
    ...
    /**
     * @@roseuid 42CE3A0000BB
     */
    public WEB3AdminFeqExchangeRegistConfirmRequest() 
    {
    ...
    {
        return new WEB3AdminFeqExchangeRegistConfirmResponse(this);
    }
}
@
