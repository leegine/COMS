...
1.1
date	2011.03.16.03.38.10;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFeqMarketLinkChangeConfirmRequest.java;
...
File Name        : 管理者外国株式市場連動区分変更確認リクエスト(WEB3AdminFeqMarketLinkChangeConfirmRequest.java)
...
/**
 * (管理者外国株式市場連動区分変更確認リクエスト)<BR>
 * 管理者外国株式市場連動区分変更確認リクエストクラス<BR>
 * 
 * @@author 何文敏(中訊)
 * @@version 1.0
 */
...
public class WEB3AdminFeqMarketLinkChangeConfirmRequest extends WEB3GenRequest 
{
    /**
     * PTYPE<BR>
     */
     ...
     */
    public WEB3AdminFeqMarketLinkChangeConfirmRequest() 
    {
   ...
   {
       return new WEB3AdminFeqMarketLinkChangeConfirmResponse(this);
   }
