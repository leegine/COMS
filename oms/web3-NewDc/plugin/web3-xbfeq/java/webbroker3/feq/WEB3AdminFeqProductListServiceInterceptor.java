...
filename	WEB3AdminFeqProductListServiceInterceptor.java;
...
File Name        : 管理者外国株式銘柄一覧インタセプタ(WEB3AdminFeqProductListServiceInterceptor.java)
...
/**
 * (管理者外国株式銘柄一覧インタセプタ)<BR>
 * 管理者外国株式銘柄一覧インタセプタ<BR>
 *   
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminFeqProductListServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFeqProductListServiceInterceptor.class);
    
    /**
     * @@roseuid 42D0CED30177
     */
    public WEB3AdminFeqProductListServiceInterceptor() 
    {
     ...
     * 　@－ログインセッションよりログインＩＤを取得，ログインＩＤに該当する<BR>
     * 管理者の情報より、<BR>
