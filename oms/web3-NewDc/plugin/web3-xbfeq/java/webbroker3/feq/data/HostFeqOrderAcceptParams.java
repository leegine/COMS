...
filename	HostFeqOrderAcceptParams.java;
...
/** 
 * host_feq_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostFeqOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostFeqOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostFeqOrderAcceptParams}が{@@link HostFeqOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostFeqOrderAcceptParams extends Params implements HostFeqOrderAcceptRow {
  ...
  public static final String PTYPE = "host_feq_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostFeqOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostFeqOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostFeqOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostFeqOrderAcceptParams() {
  ...
  /** 
   * 指定のHostFeqOrderAcceptRowオブジェクトの値を利用してHostFeqOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostFeqOrderAcceptRowオブジェクト 
   */
  public HostFeqOrderAcceptParams( HostFeqOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostFeqOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostFeqOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostFeqOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostFeqOrderAcceptRow row )
  {
  ...
  {
    return new HostFeqOrderAcceptPK(rowid);
  }
