...
filename	HostFeqChangecancelOrderRow.java;
...
/** 
 * HostFeqChangecancelOrderRowインタフェースは変更不可でリードオンリーである<em>host_feq_changecancel_order</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostFeqChangecancelOrderRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostFeqChangecancelOrderRow extends Row {


  /** 
   * この{@@link HostFeqChangecancelOrderRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_feq_changecancel_order", "session" );
   ...
   * @@return Stringの値 
   */
  public String getOrderActionSerialNo();
