...
filename	FeqLimitPriceRangeMstRow.java;
...
/** 
 * FeqLimitPriceRangeMstRowインタフェースは変更不可でリードオンリーである<em>feq_limit_price_range_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link FeqLimitPriceRangeMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface FeqLimitPriceRangeMstRow extends Row {


  /** 
   * この{@@link FeqLimitPriceRangeMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "feq_limit_price_range_mst", "master" );
