...
filename	HostFeqCloseOrderNotifyParams.java;
...
/** 
 * host_feq_close_order_notifyテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostFeqCloseOrderNotifyRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostFeqCloseOrderNotifyParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostFeqCloseOrderNotifyParams}が{@@link HostFeqCloseOrderNotifyRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostFeqCloseOrderNotifyParams extends Params implements HostFeqCloseOrderNotifyRow {
  ...
  public static final RowType TYPE = HostFeqCloseOrderNotifyRow.TYPE;
  ...
  /** 
   * 値が未設定のHostFeqCloseOrderNotifyParamsオブジェクトを作成します。 
   */
  public HostFeqCloseOrderNotifyParams() {
  ...
  /** 
   * 指定のHostFeqCloseOrderNotifyRowオブジェクトの値を利用してHostFeqCloseOrderNotifyParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostFeqCloseOrderNotifyRowオブジェクト 
   */
  public HostFeqCloseOrderNotifyParams( HostFeqCloseOrderNotifyRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostFeqCloseOrderNotifyRow ) )
       return false;
    return fieldsEqual( (HostFeqCloseOrderNotifyRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostFeqCloseOrderNotifyRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostFeqCloseOrderNotifyRow row )
  {
  ...
  {
    return new HostFeqCloseOrderNotifyPK(rowid);
  }
