...
filename	FeqOrderChangeStatusRow.java;
...
/** 
 * FeqOrderChangeStatusRowインタフェースは変更不可でリードオンリーである<em>feq_order_change_status</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link FeqOrderChangeStatusRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface FeqOrderChangeStatusRow extends Row {


  /** 
   * この{@@link FeqOrderChangeStatusRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "feq_order_change_status", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalOrderIdIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalOrderIdIsModified();
   ...
   */
  public  boolean  getNewOrderIdIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getNewOrderIdIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getNewOrderIdIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalOrderStatusIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalOrderStatusIsModified();
   ...
   * @@return Stringの値 
   */
  public String getOriginalOrderErrorMessage();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalOrderErrorMessageIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalOrderErrorMessageIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getNewOrderStatusIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getNewOrderStatusIsModified();
   ...
   * @@return Stringの値 
   */
  public String getNewOrderErrorMessage();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getNewOrderErrorMessageIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getNewOrderErrorMessageIsModified();
