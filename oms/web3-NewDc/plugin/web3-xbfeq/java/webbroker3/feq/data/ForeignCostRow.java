...
/** 
 * ForeignCostRowインタフェースは変更不可でリードオンリーである<em>foreign_cost</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link ForeignCostRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see ForeignCostPK 
 */
public interface ForeignCostRow extends Row {


  /** 
   * この{@@link ForeignCostRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "foreign_cost", "master" );
