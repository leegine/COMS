...
/** 
 * <b>FeqOrderChangeStatus</b>データベーステーブルで一意である1つのレコードをあらわす<b>FeqOrderChangeStatus</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>FeqOrderChangeStatus</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
...
public class FeqOrderChangeStatusPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: FeqOrderChangeStatusRow. 
   */
  ...
  /**
   * <em>original_order_id</em>カラムの値をあらわす18桁以下のlong値 
   */
