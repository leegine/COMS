...
filename	FeqLimitPriceRangeMstPK.java;
...
/** 
 * <b>FeqLimitPriceRangeMst</b>データベーステーブルで一意である1つのレコードをあらわす<b>FeqLimitPriceRangeMst</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>FeqLimitPriceRangeMst</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class FeqLimitPriceRangeMstPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: FeqLimitPriceRangeMstRow. 
   */
   ...
   * デフォルトコンストラクタ 
   */
  public FeqLimitPriceRangeMstPK() { 
  }
   ...
   */
  public FeqLimitPriceRangeMstPK( String p_marketCode, double p_lowPrice ) {
   ...
   */
  public static FeqLimitPriceRangeMstPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    FeqLimitPriceRangeMstPK pk = new FeqLimitPriceRangeMstPK();
  ...
  {
    if ( other == null || !( other instanceof FeqLimitPriceRangeMstPK) )
      return false;
    FeqLimitPriceRangeMstPK o = (FeqLimitPriceRangeMstPK) other;
    if ( market_code == null ) {
