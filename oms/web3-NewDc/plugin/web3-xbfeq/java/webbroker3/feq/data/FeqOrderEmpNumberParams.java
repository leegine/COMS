...
/** 
 * feq_order_emp_numberテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link FeqOrderEmpNumberRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link FeqOrderEmpNumberParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link FeqOrderEmpNumberParams}が{@@link FeqOrderEmpNumberRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class FeqOrderEmpNumberParams extends Params implements FeqOrderEmpNumberRow {
  ...
  /** 
   * <em>latest_order_emp_number</em>カラムの値 
   */
  ...
  /** 
   * 値が未設定のFeqOrderEmpNumberParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のFeqOrderEmpNumberRowオブジェクトの値を利用してFeqOrderEmpNumberParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するFeqOrderEmpNumberRowオブジェクト 
   */
   ...
   * @@param row 比較対照のFeqOrderEmpNumberRow 
  ...
  /** 
   * <em>latest_order_emp_number</em>カラムの値を設定します。 
   *
   * @@param p_latestOrderEmpNumber <em>latest_order_emp_number</em>カラムの値をあらわす4桁以下のString値 
   */
