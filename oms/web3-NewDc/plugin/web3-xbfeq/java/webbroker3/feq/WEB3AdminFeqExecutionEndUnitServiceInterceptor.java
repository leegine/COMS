...
filename	WEB3AdminFeqExecutionEndUnitServiceInterceptor.java;
...
File Name        : 外国株式出来終了UnitServiceインタセプタ(WEB3AdminFeqExecutionEndUnitServiceInterceptor.java)
...
/**
 * (外国株式出来終了UnitServiceインタセプタ)<BR>
 * 外国株式出来終了UnitServiceインタセプタ<BR><BR>
 *   
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminFeqExecutionEndUnitServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFeqExecutionEndUnitServiceInterceptor.class);
            
    /**
     * @@roseuid 42D0CED20251
     */
    public WEB3AdminFeqExecutionEndUnitServiceInterceptor() 
    {
