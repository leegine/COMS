...
filename	WEB3AdminFeqSendQueueRecoveryServiceInterceptor.java;
...
@/**
 ...
 File Name        : 管理者外国株式SENDキューリカバリサービスインタセプタ(WEB3AdminFeqSendQueueRecoveryServiceInterceptor.java)
...
/**
 * (管理者外国株式SENDキューリカバリサービスインタセプタ)<BR>
 * 管理者外国株式SENDキューリカバリサービスインタセプタ<BR>
 * 
 * @@author 徐大方
 * @@version 1.0
 */
public class WEB3AdminFeqSendQueueRecoveryServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFeqSendQueueRecoveryServiceInterceptor.class);

    /**
     * @@roseuid 42D0CED30177
     */
    public WEB3AdminFeqSendQueueRecoveryServiceInterceptor() 
    {
