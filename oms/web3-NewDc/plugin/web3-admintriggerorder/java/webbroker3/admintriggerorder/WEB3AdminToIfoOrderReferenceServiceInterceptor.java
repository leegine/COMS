...
filename	WEB3AdminToIfoOrderReferenceServiceInterceptor.java;
...
File Name        : トリガー注文管理者・先物OP注文照会サービスインタセプタ(WEB3AdminToIfoOrderReferenceServiceInterceptor.java)
...
/**
 * (トリガー注文管理者・先物OP注文照会サービスインタセプタ)<BR>
 * トリガー注文管理者・先物OP注文照会サービスインタセプタ<BR>
 *   
 * @@author 譚漢江
 * @@version 1.0
 */
public class WEB3AdminToIfoOrderReferenceServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminToIfoOrderReferenceServiceInterceptor.class);

    /**
     * @@roseuid 43F1BD9F0242
     */
    public WEB3AdminToIfoOrderReferenceServiceInterceptor() 
    {
