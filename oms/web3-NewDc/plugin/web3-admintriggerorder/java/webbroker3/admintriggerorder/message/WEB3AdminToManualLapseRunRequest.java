...
filename	WEB3AdminToManualLapseRunRequest.java;
...
File Name        : トリガー注文管理者・手動失効処理起動リクエスト(WEB3AdminToManualLapseRunRequest.java)
...
/**
 * (トリガー注文管理者・手動失効処理起動リクエスト)<BR>
 * トリガー注文管理者・手動失効処理起動リクエスト<BR>
 * 
 * @@author 余新敏
 * @@version 1.0
 */
public class WEB3AdminToManualLapseRunRequest extends WEB3GenRequest 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminToManualLapseRunRequest.class);
    ...
    /**
     * @@roseuid 44192EED0196
     */
    public WEB3AdminToManualLapseRunRequest() 
    {
     ...
     * <BR>
     * トリガー注文管理者・手動失効処理起動レスポンスオブジェクトを返却する。
     * @@return WEB3GenResponse
     * @@roseuid 41E78F6401A5
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminToManualLapseRunResponse(this);
    }
}
@
