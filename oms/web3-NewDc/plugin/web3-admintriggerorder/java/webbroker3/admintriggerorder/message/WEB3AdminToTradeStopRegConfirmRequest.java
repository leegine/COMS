...
filename	WEB3AdminToTradeStopRegConfirmRequest.java;
...
File Name        : トリガー注文管理者・取扱停止登録確認リクエスト(WEB3AdminToTradeStopRegConfirmRequest.java)
...
/**
 * (トリガー注文管理者・取扱停止登録確認リクエスト)<BR>
 * トリガー注文管理者・取扱停止登録確認リクエストクラス<BR>
 * 
 * @@author 呉衛安
 * @@version 1.0  
 */
public class WEB3AdminToTradeStopRegConfirmRequest extends WEB3GenRequest 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminToTradeStopRegConfirmRequest.class);
    ...
    /**
     * @@roseuid 4430D36202CE
     */
    public WEB3AdminToTradeStopRegConfirmRequest() 
    {
     ...
     * <BR>
     * トリガー注文管理者・取扱停止登録確認レスポンスオブジェクトを返却する。<BR>
     * @@return WEB3GenResponse
     * @@roseuid 41E78F6401A5
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminToTradeStopRegConfirmResponse(this);
    }
}@
