...
filename	WEB3AdminToManualLapseInputRequest.java;
...
File Name        : トリガー注文管理者・手動失効入力リクエスト(WEB3AdminToManualLapseInputRequest.java)
...
/**
 * (トリガー注文管理者・手動失効入力リクエスト)<BR>
 * トリガー注文管理者・手動失効入力リクエスト<BR>
 * 
 * @@author 余新敏
 * @@version 1.0
 */
public class WEB3AdminToManualLapseInputRequest extends WEB3GenRequest 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminToManualLapseInputRequest.class);
    ...
    /**
     * @@roseuid 44192EEC034B
     */
    public WEB3AdminToManualLapseInputRequest() 
    {
     ...
     * <BR>
     * トリガー注文管理者・手動失効入力レスポンスオブジェクトを返却する。
     * @@return WEB3GenResponse
     * @@roseuid 41E78F6401A5
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminToManualLapseInputResponse(this);
    }
}
@
