...
filename	WEB3AdminToEquityOrderRefInpRequest.java;
...
File Name        : トリガー注文管理者・株式注文照会入力リクエスト(WEB3AdminToEquityOrderRefInpRequest.java)
 ...
 * @@version 1.0<BR>
 */
public class WEB3AdminToEquityOrderRefInpRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminToEquityOrderRefInpRequest.class);
...
　@   * 取扱可能部店コード一覧がセットされる。<BR> 
     ...
     */
    public WEB3AdminToEquityOrderRefInpRequest() 
    {
     ...
     * <BR>
     * トリガー注文管理者・株式注文照会入力レスポンスオブジェクトを返却する。
     * @@return WEB3GenResponse
     * @@roseuid 41E78F6401A5
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminToEquityOrderRefInpResponse(this);
    }
