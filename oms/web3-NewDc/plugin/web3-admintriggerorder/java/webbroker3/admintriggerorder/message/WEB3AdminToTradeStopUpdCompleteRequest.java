...
filename	WEB3AdminToTradeStopUpdCompleteRequest.java;
...
File Name        : トリガー注文管理者・取扱停止変更完了リクエスト(WEB3AdminToTradeStopUpdCompleteRequest.java)
...
/**
 * (トリガー注文管理者・取扱停止変更完了リクエスト)<BR>
 * トリガー注文管理者・取扱停止変更完了リクエストクラス<BR>
 * 
 * @@author 張　@芳
 * @@version 1.0
 */
public class WEB3AdminToTradeStopUpdCompleteRequest extends WEB3AdminToCommonRequest 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminToTradeStopUpdCompleteRequest.class);
    ...
    /**
     * @@roseuid 4430D3B902CE
     */
    public WEB3AdminToTradeStopUpdCompleteRequest() 
    {
     ...
     * <BR>
     * トリガー注文管理者・取扱停止変更完了レスポンスオブジェクトを返却する。<BR>
     * @@return WEB3GenResponse
     * @@roseuid 41E78F6401A5
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminToTradeStopUpdCompleteResponse(this);
    }
}
@
