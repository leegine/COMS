...
File Name        : トリガー注文管理者・取扱停止削除完了リクエスト(WEB3AdminToTradeStopDelCompleteRequest.java)
...
/**
 * (トリガー注文管理者・取扱停止削除完了リクエスト)<BR>
 * トリガー注文管理者・取扱停止削除完了リクエストクラス<BR>
 * 
 * @@author 呉衛安
 * @@version 1.0   
 */
public class WEB3AdminToTradeStopDelCompleteRequest extends WEB3GenRequest 
{
     ...
     * <BR>
     * トリガー注文管理者・取扱停止削除完了レスポンスオブジェクトを返却する。<BR>
