...
filename	AdmintoIfoOrderUnitParams.java;
...
/** 
 * adminto_ifo_order_unitテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AdmintoIfoOrderUnitRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AdmintoIfoOrderUnitParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AdmintoIfoOrderUnitParams}が{@@link AdmintoIfoOrderUnitRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class AdmintoIfoOrderUnitParams extends Params implements AdmintoIfoOrderUnitRow {
  ...
  public static final RowType TYPE = AdmintoIfoOrderUnitRow.TYPE;
  ...
  /** 
   * 値が未設定のAdmintoIfoOrderUnitParamsオブジェクトを作成します。 
   */
  public AdmintoIfoOrderUnitParams() {
  ...
  /** 
   * 指定のAdmintoIfoOrderUnitRowオブジェクトの値を利用してAdmintoIfoOrderUnitParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAdmintoIfoOrderUnitRowオブジェクト 
   */
  public AdmintoIfoOrderUnitParams( AdmintoIfoOrderUnitRow p_row )
  {
  ...
  {
    if ( !( other instanceof AdmintoIfoOrderUnitRow ) )
       return false;
    return fieldsEqual( (AdmintoIfoOrderUnitRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のAdmintoIfoOrderUnitRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( AdmintoIfoOrderUnitRow row )
  {
  ...
  {
    return new AdmintoIfoOrderUnitPK(order_unit_id);
  }
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'd':
                ...
                else if ( name.equals("day_trade_type") ) {
