...
public class SessionDataSpecInstance extends DataSpec {
  ...
  private static final ColumnSpec adminto_ifo_order_unit_columns[] = {
  ...
  private static final ColumnSpec adminto_eqtype_order_unit_columns[] = {
    new ColumnSpec("order_unit_id",java.sql.Types.NUMERIC,18,0,false,true,null,null),
    new ColumnSpec("account_id",java.sql.Types.NUMERIC,18,0,false,false,null,null),
    new ColumnSpec("sub_account_id",java.sql.Types.NUMERIC,18,0,false,false,null,null),
    new ColumnSpec("branch_id",java.sql.Types.NUMERIC,18,0,false,false,null,null),
    ...
    new ColumnSpec("confirmed_estimated_price",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("confirmed_exec_condition_type",java.sql.Types.NUMERIC,6,0,true,false,null,null),
    new ColumnSpec("confirmed_price_condition_type",java.sql.Types.VARCHAR,1,0,true,false,null,null),
    ...
    new ColumnSpec("original_quantity",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("stop_order_ordered_timestamp",java.sql.Types.TIMESTAMP,0,0,true,false,null,null),
    new ColumnSpec("org_order_condition_type",java.sql.Types.VARCHAR,1,0,true,false,null,null),
    new ColumnSpec("org_order_cond_operator",java.sql.Types.VARCHAR,1,0,true,false,null,null),
    new ColumnSpec("org_stop_order_price",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("org_w_limit_price",java.sql.Types.DECIMAL,18,6,true,false,null,null),
  ...
  private static final TableSpec tables[] = {
    new TableSpec("adminto_ifo_order_unit",adminto_ifo_order_unit_columns,null),
    new TableSpec("adminto_eqtype_order_unit",adminto_eqtype_order_unit_columns,null),
  };
