...
filename	AdmintoEqtypeOrderUnitParams.java;
...
/** 
 * adminto_eqtype_order_unitテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AdmintoEqtypeOrderUnitRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AdmintoEqtypeOrderUnitParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AdmintoEqtypeOrderUnitParams}が{@@link AdmintoEqtypeOrderUnitRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class AdmintoEqtypeOrderUnitParams extends Params implements AdmintoEqtypeOrderUnitRow {
  ...
  public static final String PTYPE = "adminto_eqtype_order_unit";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = AdmintoEqtypeOrderUnitRow.TYPE;
  ...
  public RowType getRowType() {
    return AdmintoEqtypeOrderUnitRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のAdmintoEqtypeOrderUnitParamsオブジェクトを作成します。 
   */
  public AdmintoEqtypeOrderUnitParams() {
  ...
  /** 
   * 指定のAdmintoEqtypeOrderUnitRowオブジェクトの値を利用してAdmintoEqtypeOrderUnitParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAdmintoEqtypeOrderUnitRowオブジェクト 
   */
  public AdmintoEqtypeOrderUnitParams( AdmintoEqtypeOrderUnitRow p_row )
  {
  ...
  {
    if ( !( other instanceof AdmintoEqtypeOrderUnitRow ) )
       return false;
    return fieldsEqual( (AdmintoEqtypeOrderUnitRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のAdmintoEqtypeOrderUnitRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( AdmintoEqtypeOrderUnitRow row )
  {
  ...
  {
    return new AdmintoEqtypeOrderUnitPK(order_unit_id);
  }
