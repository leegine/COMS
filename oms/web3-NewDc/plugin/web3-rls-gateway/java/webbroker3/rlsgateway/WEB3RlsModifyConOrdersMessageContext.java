...
1.1
date	2011.03.22.08.25.33;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3RlsModifyConOrdersMessageContext.java;
...
@/**
 ...
 File Name        : 条件付注文注文訂正コンテキスト情報クラス(WEB3RlsModifyConOrdersMessageContext.java)
...
/**
 * 条件付注文注文訂正コンテキスト情報クラス
 *
 * @@author FLJ劉
 * @@version 1.0
 */
public class WEB3RlsModifyConOrdersMessageContext
    extends WEB3RlsMessageContext
{
     ...
     */
    public WEB3RlsModifyConOrdersMessageContext(SubAccount l_subaccount,
                                                int l_intOrderType,
    ...
    public String toString()
    {
        ...
        l_sb.append("{[WEB3RlsModifyConOrdersMessageContext]>>>");
