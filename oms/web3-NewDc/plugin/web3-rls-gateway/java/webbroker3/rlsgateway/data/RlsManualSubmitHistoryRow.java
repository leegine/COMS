...
1.1
date	2011.03.22.08.24.13;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RlsManualSubmitHistoryRow.java;
...
/** 
 * RlsManualSubmitHistoryRowインタフェースは変更不可でリードオンリーである<em>rls_manual_submit_history</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link RlsManualSubmitHistoryRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface RlsManualSubmitHistoryRow extends Row {


  /** 
   * この{@@link RlsManualSubmitHistoryRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "rls_manual_submit_history", "session" );
   ...
   */
  public  boolean  getHistoryIdIsSet();
   ...
   */
  public  boolean  getHistoryIdIsModified();
