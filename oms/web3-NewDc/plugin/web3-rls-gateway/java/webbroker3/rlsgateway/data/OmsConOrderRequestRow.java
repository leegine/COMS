...
1.1
date	2011.03.22.08.25.12;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OmsConOrderRequestRow.java;
...
/** 
 * OmsConOrderRequestRowインタフェースは変更不可でリードオンリーである<em>oms_con_order_request</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OmsConOrderRequestRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OmsConOrderRequestRow extends Row {


  /** 
   * この{@@link OmsConOrderRequestRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "oms_con_order_request", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubOrderIdIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubOrderIdIsModified();
   ...
   * @@return com.fitechlabs.xtrade.plugin.tc.gentrade.ProductTypeEnumの値 
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.ProductTypeEnum getSubProductType();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubProductTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubProductTypeIsModified();
   ...
   */
  public java.sql.Timestamp getRlsAcceptedTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRlsAcceptedTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRlsAcceptedTimestampIsModified();
