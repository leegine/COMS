...
/** 
 * FaqRowインタフェースは変更不可でリードオンリーである<em>faq</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link FaqRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see FaqPK 
 */
public interface FaqRow extends Row {


  /** 
   * この{@@link FaqRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "faq", "session" );
   ...
   */
  public  boolean  getFaqNumberIsSet();
   ...
   */
  public  boolean  getFaqNumberIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFaqTextIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFaqTextIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransactionIdIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransactionIdIsModified();
