...
filename	WEB3FaqCompleteRequest.java;
...
File Name        : 問合せ管理お問合せ完了リクエスト(WEB3FaqCompleteRequest)
 ...
 * @@version 1.0
 */
public class WEB3FaqCompleteRequest extends WEB3GenRequest
{    
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3FaqCompleteRequest.class);   
    ...
    /**
     * @@roseuid 41C25C07002E
     */
    public WEB3FaqCompleteRequest()
    {
    ...
    {
        return new WEB3FaqCompleteResponse(this);
    }
