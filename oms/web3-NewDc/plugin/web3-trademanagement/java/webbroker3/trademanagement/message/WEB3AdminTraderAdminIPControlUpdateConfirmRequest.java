...
1.1
date	2011.03.15.01.19.32;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminTraderAdminIPControlUpdateConfirmRequest.java;
...
File Name        : 管理者・ログイン拒否IP登録情報変更確認リクエスト(WEB3AdminTraderAdminIPControlUpdateConfirmRequest.java)
...
/**
 * (管理者・ログイン拒否IP登録情報変更確認リクエスト)<BR>
 * 管理者・ログイン拒否IP登録情報変更確認リクエストクラス。<BR>
 * <BR>
 * @@author 孟亞南
 * @@version 1.0
 */
public class WEB3AdminTraderAdminIPControlUpdateConfirmRequest
    extends WEB3AdminTraderAdminIPControlUpdateCommonRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminTraderAdminIPControlUpdateConfirmRequest.class);
     ...
     * serialVersionUID<BR>
     */
    public static final long serialVersionUID = 200809221820L;
    ...
    /**
     * @@roseuid 48D75CD701B4
     */
    public WEB3AdminTraderAdminIPControlUpdateConfirmRequest()
    {
    ...
    {
        return new WEB3AdminTraderAdminIPControlUpdateConfirmResponse(this);
    }
}
@
