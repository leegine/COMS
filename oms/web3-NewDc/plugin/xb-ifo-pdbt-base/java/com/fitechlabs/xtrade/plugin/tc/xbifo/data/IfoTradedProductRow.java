...
1.1
date	2011.03.22.09.07.57;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IfoTradedProductRow.java;
...
/** 
 * IfoTradedProductRowインタフェースは変更不可でリードオンリーである<em>ifo_traded_product</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link IfoTradedProductRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface IfoTradedProductRow extends Row {


  /** 
   * この{@@link IfoTradedProductRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ifo_traded_product", "master" );
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getIndicationPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getLastLiquidationPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getTargetSpotPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getLiquidationPriceIsNull();
