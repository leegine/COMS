...
1.1
date	2011.03.22.09.07.31;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IfoOrderExecutionParams.java;
...
/** 
 * ifo_order_executionテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link IfoOrderExecutionRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link IfoOrderExecutionParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link IfoOrderExecutionParams}が{@@link IfoOrderExecutionRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class IfoOrderExecutionParams extends Params implements IfoOrderExecutionRow {
  ...
  public static final String PTYPE = "ifo_order_execution";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = IfoOrderExecutionRow.TYPE;
  ...
  public RowType getRowType() {
    return IfoOrderExecutionRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のIfoOrderExecutionParamsオブジェクトを作成します。 
   */
  public IfoOrderExecutionParams() {
  ...
  /** 
   * 指定のIfoOrderExecutionRowオブジェクトの値を利用してIfoOrderExecutionParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するIfoOrderExecutionRowオブジェクト 
   */
  public IfoOrderExecutionParams( IfoOrderExecutionRow p_row )
  {
  ...
  {
    if ( !( other instanceof IfoOrderExecutionRow ) )
       return false;
    return fieldsEqual( (IfoOrderExecutionRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のIfoOrderExecutionRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( IfoOrderExecutionRow row )
  {
  ...
  {
    return new IfoOrderExecutionPK(order_execution_id);
  }
