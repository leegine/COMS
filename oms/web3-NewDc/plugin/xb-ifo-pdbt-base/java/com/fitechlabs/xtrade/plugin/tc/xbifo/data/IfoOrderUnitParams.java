...
1.1
date	2011.03.22.09.06.49;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IfoOrderUnitParams.java;
...
/** 
 * ifo_order_unitテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link IfoOrderUnitRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link IfoOrderUnitParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link IfoOrderUnitParams}が{@@link IfoOrderUnitRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 * @@see IfoOrderUnitRow 
 */
public class IfoOrderUnitParams extends Params implements IfoOrderUnitRow {
  ...
  public static final String PTYPE = "ifo_order_unit";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = IfoOrderUnitRow.TYPE;
  ...
  /** 
   * 値が未設定のIfoOrderUnitParamsオブジェクトを作成します。 
   */
  public IfoOrderUnitParams() {
  ...
  /** 
   * 指定のIfoOrderUnitRowオブジェクトの値を利用してIfoOrderUnitParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するIfoOrderUnitRowオブジェクト 
   */
  public IfoOrderUnitParams( IfoOrderUnitRow p_row )
  {
  ...
  {
    if ( !( other instanceof IfoOrderUnitRow ) )
       return false;
    return fieldsEqual( (IfoOrderUnitRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のIfoOrderUnitRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( IfoOrderUnitRow row )
  {
  ...
  {
    return new IfoOrderUnitPK(order_unit_id);
  }
