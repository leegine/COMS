...
1.1
date	2011.03.22.09.07.10;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IfoOrderActionRow.java;
...
/** 
 * IfoOrderActionRowインタフェースは変更不可でリードオンリーである<em>ifo_order_action</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link IfoOrderActionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface IfoOrderActionRow extends Row {


  /** 
   * この{@@link IfoOrderActionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ifo_order_action", "account" );
   ...
   */
  public  boolean  getOrderActionIdIsSet();
   ...
   */
  public  boolean  getOrderActionIdIsModified();
   ...
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.OrderEventTypeEnum getOrderEventType();
