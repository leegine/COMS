...
1.1
date	2011.03.22.09.06.28;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * IfoOrderUnitRowインタフェースは変更不可でリードオンリーである<em>ifo_order_unit</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link IfoOrderUnitRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see IfoOrderUnitPK 
 */
public interface IfoOrderUnitRow extends Row {


  /** 
   * この{@@link IfoOrderUnitRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ifo_order_unit", "account" );
