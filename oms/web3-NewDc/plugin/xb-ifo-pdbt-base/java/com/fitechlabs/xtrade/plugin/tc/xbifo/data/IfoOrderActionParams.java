...
1.1
date	2011.03.22.09.09.04;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IfoOrderActionParams.java;
...
/** 
 * ifo_order_actionテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link IfoOrderActionRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link IfoOrderActionParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link IfoOrderActionParams}が{@@link IfoOrderActionRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class IfoOrderActionParams extends Params implements IfoOrderActionRow {
  ...
  public static final String PTYPE = "ifo_order_action";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = IfoOrderActionRow.TYPE;
   ...
   */
  public  com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType  execution_condition_type;
  ...
  /** 
   * <em>stop_price_type</em>カラムの値 
   */
  public  String  stop_price_type;
  ...
  /** 
   * <em>org_stop_price_type</em>カラムの値 
   */
  public  String  org_stop_price_type;
   ...
   */
  public  com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType  org_w_limit_exec_cond_type;

  /** 
   * <em>w_limit_exec_cond_type</em>カラムの値 
   */
  public  com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType  w_limit_exec_cond_type;
   ...
   */
  public  com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType  w_limit_before_exec_cond_type;

  /** 
   * <em>confirmed_exec_condition_type</em>カラムの値 
   */
  public  com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType  confirmed_exec_condition_type;
  ...
  private boolean stop_price_type_is_set = false;
  private boolean stop_price_type_is_modified = false;
  ...
  private boolean org_stop_price_type_is_set = false;
  private boolean org_stop_price_type_is_modified = false;
  ...
  public String toString() {
    return "{"
      ...
      + "," + "org_stop_price_type=" +org_stop_price_type
  ...
  /** 
   * 値が未設定のIfoOrderActionParamsオブジェクトを作成します。 
   */
  public IfoOrderActionParams() {
  ...
  /** 
   * 指定のIfoOrderActionRowオブジェクトの値を利用してIfoOrderActionParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するIfoOrderActionRowオブジェクト 
   */
  public IfoOrderActionParams( IfoOrderActionRow p_row )
  {
    ...
    stop_price_type = p_row.getStopPriceType();
    stop_price_type_is_set = p_row.getStopPriceTypeIsSet();
    stop_price_type_is_modified = p_row.getStopPriceTypeIsModified();
    ...
    org_stop_price_type = p_row.getOrgStopPriceType();
    org_stop_price_type_is_set = p_row.getOrgStopPriceTypeIsSet();
    org_stop_price_type_is_modified = p_row.getOrgStopPriceTypeIsModified();
   ...
   */
    public void markAllValuesAsSet() {
      ...
      stop_price_type_is_set = true;
      stop_price_type_is_modified = true;
      ...
      org_stop_price_type_is_set = true;
      org_stop_price_type_is_modified = true;
  ...
  {
    if ( !( other instanceof IfoOrderActionRow ) )
       return false;
    return fieldsEqual( (IfoOrderActionRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のIfoOrderActionRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( IfoOrderActionRow row )
  {
    ...
    if ( stop_price_type == null ) {
      if ( row.getStopPriceType() != null )
        return false;
    } else if ( !stop_price_type.equals( row.getStopPriceType() ) ) {
        return false;
    }
    ...
    if ( org_stop_price_type == null ) {
      if ( row.getOrgStopPriceType() != null )
        return false;
    } else if ( !org_stop_price_type.equals( row.getOrgStopPriceType() ) ) {
        return false;
    }
  ...
  public int hashCode() {
      return  ((int) order_action_id)
        ...
        + (stop_price_type!=null? stop_price_type.hashCode(): 0) 
        ...
        + (org_stop_price_type!=null? org_stop_price_type.hashCode(): 0) 
   ...
   */
	public java.util.Map toInsertMap() {
		...
		if ( stop_price_type != null )
			map.put("stop_price_type",stop_price_type);
		if ( stop_order_price != null )
		...
		if ( org_stop_price_type != null )
			map.put("org_stop_price_type",org_stop_price_type);
		if ( org_stop_order_price != null )
   ...
   */
	public java.util.Map toUpdateMap() {
		...
		if ( order_cond_operator_is_modified )
			map.put("order_cond_operator",order_cond_operator);
		if ( stop_price_type_is_modified )
			map.put("stop_price_type",stop_price_type);
		...
		if ( org_order_cond_operator_is_modified )
			map.put("org_order_cond_operator",org_order_cond_operator);
		if ( org_stop_price_type_is_modified )
			map.put("org_stop_price_type",org_stop_price_type);
   ...
   */
  public final com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType getExecutionConditionType()
  {
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getStopPriceTypeIsSet() {
    return stop_price_type_is_set;
  }
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getStopPriceTypeIsModified() {
    return stop_price_type_is_modified;
  }
   ...
   * @@return Stringの値 
   */
  public final String getOrgStopPriceType()
  {
    return org_stop_price_type;
  }
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOrgStopPriceTypeIsSet() {
    return org_stop_price_type_is_set;
  }
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOrgStopPriceTypeIsModified() {
    return org_stop_price_type_is_modified;
  }
   ...
   * @@return com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionTypeの値 
   */
  public final com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType getOrgWLimitExecCondType()
  {
   ...
   * @@return com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionTypeの値 
   */
  public final com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType getWLimitExecCondType()
  {
   ...
   * @@return com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionTypeの値 
   */
  public final com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType getWLimitBeforeExecCondType()
  {
   ...
   * @@return com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionTypeの値 
   */
  public final com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType getConfirmedExecConditionType()
  {
  ...
  {
    return new IfoOrderActionPK(order_action_id);
  }
   ...
   *
   * @@param p_executionConditionType <em>execution_condition_type</em>カラムの値をあらわす6桁以下のcom.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType値 
   */
  public final void setExecutionConditionType( com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType p_executionConditionType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
  ...
  /** 
   * <em>stop_price_type</em>カラムの値を設定します。 
   *
   * @@param p_stopPriceType <em>stop_price_type</em>カラムの値をあらわす1桁以下のString値 
   */
  public final void setStopPriceType( String p_stopPriceType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    stop_price_type = p_stopPriceType;
    stop_price_type_is_set = true;
    stop_price_type_is_modified = true;
  }
  ...
  /** 
   * <em>org_stop_price_type</em>カラムの値を設定します。 
   *
   * @@param p_orgStopPriceType <em>org_stop_price_type</em>カラムの値をあらわす1桁以下のString値 
   */
  public final void setOrgStopPriceType( String p_orgStopPriceType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    org_stop_price_type = p_orgStopPriceType;
    org_stop_price_type_is_set = true;
    org_stop_price_type_is_modified = true;
  }
   ...
   *
   * @@param p_orgWLimitExecCondType <em>org_w_limit_exec_cond_type</em>カラムの値をあらわす6桁以下のcom.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType値 
   */
  public final void setOrgWLimitExecCondType( com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType p_orgWLimitExecCondType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
   ...
   *
   * @@param p_wLimitExecCondType <em>w_limit_exec_cond_type</em>カラムの値をあらわす6桁以下のcom.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType値 
   */
  public final void setWLimitExecCondType( com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType p_wLimitExecCondType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
   ...
   *
   * @@param p_wLimitBeforeExecCondType <em>w_limit_before_exec_cond_type</em>カラムの値をあらわす6桁以下のcom.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType値 
   */
  public final void setWLimitBeforeExecCondType( com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType p_wLimitBeforeExecCondType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
   ...
   *
   * @@param p_confirmedExecConditionType <em>confirmed_exec_condition_type</em>カラムの値をあらわす6桁以下のcom.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType値 
   */
  public final void setConfirmedExecConditionType( com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType p_confirmedExecConditionType )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                ...
                else if ( name.equals("closing_order") ) {
            ...
            case 'o':
                ...
                else if ( name.equals("org_stop_price_type") ) {
                    return this.org_stop_price_type;
                }
            ...
            case 's':
                ...
                else if ( name.equals("stop_price_type") ) {
                    return this.stop_price_type;
                }
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                if ( name.equals("confirmed_price") ) {
                    ...
                    if ( value != null )
                      if ( !(value instanceof com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) )
                        throw new IllegalArgumentException( "value for 'confirmed_exec_condition_type' must be com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType: '"+value+"' is not." );
                    this.confirmed_exec_condition_type = (com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) value;
            ...
            case 'e':
                if ( name.equals("execution_condition_type") ) {
                    if ( value != null )
                      if ( !(value instanceof com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) )
                        throw new IllegalArgumentException( "value for 'execution_condition_type' must be com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType: '"+value+"' is not." );
                    this.execution_condition_type = (com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) value;
            ...
            case 'o':
                if ( name.equals("order_action_id") ) {
                    ...
                    if ( value != null )
                      if ( !(value instanceof String) )
                        throw new IllegalArgumentException( "value for 'org_stop_price_type' must be String: '"+value+"' is not." );
                    this.org_stop_price_type = (String) value;
                    if (this.org_stop_price_type_is_set)
                        this.org_stop_price_type_is_modified = true;
                    this.org_stop_price_type_is_set = true;
                    return;
                }
                else if ( name.equals("org_stop_order_price") ) {
                    if ( value != null )
                    ...
                    if ( value != null )
                      if ( !(value instanceof com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) )
                        throw new IllegalArgumentException( "value for 'org_w_limit_exec_cond_type' must be com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType: '"+value+"' is not." );
                    this.org_w_limit_exec_cond_type = (com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) value;
            ...
            case 's':
                if ( name.equals("sub_account_id") ) {
                    ...
                    if ( value != null )
                      if ( !(value instanceof String) )
                        throw new IllegalArgumentException( "value for 'stop_price_type' must be String: '"+value+"' is not." );
                    this.stop_price_type = (String) value;
                    if (this.stop_price_type_is_set)
                        this.stop_price_type_is_modified = true;
                    this.stop_price_type_is_set = true;
                    return;
                }
                else if ( name.equals("stop_order_price") ) {
                    if ( value != null )
            ...
            case 'w':
                if ( name.equals("w_limit_price") ) {
                    ...
                    if ( value != null )
                      if ( !(value instanceof com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) )
                        throw new IllegalArgumentException( "value for 'w_limit_exec_cond_type' must be com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType: '"+value+"' is not." );
                    this.w_limit_exec_cond_type = (com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) value;
                    ...
                    if ( value != null )
                      if ( !(value instanceof com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) )
                        throw new IllegalArgumentException( "value for 'w_limit_before_exec_cond_type' must be com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType: '"+value+"' is not." );
                    this.w_limit_before_exec_cond_type = (com.fitechlabs.xtrade.plugin.tc.xbifo.IfoOrderExecutionConditionType) value;
