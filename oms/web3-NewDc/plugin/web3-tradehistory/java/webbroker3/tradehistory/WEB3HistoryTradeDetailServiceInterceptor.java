...
1.1
date	2011.03.15.01.03.35;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3HistoryTradeDetailServiceInterceptor.java;
...
File Name          : 取引明細サービスインタセプタ(WEB3HistoryTradeDetailServiceInterceptor)
 ...
 * @@version 1.0
 */
public class WEB3HistoryTradeDetailServiceInterceptor implements Interceptor 
{
     /**
     * Logger
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3HistoryTradeDetailServiceInterceptor.class);

    /**
     * @@roseuid 4178A55C02CE
     */
    public WEB3HistoryTradeDetailServiceInterceptor() 
    {
