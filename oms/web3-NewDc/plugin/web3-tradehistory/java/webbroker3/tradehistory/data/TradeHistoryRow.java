...
1.1
date	2011.03.15.00.48.05;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * TradeHistoryRowインタフェースは変更不可でリードオンリーである<em>trade_history</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link TradeHistoryRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see TradeHistoryPK 
 */
public interface TradeHistoryRow extends Row {


  /** 
   * この{@@link TradeHistoryRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "trade_history", "session" );
   ...
   */
  public  boolean  getTradeHistoryIdIsSet();
   ...
   */
  public  boolean  getTradeHistoryIdIsModified();
   ...
   * @@return longの値 
   */
  public long getDetailsManagementNo();
   ...
   */
  public  boolean  getDetailsManagementNoIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDetailsManagementNoIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDetailsManagementNoIsModified();
