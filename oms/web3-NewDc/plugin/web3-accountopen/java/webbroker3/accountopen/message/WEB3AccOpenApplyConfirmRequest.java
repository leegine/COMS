...
1.1
date	2011.03.14.02.59.17;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AccOpenApplyConfirmRequest.java;
...
File Name        : 口座開設申込確認リクエスト(WEB3AccOpenApplyConfirmRequest.java)
 ...
 * @@version 1.0
 */
public class WEB3AccOpenApplyConfirmRequest extends WEB3GenRequest
{
    ...
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AccOpenApplyConfirmRequest.class);
    /**
     * PTYPE<BR>
     */
    ...
    /**
     * @@roseuid 41B45E7C01E4
     */
    public WEB3AccOpenApplyConfirmRequest()
    {
    ...
    {
        return new WEB3AccOpenApplyConfirmResponse(this);
    }
