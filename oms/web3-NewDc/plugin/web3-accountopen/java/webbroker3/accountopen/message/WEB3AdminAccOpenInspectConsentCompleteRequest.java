...
1.1
date	2011.03.14.02.59.30;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccOpenInspectConsentCompleteRequest.java;
...
File Name        : 管理者口座開設審査承認完了リクエスト(WEB3AdminAccOpenInspectConsentCompleteRequest.java)
...
/**
 * (管理者口座開設審査承認完了リクエスト)<BR>
 * 管理者口座開設審査承認完了リクエスト
 * 
 * @@author 張秋穎
 * @@version 1.0
 */
public class WEB3AdminAccOpenInspectConsentCompleteRequest extends WEB3GenRequest
{
    /**
     * (ログ出力ユーティリティ。)<BR>
     */
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AdminAccOpenInspectConsentCompleteRequest.class);
    
    /**
     * PTYPE<BR>
     */
    public static final String PTYPE = "admin_AccOpen_inspectConsentComplete";
    ...
    /**
     * @@roseuid 44912C0F0157
     */
    public WEB3AdminAccOpenInspectConsentCompleteRequest() 
    {
    }
    ...
    {
        return new WEB3AdminAccOpenInspectConsentCompleteResponse(this);
    }
