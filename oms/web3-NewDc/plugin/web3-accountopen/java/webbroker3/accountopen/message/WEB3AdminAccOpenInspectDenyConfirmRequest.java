...
1.1
date	2011.03.14.02.58.34;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccOpenInspectDenyConfirmRequest.java;
...
File Name        : 管理者口座開設審査否認確認リクエスト(WEB3AdminAccOpenInspectDenyConfirmRequest.java)
...
/**
 * (管理者口座開設審査否認確認リクエスト)<BR>
 * 
 * @@author 張秋穎
 * @@version 1.0
 */ 
public class WEB3AdminAccOpenInspectDenyConfirmRequest extends WEB3GenRequest
{
    /**
     * (ログ出力ユーティリティ。)<BR>
     */
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AdminAccOpenInspectDenyConfirmRequest.class);
    /**
     * PTYPE<BR>
     */
    ...
    /**
     * @@roseuid 44912C100232
     */
    public WEB3AdminAccOpenInspectDenyConfirmRequest() 
    {
    }
    ...
    {
        return new WEB3AdminAccOpenInspectDenyConfirmResponse(this);
    }
