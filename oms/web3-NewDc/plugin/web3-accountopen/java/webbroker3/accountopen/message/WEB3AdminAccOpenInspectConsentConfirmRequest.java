...
1.1
date	2011.03.14.03.08.39;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccOpenInspectConsentConfirmRequest.java;
...
File Name        : 管理者口座開設審査承認確認リクエスト(WEB3AdminAccOpenInspectConsentConfirmRequest.java)
...
/**
 * (管理者口座開設審査承認確認リクエスト)<BR>
 * 管理者口座開設審査承認確認リクエスト<BR>
 * 
 * @@author 張秋穎
 * @@version 1.0
 */
public class WEB3AdminAccOpenInspectConsentConfirmRequest extends WEB3GenRequest
{
    /**
     * (ログ出力ユーティリティ。)<BR>
     */
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AdminAccOpenInspectConsentConfirmRequest.class);
    ...
    /**
     * @@roseuid 44912C0F034B
     */
    public WEB3AdminAccOpenInspectConsentConfirmRequest() 
    {
    }
    ...
    {
        return new WEB3AdminAccOpenInspectConsentConfirmResponse(this);
    }
}
@
