...
/** 
 * {@@link HostFDepositVoucherDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link HostFDepositVoucherRow}インスタンスへ関連付けることができます。 
...
public class HostFDepositVoucherDao extends DataAccessObject {
  ...
  /** 
   * この{@@link HostFDepositVoucherDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link HostFDepositVoucherRow}と仮定される{@@link DataAccessObject}から新たに{@@link HostFDepositVoucherDao}を返します。 
         * @@return 指定のRowに結びつく{@@link HostFDepositVoucherDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link HostFDepositVoucherRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link HostFDepositVoucherRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link HostFDepositVoucherRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link HostFDepositVoucherRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link HostFDepositVoucherRow}オブジェクトから{@@link HostFDepositVoucherDao}オブジェクトを作成します。 
   * これは実際の{@@link HostFDepositVoucherRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link HostFDepositVoucherDao}取得のために指定の{@@link HostFDepositVoucherRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link HostFDepositVoucherDao}オブジェクト 
  ...
  /** 
   * {@@link HostFDepositVoucherRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link HostFDepositVoucherRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link HostFDepositVoucherPK}やデータベースレコードとして挿入される{@@link HostFDepositVoucherParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link HostFDepositVoucherRow}を一意に特定する{@@link HostFDepositVoucherPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link HostFDepositVoucherRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link HostFDepositVoucherParams}オブジェクトの主キーとして利用可能な{@@link HostFDepositVoucherPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link HostFDepositVoucherRow}オブジェクトを検索します。 
   * 
   ...
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link HostFDepositVoucherRow} 
  ...
  /** 
   * 指定のHostFDepositVoucherPKオブジェクトから{@@link HostFDepositVoucherRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するHostFDepositVoucherPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link HostFDepositVoucherRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String,String,String,String)}および{@@link #forRow(HostFDepositVoucherRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(HostFDepositVoucherPK)}および{@@link #forRow(HostFDepositVoucherRow)}を使用してください。 
   */
  ...
  /** 
   * p_orderRequestNumber, p_requestCode, p_institutionCode, p_branchCode, p_accountCode, and にて指定の値に一致する{@@link HostFDepositVoucherRow}オブジェクトを{@@link List}として返します。 
   ...
   * @@param p_accountCode 検索対象であるp_accountCodeフィールドの値
   * 
   * @@return 引数指定のp_orderRequestNumber, p_requestCode, p_institutionCode, p_branchCode, p_accountCode, and の値と一致する{@@link HostFDepositVoucherRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderRequestNumberRequestCodeInstitutionCodeBranchCodeAccountCode(String, String, String, String, String)}および{@@link #forRow(HostFDepositVoucherRow)}を使用してください。 
   */
