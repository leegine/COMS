...
1.1
date	2011.03.14.03.20.52;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostAgencyNotifyVoucherPK.java;
...
/** 
 * <b>HostAgencyNotifyVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostAgencyNotifyVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostAgencyNotifyVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostAgencyNotifyVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostAgencyNotifyVoucherRow. 
   */
   ...
   * デフォルトコンストラクタ 
   */
  public HostAgencyNotifyVoucherPK() { 
  }
   ...
   */
  public HostAgencyNotifyVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostAgencyNotifyVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostAgencyNotifyVoucherPK pk = new HostAgencyNotifyVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostAgencyNotifyVoucherPK) )
      return false;
    HostAgencyNotifyVoucherPK o = (HostAgencyNotifyVoucherPK) other;
