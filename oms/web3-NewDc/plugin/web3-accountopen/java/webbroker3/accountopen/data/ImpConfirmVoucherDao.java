...
/** 
 * {@@link ImpConfirmVoucherDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link ImpConfirmVoucherRow}インスタンスへ関連付けることができます。 
...
public class ImpConfirmVoucherDao extends DataAccessObject {
  ...
  /** 
   * この{@@link ImpConfirmVoucherDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link ImpConfirmVoucherRow}と仮定される{@@link DataAccessObject}から新たに{@@link ImpConfirmVoucherDao}を返します。 
         * @@return 指定のRowに結びつく{@@link ImpConfirmVoucherDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link ImpConfirmVoucherRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link ImpConfirmVoucherRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link ImpConfirmVoucherRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link ImpConfirmVoucherRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link ImpConfirmVoucherRow}オブジェクトから{@@link ImpConfirmVoucherDao}オブジェクトを作成します。 
   * これは実際の{@@link ImpConfirmVoucherRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link ImpConfirmVoucherDao}取得のために指定の{@@link ImpConfirmVoucherRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link ImpConfirmVoucherDao}オブジェクト 
  ...
  /** 
   * {@@link ImpConfirmVoucherRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link ImpConfirmVoucherRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link ImpConfirmVoucherPK}やデータベースレコードとして挿入される{@@link ImpConfirmVoucherParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link ImpConfirmVoucherRow}を一意に特定する{@@link ImpConfirmVoucherPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link ImpConfirmVoucherRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link ImpConfirmVoucherParams}オブジェクトの主キーとして利用可能な{@@link ImpConfirmVoucherPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link ImpConfirmVoucherRow}オブジェクトを検索します。 
   * 
   ...
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link ImpConfirmVoucherRow} 
  ...
  /** 
   * 指定のImpConfirmVoucherPKオブジェクトから{@@link ImpConfirmVoucherRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するImpConfirmVoucherPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link ImpConfirmVoucherRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String,String,String,String)}および{@@link #forRow(ImpConfirmVoucherRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(ImpConfirmVoucherPK)}および{@@link #forRow(ImpConfirmVoucherRow)}を使用してください。 
   */
  ...
  /** 
   * p_orderRequestNumber, p_requestCode, p_institutionCode, p_branchCode, p_accountCode, and にて指定の値から一意の{@@link ImpConfirmVoucherRow}オブジェクトを検索します。 
   ...
   * @@param p_accountCode 検索対象であるp_accountCodeフィールドの値
   * 
   * @@return 引数指定のp_orderRequestNumber, p_requestCode, p_institutionCode, p_branchCode, p_accountCode, and の値と一致する{@@link ImpConfirmVoucherRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByOrderRequestNumberRequestCodeInstitutionCodeBranchCodeAccountCode(String, String, String, String, String)}および{@@link #forRow(ImpConfirmVoucherRow)}を使用してください。 
   */
