...
1.1
date	2011.03.14.03.18.26;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccOpenVoucherStatusRow.java;
...
/** 
 * AccOpenVoucherStatusRowインタフェースは変更不可でリードオンリーである<em>acc_open_voucher_status</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AccOpenVoucherStatusRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AccOpenVoucherStatusRow extends Row {


  /** 
   * この{@@link AccOpenVoucherStatusRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "acc_open_voucher_status", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getVoucherStatusIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getVoucherStatusIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getRecvTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRecvTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRecvTimestampIsModified();
