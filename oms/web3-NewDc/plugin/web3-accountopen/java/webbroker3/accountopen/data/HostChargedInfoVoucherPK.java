...
1.1
date	2011.03.14.03.20.48;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostChargedInfoVoucherPK.java;
...
/** 
 * <b>HostChargedInfoVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostChargedInfoVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostChargedInfoVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostChargedInfoVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostChargedInfoVoucherRow. 
   */
   ...
   * デフォルトコンストラクタ 
   */
  public HostChargedInfoVoucherPK() { 
  }
   ...
   */
  public HostChargedInfoVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostChargedInfoVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostChargedInfoVoucherPK pk = new HostChargedInfoVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostChargedInfoVoucherPK) )
      return false;
    HostChargedInfoVoucherPK o = (HostChargedInfoVoucherPK) other;
