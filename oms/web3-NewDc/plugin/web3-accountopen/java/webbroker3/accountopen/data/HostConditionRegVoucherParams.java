...
1.1
date	2011.03.14.03.13.42;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostConditionRegVoucherParams.java;
...
/** 
 * host_condition_reg_voucherテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostConditionRegVoucherRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostConditionRegVoucherParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostConditionRegVoucherParams}が{@@link HostConditionRegVoucherRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostConditionRegVoucherParams extends Params implements HostConditionRegVoucherRow {
  ...
  public static final String PTYPE = "host_condition_reg_voucher";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostConditionRegVoucherRow.TYPE;
  ...
  public RowType getRowType() {
    return HostConditionRegVoucherRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostConditionRegVoucherParamsオブジェクトを作成します。 
   */
  public HostConditionRegVoucherParams() {
  ...
  /** 
   * 指定のHostConditionRegVoucherRowオブジェクトの値を利用してHostConditionRegVoucherParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostConditionRegVoucherRowオブジェクト 
   */
  public HostConditionRegVoucherParams( HostConditionRegVoucherRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostConditionRegVoucherRow ) )
       return false;
    return fieldsEqual( (HostConditionRegVoucherRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostConditionRegVoucherRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostConditionRegVoucherRow row )
  {
  ...
  {
    return new HostConditionRegVoucherPK(order_request_number, request_code, institution_code, branch_code, account_code);
  }
