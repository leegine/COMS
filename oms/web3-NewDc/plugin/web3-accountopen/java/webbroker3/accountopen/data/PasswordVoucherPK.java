...
1.1
date	2011.03.14.03.22.36;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	PasswordVoucherPK.java;
...
/** 
 * <b>PasswordVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>PasswordVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>PasswordVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class PasswordVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: PasswordVoucherRow. 
   */
   ...
   */
  public PasswordVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static PasswordVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    PasswordVoucherPK pk = new PasswordVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof PasswordVoucherPK) )
      return false;
    PasswordVoucherPK o = (PasswordVoucherPK) other;
