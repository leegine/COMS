...
1.1
date	2011.03.14.03.20.40;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * BatchBranchRowインタフェースは変更不可でリードオンリーである<em>batch_branch</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link BatchBranchRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see BatchBranchPK 
 */
public interface BatchBranchRow extends Row {


  /** 
   * この{@@link BatchBranchRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "batch_branch", "session" );
   ...
   * @@return intの値 
   */
  public int getEquityOrderExeMailFlag();
   ...
   * @@return intの値 
   */
  public int getEquityOrderUnexecMailFlag();
   ...
   * @@return intの値 
   */
  public int getIfoOrderExecMailFlag();
   ...
   * @@return intの値 
   */
  public int getIfoOrderUnexecMailFlag();
   ...
   * @@return intの値 
   */
  public int getInformationMailFlag();
