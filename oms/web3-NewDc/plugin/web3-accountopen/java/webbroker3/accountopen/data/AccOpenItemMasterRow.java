...
1.1
date	2011.03.14.03.16.08;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccOpenItemMasterRow.java;
...
/** 
 * AccOpenItemMasterRowインタフェースは変更不可でリードオンリーである<em>acc_open_item_master</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AccOpenItemMasterRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AccOpenItemMasterRow extends Row {


  /** 
   * この{@@link AccOpenItemMasterRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "acc_open_item_master", "master" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getValidateTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getValidateTypeIsModified();
   ...
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.BooleanEnum getNecessaryFlag();
