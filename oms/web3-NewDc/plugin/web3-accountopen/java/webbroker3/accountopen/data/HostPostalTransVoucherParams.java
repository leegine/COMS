...
/** 
 * host_postal_trans_voucherテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostPostalTransVoucherRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostPostalTransVoucherParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostPostalTransVoucherParams}が{@@link HostPostalTransVoucherRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class HostPostalTransVoucherParams extends Params implements HostPostalTransVoucherRow {
  ...
  /** 
   * 値が未設定のHostPostalTransVoucherParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のHostPostalTransVoucherRowオブジェクトの値を利用してHostPostalTransVoucherParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostPostalTransVoucherRowオブジェクト 
   */
   ...
   * @@param row 比較対照のHostPostalTransVoucherRow 
