...
1.1
date	2011.03.14.03.15.51;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostGpRegVoucherPK.java;
...
/** 
 * <b>HostGpRegVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostGpRegVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostGpRegVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostGpRegVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostGpRegVoucherRow. 
   */
   ...
   */
  public HostGpRegVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostGpRegVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostGpRegVoucherPK pk = new HostGpRegVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostGpRegVoucherPK) )
      return false;
    HostGpRegVoucherPK o = (HostGpRegVoucherPK) other;
