...
1.1
date	2011.03.14.03.20.11;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostFDepositVoucherPK.java;
...
/** 
 * <b>HostFDepositVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostFDepositVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostFDepositVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostFDepositVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostFDepositVoucherRow. 
   */
   ...
   */
  public HostFDepositVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostFDepositVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostFDepositVoucherPK pk = new HostFDepositVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostFDepositVoucherPK) )
      return false;
    HostFDepositVoucherPK o = (HostFDepositVoucherPK) other;
