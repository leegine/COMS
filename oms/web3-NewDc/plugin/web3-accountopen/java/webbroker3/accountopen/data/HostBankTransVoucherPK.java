...
1.1
date	2011.03.14.03.15.14;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostBankTransVoucherPK.java;
...
/** 
 * <b>HostBankTransVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostBankTransVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostBankTransVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostBankTransVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostBankTransVoucherRow. 
   */
   ...
   */
  public HostBankTransVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostBankTransVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostBankTransVoucherPK pk = new HostBankTransVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostBankTransVoucherPK) )
      return false;
    HostBankTransVoucherPK o = (HostBankTransVoucherPK) other;
