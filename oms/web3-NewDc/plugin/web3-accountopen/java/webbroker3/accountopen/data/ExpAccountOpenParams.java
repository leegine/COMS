...
1.1
date	2011.03.14.03.21.09;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	ExpAccountOpenParams.java;
...
/** 
 * exp_account_openテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link ExpAccountOpenRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link ExpAccountOpenParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link ExpAccountOpenParams}が{@@link ExpAccountOpenRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class ExpAccountOpenParams extends Params implements ExpAccountOpenRow {
  ...
  public static final String PTYPE = "exp_account_open";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = ExpAccountOpenRow.TYPE;
  ...
  /** 
   * 値が未設定のExpAccountOpenParamsオブジェクトを作成します。 
   */
  public ExpAccountOpenParams() {
  ...
  /** 
   * 指定のExpAccountOpenRowオブジェクトの値を利用してExpAccountOpenParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するExpAccountOpenRowオブジェクト 
   */
  public ExpAccountOpenParams( ExpAccountOpenRow p_row )
  {
  ...
  {
    if ( !( other instanceof ExpAccountOpenRow ) )
       return false;
    return fieldsEqual( (ExpAccountOpenRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のExpAccountOpenRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( ExpAccountOpenRow row )
  {
  ...
  {
    return new ExpAccountOpenPK(institution_code, acc_open_request_number);
  }
   ...
   *
   * @@param p_agencyAccNameKana1 <em>agency_acc_name_kana1</em>カラムの値をあらわす120桁以下のString値 
   */
   ...
   *
   * @@param p_agencyAccNameKana2 <em>agency_acc_name_kana2</em>カラムの値をあらわす120桁以下のString値 
   */
   ...
   *
   * @@param p_agencyAccName1 <em>agency_acc_name1</em>カラムの値をあらわす120桁以下のString値 
   */
   ...
   *
   * @@param p_agencyAddressLine1 <em>agency_address_line1</em>カラムの値をあらわす96桁以下のString値 
   */
   ...
   *
   * @@param p_agencyRepNameKana1 <em>agency_rep_name_kana1</em>カラムの値をあらわす120桁以下のString値 
   */
   ...
   *
   * @@param p_agencyRepNameKana2 <em>agency_rep_name_kana2</em>カラムの値をあらわす120桁以下のString値 
   */
