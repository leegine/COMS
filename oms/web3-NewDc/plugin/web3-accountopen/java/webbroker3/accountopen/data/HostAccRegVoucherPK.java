...
1.1
date	2011.03.14.03.15.43;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostAccRegVoucherPK.java;
...
/** 
 * <b>HostAccRegVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostAccRegVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostAccRegVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostAccRegVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostAccRegVoucherRow. 
   */
   ...
   */
  public HostAccRegVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostAccRegVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostAccRegVoucherPK pk = new HostAccRegVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostAccRegVoucherPK) )
      return false;
    HostAccRegVoucherPK o = (HostAccRegVoucherPK) other;
