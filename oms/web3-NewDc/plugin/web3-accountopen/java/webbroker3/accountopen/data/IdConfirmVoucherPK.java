...
1.1
date	2011.03.14.03.15.18;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IdConfirmVoucherPK.java;
...
/** 
 * <b>IdConfirmVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>IdConfirmVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>IdConfirmVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class IdConfirmVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: IdConfirmVoucherRow. 
   */
   ...
   */
  public IdConfirmVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static IdConfirmVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    IdConfirmVoucherPK pk = new IdConfirmVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof IdConfirmVoucherPK) )
      return false;
    IdConfirmVoucherPK o = (IdConfirmVoucherPK) other;
