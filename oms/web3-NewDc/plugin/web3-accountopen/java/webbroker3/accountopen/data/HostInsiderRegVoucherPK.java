...
1.1
date	2011.03.14.03.14.01;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostInsiderRegVoucherPK.java;
...
/** 
 * <b>HostInsiderRegVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostInsiderRegVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostInsiderRegVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostInsiderRegVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostInsiderRegVoucherRow. 
   */
   ...
   * デフォルトコンストラクタ 
   */
  public HostInsiderRegVoucherPK() { 
  }
   ...
   */
  public HostInsiderRegVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostInsiderRegVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostInsiderRegVoucherPK pk = new HostInsiderRegVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostInsiderRegVoucherPK) )
      return false;
    HostInsiderRegVoucherPK o = (HostInsiderRegVoucherPK) other;
