...
1.1
date	2011.03.14.03.09.52;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	TradeConditionVoucherPK.java;
...
/** 
 * <b>TradeConditionVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>TradeConditionVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>TradeConditionVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class TradeConditionVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: TradeConditionVoucherRow. 
   */
   ...
   * デフォルトコンストラクタ 
   */
  public TradeConditionVoucherPK() { 
  }
   ...
   */
  public TradeConditionVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static TradeConditionVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    TradeConditionVoucherPK pk = new TradeConditionVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof TradeConditionVoucherPK) )
      return false;
    TradeConditionVoucherPK o = (TradeConditionVoucherPK) other;
