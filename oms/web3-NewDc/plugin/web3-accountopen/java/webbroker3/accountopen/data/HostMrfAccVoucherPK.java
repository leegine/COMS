...
1.1
date	2011.03.14.03.16.17;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostMrfAccVoucherPK.java;
...
/** 
 * <b>HostMrfAccVoucher</b>データベーステーブルで一意である1つのレコードをあらわす<b>HostMrfAccVoucher</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>HostMrfAccVoucher</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class HostMrfAccVoucherPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: HostMrfAccVoucherRow. 
   */
   ...
   */
  public HostMrfAccVoucherPK( String p_orderRequestNumber, String p_requestCode, String p_institutionCode, String p_branchCode, String p_accountCode ) {
   ...
   */
  public static HostMrfAccVoucherPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    HostMrfAccVoucherPK pk = new HostMrfAccVoucherPK();
  ...
  {
    if ( other == null || !( other instanceof HostMrfAccVoucherPK) )
      return false;
    HostMrfAccVoucherPK o = (HostMrfAccVoucherPK) other;
