...
1.1
date	2011.03.14.03.15.04;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostRealnameRegVoucherParams.java;
...
/** 
 * host_realname_reg_voucherテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostRealnameRegVoucherRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostRealnameRegVoucherParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostRealnameRegVoucherParams}が{@@link HostRealnameRegVoucherRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostRealnameRegVoucherParams extends Params implements HostRealnameRegVoucherRow {
  ...
  public static final String PTYPE = "host_realname_reg_voucher";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostRealnameRegVoucherRow.TYPE;
  ...
  public RowType getRowType() {
    return HostRealnameRegVoucherRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostRealnameRegVoucherParamsオブジェクトを作成します。 
   */
  public HostRealnameRegVoucherParams() {
  ...
  /** 
   * 指定のHostRealnameRegVoucherRowオブジェクトの値を利用してHostRealnameRegVoucherParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostRealnameRegVoucherRowオブジェクト 
   */
  public HostRealnameRegVoucherParams( HostRealnameRegVoucherRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostRealnameRegVoucherRow ) )
       return false;
    return fieldsEqual( (HostRealnameRegVoucherRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostRealnameRegVoucherRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostRealnameRegVoucherRow row )
  {
  ...
  {
    return new HostRealnameRegVoucherPK(order_request_number, request_code, institution_code, branch_code, account_code);
  }
