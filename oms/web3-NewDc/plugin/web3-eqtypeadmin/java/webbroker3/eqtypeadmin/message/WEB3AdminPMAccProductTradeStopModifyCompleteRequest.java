...
File Name        : 管理者・顧客銘柄別取引停止変更完了リクエスト (WEB3AdminPMAccProductTradeStopModifyCompleteRequest.java)
...
/**
 * （管理者・顧客銘柄別取引停止変更完了リクエスト）<BR>
 * <BR>
 * 管理者・顧客銘柄別取引停止変更完了リクエストクラス<BR>
 * <BR>
...
public class WEB3AdminPMAccProductTradeStopModifyCompleteRequest extends WEB3GenRequest
{
    ...
    public void validate() throws WEB3BusinessLayerException
    {
        ...
        {
            //2-2 ｔhis.accProductTradeStopInfo.validate() is called.
