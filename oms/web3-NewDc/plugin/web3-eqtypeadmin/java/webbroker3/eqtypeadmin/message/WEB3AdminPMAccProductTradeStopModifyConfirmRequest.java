...
File Name        : 管理者・顧客銘柄別取引停止変更確認リクエスト (WEB3AdminPMAccProductTradeStopModifyConfirmRequest.java)
...
/**
 * （管理者・顧客銘柄別取引停止変更確認リクエスト）<BR>
 * <BR>
 * 管理者・顧客銘柄別取引停止変更確認リクエストクラス<BR>
 * <BR>
...
public class WEB3AdminPMAccProductTradeStopModifyConfirmRequest extends WEB3GenRequest
{
     ...
     *            tag : BUSINESS_ERROR_01428<BR>
     * <BR>
     *   1-2) Call ｔhis.accProductTradeStopInfo.validate()<BR>
     * <BR>
    ...
    public void validate() throws WEB3BusinessLayerException
    {
        ...
        {
            // 1-2 Call ｔhis.accProductTradeStopInfo.validate.
