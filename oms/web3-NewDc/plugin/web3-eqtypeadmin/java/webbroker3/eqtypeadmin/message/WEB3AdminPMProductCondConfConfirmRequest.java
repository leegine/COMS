...
filename	WEB3AdminPMProductCondConfConfirmRequest.java;
...
File Name        : 管理者・株式銘柄条件設定確認リクエスト (WEB3AdminPMProductCondConfConfirmRequest.java)
...
/**
 * (管理者・株式銘柄条件設定確認リクエスト)<BR>
 * <BR>
 * 管理者・株式銘柄条件設定確認リクエストクラス<BR>
 * <BR>
 * WEB3AdminPMProductCondConfConfirmRequest<BR>
 * <BR>
 * @@author Sudhindrakinnal
 * @@version 1.0
 */
public class WEB3AdminPMProductCondConfConfirmRequest extends WEB3GenRequest
{
    /**
     * PTYPE<BR>
     */
    public final static String PTYPE = "admin_pm_product_cond_conf_confirm";
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminPMProductCondConfConfirmRequest.class);
    ...
    /**
     * @@roseuid 41FA29EE02DF
     */
    public WEB3AdminPMProductCondConfConfirmRequest()
    {
     ...
     * 　@　@　@　@　@Throw the exception "confirm content is null"<BR>
    ...
    public void validate() throws WEB3BusinessLayerException
    {
        ...
        {
            // 1-2 if productCode is Not Numeric & its length not equal to 5 digits, throw Exception
        ...
        // 2-1 if instance of flowing are null, throw exception.
    ...
    */
    ...
    {
        return new WEB3AdminPMProductCondConfConfirmResponse(this);
    }
}
@
