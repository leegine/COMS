...
filename	WEB3AdminEquityManualLapseInputRequest.java;
...
File Name        : 管理者・株式手動失効入力リクエスト(WEB3AdminEquityManualLapseInputRequest.java)
...
/**
 * (管理者・株式手動失効入力リクエスト)<BR>
 * 管理者・株式手動失効入力リクエストクラス
 * <BR>
 * @@author 肖志偉(中訊)
 * @@version 1.0
 */

public class WEB3AdminEquityManualLapseInputRequest extends WEB3GenRequest 
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminEquityManualLapseInputRequest.class);
     ...
     */
    public WEB3AdminEquityManualLapseInputRequest() 
    {
    ...
    {
        return new WEB3AdminEquityManualLapseInputResponse(this);
    }
}
@
