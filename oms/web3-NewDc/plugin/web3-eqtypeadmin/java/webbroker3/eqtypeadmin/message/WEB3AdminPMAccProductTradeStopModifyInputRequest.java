...
filename	WEB3AdminPMAccProductTradeStopModifyInputRequest.java;
...
File Name        : 管理者・顧客銘柄別取引停止変更入力リクエスト (WEB3AdminPMAccProductTradeStopModifyInputRequest.java)
...
/**
 * （管理者・顧客銘柄別取引停止変更入力リクエスト）<BR>
 * <BR>
 * 管理者・顧客銘柄別取引停止変更入力リクエストクラス<BR>
 * <BR>
 * WEB3AdminPMAccProductTradeStopModifyInputRequest<BR>
 * <BR>
 * @@author Sudhindrakinnal
 * @@version 1.0
 */
public class WEB3AdminPMAccProductTradeStopModifyInputRequest extends WEB3GenRequest
{
    /**
     * PTYPE<BR>
     */
    ...
    /**
     * @@roseuid 41FD93D400BB
     */
    public WEB3AdminPMAccProductTradeStopModifyInputRequest()
    {
     ...
     * <BR>           class : WEB3BusinessLayerException<BR>
     ...
     *            tag : BUSINESS_ERROR_01067<BR>
     * <BR>
     * 4)expirationStartDate <BR>
     * 　@4-1) If this.expirationStartDate == null <BR>
    ...
    public void validate() throws WEB3BusinessLayerException
    {
        ...
        {
            // 1-2 if branchCode is not Numeric & its length not equal to 3 throw Exception.
        ...
        // 2-1 if accountCode is not Numeric & its length not equal to 3 throw Exception.
        if (accountCode != null)
        {
        ...
        // 3-1if productCode is not Numeric & its length not equal to 3 throw Exception.
        if (productCode != null)
        {
        ...
        {
            // 4-2 if expirationStartDate can not be formated to Date Type , throw Exception.
    ...
    {
        return new WEB3AdminPMAccProductTradeStopModifyInputResponse(this);
    }
}
@
