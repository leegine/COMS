...
filename	HostAttentionInfoNotifyRow.java;
...
/** 
 * HostAttentionInfoNotifyRowインタフェースは変更不可でリードオンリーである<em>host_attention_info_notify</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostAttentionInfoNotifyRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostAttentionInfoNotifyRow extends Row {


  /** 
   * この{@@link HostAttentionInfoNotifyRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_attention_info_notify", "session" );
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getHighPriceRangeIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getHighPriceRangeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getHighPriceRangeIsModified();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getLowPriceRangeIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getLowPriceRangeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getLowPriceRangeIsModified();
