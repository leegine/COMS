...
filename	ForcedSettleOrderInqRow.java;
...
/** 
 * ForcedSettleOrderInqRowインタフェースは変更不可でリードオンリーである<em>forced_settle_order_inq</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link ForcedSettleOrderInqRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface ForcedSettleOrderInqRow extends Row {


  /** 
   * この{@@link ForcedSettleOrderInqRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "forced_settle_order_inq", "session" );
   ...
   * @@return longの値 
   */
  public long getForcedSettleOrderInqId();
   ...
   */
  public  boolean  getForcedSettleOrderInqIdIsSet();
   ...
   */
  public  boolean  getForcedSettleOrderInqIdIsModified();
