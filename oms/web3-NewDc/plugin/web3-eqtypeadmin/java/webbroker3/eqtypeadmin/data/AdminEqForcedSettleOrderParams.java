...
filename	AdminEqForcedSettleOrderParams.java;
...
/** 
 * admin_eq_forced_settle_orderテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AdminEqForcedSettleOrderRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AdminEqForcedSettleOrderParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AdminEqForcedSettleOrderParams}が{@@link AdminEqForcedSettleOrderRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class AdminEqForcedSettleOrderParams extends Params implements AdminEqForcedSettleOrderRow {
  ...
  public static final String PTYPE = "admin_eq_forced_settle_order";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = AdminEqForcedSettleOrderRow.TYPE;
  ...
  public RowType getRowType() {
    return AdminEqForcedSettleOrderRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のAdminEqForcedSettleOrderParamsオブジェクトを作成します。 
   */
  public AdminEqForcedSettleOrderParams() {
  }
  ...
  /** 
   * 指定のAdminEqForcedSettleOrderRowオブジェクトの値を利用してAdminEqForcedSettleOrderParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAdminEqForcedSettleOrderRowオブジェクト 
   */
  public AdminEqForcedSettleOrderParams( AdminEqForcedSettleOrderRow p_row )
  {
    ...
    contract_amount = p_row.getContractAmount();
  ...
  {
    if ( !( other instanceof AdminEqForcedSettleOrderRow ) )
       return false;
    return fieldsEqual( (AdminEqForcedSettleOrderRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のAdminEqForcedSettleOrderRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( AdminEqForcedSettleOrderRow row )
  {
    ...
    if ( contract_amount != row.getContractAmount() )
      return false;
   ...
   */
	protected void assertValidForInsert() throws IllegalArgumentException {
		...
		if ( !contract_amount_is_set )
			throw new IllegalArgumentException("non-nullable field 'contract_amount' must be set before inserting.");
   ...
   */
	public java.util.Map toInsertMap() {
		...
		map.put("contract_amount",new Double(contract_amount));
  ...
  {
    throw new UnsupportedOperationException("Table admin_eq_forced_settle_order has no primary key.");
  }
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                if ( name.equals("created_timestamp") ) {
                    ...
                    return new Double( contract_amount );
                }
                break;
            case 'd':
            ...
            case 'e':
                ...
                break;
            case 'f':
                if ( name.equals("forced_settle_reason_type") ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                if ( name.equals("created_timestamp") ) {
                    ...
                    this.contract_amount = ((Double) value).doubleValue();
