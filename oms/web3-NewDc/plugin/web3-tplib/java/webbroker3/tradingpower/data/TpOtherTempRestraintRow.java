...
/** 
 * TpOtherTempRestraintRowインタフェースは変更不可でリードオンリーである<em>tp_other_temp_restraint</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link TpOtherTempRestraintRow}インタフェースの実装オブジェクトを検索します。 
 * 
...
public interface TpOtherTempRestraintRow extends Row {
  ...
  /** 
   * この{@@link TpOtherTempRestraintRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
