...
1.1
date	2011.03.15.00.32.03;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	TpCalcResultExecNotifyRow.java;
...
/** 
 * TpCalcResultExecNotifyRowインタフェースは変更不可でリードオンリーである<em>tp_calc_result_exec_notify</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link TpCalcResultExecNotifyRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface TpCalcResultExecNotifyRow extends Row {


  /** 
   * この{@@link TpCalcResultExecNotifyRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "tp_calc_result_exec_notify", "session" );
   ...
   */
  public  boolean  getOccurredDivIsSet();
   ...
   */
  public  boolean  getOccurredDivIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRealCalcFlagIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRealCalcFlagIsModified();
