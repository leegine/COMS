...
1.1
date	2011.03.17.01.31.59;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3QtpRichPushEquityMarginOrderAcceptUnitServiceImpl.java;
...
@/*
 ...
 File Name        : QTPリッチクライアントプッシュ株式注文受付通知サービス実装(WEB3QtpRichPushEquityMarginOrderAcceptUnitServiceImpl.java)
...
/**
 * QTPリッチクライアントデータプッシュ株式注文受付通知サービスサービス実装<br/>
 * 
 * @@author 毛(FTL)
 * @@version 1.0
 */
public class WEB3QtpRichPushEquityMarginOrderAcceptUnitServiceImpl
    extends WEB3QtpRichPushUnitServiceImpl
    implements WEB3QtpRichPushEquityMarginOrderAcceptUnitService
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3QtpRichPushEquityMarginOrderAcceptUnitServiceImpl.class);
        ...
        throws DataQueryException, DataNetworkException
    {
        ...
        List l_equityOrderAcceptList =
            l_perService.getQtpEquityOrderAcceptRichPushData(l_lngFromAccountId, l_lngToAccountId);
