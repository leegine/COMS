...
1.1
date	2011.03.17.01.31.50;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3QtpRichPushSwapOrderAcceptUnitServiceImpl.java;
...
@/*
 ...
 File Name        : QTPリッチクライアントプッシュ株式現引現渡受付サービス実装(WEB3QtpRichPushSwapOrderAcceptUnitServiceImpl.java)
...
/**
 * QTPリッチクライアントプッシュ株式現引現渡受付サービス実装<br/>
 * 
 * @@author 毛(FTL)
 * @@version 1.0
 */
public class WEB3QtpRichPushSwapOrderAcceptUnitServiceImpl
    extends WEB3QtpRichPushUnitServiceImpl
    implements WEB3QtpRichPushSwapOrderAcceptUnitService
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3QtpRichPushSwapOrderAcceptUnitServiceImpl.class);
        ...
        throws DataQueryException, DataNetworkException
    {
        ...
        List l_equitySwapOrderAcceptList =
            l_perService.getQtpSwapOrderAcceptRichPushData(l_lngFromAccountId, l_lngToAccountId);
    ...
    public WEB3QtpExcutionInformUnit createRichPushXmlMessage( Row l_dataRow )
    {
        ...
        WEB3QtpExcutionInformUnit l_pushObj = web3QtpRichPushUtil.createWEB3QtpExcutionInformUnit(l_dataRow);
