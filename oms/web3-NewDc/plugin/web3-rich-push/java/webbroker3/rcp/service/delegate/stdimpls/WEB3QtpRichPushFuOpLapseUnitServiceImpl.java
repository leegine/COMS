...
1.1
date	2011.03.17.01.32.41;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3QtpRichPushFuOpLapseUnitServiceImpl.java;
...
@/*
 ...
 File Name        : QTPリッチクライアントプッシュ先物OP失効通知サービス実装(WEB3QtpRichPushFuOpLapseUnitServiceImpl.java)
...
/**
 * QTPリッチクライアントプッシュ先物OP失効通知サービス実装<br/>
 * 
 * @@author 毛(FTL)
 * @@version 1.0
 */
public class WEB3QtpRichPushFuOpLapseUnitServiceImpl
    extends WEB3QtpRichPushUnitServiceImpl
    implements WEB3QtpRichPushFuOpLapseUnitService
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3QtpRichPushFuOpLapseUnitServiceImpl.class);
        ...
        throws DataQueryException, DataNetworkException
    {
        ...
        List l_ifoLapseList =
            l_perService.getQtpIfoLapseRichPushData(l_lngFromAccountId, l_lngToAccountId);
