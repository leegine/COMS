...
1.1
date	2011.03.17.01.33.36;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3QtpRichPushFuOpOrderAcceptUnitServiceImpl.java;
...
@/*
 ...
 File Name        : QTPリッチクライアントプッシュ先物OP注文受付通知サービス実装(WEB3QtpRichPushFuOpOrderAcceptUnitServiceImpl.java)
...
/**
 * QTPリッチクライアントプッシュ先物OP注文受付通知サービス実装<br/>
 * 
 * @@author 毛(FTL)
 * @@version 1.0
 */
public class WEB3QtpRichPushFuOpOrderAcceptUnitServiceImpl
    extends WEB3QtpRichPushUnitServiceImpl
    implements WEB3QtpRichPushFuOpOrderAcceptUnitService
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3QtpRichPushFuOpOrderAcceptUnitServiceImpl.class);
        ...
        throws DataQueryException, DataNetworkException
    {
        ...
        List l_ifoOrderAcceptList =
            l_perService.getQtpIfoOrderAcceptRichPushData(l_lngFromAccountId, l_lngToAccountId);
