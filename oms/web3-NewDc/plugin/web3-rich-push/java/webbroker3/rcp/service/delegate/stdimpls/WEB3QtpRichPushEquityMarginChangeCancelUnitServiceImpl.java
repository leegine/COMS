...
1.1
date	2011.03.17.01.33.28;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3QtpRichPushEquityMarginChangeCancelUnitServiceImpl.java;
...
@/*
 ...
 File Name        : QTPリッチクライアントプッシュ株式訂正取消通知サービス実装(WEB3QtpRichPushEquityMarginChangeCancelUnitServiceImpl.java)
...
/**
 * QTPリッチクライアントデータプッシュ株式訂正取消通知サービス実装<br/>
 * 
 * @@author 毛(FTL)
 * @@version 1.0
 */
public class WEB3QtpRichPushEquityMarginChangeCancelUnitServiceImpl
    extends WEB3QtpRichPushUnitServiceImpl
    implements WEB3QtpRichPushEquityMarginChangeCancelUnitService
{
    /**
     * ログ出力ユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3QtpRichPushEquityMarginChangeCancelUnitServiceImpl.class);
        ...
        throws DataQueryException, DataNetworkException
    {
        ...
        List l_equityMarginChangeCancelList =
            l_perService.getQtpEquityChangeCancelRichPushData(l_lngFromAccountId, l_lngToAccountId);
