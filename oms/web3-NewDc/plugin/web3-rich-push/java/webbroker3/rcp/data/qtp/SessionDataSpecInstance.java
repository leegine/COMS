...
1.1
date	2011.03.17.01.26.11;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public class SessionDataSpecInstance extends DataSpec {
  ...
  private static final ColumnSpec qtp_rich_push_history_columns[] = {
  ...
  private static final ColumnSpec qtp_rich_push_history_top_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("serlnum",java.sql.Types.NUMERIC,18,0,false,true,null,null),
  };
  private static final ColumnSpec qtp_rich_push_eq_orderaccept_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    ...
    new ColumnSpec("created_timestamp",java.sql.Types.TIMESTAMP,0,0,true,false,null,null),
    new ColumnSpec("last_updated_timestamp",java.sql.Types.TIMESTAMP,0,0,true,false,null,null),
    new ColumnSpec("sid",java.sql.Types.VARCHAR,8,0,false,false,null,null),
    new ColumnSpec("serlnum",java.sql.Types.NUMERIC,18,0,false,true,null,null),
  };
  private static final ColumnSpec qtp_rich_push_sw_orderaccept_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,true,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,true,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_eq_changecancel_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,true,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,true,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_equity_cont_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,true,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,true,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_equity_lapse_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,true,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,true,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_ifo_orderaccept_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,true,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,true,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_ifo_changecancel_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_ifo_cont_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,false,false,null,null),
  ...
  private static final ColumnSpec qtp_rich_push_ifo_lapse_columns[] = {
    new ColumnSpec("tpk",java.sql.Types.VARCHAR,50,0,false,false,null,null),
    new ColumnSpec("type",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("request_code",java.sql.Types.VARCHAR,5,0,false,false,null,null),
    new ColumnSpec("institution_code",java.sql.Types.VARCHAR,3,0,false,false,null,null),
  ...
  private static final TableSpec tables[] = {
    new TableSpec("qtp_rich_push_history",qtp_rich_push_history_columns,null),
    new TableSpec("qtp_rich_push_history_top",qtp_rich_push_history_top_columns,null),
    new TableSpec("qtp_rich_push_eq_orderaccept",qtp_rich_push_eq_orderaccept_columns,null),
    new TableSpec("qtp_rich_push_sw_orderaccept",qtp_rich_push_sw_orderaccept_columns,null),
    new TableSpec("qtp_rich_push_eq_changecancel",qtp_rich_push_eq_changecancel_columns,null),
    new TableSpec("qtp_rich_push_equity_cont",qtp_rich_push_equity_cont_columns,null),
    new TableSpec("qtp_rich_push_equity_lapse",qtp_rich_push_equity_lapse_columns,null),
    new TableSpec("qtp_rich_push_ifo_orderaccept",qtp_rich_push_ifo_orderaccept_columns,null),
    new TableSpec("qtp_rich_push_ifo_changecancel",qtp_rich_push_ifo_changecancel_columns,null),
    new TableSpec("qtp_rich_push_ifo_cont",qtp_rich_push_ifo_cont_columns,null),
    new TableSpec("qtp_rich_push_ifo_lapse",qtp_rich_push_ifo_lapse_columns,null),
  };
