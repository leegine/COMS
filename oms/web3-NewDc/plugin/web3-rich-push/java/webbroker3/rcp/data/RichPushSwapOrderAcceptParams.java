...
1.1
date	2011.03.17.01.30.04;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RichPushSwapOrderAcceptParams.java;
...
/** 
 * rich_push_swap_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link RichPushSwapOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link RichPushSwapOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link RichPushSwapOrderAcceptParams}が{@@link RichPushSwapOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class RichPushSwapOrderAcceptParams extends Params implements RichPushSwapOrderAcceptRow {
  ...
  public static final String PTYPE = "rich_push_swap_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = RichPushSwapOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return RichPushSwapOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のRichPushSwapOrderAcceptParamsオブジェクトを作成します。 
   */
  public RichPushSwapOrderAcceptParams() {
  ...
  /** 
   * 指定のRichPushSwapOrderAcceptRowオブジェクトの値を利用してRichPushSwapOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するRichPushSwapOrderAcceptRowオブジェクト 
   */
  public RichPushSwapOrderAcceptParams( RichPushSwapOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof RichPushSwapOrderAcceptRow ) )
       return false;
    return fieldsEqual( (RichPushSwapOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のRichPushSwapOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( RichPushSwapOrderAcceptRow row )
  {
    if ( tpk == null ) {
      if ( row.getTpk() != null )
        return false;
  ...
  {
    return new RichPushSwapOrderAcceptPK(serlnum);
  }
