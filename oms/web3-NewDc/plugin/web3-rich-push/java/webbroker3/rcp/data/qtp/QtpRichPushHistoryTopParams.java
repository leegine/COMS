...
1.1
date	2011.03.17.01.25.45;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	QtpRichPushHistoryTopParams.java;
...
/** 
 * qtp_rich_push_history_topテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link QtpRichPushHistoryTopRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link QtpRichPushHistoryTopParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link QtpRichPushHistoryTopParams}が{@@link QtpRichPushHistoryTopRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class QtpRichPushHistoryTopParams extends Params implements QtpRichPushHistoryTopRow {
  ...
  public static final String PTYPE = "qtp_rich_push_history_top";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = QtpRichPushHistoryTopRow.TYPE;
  ...
  public RowType getRowType() {
    return QtpRichPushHistoryTopRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のQtpRichPushHistoryTopParamsオブジェクトを作成します。 
   */
  public QtpRichPushHistoryTopParams() {
  ...
  /** 
   * 指定のQtpRichPushHistoryTopRowオブジェクトの値を利用してQtpRichPushHistoryTopParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するQtpRichPushHistoryTopRowオブジェクト 
   */
  public QtpRichPushHistoryTopParams( QtpRichPushHistoryTopRow p_row )
  {
  ...
  {
    if ( !( other instanceof QtpRichPushHistoryTopRow ) )
       return false;
    return fieldsEqual( (QtpRichPushHistoryTopRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のQtpRichPushHistoryTopRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( QtpRichPushHistoryTopRow row )
  {
    if ( tpk == null ) {
      if ( row.getTpk() != null )
        return false;
  ...
  {
    return new QtpRichPushHistoryTopPK(serlnum);
  }
