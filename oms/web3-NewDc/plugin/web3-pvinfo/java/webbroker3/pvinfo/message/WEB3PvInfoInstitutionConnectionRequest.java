...
1.1
date	2011.03.22.08.05.02;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3PvInfoInstitutionConnectionRequest.java;
...
File Name        : 証券会社連絡リクエスト(WEB3PvInfoInstitutionConnectionRequest.java)
 ...
 * @@version 1.00
 */
public class WEB3PvInfoInstitutionConnectionRequest extends WEB3GenRequest
{
     ...
     * @@roseuid 4173439A030D
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3PvInfoInstitutionConnectionResponse(this);
    }
}
@
