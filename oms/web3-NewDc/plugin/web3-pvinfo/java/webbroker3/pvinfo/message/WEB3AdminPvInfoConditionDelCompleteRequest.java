...
File Name        : 管理者・表示設定削除完了リクエスト(WEB3AdminPvInfoConditionDelCompleteRequest.java)
...
/**
 * (管理者・表示設定削除完了リクエスト)<BR>
 * 管理者・表示設定削除完了リクエストクラス<BR>
 * @@author 王亞洲
 * @@version 1.00
 */
public class WEB3AdminPvInfoConditionDelCompleteRequest extends WEB3GenRequest 
{
    ...
    public void validate() throws WEB3BusinessLayerException
    {
        ...
        //１）表示内容IDのチェック
        //１－１）this.表示内容ID == nullの場合,表示内容IDがnull」の例外をスローする。
