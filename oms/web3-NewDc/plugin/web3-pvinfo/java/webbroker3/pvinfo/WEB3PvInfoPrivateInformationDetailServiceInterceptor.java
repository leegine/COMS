...
1.1
date	2011.03.22.08.10.51;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3PvInfoPrivateInformationDetailServiceInterceptor.java;
...
File Name        : ﾌﾟﾗｲﾍﾞｰﾄｲﾝﾌｫﾒｰｼｮﾝ詳細サービスインタセプタ(WEB3PvInfoPrivateInformationDetailServiceInterceptor.java)
...
/**
 * (ﾌﾟﾗｲﾍﾞｰﾄｲﾝﾌｫﾒｰｼｮﾝ詳細サービスインタセプタ)<BR>
 * ﾌﾟﾗｲﾍﾞｰﾄｲﾝﾌｫﾒｰｼｮﾝ詳細サービスインタセプタ<BR>
 * @@author 王亞洲
 * @@version 1.00
 */
public class WEB3PvInfoPrivateInformationDetailServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3PvInfoPrivateInformationDetailServiceInterceptor.class);

    /**
     * サービスメソッド開始時にコールされる。<BR>
     * <BR>
     * 取引カレンダが利用するcを生成する。<BR>
    ...
    public java.lang.Object onCall(Method l_method, Object[] l_serviceParam) 
    {
        ...
        try
        {
            ...
            log.info("getService(OpLoginSecurityService.class): " + l_opLoginSec);
