...
1.1
date	2011.03.15.05.50.32;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	IpoBookbuildingOrderActionRow.java;
...
/** 
 * IpoBookbuildingOrderActionRowインタフェースは変更不可でリードオンリーである<em>ipo_bookbuilding_order_action</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link IpoBookbuildingOrderActionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface IpoBookbuildingOrderActionRow extends Row {


  /** 
   * この{@@link IpoBookbuildingOrderActionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ipo_bookbuilding_order_action", "account" );
   ...
   * @@return longの値 
   */
  public long getBookbuildingOrderActionId();
   ...
   */
  public  boolean  getBookbuildingOrderActionIdIsSet();
   ...
   */
  public  boolean  getBookbuildingOrderActionIdIsModified();
   ...
   * @@return Stringの値 
   */
  public String getActionSendStatus();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getActionSendStatusIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getActionSendStatusIsModified();
