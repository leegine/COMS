...
1.1
date	2011.03.14.06.59.50;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SeszSleRepliesCallback.java;
 ...
 * @@version     V1.0  
 */
public class WEB3SeszSleRepliesCallback implements SleRepliesCallback
{
     ...
     * ログ出力オブジェクト
     */
	private static final Category m_log =  Category.getInstance(WEB3SeszSleRepliesCallback.class);
...
//   private final String m_glid = WEB3SleCallbackConstantsDef.Markets.SEHK.GLID;
     ...
     */
    public WEB3SeszSleRepliesCallback(Map l_hmParams)
    {
