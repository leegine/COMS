...
1.1
date	2011.03.14.06.59.54;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SeshSleRepliesCallback.java;
...
@/**
 ...
 File Name        : WEB3SeshSleRepliesCallbackクラス
 Author Name      : Daiwa Institute of Research
 Revision History : 2008/09/01  許(FLJ) 新規作成
 */
 ...
 * @@version     V1.0  
 */
public class WEB3SeshSleRepliesCallback implements SleRepliesCallback
{
     ...
     * ログ出力オブジェクト
     */
    private static final Category m_log =  Category.getInstance(WEB3SeshSleRepliesCallback.class);
     ...
     */
    public WEB3SeshSleRepliesCallback(Map l_hmParams)
    {
...
//                    String l_strSql = "select xblocks_product_type from SLE_EXCHANGE_ORDER_KEY_MNG where order_unit_id = ? and xblocks_product_type = ?";
    ...
    private boolean doRcvdqInsert(GlData l_glData, Map l_hmAdditionData) throws SQLException
    {
        ...
        final Object[][] l_aryValues = {
                ...
                { l_glData.getBigDecimal("average_price"), ORACLE_TYPES_NUMERIC },//average_price
                { l_glData.getBigDecimal("executed_quantity"), ORACLE_TYPES_NUMERIC },
                { l_glData.getBigDecimal("remaining_quantity"), ORACLE_TYPES_NUMERIC },//remaining_quantity
