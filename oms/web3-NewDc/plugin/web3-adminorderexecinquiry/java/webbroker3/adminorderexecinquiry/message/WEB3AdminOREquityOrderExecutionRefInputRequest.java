...
1.1
date	2011.03.14.02.46.38;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminOREquityOrderExecutionRefInputRequest.java;
...
File Name        : 管理者・株式注文約定照会入力リクエスト (WEB3AdminOREquityOrderExecutionRefInputRequest.java)
 ...
 * @@version 1.0
 */
public class WEB3AdminOREquityOrderExecutionRefInputRequest extends WEB3GenRequest
{
    /**
     * PTYPE<BR>
     */
    ...
    /**
     * @@roseuid 4212FB19020B
     */
    public WEB3AdminOREquityOrderExecutionRefInputRequest()
    {
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        // 1-2 if branchCode.length is equla to 0, throw Exception.
    ...
    {
        return new WEB3AdminOREquityOrderExecutionRefInputResponse(this);
    }
}@
