...
1.1
date	2011.03.14.03.47.45;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminMutualRuitoExecuteReferenceServiceInterceptor.java;
...
File Name        : 管理者投信累投注文約定照会サービスインタセプタ
                        (WEB3AdminMutualRuitoExecuteReferenceServiceInterceptor.java)
...
/**
 * (管理者投信累投注文約定照会サービスインタセプタ)<BR>
 * <BR>
 * 管理者投信累投注文約定照会サービスインタセプタ<BR>
 * <BR>
 * WEB3AdminMutualRuitoExecuteReferenceServiceInterceptor<BR>
 * <BR>
 * @@author Vijay Kumar
 * @@version 1.0
 */
public class WEB3AdminMutualRuitoExecuteReferenceServiceInterceptor implements Interceptor
{
    /**
      * WEB3LogUtility log<BR>
      */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminMutualRuitoExecuteReferenceServiceInterceptor.class);

    /**
     * @@roseuid 42130A8201BD
     */
    public WEB3AdminMutualRuitoExecuteReferenceServiceInterceptor()
    {
    }
