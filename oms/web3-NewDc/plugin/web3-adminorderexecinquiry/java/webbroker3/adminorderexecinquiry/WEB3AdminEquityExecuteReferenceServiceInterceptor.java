...
1.1
date	2011.03.14.03.47.12;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminEquityExecuteReferenceServiceInterceptor.java;
...
File Name        : 管理者株式注文約定照会サービスインタセプタ(WEB3AdminEquityExecuteReferenceServiceInterceptor.java)
...
/**
 * (管理者株式注文約定照会サービスインタセプタ)<BR>
 * <BR>
 * 管理者株式注文約定照会サービスインタセプタ<BR>
 * <BR>
 * ----<English>--------------------<BR>
 * WEB3AdminEquityExecuteReferenceServiceInterceptor<BR>
 * <BR>
 * WEB3AdminEquityExecuteReferenceServiceInterceptor class<BR>
 * <BR>
 * @@author Wanishree
 * @@version 1.0
 */
public  class WEB3AdminEquityExecuteReferenceServiceInterceptor implements Interceptor
{
    /**
       * WEB3LogUtility log<BR>
       */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminEquityExecuteReferenceServiceInterceptor.class);

    /**
     * @@roseuid 42130ABF0279
     */
    public WEB3AdminEquityExecuteReferenceServiceInterceptor()
    {
