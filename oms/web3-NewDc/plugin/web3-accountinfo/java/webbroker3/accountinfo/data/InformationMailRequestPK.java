...
/** 
 * <b>InformationMailRequest</b>データベーステーブルで一意である1つのレコードをあらわす<b>InformationMailRequest</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>InformationMailRequest</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
...
public class InformationMailRequestPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: InformationMailRequestRow. 
   */
  ...
  /**
   * <em>information_mail_request_id</em>カラムの値をあらわす18桁以下のlong値 
   */
