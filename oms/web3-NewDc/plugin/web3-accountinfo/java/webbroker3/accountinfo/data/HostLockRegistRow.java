...
1.1
date	2011.03.10.02.15.06;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostLockRegistRow.java;
...
/** 
 * HostLockRegistRowインタフェースは変更不可でリードオンリーである<em>host_lock_regist</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostLockRegistRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostLockRegistRow extends Row {


  /** 
   * この{@@link HostLockRegistRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_lock_regist", "session" );
   ...
   */
  public java.sql.Timestamp getBeforeMngLockStartDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeMngLockStartDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeMngLockStartDateIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getBeforeMngLockEndDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeMngLockEndDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeMngLockEndDateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getBeforeBranchLock();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeBranchLockIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeBranchLockIsModified();
   ...
   * @@return Stringの値 
   */
  public String getBeforeOrderPermission();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeOrderPermissionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeOrderPermissionIsModified();
   ...
   * @@return Stringの値 
   */
  public String getBeforeLockRegistReason();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeLockRegistReasonIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeLockRegistReasonIsModified();
   ...
   * @@return Stringの値 
   */
  public String getBeforeYellowCustomer();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeYellowCustomerIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBeforeYellowCustomerIsModified();
   ...
   * @@return Stringの値 
   */
  public String getMngLockCancelDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMngLockCancelDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMngLockCancelDivIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getMngLockCancelStartDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMngLockCancelStartDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMngLockCancelStartDateIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getMngLockCancelEndDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMngLockCancelEndDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMngLockCancelEndDateIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAttributeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAttributeIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegiEraseDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegiEraseDivIsModified();
