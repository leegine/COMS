...
1.1
date	2011.03.10.02.16.48;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CommCampaignCondMstRow.java;
...
/** 
 * CommCampaignCondMstRowインタフェースは変更不可でリードオンリーである<em>comm_campaign_cond_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CommCampaignCondMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface CommCampaignCondMstRow extends Row {


  /** 
   * この{@@link CommCampaignCondMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "comm_campaign_cond_mst", "session" );
   ...
   */
  public  boolean  getCampaignIdIsSet();
   ...
   */
  public  boolean  getCampaignIdIsModified();
   ...
   * @@return Stringの値 
   */
  public String getCommCampaignName();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCommCampaignNameIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCommCampaignNameIsModified();
   ...
   * @@return Stringの値 
   */
  public String getAccOpenPassMonth();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenPassMonthIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenPassMonthIsModified();
   ...
   * @@return Stringの値 
   */
  public String getAccOpenPassDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenPassDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenPassDateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getAccOpenKindDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenKindDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenKindDivIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getAccOpenDateFrom();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenDateFromIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenDateFromIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getAccOpenDateTo();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenDateToIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccOpenDateToIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegistTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegistTypeIsModified();
