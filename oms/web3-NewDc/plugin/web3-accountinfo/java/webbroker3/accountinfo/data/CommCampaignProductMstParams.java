...
1.1
date	2011.03.10.02.14.41;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CommCampaignProductMstParams.java;
...
/** 
 * comm_campaign_product_mstテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link CommCampaignProductMstRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link CommCampaignProductMstParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link CommCampaignProductMstParams}が{@@link CommCampaignProductMstRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class CommCampaignProductMstParams extends Params implements CommCampaignProductMstRow {
  ...
  public static final RowType TYPE = CommCampaignProductMstRow.TYPE;
  ...
  /** 
   * 値が未設定のCommCampaignProductMstParamsオブジェクトを作成します。 
   */
  public CommCampaignProductMstParams() {
  ...
  /** 
   * 指定のCommCampaignProductMstRowオブジェクトの値を利用してCommCampaignProductMstParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するCommCampaignProductMstRowオブジェクト 
   */
  public CommCampaignProductMstParams( CommCampaignProductMstRow p_row )
  {
  ...
  {
    if ( !( other instanceof CommCampaignProductMstRow ) )
       return false;
    return fieldsEqual( (CommCampaignProductMstRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のCommCampaignProductMstRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( CommCampaignProductMstRow row )
  {
  ...
  {
    return new CommCampaignProductMstPK(campaign_id, comm_product_code);
  }
