...
/** 
 * CommAccountSendRowインタフェースは変更不可でリードオンリーである<em>comm_account_send</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CommAccountSendRow}インタフェースの実装オブジェクトを検索します。 
 * 
...
public interface CommAccountSendRow extends Row {
  ...
  /** 
   * この{@@link CommAccountSendRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
