...
/** 
 * comm_campaign_cond_mstテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link CommCampaignCondMstRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link CommCampaignCondMstParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link CommCampaignCondMstParams}が{@@link CommCampaignCondMstRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class CommCampaignCondMstParams extends Params implements CommCampaignCondMstRow {
  ...
  /** 
   * <em>acc_open_pass_month</em>カラムの値 
   */
  public  String  acc_open_pass_month;

  /** 
   * <em>acc_open_pass_date</em>カラムの値 
   */
  ...
  /** 
   * <em>acc_open_date_from</em>カラムの値 
   */
  public  java.sql.Timestamp  acc_open_date_from;

  /** 
   * <em>acc_open_date_to</em>カラムの値 
   */
  ...
  /** 
   * 値が未設定のCommCampaignCondMstParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のCommCampaignCondMstRowオブジェクトの値を利用してCommCampaignCondMstParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するCommCampaignCondMstRowオブジェクト 
   */
   ...
   * @@param row 比較対照のCommCampaignCondMstRow 
  ...
  /** 
   * <em>acc_open_pass_month</em>カラムの値を取得します。
   * @@return Stringの値 
   */
  ...
  /** 
   * <em>acc_open_pass_month</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_pass_month</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_pass_date</em>カラムの値を取得します。
   * @@return Stringの値 
   */
  ...
  /** 
   * <em>acc_open_pass_date</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_pass_date</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_date_from</em>カラムの値を取得します。
   * @@return java.sql.Timestampの値 
   */
  ...
  /** 
   * <em>acc_open_date_from</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_date_from</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_date_to</em>カラムの値を取得します。
   * @@return java.sql.Timestampの値 
   */
  ...
  /** 
   * <em>acc_open_date_to</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_date_to</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>acc_open_pass_month</em>カラムの値を設定します。 
   *
   * @@param p_accOpenPassMonth <em>acc_open_pass_month</em>カラムの値をあらわす2桁以下のString値 
   */
  ...
  /** 
   * <em>acc_open_pass_date</em>カラムの値を設定します。 
   *
   * @@param p_accOpenPassDate <em>acc_open_pass_date</em>カラムの値をあらわす2桁以下のString値 
   */
  ...
  /** 
   * <em>acc_open_date_from</em>カラムの値を設定します。 
   *
   * @@param p_accOpenDateFrom <em>acc_open_date_from</em>カラムの値をあらわすjava.sql.Timestamp値
   */
  public final void setAccOpenDateFrom( java.sql.Timestamp p_accOpenDateFrom )  {
   ...
   /** 
   * 一般のjava.util.Dateオブジェクトを使って<em>acc_open_date_from</em>カラムに値を設定します。 
   * @@param date 設定する値を含むjava.util.Date 
    */
  ...
  /** 
   * <em>acc_open_date_to</em>カラムの値を設定します。 
   *
   * @@param p_accOpenDateTo <em>acc_open_date_to</em>カラムの値をあらわすjava.sql.Timestamp値
   */
  public final void setAccOpenDateTo( java.sql.Timestamp p_accOpenDateTo )  {
   ...
   /** 
   * 一般のjava.util.Dateオブジェクトを使って<em>acc_open_date_to</em>カラムに値を設定します。 
   * @@param date 設定する値を含むjava.util.Date 
    */
