...
1.1
date	2011.03.10.02.14.33;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostLockRegiAcceptParams.java;
...
/** 
 * host_lock_regi_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostLockRegiAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostLockRegiAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostLockRegiAcceptParams}が{@@link HostLockRegiAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostLockRegiAcceptParams extends Params implements HostLockRegiAcceptRow {
  ...
  public static final RowType TYPE = HostLockRegiAcceptRow.TYPE;
  ...
  /** 
   * 値が未設定のHostLockRegiAcceptParamsオブジェクトを作成します。 
   */
  public HostLockRegiAcceptParams() {
  ...
  /** 
   * 指定のHostLockRegiAcceptRowオブジェクトの値を利用してHostLockRegiAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostLockRegiAcceptRowオブジェクト 
   */
  public HostLockRegiAcceptParams( HostLockRegiAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostLockRegiAcceptRow ) )
       return false;
    return fieldsEqual( (HostLockRegiAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostLockRegiAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostLockRegiAcceptRow row )
  {
  ...
  {
    return new HostLockRegiAcceptPK(rowid);
  }
