...
1.1
date	2011.03.10.02.15.02;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CommCampaignAccHistoryRow.java;
...
/** 
 * CommCampaignAccHistoryRowインタフェースは変更不可でリードオンリーである<em>comm_campaign_acc_history</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CommCampaignAccHistoryRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface CommCampaignAccHistoryRow extends Row {


  /** 
   * この{@@link CommCampaignAccHistoryRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "comm_campaign_acc_history", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getValidDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getValidDivIsModified();
