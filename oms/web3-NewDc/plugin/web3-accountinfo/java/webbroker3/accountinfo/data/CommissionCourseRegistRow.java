...
1.1
date	2011.03.10.02.15.39;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CommissionCourseRegistRow.java;
...
/** 
 * CommissionCourseRegistRowインタフェースは変更不可でリードオンリーである<em>commission_course_regist</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CommissionCourseRegistRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface CommissionCourseRegistRow extends Row {


  /** 
   * この{@@link CommissionCourseRegistRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "commission_course_regist", "account" );
   ...
   * @@return longの値 
   */
  public long getCommissionCourseRegistId();
   ...
   */
  public  boolean  getCommissionCourseRegistIdIsSet();
   ...
   */
  public  boolean  getCommissionCourseRegistIdIsModified();
   ...
   */
  public java.sql.Timestamp getAppliStartDatetime();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliStartDatetimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliStartDatetimeIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getAppliEndDatetime();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliEndDatetimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliEndDatetimeIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getRegistTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegistTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegistTimestampIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getRegistEndTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegistEndTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRegistEndTimestampIsModified();
   ...
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.BooleanEnum getDownloadFlag();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDownloadFlagIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDownloadFlagIsModified();
