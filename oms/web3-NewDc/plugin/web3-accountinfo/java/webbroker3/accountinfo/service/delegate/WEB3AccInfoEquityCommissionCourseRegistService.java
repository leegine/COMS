...
File Name        : お客様情報株式委託手数料コース変更申込サービス(WEB3AccInfoEquityCommissionCourseRegistService.java)
...
/**
 * (お客様情報株式委託手数料コース変更申込サービス)<BR>
 * お客様情報株式委託手数料コース変更申込サービスインタフェイス<BR>
 * @@author 彭巍
 * @@version 1.0
 */
