...
1.1
date	2011.03.10.02.11.17;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoLoginPasswordResetInputRequest.java;
...
File Name        : (管理者お客様情報パスワードリセット入力リクエスト(WEB3AdminAccInfoLoginPasswordResetInputRequest)
...
/**
 * (管理者お客様情報パスワードリセット入力リクエスト)<BR>
 * 管理者お客様情報パスワードリセット入力リクエスト<BR>
 * 
 * @@author 張宝楠(中訊)
 * @@version 1.0
 */
public class WEB3AdminAccInfoLoginPasswordResetInputRequest extends WEB3GenRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoLoginPasswordResetInputRequest.class);   
    ...
    /**
     * @@roseuid 418F385E009C
     */
    public WEB3AdminAccInfoLoginPasswordResetInputRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoLoginPasswordResetInputResponse(this);
    }
