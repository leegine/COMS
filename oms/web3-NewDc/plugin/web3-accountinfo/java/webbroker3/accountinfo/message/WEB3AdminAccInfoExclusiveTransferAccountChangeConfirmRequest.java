...
1.1
date	2011.03.10.01.57.37;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoExclusiveTransferAccountChangeConfirmRequest.java;
...
File Name        : 管理者お客様情報専用振込先口座変更確認ﾘｸｴｽﾄ(WEB3AdminAccInfoExclusiveTransferAccountChangeConfirmRequest.java)
...
/**
 * (管理者お客様情報専用振込先口座変更確認ﾘｸｴｽﾄ)<BR>
 * 管理者お客様情報専用振込先口座変更確認ﾘｸｴｽﾄ<BR>
 * @@author カク寛新
 * @@version 1.0
 */
public class WEB3AdminAccInfoExclusiveTransferAccountChangeConfirmRequest extends WEB3GenRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoExclusiveTransferAccountChangeConfirmRequest.class);
    ...
    /**
     * @@roseuid 418F386701E4
     */
    public WEB3AdminAccInfoExclusiveTransferAccountChangeConfirmRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoExclusiveTransferAccountChangeConfirmResponse(this);
    }
