...
1.1
date	2011.03.10.02.06.58;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoPasswordResetRequest.java;
...
File Name        : 管理者お客様情報暗証番号リセットリクエスト(WEB3AdminAccInfoPasswordResetRequest)
...
/**
 * (管理者お客様情報暗証番号リセットリクエスト)<BR>
 * 管理者お客様情報暗証番号リセットリクエスト<BR>
 * 
 * @@author 張宝楠(中訊)
 * @@version 1.0
 */
public class WEB3AdminAccInfoPasswordResetRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoPasswordResetRequest.class);        
    ...
    /**
     * @@roseuid 418F385B01D4
     */
    public WEB3AdminAccInfoPasswordResetRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoPasswordResetResponse(this);
    }
