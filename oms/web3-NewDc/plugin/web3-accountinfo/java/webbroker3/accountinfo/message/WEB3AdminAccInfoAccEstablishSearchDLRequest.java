...
1.1
date	2011.03.10.02.04.43;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoAccEstablishSearchDLRequest.java;
...
File Name        : 管理者お客様情報新規口座開設・口座移管・ログインロック顧客検索ﾀﾞｳﾝﾛｰﾄﾞﾘｸｴｽﾄ(WEB3AdminAccInfoAccEstablishSearchDLRequest.java)
...
/**
 * (管理者お客様情報新規口座開設・口座移管・ログインロック顧客検索ﾀﾞｳﾝﾛｰﾄﾞﾘｸｴｽﾄ)<BR>
 * 管理者お客様情報新規口座開設・口座移管・ログインロック顧客検索ﾀﾞｳﾝﾛｰﾄﾞﾘｸｴｽﾄ<BR>
 * <BR>
 * @@author 何文敏
 * @@version 1.0
...
public class WEB3AdminAccInfoAccEstablishSearchDLRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoAccEstablishSearchDLRequest.class);
     ...
     */
    public WEB3AdminAccInfoAccEstablishSearchDLRequest()
    {
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        // 8 －３） ソートキーの要素数分、下記のチェックを繰り返して行う。
        // 　@　@8 －３－１） ソートキー.validate()をコールする。
        //　@ 　@ 8 －３－２） ソートキー.キー項目が下記の項目名以外の場合、 例外をスローする。
        //　@　@ 　@　@　@　@　@　@　@　@　@・部店コード
        //　@　@　@ 　@　@　@　@　@　@　@　@・扱者コード
        //　@　@　@　@ 　@　@　@　@　@　@　@・顧客コード
        //　@　@　@　@　@ 　@　@　@　@　@　@・口座開設日
    ...
    {
        return new WEB3AdminAccInfoAccEstablishSearchDLResponse(this);
    }
}
@
