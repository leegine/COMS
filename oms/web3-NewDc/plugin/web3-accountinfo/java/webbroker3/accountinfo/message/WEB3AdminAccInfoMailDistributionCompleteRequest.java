...
1.1
date	2011.03.10.02.05.00;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoMailDistributionCompleteRequest.java;
...
File Name        : 管理者お客様情報案内メール配信指示完了要求(WEB3AdminAccInfoMailDistributionCompleteRequest)
...
/**
 * (管理者お客様情報案内メール配信指示完了要求)<BR>
 * 管理者お客様情報案内メール配信指示完了要求<BR>
 */
public class WEB3AdminAccInfoMailDistributionCompleteRequest extends WEB3GenRequest
{
    ...
    */
    private static WEB3LogUtility log =
           WEB3LogUtility.getInstance(WEB3AdminAccInfoMailDistributionCompleteRequest.class);
    /**
     * PTYPE<BR>
     */
     ...
     */
    public WEB3AdminAccInfoMailDistributionCompleteRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoMailDistributionCompleteResponse(this);
    }
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        if (!WEB3SendmailDivDef.ACCINFO_GUIDE_MAIL.equals(this.sendMailDiv))
        {
            ...
            throw new WEB3BusinessLayerException(
                ...
                getClass().getName() + STR_METHOD_NAME, "送信メール区分案内メール（'0401')以外の値場合");
        }
        
        if (this.discernId == null || "".equals(this.discernId))
        {
            log.debug("[識別ＩＤ] = " + discernId);
            throw new WEB3BusinessLayerException(WEB3ErrorCatalog.BUSINESS_ERROR_00865, getClass().getName() + STR_METHOD_NAME, "識別ＩＤ未入力の場合");
        }
