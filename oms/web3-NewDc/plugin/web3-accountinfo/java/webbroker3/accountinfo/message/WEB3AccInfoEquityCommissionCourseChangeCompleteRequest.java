...
File Name        : お客様情報株式委託手数料コース変更申込完了リクエスト(WEB3AccInfoEquityCommissionCourseChangeCompleteRequest.java)
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        if (this.commissionCourse == null || "".equals(this.commissionCourse))
        {
            ...
            throw new WEB3BusinessLayerException(
                ...
                this.getClass().getName()  + STR_METHOD_NAME,"手数料コースの未入力の場合");
        } 
