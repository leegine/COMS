...
1.1
date	2011.03.10.02.07.19;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoMailAddressChangeConfirmRequest.java;
...
File Name        : 管理者お客様情報メールアドレス変更確認リクエスト(WEB3AdminAccInfoMailAddressChangeConfirmRequest.java)
...
/**
 * (管理者お客様情報メールアドレス変更確認リクエスト)<BR>
 * 管理者お客様情報メールアドレス変更確認リクエスト<BR>
 * @@author 劉江涛
 * @@version 1.0
 */
public class WEB3AdminAccInfoMailAddressChangeConfirmRequest extends WEB3GenRequest
{
    /**         
     * ログ出力ユーティリティ。         
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoMailAddressChangeConfirmRequest.class);
    /**
     * PTYPE<BR>
     */
    ...
    /**
     * @@roseuid 418F385703C8
     */
    public WEB3AdminAccInfoMailAddressChangeConfirmRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoMailAddressChangeConfirmResponse(this);
    }
...
　@   *    ※ 削除と口座開設完了メールは同時に指定できない。<BR>
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        if (this.mailAddressDelFlag && (this.changedMailAddress != null && (!"".equals(this.changedMailAddress))))
        {
            ...
            throw new WEB3BusinessLayerException(WEB3ErrorCatalog.BUSINESS_ERROR_01154, getClass().getName() + STR_METHOD_NAME, "メールアドレス削除フラグ == trueの場合、変更後メールアドレスが入力");
        }
