...
1.1
date	2011.03.10.02.11.33;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoLoginErrorResetInputRequest.java;
...
File Name        : 管理者お客様情報ログインエラーリセット入力リクエスト(WEB3AdminAccInfoLoginErrorResetInputRequest)
...
/**
 * (管理者お客様情報ログインエラーリセット入力リクエスト)<BR>
 * 管理者お客様情報ログインエラーリセット入力リクエスト<BR>
 * 
 * @@author 張宝楠(中訊)
 * @@version 1.0
 */
public class WEB3AdminAccInfoLoginErrorResetInputRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoLoginErrorResetInputRequest.class);
    ...
    /**
     * @@roseuid 418F385E03B9
     */
    public WEB3AdminAccInfoLoginErrorResetInputRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoLoginErrorResetInputResponse(this);
    }
