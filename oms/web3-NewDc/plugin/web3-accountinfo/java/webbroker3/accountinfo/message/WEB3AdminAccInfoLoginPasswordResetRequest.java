...
1.1
date	2011.03.10.02.07.52;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoLoginPasswordResetRequest.java;
...
File Name        : (管理者お客様情報パスワードリセットリクエスト(WEB3AdminAccInfoLoginPasswordResetRequest)
...
/**
 * (管理者お客様情報パスワードリセットリクエスト)<BR>
 * 管理者お客様情報パスワードリセットリクエスト<BR>
 * 
 * @@author 張宝楠(中訊)
 * @@version 1.0
 */
public class WEB3AdminAccInfoLoginPasswordResetRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoLoginPasswordResetRequest.class);   
    ...
    /**
     * @@roseuid 418F385B002E
     */
    public WEB3AdminAccInfoLoginPasswordResetRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoLoginPasswordResetResponse(this);
    }
