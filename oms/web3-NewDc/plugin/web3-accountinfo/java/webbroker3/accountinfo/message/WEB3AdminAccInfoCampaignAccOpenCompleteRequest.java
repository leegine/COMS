...
1.1
date	2011.03.10.01.58.22;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAccInfoCampaignAccOpenCompleteRequest.java;
...
File Name        : 管理者お客様情報手数料割引ｷｬﾝﾍﾟｰﾝ口座開設条件変更完了ﾘｸｴｽﾄ(WEB3AdminAccInfoCampaignAccOpenCompleteRequest.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/2/1  齊珂(中訊) 新規作成
Revision History : 2007/2/1  モデルNo.165
Revision History : 2007/2/5  モデルNo.179
Revision History : 2007/2/28 Inomata(SCS)モデルNo.203
...
/**
 * (管理者お客様情報手数料割引ｷｬﾝﾍﾟｰﾝ口座開設条件変更完了ﾘｸｴｽﾄ)<BR>
 * 管理者お客様情報手数料割引ｷｬﾝﾍﾟｰﾝ口座開設条件変更完了ﾘｸｴｽﾄ<BR>
 * <BR>
 * @@author 齊珂
 * @@version 1.0
 */
public class WEB3AdminAccInfoCampaignAccOpenCompleteRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAccInfoCampaignAccOpenCompleteRequest.class);

    /**
     * PTYPE<BR>
     */
    public static final String PTYPE = "admin_accInfo_campaignAccOpenComplete";

    /**
     * SerialVersionUID<BR>
     */
    public static final long serialVersionUID = 200701312022L;
    ...
    /**
     * @@roseuid 45C0875F00E0
     */
    public WEB3AdminAccInfoCampaignAccOpenCompleteRequest()
    {
    ...
    {
        return new WEB3AdminAccInfoCampaignAccOpenCompleteResponse(this);
    }
