...
1.1
date	2011.03.10.02.02.11;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AccInfoMailAddressChangeConfirmRequest.java;
...
File Name        : お客様情報メールアドレス変更確認リクエスト(WEB3AccInfoMailAddressChangeConfirmRequest.java)
...
/**
 * (お客様情報メールアドレス変更確認リクエスト)<BR>
 * お客様情報メールアドレス変更確認リクエスト<BR>
 * @@author 劉江涛
 * @@version 1.0
 */
public class WEB3AccInfoMailAddressChangeConfirmRequest extends WEB3GenRequest
{
    /**         
     * ログ出力ユーティリティ。         
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AccInfoMailAddressChangeConfirmRequest.class);
    /**
     * PTYPE<BR>
     */
     ...
     */
    public WEB3AccInfoMailAddressChangeConfirmRequest()
    {
    ...
    {
        return new WEB3AccInfoMailAddressChangeConfirmResponse(this);
    }
