...
1.1
date	2011.03.14.02.34.36;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountPreferencesRow.java;
...
/** 
 * AccountPreferencesRowインタフェースは変更不可でリードオンリーである<em>account_preferences</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AccountPreferencesRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AccountPreferencesRow extends Row {


  /** 
   * この{@@link AccountPreferencesRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "account_preferences", "account" );
