...
1.1
date	2011.03.14.02.37.00;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	TradedProductCalendarParams.java;
...
/** 
 * traded_product_calendarテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link TradedProductCalendarRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link TradedProductCalendarParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link TradedProductCalendarParams}が{@@link TradedProductCalendarRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class TradedProductCalendarParams extends Params implements TradedProductCalendarRow {
  ...
  public static final RowType TYPE = TradedProductCalendarRow.TYPE;
  ...
  /** 
   * 値が未設定のTradedProductCalendarParamsオブジェクトを作成します。 
   */
  public TradedProductCalendarParams() {
  ...
  /** 
   * 指定のTradedProductCalendarRowオブジェクトの値を利用してTradedProductCalendarParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するTradedProductCalendarRowオブジェクト 
   */
  public TradedProductCalendarParams( TradedProductCalendarRow p_row )
  {
  ...
  {
    if ( !( other instanceof TradedProductCalendarRow ) )
       return false;
    return fieldsEqual( (TradedProductCalendarRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のTradedProductCalendarRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( TradedProductCalendarRow row )
  {
  ...
  {
    return new TradedProductCalendarPK(traded_product_id, trade_date);
  }
