...
/** 
 * sub_account_preferencesテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link SubAccountPreferencesRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link SubAccountPreferencesParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link SubAccountPreferencesParams}が{@@link SubAccountPreferencesRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class SubAccountPreferencesParams extends Params implements SubAccountPreferencesRow {
  ...
  /** 
   * 値が未設定のSubAccountPreferencesParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のSubAccountPreferencesRowオブジェクトの値を利用してSubAccountPreferencesParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するSubAccountPreferencesRowオブジェクト 
   */
   ...
   * @@param row 比較対照のSubAccountPreferencesRow 
