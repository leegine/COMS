...
1.1
date	2011.03.14.02.34.44;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	SystemPreferencesParams.java;
...
/** 
 * system_preferencesテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link SystemPreferencesRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link SystemPreferencesParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link SystemPreferencesParams}が{@@link SystemPreferencesRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class SystemPreferencesParams extends Params implements SystemPreferencesRow {
  ...
  public static final RowType TYPE = SystemPreferencesRow.TYPE;
  ...
  /** 
   * 値が未設定のSystemPreferencesParamsオブジェクトを作成します。 
   */
  public SystemPreferencesParams() {
  ...
  /** 
   * 指定のSystemPreferencesRowオブジェクトの値を利用してSystemPreferencesParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するSystemPreferencesRowオブジェクト 
   */
  public SystemPreferencesParams( SystemPreferencesRow p_row )
  {
    name = p_row.getName();
  ...
  {
    if ( !( other instanceof SystemPreferencesRow ) )
       return false;
    return fieldsEqual( (SystemPreferencesRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のSystemPreferencesRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( SystemPreferencesRow row )
  {
    if ( name == null ) {
      if ( row.getName() != null )
        return false;
  ...
  {
    return new SystemPreferencesPK(name);
  }
