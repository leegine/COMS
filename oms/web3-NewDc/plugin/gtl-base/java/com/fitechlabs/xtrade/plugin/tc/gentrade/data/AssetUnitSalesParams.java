...
/** 
 * asset_unit_salesテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AssetUnitSalesRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AssetUnitSalesParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AssetUnitSalesParams}が{@@link AssetUnitSalesRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class AssetUnitSalesParams extends Params implements AssetUnitSalesRow {
  ...
  /** 
   * <em>asset_unit_sales_id</em>カラムの値 
   */
  ...
  /** 
   * 値が未設定のAssetUnitSalesParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のAssetUnitSalesRowオブジェクトの値を利用してAssetUnitSalesParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAssetUnitSalesRowオブジェクト 
   */
   ...
   * @@param row 比較対照のAssetUnitSalesRow 
  ...
  /** 
   * <em>asset_unit_sales_id</em>カラムの値を設定します。 
   *
