...
1.1
date	2011.03.14.02.38.14;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	SubAccountPreferencesRow.java;
...
/** 
 * SubAccountPreferencesRowインタフェースは変更不可でリードオンリーである<em>sub_account_preferences</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link SubAccountPreferencesRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface SubAccountPreferencesRow extends Row {


  /** 
   * この{@@link SubAccountPreferencesRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "sub_account_preferences", "account" );
