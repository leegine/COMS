...
1.1
date	2011.03.14.02.38.55;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountPreferencesParams.java;
...
/** 
 * account_preferencesテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AccountPreferencesRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AccountPreferencesParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AccountPreferencesParams}が{@@link AccountPreferencesRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class AccountPreferencesParams extends Params implements AccountPreferencesRow {
  ...
  public static final RowType TYPE = AccountPreferencesRow.TYPE;
  ...
  /** 
   * 値が未設定のAccountPreferencesParamsオブジェクトを作成します。 
   */
  public AccountPreferencesParams() {
  ...
  /** 
   * 指定のAccountPreferencesRowオブジェクトの値を利用してAccountPreferencesParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAccountPreferencesRowオブジェクト 
   */
  public AccountPreferencesParams( AccountPreferencesRow p_row )
  {
  ...
  {
    if ( !( other instanceof AccountPreferencesRow ) )
       return false;
    return fieldsEqual( (AccountPreferencesRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のAccountPreferencesRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( AccountPreferencesRow row )
  {
  ...
  {
    return new AccountPreferencesPK(account_id, name, name_serial_no);
  }
