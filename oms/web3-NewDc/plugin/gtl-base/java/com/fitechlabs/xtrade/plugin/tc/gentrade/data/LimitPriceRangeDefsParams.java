...
/** 
 * limit_price_range_defsテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link LimitPriceRangeDefsRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link LimitPriceRangeDefsParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link LimitPriceRangeDefsParams}が{@@link LimitPriceRangeDefsRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class LimitPriceRangeDefsParams extends Params implements LimitPriceRangeDefsRow {
  ...
  /** 
   * <em>limit_price_range_defs_id</em>カラムの値 
   */
  ...
  /** 
   * 値が未設定のLimitPriceRangeDefsParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のLimitPriceRangeDefsRowオブジェクトの値を利用してLimitPriceRangeDefsParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するLimitPriceRangeDefsRowオブジェクト 
   */
   ...
   * @@param row 比較対照のLimitPriceRangeDefsRow 
  ...
  /** 
   * <em>limit_price_range_defs_id</em>カラムの値を取得します。
   * @@return longの値 
   */
  ...
  /** 
   * <em>limit_price_range_defs_id</em>カラムに値が設定されているかどうか調べます。
  ...
  /** 
   * <em>limit_price_range_defs_id</em>カラムの値が変更されているかどうか調べます。
  ...
  /** 
   * <em>limit_price_range_defs_id</em>カラムの値を設定します。 
   *
   * @@param p_limitPriceRangeDefsId <em>limit_price_range_defs_id</em>カラムの値をあらわす18桁以下のlong値 
   */
