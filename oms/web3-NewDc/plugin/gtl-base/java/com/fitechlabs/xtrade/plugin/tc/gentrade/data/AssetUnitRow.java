...
1.1
date	2011.03.14.02.40.05;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * AssetUnitRowインタフェースは変更不可でリードオンリーである<em>asset_unit</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AssetUnitRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see AssetUnitPK 
 */
public interface AssetUnitRow extends Row {


  /** 
   * この{@@link AssetUnitRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "asset_unit", "account" );
   ...
   */
  public  boolean  getAssetUnitIdIsSet();
   ...
   */
  public  boolean  getAssetUnitIdIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAcquiredPriceIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAcquiredPriceIsModified();
   ...
   */
  public java.sql.Timestamp getAcquiredTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAcquiredTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAcquiredTimestampIsModified();
   ...
   * @@return longの値 
   */
  public long getAccruedInterestPrice();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccruedInterestPriceIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccruedInterestPriceIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCustodyTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCustodyTypeIsModified();
   ...
   */
  public  boolean  getEvaluationPriceIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getEvaluationPriceIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getEvaluationPriceIsModified();
