...
1.1
date	2011.03.14.02.39.03;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * TraderRowインタフェースは変更不可でリードオンリーである<em>trader</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link TraderRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see TraderPK 
 */
public interface TraderRow extends Row {


  /** 
   * この{@@link TraderRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "trader", "master" );
   ...
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.TraderTypeEnum getTraderType();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTraderTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTraderTypeIsModified();
   ...
   * @@return Stringの値 
   */
  public String getAccountOrderFlag();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccountOrderFlagIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccountOrderFlagIsModified();
