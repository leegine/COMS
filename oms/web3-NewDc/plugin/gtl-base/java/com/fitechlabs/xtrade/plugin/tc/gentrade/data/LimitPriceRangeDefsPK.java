...
/** 
 * <b>LimitPriceRangeDefs</b>データベーステーブルで一意である1つのレコードをあらわす<b>LimitPriceRangeDefs</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>LimitPriceRangeDefs</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
...
public class LimitPriceRangeDefsPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: LimitPriceRangeDefsRow. 
   */
  ...
  /**
   * <em>limit_price_range_defs_id</em>カラムの値をあらわす18桁以下のlong値 
   */
