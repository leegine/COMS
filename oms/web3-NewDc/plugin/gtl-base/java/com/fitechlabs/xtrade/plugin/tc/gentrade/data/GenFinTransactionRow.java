...
1.1
date	2011.03.14.02.37.29;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	GenFinTransactionRow.java;
...
/** 
 * GenFinTransactionRowインタフェースは変更不可でリードオンリーである<em>gen_fin_transaction</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link GenFinTransactionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface GenFinTransactionRow extends Row {


  /** 
   * この{@@link GenFinTransactionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "gen_fin_transaction", "account" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransactionDescriptionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransactionDescriptionIsModified();
   ...
   * @@return Stringの値 
   */
  public String getTradeModuleName();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTradeModuleNameIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTradeModuleNameIsModified();
   ...
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.FinTransactionType getTransactionType();
