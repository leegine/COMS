...
File Name        : 下り処理用リクエストの基底クラス(WEB3BackRequest.java)
 ...
 */
public abstract class WEB3BackRequest extends Request
{
    /**
     * コンストラクタ。
     */
    public WEB3BackRequest()
    {
    }
     ...
     * @@return レスポンスオブジェクト
     */
    public abstract WEB3BackResponse createResponse();
}
@
