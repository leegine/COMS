...
1.1
date	2011.03.14.05.05.13;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OrderUnexeFlagDef.java;
...
File Name        : 未約定通知送信フラグ定数定義インタフェイス(WEB3OrderUnexeFlagDef.java)
...
/**
 * 顧客マスターの未約定通知送信フラグ 定数定義インタフェイス
 *
 * @@author 栄イ(中訊)
 * @@version 1.0
 */
public interface WEB3OrderUnexeFlagDef
{
    /**
     * 0：未送信
     */
