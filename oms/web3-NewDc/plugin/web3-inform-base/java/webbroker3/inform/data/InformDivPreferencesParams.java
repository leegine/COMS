...
1.1
date	2011.03.15.04.57.47;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	InformDivPreferencesParams.java;
...
/** 
 * inform_div_preferencesテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link InformDivPreferencesRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link InformDivPreferencesParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link InformDivPreferencesParams}が{@@link InformDivPreferencesRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class InformDivPreferencesParams extends Params implements InformDivPreferencesRow {
  ...
  public static final RowType TYPE = InformDivPreferencesRow.TYPE;
  ...
  /** 
   * 値が未設定のInformDivPreferencesParamsオブジェクトを作成します。 
   */
  public InformDivPreferencesParams() {
  ...
  /** 
   * 指定のInformDivPreferencesRowオブジェクトの値を利用してInformDivPreferencesParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するInformDivPreferencesRowオブジェクト 
   */
  public InformDivPreferencesParams( InformDivPreferencesRow p_row )
  {
  ...
  {
    if ( !( other instanceof InformDivPreferencesRow ) )
       return false;
    return fieldsEqual( (InformDivPreferencesRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のInformDivPreferencesRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( InformDivPreferencesRow row )
  {
  ...
  {
    return new InformDivPreferencesPK(branch_id, inform_div, name, name_serial_no);
  }
