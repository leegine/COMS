...
/** 
 * inform_dl_form_masterテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link InformDlFormMasterRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link InformDlFormMasterParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link InformDlFormMasterParams}が{@@link InformDlFormMasterRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class InformDlFormMasterParams extends Params implements InformDlFormMasterRow {
  ...
  /** 
   * 値が未設定のInformDlFormMasterParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のInformDlFormMasterRowオブジェクトの値を利用してInformDlFormMasterParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するInformDlFormMasterRowオブジェクト 
   */
   ...
   * @@param row 比較対照のInformDlFormMasterRow 
   ...
   *
   * @@param p_columnLabel <em>column_label</em>カラムの値をあらわす30桁以下のString値 
   */
