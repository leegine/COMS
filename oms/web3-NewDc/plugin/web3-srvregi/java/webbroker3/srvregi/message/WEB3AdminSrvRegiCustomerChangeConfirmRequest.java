...
1.1
date	2011.03.14.06.33.30;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiCustomerChangeConfirmRequest.java;
...
File Name        : サービス利用管理者顧客変更確認リクエスト(WEB3AdminSrvRegiCustomerChangeConfirmRequest.java)
...
/**
 * (サービス利用管理者顧客変更確認リクエスト)<BR>
 * サービス利用管理者顧客変更確認リクエストクラス<BR>
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3AdminSrvRegiCustomerChangeConfirmRequest extends WEB3GenRequest
{
    /**
     * Logger
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminSrvRegiCustomerChangeConfirmRequest.class);
     ...
     * (サービス利用管理者顧客変更確認リクエスト)<BR>
     * デフォルトコンストラクタ<BR>
     * @@roseuid 40F232AD036A
     */
    public WEB3AdminSrvRegiCustomerChangeConfirmRequest()
    {
    ...
    /**
     * (createレスポンス)<BR>
     * サービス利用管理者顧客変更確認レスポンスを生成して返却する。<BR>
     * @@return WEB3GenResponse
     * @@roseuid 40F2330102AF
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminSrvRegiCustomerChangeConfirmResponse(this);
    }
     ...
     *  2-4) this.変更顧客一覧.顧客コード==nullの場合、例外をスローする。<BR>
     *         class: WEB3BusinessLayerException<BR>
     *         tag:   BUSINESS_ERROR_00835<BR>
     *  2-5) this.変更顧客一覧.顧客コードの桁数＞6桁の場合、例外をスローする。<BR>
     *         class: WEB3BusinessLayerException<BR>
     *         tag:   BUSINESS_ERROR_00836<BR>
     *  2-6) this.変更顧客一覧.適用開始日==nullの場合、例外をスローする。<BR>
     *         class: WEB3BusinessLayerException<BR>
     *         tag:   BUSINESS_ERROR_00837<BR>
     *  2-7) this.変更顧客一覧.適用終了日==nullの場合、例外をスローする。<BR>
     *         class: WEB3BusinessLayerException<BR>
     ...
     *  2-12) this.変更顧客一覧.利用料金!=nullであり、かつ数値以外の場合、<BR>
     * 例外をスローする。<BR>
     *         class: WEB3BusinessLayerException<BR>
