...
1.1
date	2011.03.14.06.30.31;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceChangeInputResponse.java;
...
File Name        : サービス利用管理者サービス変更入力レスポンス(WEB3AdminSrvRegiServiceChangeInputResponse.java)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/10/22 郭英 (中訊) 新規作成
Revesion History : 2007/06/06 肖志偉 (中訊) 仕様変更モデル250
*/
...
/**
 * (サービス利用管理者サービス変更入力レスポンス)<BR>
 * サービス利用管理者サービス変更入力レスポンスクラス<BR>
 * 
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceChangeInputResponse extends WEB3GenResponse 
{
     ...
     * (サービス利用管理者サービス変更入力レスポンス)<BR>
     * デフォルトコンストラクタ<BR>
     * @@roseuid 40EE3A4A02E4
     */
    public WEB3AdminSrvRegiServiceChangeInputResponse() 
    {
     ...
     */
    protected WEB3AdminSrvRegiServiceChangeInputResponse(WEB3GenRequest l_request)
    {
        super(l_request);
    }    
