...
1.1
date	2011.03.14.06.40.50;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceChangeServiceInterceptor.java;
...
File Name        : サービス利用管理者サービス変更サービスインタセプタ(WEB3AdminSrvRegiServiceChangeServiceInterceptor.java)
...
/**
 * (サービス利用管理者サービス変更サービスインタセプタ)<BR>
 * サービス利用管理者サービス変更サービスインタセプタクラス<BR>
 * 
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceChangeServiceInterceptor implements Interceptor 
{
    
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceChangeServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E6029F
     */
    public WEB3AdminSrvRegiServiceChangeServiceInterceptor() 
    {
