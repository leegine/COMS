...
1.1
date	2011.03.14.06.38.16;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceRegiServiceInterceptor.java;
...
File Name        : サービス利用管理者サービス登録サービスインタセプタ(WEB3AdminSrvRegiServiceRegiServiceInterceptor.java)
...
/**
 * (サービス利用管理者サービス登録サービスインタセプタ)<BR>
 * サービス利用管理者サービス登録サービスインタセプタクラス<BR>
 * 
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceRegiServiceInterceptor implements Interceptor 
{
    
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceRegiServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E7004E
     */
    public WEB3AdminSrvRegiServiceRegiServiceInterceptor() 
    {
