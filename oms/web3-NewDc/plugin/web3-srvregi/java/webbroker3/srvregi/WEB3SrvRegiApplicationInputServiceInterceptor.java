...
1.1
date	2011.03.14.06.39.56;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SrvRegiApplicationInputServiceInterceptor.java;
...
File Name        : サービス利用申込入力サービスインタセプタ(WEB3SrvRegiApplicationInputServiceInterceptor.java)
...
/**
 * (サービス利用申込入力サービスインタセプタ)<BR>
 * サービス利用申込入力サービスインタセプタクラス<BR>
 * 
 * @@author 李頴淵
 * @@version 1.0 
 */
public class WEB3SrvRegiApplicationInputServiceInterceptor implements Interceptor 
{
    
    /**
     * Logger
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3SrvRegiApplicationInputServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E70109
     */
    public WEB3SrvRegiApplicationInputServiceInterceptor() 
    {
