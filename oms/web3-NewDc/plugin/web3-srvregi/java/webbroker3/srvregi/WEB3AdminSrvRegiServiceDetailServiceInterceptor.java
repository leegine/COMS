...
1.1
date	2011.03.14.06.38.04;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceDetailServiceInterceptor.java;
...
File Name        : サービス利用管理者サービス詳細サービスインターフェイス(WEB3AdminSrvRegiServiceDetailServiceInterceptor.java)
...
/**
 * (サービス利用管理者サービス詳細サービスインターフェイス)<BR>
 * サービス利用管理者サービス詳細サービスインターフェイスクラス<BR>
 * 
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceDetailServiceInterceptor implements Interceptor 
{
    
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceDetailServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E6036B
     */
    public WEB3AdminSrvRegiServiceDetailServiceInterceptor() 
    {
