...
1.1
date	2011.03.14.06.37.39;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceBidPriceUpdateServiceInterceptor.java;
...
File Name        : サービス利用管理者サービス落札額更新サービスインタセプタ(WEB3AdminSrvRegiServiceBidPriceUpdateServiceInterceptor.java)
...
/**
 * (サービス利用管理者サービス落札額更新サービスインタセプタ)<BR>
 * サービス利用管理者サービス落札額更新サービスインタセプタクラス<BR> 
 *                                                               
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceBidPriceUpdateServiceInterceptor implements Interceptor 
{
    /**
     * (ログユーティリティ)<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceBidPriceUpdateServiceInterceptor.class);
        
    /**
     * @@roseuid 416F50E60128
     */
    public WEB3AdminSrvRegiServiceBidPriceUpdateServiceInterceptor() 
    {
