...
1.1
date	2011.03.14.06.38.12;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountChangeServiceInterceptor.java;
...
File Name        : サービス利用管理者顧客変更サービスインタセプタ(WEB3AdminSrvRegiAccountChangeServiceInterceptor.java)
...
/**
 * (サービス利用管理者顧客変更サービスインタセプタ)<BR>
 * サービス利用管理者顧客変更サービスインタセプタ　@クラス<BR> 
 *                                                               
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3AdminSrvRegiAccountChangeServiceInterceptor implements Interceptor 
{
    /**
     * (ログユーティリティ)<BR>
     */
     ...
     */
    public WEB3AdminSrvRegiAccountChangeServiceInterceptor() 
    {
