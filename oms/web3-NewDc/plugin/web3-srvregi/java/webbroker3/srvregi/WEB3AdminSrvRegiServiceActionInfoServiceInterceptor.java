...
1.1
date	2011.03.14.06.38.08;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceActionInfoServiceInterceptor.java;
...
File Name        : サービス利用管理者サービス履歴情報サービスインタセプタ(WEB3AdminSrvRegiServiceActionInfoServiceInterceptor.java)
...
/**
 * (サービス利用管理者サービス履歴情報サービスインタセプタ)<BR>
 * サービス利用管理者サービス履歴情報サービスインタセプタクラス<BR>
 * 
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceActionInfoServiceInterceptor implements Interceptor 
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceActionInfoServiceInterceptor.class);

    /**
     * @@roseuid 416F50E6006D
     */
    public WEB3AdminSrvRegiServiceActionInfoServiceInterceptor() 
    {
