...
1.1
date	2011.03.14.06.38.25;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceBidPriceUpdateInputServiceInterceptor.java;
...
File Name        : （サービス利用管理者）顧客落札額更新入力サービスインタセプタ(WEB3AdminSrvRegiServiceBidPriceUpdateInputServiceInterceptor.java)
...
/**
 * (（サービス利用管理者）顧客落札額更新入力サービスインタセプタ)<BR>
 * （サービス利用管理者）顧客落札額更新入力サービスインタセプタクラス<BR> 
 *                                                               
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceBidPriceUpdateInputServiceInterceptor implements Interceptor 
{
    /**
     * (ログユーティリティ)<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceBidPriceUpdateInputServiceInterceptor.class);
        
    /**
     * @@roseuid 416F50E402EE
     */
    public WEB3AdminSrvRegiServiceBidPriceUpdateInputServiceInterceptor() 
    {
     ...
     * Q&A:WEB3-SRVREGI-A-UT-0074 Added<BR> 
