...
1.1
date	2011.03.14.06.40.58;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountAppliStateListServiceInterceptor.java;
...
File Name        : サービス利用管理者顧客申込状況一覧サービスインタセプタ(WEB3AdminSrvRegiAccountAppliStateListServiceInterceptor.java)
...
/**
 * (サービス利用管理者顧客申込状況一覧サービスインタセプタ)<BR>
 * サービス利用管理者顧客申込状況一覧サービスインタセプタ　@クラス<BR>
 *  
 * @@author 鄭海良
 * @@version 1.0  
 */
public class WEB3AdminSrvRegiAccountAppliStateListServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiAccountAppliStateListServiceInterceptor.class);
    
    /**
     * @@roseuid 416F4FEE0203
     */
    public WEB3AdminSrvRegiAccountAppliStateListServiceInterceptor() 
    {
