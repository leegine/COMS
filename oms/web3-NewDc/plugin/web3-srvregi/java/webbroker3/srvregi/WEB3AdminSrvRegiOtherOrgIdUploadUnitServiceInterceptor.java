...
1.1
date	2011.03.14.06.38.33;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiOtherOrgIdUploadUnitServiceInterceptor.java;
...
File Name           : サービス利用管理者外部連携ID照会ｱｯﾌﾟﾛｰﾄﾞUnitServiceｲﾝﾀｾﾌﾟﾀ(WEB3AdminSrvRegiOtherOrgIdUploadUnitServiceInterceptor.java)
...
/**
 * (サービス利用管理者外部連携ID照会ｱｯﾌﾟﾛｰﾄﾞUnitServiceｲﾝﾀｾﾌﾟﾀ)<BR>
 * サービス利用管理者外部連携ID照会ｱｯﾌﾟﾛｰﾄﾞUnitServiceｲﾝﾀｾﾌﾟﾀクラス<BR>
 * <BR>
 * @@author 柴双紅
 * @@version 1.0
 */
public class WEB3AdminSrvRegiOtherOrgIdUploadUnitServiceInterceptor implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminSrvRegiOtherOrgIdUploadUnitServiceInterceptor.class);

    /**
     * @@roseuid 47D1112D01E6
     */
    public WEB3AdminSrvRegiOtherOrgIdUploadUnitServiceInterceptor()
    {
