...
1.1
date	2011.03.14.06.38.50;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountChangeInputServiceInterceptor.java;
...
File Name        : サービス利用管理者顧客変更入力サービスインタセプタ(WEB3AdminSrvRegiAccountChangeInputServiceInterceptor.java)
...
/**
 * (サービス利用管理者顧客変更入力サービスインタセプタ)<BR>
 * サービス利用管理者顧客変更入力サービスインタセプタ　@クラス<BR> 
 *                                                               
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3AdminSrvRegiAccountChangeInputServiceInterceptor implements Interceptor 
{
    /**
     * (ログユーティリティ)<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiAccountChangeInputServiceInterceptor.class);
        
    /**
     * @@roseuid 416F50E403A9
     */
    public WEB3AdminSrvRegiAccountChangeInputServiceInterceptor() 
    {
