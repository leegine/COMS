...
1.1
date	2011.03.14.06.40.42;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountRegistServiceInterceptor.java;
...
File Name        : サービス利用管理者顧客登録サービスインタセプタ(WEB3AdminSrvRegiAccountRegistServiceInterceptor.java)
...
/**
 * (サービス利用管理者顧客登録サービスインタセプタ)<BR>
 * サービス利用管理者顧客登録サービスインタセプタクラス<BR> 
 *                                                               
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3AdminSrvRegiAccountRegistServiceInterceptor implements Interceptor
{
    /**
     * (ログユーティリティ)<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiAccountRegistServiceInterceptor.class);

    /**
     * @@roseuid 416F50E50399
     */
    public WEB3AdminSrvRegiAccountRegistServiceInterceptor()
    {
    ...
    public Object onCall(Method l_method, Object[] l_serviceParams)
    {
        ...
        {  
			...
			//サービス利用管理者顧客登録リクエストの場合。
			if(l_serviceParams[0] instanceof WEB3AdminSrvRegiCustomerRegistCompleteRequest)
			{
				//口座をロックする。 
				...
				WEB3AdminSrvRegiCustomerRegistCompleteRequest l_request =	 
					(WEB3AdminSrvRegiCustomerRegistCompleteRequest) l_serviceParams[0];
					
				//get顧客(String, String, String)
				WEB3GentradeMainAccount l_mainAccount = l_gentradeAccMgr.getMainAccount(
