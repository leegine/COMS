...
1.1
date	2011.03.14.06.39.19;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountDataUploadInterceptor.java;
...
File Name        : サービス利用管理者顧客データアップロードインタセプタ(WEB3AdminSrvRegiAccountDataUploadInterceptor.java)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/10/22 鄭海良(中訊) 新規作成
*/
...
/**
 * (サービス利用管理者顧客データアップロードインタセプタ)<BR>
 * 顧客アップロードインタセプタクラス<BR>
 */
public class WEB3AdminSrvRegiAccountDataUploadInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminSrvRegiAccountDataUploadInterceptor.class);
                
    /**
     * @@roseuid 416F50E50213
     */
    public WEB3AdminSrvRegiAccountDataUploadInterceptor() 
    {
