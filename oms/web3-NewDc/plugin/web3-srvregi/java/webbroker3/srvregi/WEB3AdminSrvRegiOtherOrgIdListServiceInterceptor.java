...
1.1
date	2011.03.14.06.40.29;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor.java;
...
File Name           : サービス利用管理者外部連携ID一覧照会ｻｰﾋﾞｽ(WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor.java)
...
/**
 * (サービス利用管理者外部連携ID一覧照会ｻｰﾋﾞｽｲﾝﾀｾﾌﾟﾀ)<BR>
 * サービス利用管理者外部連携ID一覧照会ｻｰﾋﾞｽｲﾝﾀｾﾌﾟﾀクラス<BR>
 * <BR>
 * @@author 柴双紅
 * @@version 1.0
 */
public class WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor.class);

    /**
     * @@roseuid 47D1112D034E
     */
    public WEB3AdminSrvRegiOtherOrgIdListServiceInterceptor()
    {
