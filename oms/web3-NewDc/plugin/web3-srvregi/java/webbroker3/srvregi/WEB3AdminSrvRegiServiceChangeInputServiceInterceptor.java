...
1.1
date	2011.03.14.06.40.17;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiServiceChangeInputServiceInterceptor.java;
...
File Name        : サービス利用管理者サービス変更入力サービスインターセプタ(WEB3AdminSrvRegiServiceChangeInputServiceInterceptor.java)
...
/**
 * (サービス利用管理者サービス変更入力サービスインターセプタ)<BR>
 * サービス利用管理者サービス変更入力サービスインタセプタクラス<BR>
 * 
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3AdminSrvRegiServiceChangeInputServiceInterceptor implements Interceptor 
{
    
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminSrvRegiServiceChangeInputServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E601E4
     */
    public WEB3AdminSrvRegiServiceChangeInputServiceInterceptor() 
    {
