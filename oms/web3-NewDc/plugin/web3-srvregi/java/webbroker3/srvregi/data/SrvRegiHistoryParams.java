...
1.1
date	2011.03.14.06.42.34;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	SrvRegiHistoryParams.java;
...
/** 
 * srv_regi_historyテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link SrvRegiHistoryRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link SrvRegiHistoryParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link SrvRegiHistoryParams}が{@@link SrvRegiHistoryRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class SrvRegiHistoryParams extends Params implements SrvRegiHistoryRow {
  ...
  public static final String PTYPE = "srv_regi_history";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = SrvRegiHistoryRow.TYPE;
   ...
   */
  public  java.sql.Timestamp  regist_date;
  ...
  /** 
   * 値が未設定のSrvRegiHistoryParamsオブジェクトを作成します。 
   */
  public SrvRegiHistoryParams() {
  ...
  /** 
   * 指定のSrvRegiHistoryRowオブジェクトの値を利用してSrvRegiHistoryParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するSrvRegiHistoryRowオブジェクト 
   */
  public SrvRegiHistoryParams( SrvRegiHistoryRow p_row )
  {
  ...
  {
    if ( !( other instanceof SrvRegiHistoryRow ) )
       return false;
    return fieldsEqual( (SrvRegiHistoryRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のSrvRegiHistoryRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( SrvRegiHistoryRow row )
  {
   ...
   */
	protected void assertValidForInsert() throws IllegalArgumentException {
		...
		if ( !regist_date_is_set )
			throw new IllegalArgumentException("non-nullable field 'regist_date' must be set before inserting.");
   ...
   */
  public final java.sql.Timestamp getRegistDate()
  {
    return regist_date;
  }
  ...
  {
    return new SrvRegiHistoryPK(institution_code, branch_code, srv_div, account_code);
  }
   ...
   *
   * @@param p_registDate <em>regist_date</em>カラムの値をあらわすjava.sql.Timestamp値
   */
  public final void setRegistDate( java.sql.Timestamp p_registDate )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
   ...
   /** 
   * 一般のjava.util.Dateオブジェクトを使って<em>regist_date</em>カラムに値を設定します。 
   * @@param date 設定する値を含むjava.util.Date 
    */
  public final void setRegistDate( java.util.Date date )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object can't be modified. Use copy contructor to create a new Params object for modification.");
    regist_date = (date==null? null: new java.sql.Timestamp( date.getTime() ));
    regist_date_is_set = true;
    regist_date_is_modified = true;
  }
    ...
    public void setColumn( String name, Object value ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'r':
                if ( name.equals("regist_date") ) {
                    if ( !(value instanceof java.sql.Timestamp) )
                        throw new IllegalArgumentException( "value for 'regist_date' must be java.sql.Timestamp: '"+value+"' is not." );
                    this.regist_date = (java.sql.Timestamp) value;
