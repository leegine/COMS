...
1.1
date	2011.03.14.06.43.07;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	SrvRegiLotInfoPK.java;
...
/** 
 * <b>SrvRegiLotInfo</b>データベーステーブルで一意である1つのレコードをあらわす<b>SrvRegiLotInfo</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>SrvRegiLotInfo</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class SrvRegiLotInfoPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: SrvRegiLotInfoRow. 
   */
   ...
   */
  public SrvRegiLotInfoPK( String p_institutionCode, String p_srvDiv, long p_consecutiveNumbers ) {
   ...
   */
  public static SrvRegiLotInfoPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    SrvRegiLotInfoPK pk = new SrvRegiLotInfoPK();
  ...
  {
    if ( other == null || !( other instanceof SrvRegiLotInfoPK) )
      return false;
    SrvRegiLotInfoPK o = (SrvRegiLotInfoPK) other;
