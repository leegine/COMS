...
1.1
date	2011.03.14.06.43.24;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	SrvAppliAttributeRow.java;
...
/** 
 * SrvAppliAttributeRowインタフェースは変更不可でリードオンリーである<em>srv_appli_attribute</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link SrvAppliAttributeRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface SrvAppliAttributeRow extends Row {


  /** 
   * この{@@link SrvAppliAttributeRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "srv_appli_attribute", "master" );
  ...
  /** 
   * <em>appli_attribute</em>カラムの値を取得します。
   * @@return Stringの値 
   */
  public String getAppliAttribute();


  /** 
   * <em>appli_attribute</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliAttributeIsSet();


  /** 
   * <em>appli_attribute</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliAttributeIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getProcDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getProcDivIsModified();
