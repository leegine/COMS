...
1.1
date	2011.03.14.06.41.19;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OtherOrgInfoAdminRow.java;
...
/** 
 * OtherOrgInfoAdminRowインタフェースは変更不可でリードオンリーである<em>other_org_info_admin</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OtherOrgInfoAdminRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OtherOrgInfoAdminRow extends Row {


  /** 
   * この{@@link OtherOrgInfoAdminRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "other_org_info_admin", "master" );
   ...
   */
  public  boolean  getSequenceNumberIsSet();
   ...
   */
  public  boolean  getSequenceNumberIsModified();
