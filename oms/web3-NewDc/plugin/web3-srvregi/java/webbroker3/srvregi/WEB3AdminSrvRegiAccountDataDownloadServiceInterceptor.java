...
1.1
date	2011.03.14.06.40.38;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountDataDownloadServiceInterceptor.java;
...
File Name        : サービス利用管理者顧客データダウンロードサービスインタセプタ(WEB3AdminSrvRegiAccountDataDownloadServiceInterceptor)
Author Name      : Daiwa Institute of Research
Revesion History : 2005/03/17 今井（SRA） 
*/
...
/**
 * (サービス利用管理者顧客データダウンロードサービスインタセプタ)<BR>
 * サービス利用管理者顧客データダウンロードサービスインタセプタ　@クラス<BR> 
 *                                                               
 * @@author 今井（SRA）
 * @@version 1.0
 */
public class WEB3AdminSrvRegiAccountDataDownloadServiceInterceptor implements Interceptor 
{
    /**
     * (ログユーティリティ)<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiAccountChangeServiceInterceptor.class);
        
    /**
     * @@roseuid 416F50E5008C
     */
    public WEB3AdminSrvRegiAccountDataDownloadServiceInterceptor() 
    {
