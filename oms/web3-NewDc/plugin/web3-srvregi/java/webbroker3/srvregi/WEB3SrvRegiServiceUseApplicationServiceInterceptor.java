...
1.1
date	2011.03.14.06.37.43;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SrvRegiServiceUseApplicationServiceInterceptor.java;
...
File Name        : サービス利用申込サービスインタセプタ(WEB3SrvRegiServiceUseApplicationServiceInterceptor.java)
...
/**
 * (サービス利用申込サービスインタセプタ)<BR>
 * サービス利用申込サービスインタセプタクラス<BR>
 * 
 * @@author 李頴淵
 * @@version 1.0 
 */
public class WEB3SrvRegiServiceUseApplicationServiceInterceptor implements Interceptor 
{
    /**
     * Logger
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3SrvRegiServiceUseApplicationServiceInterceptor.class);
    
    /**
     * @@roseuid 416F51C7030D
     */
    public WEB3SrvRegiServiceUseApplicationServiceInterceptor() 
    {
    ...
    public Object onCall(Method l_method, Object[] l_serviceParams) 
    {
        ...
        try
        {
            ...
            //サービス利用申込完了リクエストの場合。
			if(l_serviceParams[0] instanceof WEB3SrvRegiApplyCompleteRequest)
			{
			    //口座をロックする。 
