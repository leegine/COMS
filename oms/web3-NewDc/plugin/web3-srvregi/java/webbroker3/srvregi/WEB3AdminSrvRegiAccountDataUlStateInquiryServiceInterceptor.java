...
1.1
date	2011.03.14.06.39.31;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSrvRegiAccountDataUlStateInquiryServiceInterceptor.java;
...
File Name        : サービス利用管理者顧客データUL状況照会サービスインタセプタ(WEB3AdminSrvRegiAccountDataUlStateInquiryServiceInterceptor.java)
...
/**
 * (サービス利用管理者顧客データUL状況照会サービスインタセプタ)<BR>
 * サービス利用管理者顧客データUL状況照会サービスインタセプタクラス<BR>
 *  
 * @@author 鄭海良
 * @@version 1.0  
 */
public class WEB3AdminSrvRegiAccountDataUlStateInquiryServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3AdminSrvRegiAccountDataUlStateInquiryServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E50157
     */
    public WEB3AdminSrvRegiAccountDataUlStateInquiryServiceInterceptor() 
    {
