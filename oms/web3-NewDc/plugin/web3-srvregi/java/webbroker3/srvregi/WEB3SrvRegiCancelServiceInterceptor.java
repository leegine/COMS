...
1.1
date	2011.03.14.06.39.35;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SrvRegiCancelServiceInterceptor.java;
...
File Name        : サービス利用取消サービスインタセプタ(WEB3SrvRegiCancelServiceInterceptor.java)
...
/**
 * (サービス利用取消サービスインタセプタ)<BR>
 * サービス利用取消サービスインタセプタクラス<BR>
 * 
 * @@author 李頴淵
 * @@version 1.0
 */
public class WEB3SrvRegiCancelServiceInterceptor implements Interceptor 
{
    
    /**
     * Logger
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3SrvRegiCancelServiceInterceptor.class);
    
    /**
     * @@roseuid 416F50E701D4
     */
    public WEB3SrvRegiCancelServiceInterceptor() 
    {
    ...
    public Object onCall(Method l_method, Object[] l_serviceParams) 
    {
        ...
        try
        {
            ...
            //サービス利用取消完了リクエストの場合。
			if(l_serviceParams[0] instanceof WEB3SrvRegiCancelCompleteRequest)
			{
				//口座をロックする。 
