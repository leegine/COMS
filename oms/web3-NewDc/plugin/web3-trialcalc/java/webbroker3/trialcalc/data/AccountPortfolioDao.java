...
/** 
 * {@@link AccountPortfolioDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link AccountPortfolioRow}インスタンスへ関連付けることができます。 
...
public class AccountPortfolioDao extends DataAccessObject {
  ...
  /** 
   * この{@@link AccountPortfolioDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link AccountPortfolioRow}と仮定される{@@link DataAccessObject}から新たに{@@link AccountPortfolioDao}を返します。 
         * @@return 指定のRowに結びつく{@@link AccountPortfolioDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link AccountPortfolioRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link AccountPortfolioRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link AccountPortfolioRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link AccountPortfolioRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link AccountPortfolioRow}オブジェクトから{@@link AccountPortfolioDao}オブジェクトを作成します。 
   * これは実際の{@@link AccountPortfolioRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link AccountPortfolioDao}取得のために指定の{@@link AccountPortfolioRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link AccountPortfolioDao}オブジェクト 
  ...
  /** 
   * {@@link AccountPortfolioRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link AccountPortfolioRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link AccountPortfolioPK}やデータベースレコードとして挿入される{@@link AccountPortfolioParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link AccountPortfolioRow}を一意に特定する{@@link AccountPortfolioPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link AccountPortfolioRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link AccountPortfolioParams}オブジェクトの主キーとして利用可能な{@@link AccountPortfolioPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link AccountPortfolioRow}オブジェクトを検索します。 
   * 
   ...
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link AccountPortfolioRow} 
  ...
  /** 
   * 指定のAccountPortfolioPKオブジェクトから{@@link AccountPortfolioRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するAccountPortfolioPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link AccountPortfolioRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,long,long,String)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(AccountPortfolioPK)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link AccountPortfolioDao}に紐付く{@@link AccountPortfolioRow}内で外部キーの関係をもつ{@@link BranchRow}を検索します。 
   * 
   * @@return {@@link AccountPortfolioDao}と外部キーの関係にある{@@link BranchRow} 
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchBranchRowViaBranchId()}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link AccountPortfolioDao}に紐付く{@@link AccountPortfolioRow}内で外部キーの関係をもつ{@@link MainAccountRow}を検索します。 
   * 
   * @@return {@@link AccountPortfolioDao}と外部キーの関係にある{@@link MainAccountRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchMainAccountRowViaAccountId()}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link BranchRow}と外部キーの関係にある{@@link AccountPortfolioRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link BranchRow}オブジェクト 
   * @@return 指定の{@@link BranchRow}に外部キーを持つ{@@link AccountPortfolioRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link BranchPK}と外部キーの関係にある{@@link AccountPortfolioRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link BranchPK}オブジェクト 
   * @@return {@@link BranchPK}と外部キーが一致する値を持つ{@@link AccountPortfolioRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * 指定の外部キーの値（場合により複数）から{@@link AccountPortfolioRow}オブジェクトを検索し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param p_branchId 検索対象であるp_branchIdフィールドの値
   * 
   * @@return 指定の外部キーを持つ{@@link AccountPortfolioRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByBranchId(BranchRow)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByBranchId(BranchRow)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByBranchId(BranchPK)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByBranchId(long)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link MainAccountRow}と外部キーの関係にある{@@link AccountPortfolioRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link MainAccountRow}オブジェクト 
   * @@return 指定の{@@link MainAccountRow}に外部キーを持つ{@@link AccountPortfolioRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link MainAccountPK}と外部キーの関係にある{@@link AccountPortfolioRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link MainAccountPK}オブジェクト 
   * @@return {@@link MainAccountPK}と外部キーが一致する値を持つ{@@link AccountPortfolioRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByAccountId(MainAccountRow)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(MainAccountRow)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(MainAccountPK)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(long)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
  ...
  /** 
   * p_institutionCode, p_branchId, p_accountId, p_portfolioCode, and にて指定の値から一意の{@@link AccountPortfolioRow}オブジェクトを検索します。 
   ...
   * @@param p_portfolioCode 検索対象であるp_portfolioCodeフィールドの値
   * 
   * @@return 引数指定のp_institutionCode, p_branchId, p_accountId, p_portfolioCode, and の値と一致する{@@link AccountPortfolioRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByInstitutionCodeBranchIdAccountIdPortfolioCode(String, long, long, String)}および{@@link #forRow(AccountPortfolioRow)}を使用してください。 
   */
