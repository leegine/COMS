...
1.1
date	2011.03.14.03.50.47;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountPortfolioProductParams.java;
...
/** 
 * account_portfolio_productテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AccountPortfolioProductRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AccountPortfolioProductParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AccountPortfolioProductParams}が{@@link AccountPortfolioProductRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class AccountPortfolioProductParams extends Params implements AccountPortfolioProductRow {
  ...
  public static final RowType TYPE = AccountPortfolioProductRow.TYPE;
  ...
  /** 
   * 値が未設定のAccountPortfolioProductParamsオブジェクトを作成します。 
   */
  public AccountPortfolioProductParams() {
  ...
  /** 
   * 指定のAccountPortfolioProductRowオブジェクトの値を利用してAccountPortfolioProductParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAccountPortfolioProductRowオブジェクト 
   */
  public AccountPortfolioProductParams( AccountPortfolioProductRow p_row )
  {
  ...
  {
    if ( !( other instanceof AccountPortfolioProductRow ) )
       return false;
    return fieldsEqual( (AccountPortfolioProductRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のAccountPortfolioProductRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( AccountPortfolioProductRow row )
  {
   ...
   */
	public java.util.Map toInsertMap() {
		...
		map.put("buy_price",new Double(buy_price));
  ...
  {
    return new AccountPortfolioProductPK(institution_code, branch_id, account_id, portfolio_code, product_id, market_code, buy_price);
  }
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'b':
                if ( name.equals("branch_id") ) {
                    ...
                    this.buy_price = ((Double) value).doubleValue();
