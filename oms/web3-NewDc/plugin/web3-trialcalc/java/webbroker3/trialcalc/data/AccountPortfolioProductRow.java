...
1.1
date	2011.03.14.03.50.43;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountPortfolioProductRow.java;
...
/** 
 * AccountPortfolioProductRowインタフェースは変更不可でリードオンリーである<em>account_portfolio_product</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AccountPortfolioProductRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AccountPortfolioProductRow extends Row {


  /** 
   * この{@@link AccountPortfolioProductRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "account_portfolio_product", "account" );
  ...
  /** 
   * <em>portfolio_code</em>カラムの値を取得します。
   * @@return Stringの値 
   */
  ...
  /** 
   * <em>portfolio_code</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPortfolioCodeIsSet();


  /** 
   * <em>portfolio_code</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPortfolioCodeIsModified();
