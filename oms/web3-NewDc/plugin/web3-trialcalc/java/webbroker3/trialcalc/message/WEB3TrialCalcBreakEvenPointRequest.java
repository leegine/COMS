...
File Name        : 計算サービス損益分岐点計算リクエスト(WEB3TrialCalcBreakEvenPointRequest.java)
...
/**
 * （計算サービス損益分岐点計算リクエスト）<BR>
 * <BR>
 * 計算サービス損益分岐点計算サービスのリクエストデータ。<BR>
 * <BR>
 * ----<English>--------------------<BR>
 * <BR>
...
public class WEB3TrialCalcBreakEvenPointRequest extends WEB3GenRequest
{
    ...
    */
     ...
     * １）　@株数チェック<BR>
     * <BR>
     * 　@１－１）　@this.株数＝nullの場合、「株数がnull」の例外をthrowする。
     * <BR>
     ...
     * ３）　@注文形態チェック<BR>
     * <BR>
     * 　@３－１）　@this.注文形態＝nullの場合、「注文形態がnull」の例外をthrowする。<BR>
     * <BR>
     * class : WEB3BusinessLayerException
     * tag : BUSINESS_ERROR_01394
     * <BR>
     * 　@３－２）　@this.注文形態≠null、かつ 以下の値以外の場合、<BR>
     ...
     * ４）　@現物／ミニ株区分チェック<BR>
     * <BR>
     * 　@４－１）　@this.現物／ミニ株区分＝nullの場合、「現物／ミニ株区分がnull」の例外?
     * throwする。<BR>
     * <BR>
     * class : WEB3BusinessLayerException<BR>
     * tag : BUSINESS_ERROR_01396<BR>
     * <BR>
     * 　@４－２）　@this.現物／ミニ株区分≠null、かつ 以下の値以外の場合、 <BR>
     ...
     * <BR>
     * <BR>
     * ５）　@現物／ミニ株区分・売買単位チェック<BR>
     * <BR>
     * 　@５－１）　@this.現物／ミニ株区分＝"2：ミニ株"の場合、<BR>
     * 　@　@　@　@　@　@this.売買単位＝nullであれば「売買単位がnull」の例外をthrowする。<BR>
     * <BR>
     * class : WEB3BusinessLayerException<BR>
     * tag : BUSINESS_ERROR_01398<BR>
     * <BR>
     * 　@５－２）　@this.売買単位≠null、かつ
     * 以下のいずれかに該当する場合は、以下の例外をthrowする。<BR>
     * 　@　@　@・this.売買単位≠数字<BR>
