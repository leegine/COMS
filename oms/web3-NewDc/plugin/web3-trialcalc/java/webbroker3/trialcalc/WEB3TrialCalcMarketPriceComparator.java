...
File Name        : 計算サービス評価単価Comparator(WEB3TrialCalcMarketPriceComparator.java)
...
/**
 * （計算サービス評価単価Comparator）<BR>
 * <BR>
 * 計算サービス評価単価Comparatorクラス。<BR>
 * <BR>
...
public class WEB3TrialCalcMarketPriceComparator
{
     ...
     * 　@※銘柄明細1.評価単価 == nullの場合は、銘柄明細1.評価単価を0として扱う。<BR>
     * 　@※銘柄明細2.評価単価 == nullの場合は、銘柄明細2.評価単価を0として扱う。<BR>
     * <BR>
     * 　@[昇順指定の場合（this.orderBy == ”昇順”）] <BR>
     * 　@・（銘柄明細1.評価単価 <
     * 銘柄明細2.評価単価）の場合、負の整数（-1）を返却する。 <BR>
     * 　@・（銘柄明細1.評価単価 == 銘柄明細2.評価単価）の場合、0を返却する。 <BR>
     * 　@・（銘柄明細1.評価単価 >
     * 銘柄明細2.評価単価）の場合、正の整数（1）を返却する。 <BR>
     * <BR>
