...
File Name        : 計算サービス評価額Comparator(WEB3TrialCalcAppraisalPriceComparator.java)
...
/**
 * （計算サービス評価額Comparator）<BR>
 * <BR>
 * 計算サービス評価額Comparatorクラス。<BR>
 * <BR>
...
public class WEB3TrialCalcAppraisalPriceComparator implements Comparator
{
    ...
    * 　@※銘柄明細1.評価額 == nullの場合は、銘柄明細1.評価額を0として扱う。<BR>
    * 　@※銘柄明細2.評価額 == nullの場合は、銘柄明細2.評価額を0として扱う。<BR>
    * <BR>
    * 　@[昇順指定の場合（this.orderBy == ”昇順”）] <BR>
    * 　@・（銘柄明細1.評価額 < 銘柄明細2.評価額）の場合、負の整数（-1）を返却する。
    * <BR>
    * 　@・（銘柄明細1.評価額 == 銘柄明細2.評価額）の場合、0を返却する。 <BR>
    * 　@・（銘柄明細1.評価額 > 銘柄明細2.評価額）の場合、正の整数（1）を返却する。
    * <BR>
    * <BR>
    ...
    * 　@・If "l_productDetails1.appraisalPrice < l_productDetails2.appraisalPrice"<BR>
    *      return '1'<BR>
    * 　@・If "l_productDetails1.appraisalPrice ==
    * l_productDetails2.appraisalPrice"<BR>
    *      return '0'<BR>
