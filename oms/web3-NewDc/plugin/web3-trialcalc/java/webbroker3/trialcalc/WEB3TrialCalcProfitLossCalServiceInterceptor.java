...
File Name        : 計算サービスポートフォリオインタセプタ(WEB3TrialCalcProfitLossCalServiceInterceptor.java)
...
/**
 * （計算サービス損益計算サービスインタセプタ）<BR>
 * <BR>
 * 損益計算サービスインタセプタクラス。<BR>
 * <BR>
 * ----<English>--------------------<BR>
 * <BR>
...
public class WEB3TrialCalcProfitLossCalServiceInterceptor implements Interceptor
{
    ...
    /**
      ...
      * <BR>
      * 　@(*1)リクエストデータの型＝「計算サービス損益計算入力リクエスト」の場合は、null
      * 。<BR>
      * 　@　@　@　@リクエストデータの型＝「計算サービス損益計算リクエスト」の場合は、<BR>
      ...
      * <BR>
      * 　@ (* 2)
      * リクエストデータの型＝「計算サービス損益計算入力リクエスト」の場合は、"01：株式?
      * 信用"。<BR>
      * 　@　@　@　@リクエストデータの型＝「計算サービス損益計算リクエスト」の場合は、<BR>
