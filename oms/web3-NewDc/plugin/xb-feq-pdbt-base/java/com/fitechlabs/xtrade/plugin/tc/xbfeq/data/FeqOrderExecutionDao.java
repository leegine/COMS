...
/** 
 * {@@link FeqOrderExecutionDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link FeqOrderExecutionRow}インスタンスへ関連付けることができます。 
...
public class FeqOrderExecutionDao extends DataAccessObject {
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link FeqOrderExecutionRow}と仮定される{@@link DataAccessObject}から新たに{@@link FeqOrderExecutionDao}を返します。 
         * @@return 指定のRowに結びつく{@@link FeqOrderExecutionDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link FeqOrderExecutionRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link FeqOrderExecutionRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link FeqOrderExecutionRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link FeqOrderExecutionRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link FeqOrderExecutionRow}オブジェクトから{@@link FeqOrderExecutionDao}オブジェクトを作成します。 
   * これは実際の{@@link FeqOrderExecutionRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link FeqOrderExecutionDao}取得のために指定の{@@link FeqOrderExecutionRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link FeqOrderExecutionDao}オブジェクト 
  ...
  /** 
   * {@@link FeqOrderExecutionRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link FeqOrderExecutionRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link FeqOrderExecutionPK}やデータベースレコードとして挿入される{@@link FeqOrderExecutionParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link FeqOrderExecutionRow}を一意に特定する{@@link FeqOrderExecutionPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link FeqOrderExecutionRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link FeqOrderExecutionParams}オブジェクトの主キーとして利用可能な{@@link FeqOrderExecutionPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link FeqOrderExecutionRow}オブジェクトを検索します。 
   * 
   * @@param p_orderExecutionId 検索対象であるp_orderExecutionIdフィールドの値
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link FeqOrderExecutionRow} 
  ...
  /** 
   * 指定のFeqOrderExecutionPKオブジェクトから{@@link FeqOrderExecutionRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するFeqOrderExecutionPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link FeqOrderExecutionRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(FeqOrderExecutionPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link FeqProductRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link FeqProductRow} 
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchFeqProductRowViaProductId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link FeqOrderRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link FeqOrderRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchFeqOrderRowViaOrderId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link FeqOrderUnitRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link FeqOrderUnitRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchFeqOrderUnitRowViaOrderUnitId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link SubAccountRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link SubAccountRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchSubAccountRowViaAccountIdSubAccountId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link MarketRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link MarketRow}または外部キーIDの値が現在nullに設定の場合はnull 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */	
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchMarketRowViaMarketId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link MainAccountRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link MainAccountRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchMainAccountRowViaAccountId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link TraderRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link TraderRow}または外部キーIDの値が現在nullに設定の場合はnull 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */	
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchTraderRowViaTraderId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に紐付く{@@link FeqOrderExecutionRow}内で外部キーの関係をもつ{@@link BranchRow}を検索します。 
   * 
   * @@return {@@link FeqOrderExecutionDao}と外部キーの関係にある{@@link BranchRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchBranchRowViaBranchId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link FeqOrderExecutionDao}に関連する{@@link FeqOrderExecutionRow}の外部キーがある{@@link FeqFinTransactionRow}オブジェクトを検索し{@@link List}として返します。 
   * 
   * @@return この{@@link FeqOrderExecutionDao}に関連する{@@link FeqOrderExecutionRow}の外部キーがある{@@link FeqFinTransactionRow}オブジェクトの{@@link List}
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchFeqFinTransactionRowsByOrderExecutionId()}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link FeqProductRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link FeqProductRow}オブジェクト 
   * @@return 指定の{@@link FeqProductRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link FeqProductPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link FeqProductPK}オブジェクト 
   * @@return {@@link FeqProductPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * 指定の外部キーの値（場合により複数）から{@@link FeqOrderExecutionRow}オブジェクトを検索し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param p_productId 検索対象であるp_productIdフィールドの値
   * 
   * @@return 指定の外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByProductId(FeqProductRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByProductId(FeqProductRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByProductId(FeqProductPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByProductId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link FeqOrderRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link FeqOrderRow}オブジェクト 
   * @@return 指定の{@@link FeqOrderRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link FeqOrderPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link FeqOrderPK}オブジェクト 
   * @@return {@@link FeqOrderPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByOrderId(FeqOrderRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderId(FeqOrderRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderId(FeqOrderPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link FeqOrderUnitRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link FeqOrderUnitRow}オブジェクト 
   * @@return 指定の{@@link FeqOrderUnitRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link FeqOrderUnitPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link FeqOrderUnitPK}オブジェクト 
   * @@return {@@link FeqOrderUnitPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByOrderUnitId(FeqOrderUnitRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderUnitId(FeqOrderUnitRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderUnitId(FeqOrderUnitPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderUnitId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link SubAccountRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link SubAccountRow}オブジェクト 
   * @@return 指定の{@@link SubAccountRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link SubAccountPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link SubAccountPK}オブジェクト 
   * @@return {@@link SubAccountPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByAccountIdSubAccountId(SubAccountRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountIdSubAccountId(SubAccountRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountIdSubAccountId(SubAccountPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountIdSubAccountId(long, long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link MarketRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link MarketRow}オブジェクト 
   * @@return 指定の{@@link MarketRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link MarketPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link MarketPK}オブジェクト 
   * @@return {@@link MarketPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByMarketId(MarketRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByMarketId(MarketRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByMarketId(MarketPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByMarketId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link MainAccountRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link MainAccountRow}オブジェクト 
   * @@return 指定の{@@link MainAccountRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link MainAccountPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link MainAccountPK}オブジェクト 
   * @@return {@@link MainAccountPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByAccountId(MainAccountRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(MainAccountRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(MainAccountPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link TraderRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link TraderRow}オブジェクト 
   * @@return 指定の{@@link TraderRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link TraderPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link TraderPK}オブジェクト 
   * @@return {@@link TraderPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByTraderId(TraderRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByTraderId(TraderRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByTraderId(TraderPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByTraderId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link BranchRow}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link BranchRow}オブジェクト 
   * @@return 指定の{@@link BranchRow}に外部キーを持つ{@@link FeqOrderExecutionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link BranchPK}と外部キーの関係にある{@@link FeqOrderExecutionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link BranchPK}オブジェクト 
   * @@return {@@link BranchPK}と外部キーが一致する値を持つ{@@link FeqOrderExecutionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByBranchId(BranchRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByBranchId(BranchRow)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByBranchId(BranchPK)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByBranchId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
  ...
  /** 
   * p_orderExecutionId, and にて指定の値から一意の{@@link FeqOrderExecutionRow}オブジェクトを検索します。 
   * 該当するオブジェクトがない場合はnullを返します。
   * 
   * @@param p_orderExecutionId 検索対象であるp_orderExecutionIdフィールドの値
   * 
   * @@return 引数指定のp_orderExecutionId, and の値と一致する{@@link FeqOrderExecutionRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByOrderExecutionId(long)}および{@@link #forRow(FeqOrderExecutionRow)}を使用してください。 
   */
