...
1.1
date	2011.03.22.09.01.40;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	FeqTradedProductUpdqPK.java;
...
/** 
 * <b>FeqTradedProductUpdq</b>データベーステーブルで一意である1つのレコードをあらわす<b>FeqTradedProductUpdq</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>FeqTradedProductUpdq</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class FeqTradedProductUpdqPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: FeqTradedProductUpdqRow. 
   */
   ...
   */
  public FeqTradedProductUpdqPK( long p_tradedProductId, String p_validForBizDate ) {
   ...
   */
  public static FeqTradedProductUpdqPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    FeqTradedProductUpdqPK pk = new FeqTradedProductUpdqPK();
  ...
  {
    if ( other == null || !( other instanceof FeqTradedProductUpdqPK) )
      return false;
    FeqTradedProductUpdqPK o = (FeqTradedProductUpdqPK) other;
