...
1.1
date	2011.03.22.09.03.29;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	FeqTradedProductParams.java;
...
/** 
 * feq_traded_productテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link FeqTradedProductRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link FeqTradedProductParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link FeqTradedProductParams}が{@@link FeqTradedProductRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class FeqTradedProductParams extends Params implements FeqTradedProductRow {
  ...
  public static final String PTYPE = "feq_traded_product";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = FeqTradedProductRow.TYPE;
  ...
  public RowType getRowType() {
    return FeqTradedProductRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のFeqTradedProductParamsオブジェクトを作成します。 
   */
  public FeqTradedProductParams() {
  ...
  /** 
   * 指定のFeqTradedProductRowオブジェクトの値を利用してFeqTradedProductParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するFeqTradedProductRowオブジェクト 
   */
  public FeqTradedProductParams( FeqTradedProductRow p_row )
  {
  ...
  {
    if ( !( other instanceof FeqTradedProductRow ) )
       return false;
    return fieldsEqual( (FeqTradedProductRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のFeqTradedProductRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( FeqTradedProductRow row )
  {
  ...
  {
    return new FeqTradedProductPK(traded_product_id);
  }
