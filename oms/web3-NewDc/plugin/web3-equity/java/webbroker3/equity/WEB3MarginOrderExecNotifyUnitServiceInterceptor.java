...
filename	WEB3MarginOrderExecNotifyUnitServiceInterceptor.java;
...
File Name        : 信用取引出来通知一件サービスインタセプタ(WEB3MarginExecNotifyUnitServiceInterceptor.java)
...
/**
 * （信用取引出来通知一件サービスインタセプタクラス）。
 * @@author 凌建平
 * @@version 1.0
 */
public class WEB3MarginOrderExecNotifyUnitServiceInterceptor implements Interceptor 
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3MarginOrderExecNotifyUnitServiceInterceptor.class);

    /**
     * コンストラクタ。<BR>
     */
    public WEB3MarginOrderExecNotifyUnitServiceInterceptor()
    {
    }
