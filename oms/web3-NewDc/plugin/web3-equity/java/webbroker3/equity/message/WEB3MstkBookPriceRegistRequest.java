...
filename	WEB3MstkBookPriceRegistRequest.java;
...
File Name        : 株式ミニ投資簿価単価登録リクエスト(WEB3MstkBookPriceRegistRequest.java)
...
/**
 * （株式ミニ投資簿価単価登録リクエスト）。<BR>
 * <BR>
 * 株式ミニ投資簿価単価登録リクエストクラス<BR>
 */
public class WEB3MstkBookPriceRegistRequest extends WEB3GenRequest 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MstkBookPriceRegistRequest.class);
    ...
    /**
     * @@roseuid 4206CF4501F0<BR>
     */
    public WEB3MstkBookPriceRegistRequest() 
    {
    ...
    {
        return new WEB3MstkBookPriceRegistResponse(this);
    }
}
@
