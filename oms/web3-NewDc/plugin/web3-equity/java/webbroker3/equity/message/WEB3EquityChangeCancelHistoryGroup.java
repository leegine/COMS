...
File Name        : 現物株式注文約定履歴明細(WEB3EquityChangeCancelHistoryGroup.java)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/05/17 張坤芳 (中訊) 新規作成
Revesion History : 2004/12/13 桑原 (SRA) 残案件対応
                   2006/11/01 張騰宇(中訊) モデル 948,999
Revesion History : 2007/07/24 何文敏(中訊) モデル No.1188
*/
...
public class WEB3EquityChangeCancelHistoryGroup extends Message
{
     ...
     * 16：無効 17：注文繰越 18：注文繰越(失敗) 19：約定取消(現引現渡)<BR>
     * 20：発注中  21：発注遅延<BR>
     * 22：切替遅延 23：切替注文 24：切替受付 25：切替完了<BR>
     * 26：切替注文(失敗) 27：ストップ注文失効 29：強制失効99：その他<BR>
     */
     ...
     * 0004：保証金不足エラー 0005：建株残高不足エラー<BR>
     * 0006：売買停止銘柄エラー 0007：市場変更銘柄エラー<BR>
     * 0008：買付余力エラー 0009：売付可能数量エラー<BR>
     * 0010：特定口座エラー 0011：注文繰越スキップ銘柄エラー 9001：その他エラー<BR>
     */
