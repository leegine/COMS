...
File Name        :  注文繰越スキップ銘柄通知リクエスト(WEB3EquityCarryOverSkipRequest.java)
...
/**
 * （株式注文繰越スキップ銘柄通知リクエスト）。<br>
 * <br>
 * 株式注文繰越スキップ銘柄通知リクエストクラス
 * @@version 1.0
 */
public class WEB3EquityCarryOverSkipRequest extends WEB3BackRequest
{
    ...
    /**
     * <p>（createレスポンス）。</p>
     * <p>株式注文繰越スキップ銘柄通知レスポンスを生成して返す。</p>
     * @@return 株式注文繰越スキップ銘柄通知レスポンス
     */
