...
filename	WEB3EquityReceiveChangeEventServiceInterceptor.java;
...
File Name        : 現物株式訂正取消通知訂正一件サービスインタセプタ(WEB3EquityReceiveChangeEventServiceInterceptor.java)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/05/24 李綱 (中訊) 新規作成
Revesion History : 2004/12/17 中尾寿彦(SRA) 残案件対応による修正
...
/**
 * （現物株式訂正取消通知訂正一件サービスインタセプタ）。<BR>
 * <BR>
 * 現物株式訂正取消通知訂正一件サービスインタセプタクラス
 * @@author 李綱
 * @@version 1.0
 */
public class WEB3EquityReceiveChangeEventServiceInterceptor
    implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3EquityReceiveChangeEventServiceInterceptor.class);

    /**
     * @@roseuid 40A436F401F1<BR>
     */
    public WEB3EquityReceiveChangeEventServiceInterceptor()
    {
     ...
     * （xTradeカーネルより、[訂正取消通知訂正一件サービス]実行前に呼び出される）<BR>
     * <BR>
     ...
     * (onThrowable)<BR>
     * <BR>
     * 訂正取消通知訂正一件サービスが例外をスローした場合にコールされる<BR>
     * <BR>
     * ThreadLocalSystemAttributesRegistryの以下の内容をクリアする。<BR>
     * <BR>
     * 取引時間管理.TIMESTAMP_TAG<BR>
