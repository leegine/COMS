...
filename	WEB3MstkBookValuePriceRegistServiceInterceptor.java;
...
File Name        :株式ミニ投資簿価単価登録サービスインタセプタ(WEB3MstkBookValuePriceRegistServiceInterceptor.java)
...
/**
 * （株式ミニ投資簿価単価登録サービスインタセプタ）。<BR>
 * <BR>
 * 株式ミニ投資簿価単価登録サービスインタセプタ<BR>
 */
public class WEB3MstkBookValuePriceRegistServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3MstkBookValuePriceRegistServiceInterceptor.class);
    
    /**
     * @@roseuid 4206F07E0115<BR>
     */
    public WEB3MstkBookValuePriceRegistServiceInterceptor() 
    {
