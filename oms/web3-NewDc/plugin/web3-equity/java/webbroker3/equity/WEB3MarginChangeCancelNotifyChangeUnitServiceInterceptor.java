...
filename	WEB3MarginChangeCancelNotifyChangeUnitServiceInterceptor.java;
...
File Name        : 信用取引訂正取消通知訂正一件サービスインタセプタ(WEB3MarginChangeCancelNotifyChangeUnitServiceInterceptor.java)
...
/**
 * （信用取引訂正取消通知訂正一件サービスインタセプタ）。<BR>
 * <BR>
 * 信用取引訂正取消通知訂正一件サービスインタセプタクラス
 * @@version 1.0
 */
public class WEB3MarginChangeCancelNotifyChangeUnitServiceInterceptor
    implements Interceptor
{
     ...
     */
    public WEB3MarginChangeCancelNotifyChangeUnitServiceInterceptor()
    {
