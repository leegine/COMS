...
filename	WEB3MstkBalanceReferenceServiceInterceptor.java;
...
File Name        : 株式ミニ投資残高照会サービスインタセプタ(WEB3MstkBalanceReferenceServiceInterceptor.java)
...
/**
 * （株式ミニ投資残高照会サービスインタセプタ）。<BR>
 * <BR>
 * 株式ミニ投資残高照会サービスインタセプタ<BR>
 */
public class WEB3MstkBalanceReferenceServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MstkBalanceReferenceServiceInterceptor.class);
        
    /**
     * @@roseuid 4206CD480348
     */
    public WEB3MstkBalanceReferenceServiceInterceptor() 
    {
