...
filename	HostEqtypeOrderClmdReceiptParams.java;
...
/** 
 * host_eqtype_order_clmd_receiptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostEqtypeOrderClmdReceiptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostEqtypeOrderClmdReceiptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostEqtypeOrderClmdReceiptParams}が{@@link HostEqtypeOrderClmdReceiptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostEqtypeOrderClmdReceiptParams extends Params implements HostEqtypeOrderClmdReceiptRow {
  ...
  public static final String PTYPE = "host_eqtype_order_clmd_receipt";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostEqtypeOrderClmdReceiptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostEqtypeOrderClmdReceiptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostEqtypeOrderClmdReceiptParamsオブジェクトを作成します。 
   */
  public HostEqtypeOrderClmdReceiptParams() {
  ...
  /** 
   * 指定のHostEqtypeOrderClmdReceiptRowオブジェクトの値を利用してHostEqtypeOrderClmdReceiptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostEqtypeOrderClmdReceiptRowオブジェクト 
   */
  public HostEqtypeOrderClmdReceiptParams( HostEqtypeOrderClmdReceiptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostEqtypeOrderClmdReceiptRow ) )
       return false;
    return fieldsEqual( (HostEqtypeOrderClmdReceiptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostEqtypeOrderClmdReceiptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostEqtypeOrderClmdReceiptRow row )
  {
  ...
  {
    return new HostEqtypeOrderClmdReceiptPK(rowid);
  }
