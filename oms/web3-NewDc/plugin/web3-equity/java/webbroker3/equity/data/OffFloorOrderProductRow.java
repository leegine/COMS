...
filename	OffFloorOrderProductRow.java;
...
/** 
 * OffFloorOrderProductRowインタフェースは変更不可でリードオンリーである<em>off_floor_order_product</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OffFloorOrderProductRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OffFloorOrderProductRow extends Row {


  /** 
   * この{@@link OffFloorOrderProductRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "off_floor_order_product", "master" );
   ...
   */
  public java.sql.Timestamp getOrderStartDatetime();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderStartDatetimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderStartDatetimeIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getOrderEndDatetime();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderEndDatetimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderEndDatetimeIsModified();
   ...
   * @@return doubleの値 
   */
  public double getMaxApplyQuantity();
   ...
   */
  public  boolean  getMaxApplyQuantityIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMaxApplyQuantityIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMaxApplyQuantityIsModified();
   ...
   * @@return doubleの値 
   */
  public double getOffFloorOrderPrice();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getOffFloorOrderPriceIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOffFloorOrderPriceIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOffFloorOrderPriceIsModified();
