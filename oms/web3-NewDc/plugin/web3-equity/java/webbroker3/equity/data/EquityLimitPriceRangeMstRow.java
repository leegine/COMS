...
filename	EquityLimitPriceRangeMstRow.java;
...
/** 
 * EquityLimitPriceRangeMstRowインタフェースは変更不可でリードオンリーである<em>equity_limit_price_range_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EquityLimitPriceRangeMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface EquityLimitPriceRangeMstRow extends Row {


  /** 
   * この{@@link EquityLimitPriceRangeMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "equity_limit_price_range_mst", "master" );
