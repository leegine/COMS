...
filename	EquityLimitPriceRangeMstParams.java;
...
/** 
 * equity_limit_price_range_mstテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link EquityLimitPriceRangeMstRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link EquityLimitPriceRangeMstParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link EquityLimitPriceRangeMstParams}が{@@link EquityLimitPriceRangeMstRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class EquityLimitPriceRangeMstParams extends Params implements EquityLimitPriceRangeMstRow {
  ...
  public static final RowType TYPE = EquityLimitPriceRangeMstRow.TYPE;
  ...
  /** 
   * 値が未設定のEquityLimitPriceRangeMstParamsオブジェクトを作成します。 
   */
  public EquityLimitPriceRangeMstParams() {
  ...
  /** 
   * 指定のEquityLimitPriceRangeMstRowオブジェクトの値を利用してEquityLimitPriceRangeMstParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するEquityLimitPriceRangeMstRowオブジェクト 
   */
  public EquityLimitPriceRangeMstParams( EquityLimitPriceRangeMstRow p_row )
  {
  ...
  {
    if ( !( other instanceof EquityLimitPriceRangeMstRow ) )
       return false;
    return fieldsEqual( (EquityLimitPriceRangeMstRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のEquityLimitPriceRangeMstRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( EquityLimitPriceRangeMstRow row )
  {
    if ( market_code == null ) {
  ...
  {
    return new EquityLimitPriceRangeMstPK(market_code, low_price);
  }
