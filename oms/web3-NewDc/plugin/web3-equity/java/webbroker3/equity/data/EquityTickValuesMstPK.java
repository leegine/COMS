...
filename	EquityTickValuesMstPK.java;
...
/** 
 * <b>EquityTickValuesMst</b>データベーステーブルで一意である1つのレコードをあらわす<b>EquityTickValuesMst</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>EquityTickValuesMst</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class EquityTickValuesMstPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: EquityTickValuesMstRow. 
   */
   ...
   */
  public EquityTickValuesMstPK( String p_marketCode, double p_lowPrice ) {
   ...
   */
  public static EquityTickValuesMstPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    EquityTickValuesMstPK pk = new EquityTickValuesMstPK();
  ...
  {
    if ( other == null || !( other instanceof EquityTickValuesMstPK) )
      return false;
    EquityTickValuesMstPK o = (EquityTickValuesMstPK) other;
    if ( market_code == null ) {
