...
filename	HostEqtypeSwapAcceptParams.java;
...
/** 
 * host_eqtype_swap_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostEqtypeSwapAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostEqtypeSwapAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostEqtypeSwapAcceptParams}が{@@link HostEqtypeSwapAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostEqtypeSwapAcceptParams extends Params implements HostEqtypeSwapAcceptRow {
  ...
  public static final RowType TYPE = HostEqtypeSwapAcceptRow.TYPE;
  ...
  /** 
   * 値が未設定のHostEqtypeSwapAcceptParamsオブジェクトを作成します。 
   */
  public HostEqtypeSwapAcceptParams() {
  ...
  /** 
   * 指定のHostEqtypeSwapAcceptRowオブジェクトの値を利用してHostEqtypeSwapAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostEqtypeSwapAcceptRowオブジェクト 
   */
  public HostEqtypeSwapAcceptParams( HostEqtypeSwapAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostEqtypeSwapAcceptRow ) )
       return false;
    return fieldsEqual( (HostEqtypeSwapAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostEqtypeSwapAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostEqtypeSwapAcceptRow row )
  {
  ...
  {
    return new HostEqtypeSwapAcceptPK(rowid);
  }
