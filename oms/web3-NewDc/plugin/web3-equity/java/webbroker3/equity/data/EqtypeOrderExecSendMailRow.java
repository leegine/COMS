...
filename	EqtypeOrderExecSendMailRow.java;
...
/** 
 * EqtypeOrderExecSendMailRowインタフェースは変更不可でリードオンリーである<em>eqtype_order_exec_send_mail</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EqtypeOrderExecSendMailRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface EqtypeOrderExecSendMailRow extends Row {


  /** 
   * この{@@link EqtypeOrderExecSendMailRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "eqtype_order_exec_send_mail", "session" );
   ...
   * @@return doubleの値 
   */
  public double getDelivalyAmount();
   ...
   */
  public  boolean  getDelivalyAmountIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDelivalyAmountIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDelivalyAmountIsModified();
