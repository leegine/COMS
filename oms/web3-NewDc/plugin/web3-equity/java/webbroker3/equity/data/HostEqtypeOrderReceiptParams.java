...
/** 
 * host_eqtype_order_receiptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostEqtypeOrderReceiptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostEqtypeOrderReceiptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostEqtypeOrderReceiptParams}が{@@link HostEqtypeOrderReceiptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class HostEqtypeOrderReceiptParams extends Params implements HostEqtypeOrderReceiptRow {
  ...
  /** 
   * <em>commition_number</em>カラムの値 
   */
  public  String  commition_number;

  /** 
   * <em>commition_branch_number</em>カラムの値 
   */
  ...
  /** 
   * 値が未設定のHostEqtypeOrderReceiptParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のHostEqtypeOrderReceiptRowオブジェクトの値を利用してHostEqtypeOrderReceiptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostEqtypeOrderReceiptRowオブジェクト 
   */
   ...
   * @@param row 比較対照のHostEqtypeOrderReceiptRow 
  ...
  /** 
   * <em>commition_number</em>カラムの値を設定します。 
   *
   * @@param p_commitionNumber <em>commition_number</em>カラムの値をあらわす2桁以下のString値 
   */
  ...
  /** 
   * <em>commition_branch_number</em>カラムの値を設定します。 
   *
   * @@param p_commitionBranchNumber <em>commition_branch_number</em>カラムの値をあらわす1桁以下のString値 
   */
