...
filename	HostEqtypeCloseOrderNotifyParams.java;
...
/** 
 * host_eqtype_close_order_notifyテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostEqtypeCloseOrderNotifyRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostEqtypeCloseOrderNotifyParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostEqtypeCloseOrderNotifyParams}が{@@link HostEqtypeCloseOrderNotifyRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostEqtypeCloseOrderNotifyParams extends Params implements HostEqtypeCloseOrderNotifyRow {
  ...
  public static final String PTYPE = "host_eqtype_close_order_notify";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostEqtypeCloseOrderNotifyRow.TYPE;
  ...
  public RowType getRowType() {
    return HostEqtypeCloseOrderNotifyRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostEqtypeCloseOrderNotifyParamsオブジェクトを作成します。 
   */
  public HostEqtypeCloseOrderNotifyParams() {
  ...
  /** 
   * 指定のHostEqtypeCloseOrderNotifyRowオブジェクトの値を利用してHostEqtypeCloseOrderNotifyParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostEqtypeCloseOrderNotifyRowオブジェクト 
   */
  public HostEqtypeCloseOrderNotifyParams( HostEqtypeCloseOrderNotifyRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostEqtypeCloseOrderNotifyRow ) )
       return false;
    return fieldsEqual( (HostEqtypeCloseOrderNotifyRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostEqtypeCloseOrderNotifyRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostEqtypeCloseOrderNotifyRow row )
  {
  ...
  /** 
   * <em>close_quantity</em>カラムの値を取得します。
   * @@return doubleの値 
   */
  ...
  /** 
   * <em>close_quantity</em>カラムの値がnullかどうか調べます。
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  ...
  /** 
   * <em>close_quantity</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>close_quantity</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  {
    return new HostEqtypeCloseOrderNotifyPK(rowid);
  }
  ...
  /** 
   * <em>close_quantity</em>カラムの値を設定します。 
   *
   * @@param p_closeQuantity <em>close_quantity</em>カラムの値をあらわす18桁以下のdouble値で、その精度は6桁まで
   */
  ...
  /** 
   * 指定のオブジェクト（場合によってはnull）を使って<em>close_quantity</em>カラムに値を設定します。 
   */
  public final void setCloseQuantity( Double p_closeQuantity )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object can't be modified. Use copy contructor to create a new Params object for modification.");
