...
filename	EquityTickValuesMstRow.java;
...
/** 
 * EquityTickValuesMstRowインタフェースは変更不可でリードオンリーである<em>equity_tick_values_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EquityTickValuesMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface EquityTickValuesMstRow extends Row {


  /** 
   * この{@@link EquityTickValuesMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "equity_tick_values_mst", "master" );
