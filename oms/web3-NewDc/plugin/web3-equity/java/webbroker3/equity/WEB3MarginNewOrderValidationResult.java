...
filename	WEB3MarginNewOrderValidationResult.java;
...
File Name        : 信用新規建新規注文発注審査結果(WEB3MarginNewOrderValidationResult.java)
 ...
 * （信用新規建新規注文発注審査結果）。<BR>
 * <BR>
 * 信用新規建注文の発注審査の結果を示すために利用するクラス。<BR>
 * （EqTypeNewOrderValidationResultの拡張クラス）
 * @@version 1.0
 */
public class WEB3MarginNewOrderValidationResult extends EqTypeNewOrderValidationResult
{
    /**
     * 空売り規制対象フラグ。<BR>
     */
     ...
     */
    public WEB3MarginNewOrderValidationResult(ProcessingResult l_result, boolean isShortSellingRestraint)
    {
        super(l_result);
