...
filename	WEB3EquityBookValuePriceRegistServiceInterceptor.java;
...
File Name        : 現物株式簿価単価登録サービスインタセプタ(WEB3EquityBookValuePriceRegistServiceInterceptor.java)
...
/**
 * （現物株式簿価単価登録サービスインタセプタ）。<BR>
 * <BR>
 * 現物株式簿価単価登録サービスインタセプタ<BR>
 */
public class WEB3EquityBookValuePriceRegistServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3EquityBookValuePriceRegistServiceInterceptor.class);
    
   /**
    * @@roseuid 4206EF900098
    */
   public WEB3EquityBookValuePriceRegistServiceInterceptor() 
   {
