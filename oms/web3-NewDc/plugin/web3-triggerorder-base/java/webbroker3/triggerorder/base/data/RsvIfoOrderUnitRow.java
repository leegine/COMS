...
1.1
date	2011.03.15.02.19.50;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RsvIfoOrderUnitRow.java;
...
/** 
 * RsvIfoOrderUnitRowインタフェースは変更不可でリードオンリーである<em>rsv_ifo_order_unit</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link RsvIfoOrderUnitRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface RsvIfoOrderUnitRow extends Row {


  /** 
   * この{@@link RsvIfoOrderUnitRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "rsv_ifo_order_unit", "account" );
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getFirstOrderIdIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFirstOrderIdIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFirstOrderIdIsModified();
