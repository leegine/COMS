...
1.1
date	2011.03.15.02.18.54;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RsvIfoOrderActionRow.java;
...
/** 
 * RsvIfoOrderActionRowインタフェースは変更不可でリードオンリーである<em>rsv_ifo_order_action</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link RsvIfoOrderActionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface RsvIfoOrderActionRow extends Row {


  /** 
   * この{@@link RsvIfoOrderActionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "rsv_ifo_order_action", "account" );
