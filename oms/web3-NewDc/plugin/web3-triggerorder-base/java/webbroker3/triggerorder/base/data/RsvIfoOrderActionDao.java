...
/** 
 * {@@link RsvIfoOrderActionDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link RsvIfoOrderActionRow}インスタンスへ関連付けることができます。 
...
public class RsvIfoOrderActionDao extends DataAccessObject {
  ...
  /** 
   * この{@@link RsvIfoOrderActionDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link RsvIfoOrderActionRow}と仮定される{@@link DataAccessObject}から新たに{@@link RsvIfoOrderActionDao}を返します。 
         * @@return 指定のRowに結びつく{@@link RsvIfoOrderActionDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link RsvIfoOrderActionRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link RsvIfoOrderActionRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link RsvIfoOrderActionRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link RsvIfoOrderActionRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link RsvIfoOrderActionRow}オブジェクトから{@@link RsvIfoOrderActionDao}オブジェクトを作成します。 
   * これは実際の{@@link RsvIfoOrderActionRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link RsvIfoOrderActionDao}取得のために指定の{@@link RsvIfoOrderActionRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link RsvIfoOrderActionDao}オブジェクト 
  ...
  /** 
   * この{@@link RsvIfoOrderActionDao}に紐付く{@@link RsvIfoOrderActionRow}内で外部キーの関係をもつ{@@link MainAccountRow}を検索します。 
   * 
   * @@return {@@link RsvIfoOrderActionDao}と外部キーの関係にある{@@link MainAccountRow} 
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchMainAccountRowViaAccountId()}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link RsvIfoOrderActionDao}に紐付く{@@link RsvIfoOrderActionRow}内で外部キーの関係をもつ{@@link SubAccountRow}を検索します。 
   * 
   * @@return {@@link RsvIfoOrderActionDao}と外部キーの関係にある{@@link SubAccountRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchSubAccountRowViaAccountIdSubAccountId()}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link RsvIfoOrderActionDao}に紐付く{@@link RsvIfoOrderActionRow}内で外部キーの関係をもつ{@@link TraderRow}を検索します。 
   * 
   * @@return {@@link RsvIfoOrderActionDao}と外部キーの関係にある{@@link TraderRow}または外部キーIDの値が現在nullに設定の場合はnull 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */	
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchTraderRowViaTraderId()}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * この{@@link RsvIfoOrderActionDao}に紐付く{@@link RsvIfoOrderActionRow}内で外部キーの関係をもつ{@@link RsvIfoOrderUnitRow}を検索します。 
   * 
   * @@return {@@link RsvIfoOrderActionDao}と外部キーの関係にある{@@link RsvIfoOrderUnitRow} 
   * @@exception DataFindException 外部キーIDがnullでなくクエリが実行されたが、データベースに該当データの存在がなくオブジェクト検索に失敗した場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #fetchRsvIfoOrderUnitRowViaOrderId()}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link MainAccountRow}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link MainAccountRow}オブジェクト 
   * @@return 指定の{@@link MainAccountRow}に外部キーを持つ{@@link RsvIfoOrderActionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link MainAccountPK}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link MainAccountPK}オブジェクト 
   * @@return {@@link MainAccountPK}と外部キーが一致する値を持つ{@@link RsvIfoOrderActionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * 指定の外部キーの値（場合により複数）から{@@link RsvIfoOrderActionRow}オブジェクトを検索し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param p_accountId 検索対象であるp_accountIdフィールドの値
   * 
   * @@return 指定の外部キーを持つ{@@link RsvIfoOrderActionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByAccountId(MainAccountRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(MainAccountRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(MainAccountPK)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountId(long)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link SubAccountRow}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link SubAccountRow}オブジェクト 
   * @@return 指定の{@@link SubAccountRow}に外部キーを持つ{@@link RsvIfoOrderActionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link SubAccountPK}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link SubAccountPK}オブジェクト 
   * @@return {@@link SubAccountPK}と外部キーが一致する値を持つ{@@link RsvIfoOrderActionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByAccountIdSubAccountId(SubAccountRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountIdSubAccountId(SubAccountRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountIdSubAccountId(SubAccountPK)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByAccountIdSubAccountId(long, long)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link TraderRow}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link TraderRow}オブジェクト 
   * @@return 指定の{@@link TraderRow}に外部キーを持つ{@@link RsvIfoOrderActionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link TraderPK}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link TraderPK}オブジェクト 
   * @@return {@@link TraderPK}と外部キーが一致する値を持つ{@@link RsvIfoOrderActionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByTraderId(TraderRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByTraderId(TraderRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByTraderId(TraderPK)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByTraderId(long)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * {@@link RsvIfoOrderUnitRow}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param row 外部キーの参照をする{@@link RsvIfoOrderUnitRow}オブジェクト 
   * @@return 指定の{@@link RsvIfoOrderUnitRow}に外部キーを持つ{@@link RsvIfoOrderActionRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * {@@link RsvIfoOrderUnitPK}と外部キーの関係にある{@@link RsvIfoOrderActionRow}オブジェクトを参照し{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param pk クエリ内で利用する{@@link RsvIfoOrderUnitPK}オブジェクト 
   * @@return {@@link RsvIfoOrderUnitPK}と外部キーが一致する値を持つ{@@link RsvIfoOrderActionRow}の{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link DataAccessObject#getRow()}、{@@link #findRowsByOrderId(RsvIfoOrderUnitRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderId(RsvIfoOrderUnitRow)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderId(RsvIfoOrderUnitPK)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByOrderId(long)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
  ...
  /** 
   * p_orderId, p_orderActionSerialNo, and にて指定の値から一意の{@@link RsvIfoOrderActionRow}オブジェクトを検索します。 
   * 該当するオブジェクトがない場合はnullを返します。
   * 
   * @@param p_orderId 検索対象であるp_orderIdフィールドの値
   * @@param p_orderActionSerialNo 検索対象であるp_orderActionSerialNoフィールドの値
   * 
   * @@return 引数指定のp_orderId, p_orderActionSerialNo, and の値と一致する{@@link RsvIfoOrderActionRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByOrderIdOrderActionSerialNo(long, int)}および{@@link #forRow(RsvIfoOrderActionRow)}を使用してください。 
   */
