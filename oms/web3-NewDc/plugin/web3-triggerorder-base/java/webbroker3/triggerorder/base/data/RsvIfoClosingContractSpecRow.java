...
1.1
date	2011.03.15.02.20.10;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RsvIfoClosingContractSpecRow.java;
...
/** 
 * RsvIfoClosingContractSpecRowインタフェースは変更不可でリードオンリーである<em>rsv_ifo_closing_contract_spec</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link RsvIfoClosingContractSpecRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface RsvIfoClosingContractSpecRow extends Row {


  /** 
   * この{@@link RsvIfoClosingContractSpecRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "rsv_ifo_closing_contract_spec", "account" );
