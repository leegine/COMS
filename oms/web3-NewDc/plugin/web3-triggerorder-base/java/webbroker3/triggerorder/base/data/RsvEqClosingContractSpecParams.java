...
1.1
date	2011.03.15.02.18.58;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RsvEqClosingContractSpecParams.java;
...
/** 
 * rsv_eq_closing_contract_specテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link RsvEqClosingContractSpecRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link RsvEqClosingContractSpecParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link RsvEqClosingContractSpecParams}が{@@link RsvEqClosingContractSpecRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class RsvEqClosingContractSpecParams extends Params implements RsvEqClosingContractSpecRow {
  ...
  public static final String PTYPE = "rsv_eq_closing_contract_spec";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = RsvEqClosingContractSpecRow.TYPE;
  ...
  public RowType getRowType() {
    return RsvEqClosingContractSpecRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のRsvEqClosingContractSpecParamsオブジェクトを作成します。 
   */
  public RsvEqClosingContractSpecParams() {
  }
  ...
  /** 
   * 指定のRsvEqClosingContractSpecRowオブジェクトの値を利用してRsvEqClosingContractSpecParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するRsvEqClosingContractSpecRowオブジェクト 
   */
  public RsvEqClosingContractSpecParams( RsvEqClosingContractSpecRow p_row )
  {
  ...
  {
    if ( !( other instanceof RsvEqClosingContractSpecRow ) )
       return false;
    return fieldsEqual( (RsvEqClosingContractSpecRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のRsvEqClosingContractSpecRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( RsvEqClosingContractSpecRow row )
  {
  ...
  {
    throw new UnsupportedOperationException("Table rsv_eq_closing_contract_spec has no primary key.");
  }
