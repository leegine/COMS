...
filename	WEB3FuturesSettleContractInputServiceInterceptor.java;
...
File Name        : 株価指数先物返済入力サービスインタセプタ(WEB3FuturesSettleContractInputServiceInterceptor)
...
/**
 * (先物返済入力サービスインタセプタ)<BR>
 * 株価指数先物返済入力サービスインタセプタ
 * @@author 鄒鋭
 * @@version 1.0
 */
public class WEB3FuturesSettleContractInputServiceInterceptor implements Interceptor
{

    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3FuturesSettleContractInputServiceInterceptor.class);

    /**
     * @@roseuid 40F7B0E2005D
     */
    public WEB3FuturesSettleContractInputServiceInterceptor()
    {
    ...
    public Object onCall(Method l_method, Object[] l_serviceParam)
    {
        ...
        {
            log.error("データ不整合エラー。", new WEB3SystemLayerException(WEB3ErrorCatalog.SYSTEM_ERROR_80005, this.getClass().getName() + STR_METHOD_NAME, l_ex.getMessage(), l_ex));
