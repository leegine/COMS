...
1.1
date	2011.03.16.03.15.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FuturesSessionTypeComparator.java;
...
File Name        : 先物立会区分Comparator (WEB3FuturesSessionTypeComparator.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/06/21 張騰宇 (中訊) 新規作成 モデル717
*/
 ...
 * @@version 1.0
 */
public class WEB3FuturesSessionTypeComparator implements Comparator
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3FuturesSessionTypeComparator.class);
     ...
     * D：降順<BR>
     */
    public WEB3FuturesSessionTypeComparator(String l_strOrderBy)
    {
    ...
    public int compare(Object l_obj1, Object l_obj2)
    {
        ...
        {
            l_strAttr1 = ((WEB3FuturesContractReferenceUnit)l_obj1).sessionType;
            l_strAttr2 = ((WEB3FuturesContractReferenceUnit)l_obj2).sessionType;
        }
        else
        {
            ...
            throw new IllegalArgumentException(
                ...
                "または　@'WEB3FuturesContractReferenceUnit'類型");
        }
    ...
    {
        if (l_obj instanceof WEB3FuturesSessionTypeComparator)
        {
            WEB3FuturesSessionTypeComparator l_comparator =
                (WEB3FuturesSessionTypeComparator)l_obj;
