...
1.1
date	2011.03.16.03.16.39;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionsContractPriceComparator.java;
...
File Name        : 建単価Comparator(WEBOptionContractPriceComparator)
 ...
 * @@version 1.0 
 */
public class WEB3OptionsContractPriceComparator implements Comparator
{
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3OptionsContractPriceComparator.class);
     ...
     */
    public WEB3OptionsContractPriceComparator(String l_strOrderBy)
    {
     ...
     * １）　@引数のキャスト<BR> 
     * 　@パラメータ.明細1および2を、株価指数オプション建玉明細にキャストする。<BR> 
     * <BR>
     * ２）　@比較<BR>
    ...
    {
        if (l_obj instanceof WEB3OptionsContractPriceComparator)
        {
            WEB3OptionsContractPriceComparator l_comparator =
                (WEB3OptionsContractPriceComparator) l_obj;
