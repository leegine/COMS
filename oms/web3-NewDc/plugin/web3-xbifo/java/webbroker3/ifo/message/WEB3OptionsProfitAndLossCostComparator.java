...
1.1
date	2011.03.16.03.17.45;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionsProfitAndLossCostComparator.java;
...
File Name        :損益(諸経費込)Comparator(WEB3OptionsProfitAndLossCostComparator)
...
/**
 * (損益(諸経費込)Comparator)<BR>
 */
public class WEB3OptionsProfitAndLossCostComparator implements Comparator
{
    ...
    */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
	        WEB3OptionsProfitAndLossCostComparator.class);
     ...
     * コンストラクタ<BR>
     */
    public WEB3OptionsProfitAndLossCostComparator()
    {
     ...
     * @@return Void
     */
    public WEB3OptionsProfitAndLossCostComparator(String l_strOrderBy)
    {
    ...
    public int compare(Object l_obj1, Object l_obj2)
    {
		...
		//株価指数オプション建玉照会明細クラスの場合
		if((l_obj1 instanceof WEB3OptionsContractReferenceUnit) 
			&& (l_obj2 instanceof WEB3OptionsContractReferenceUnit))
		{
			l_strAttr1 = ((WEB3OptionsContractReferenceUnit)l_obj1).incomeCost;
			l_strAttr2 = ((WEB3OptionsContractReferenceUnit)l_obj2).incomeCost; 
		}
		//建玉明細クラスの場合
		...
		//株価指数オプション返済一覧行クラスの場合
		else if((l_obj1 instanceof WEB3OptionsCloseMarginGroup) 
			&& (l_obj2 instanceof WEB3OptionsCloseMarginGroup))
		{
			l_strAttr1 = ((WEB3OptionsCloseMarginGroup)l_obj1).incomeCost;
			l_strAttr2 = ((WEB3OptionsCloseMarginGroup)l_obj2).incomeCost; 
		}
        else
        {
    ...
    public boolean equals(Object l_obj)
    {
        ...
        if (l_obj instanceof WEB3OptionsProfitAndLossCostComparator)
        {
			WEB3OptionsProfitAndLossCostComparator l_comparator =
                (WEB3OptionsProfitAndLossCostComparator)l_obj;
