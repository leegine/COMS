...
File Name        : 株価指数オプション取消注文確認レスポンス(WEB3OptionsCancelConfirmResponse.java)
...
Revesion History : 2007/06/21 孟亜南 (中訊) モデルNo.711
*/
...
/**
 * (株価指数オプション取消注文確認レスポンス)<BR>
 * 株価指数オプション取消注文確認レスポンスクラス<BR>
 * @@author 鄒鋭
 * @@version 1.0
 */
