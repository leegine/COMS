...
File Name        : 株価指数先物訂正返済入力サービスインタセプタ(WEB3FuturesChangeClosingContractInputServiceInterceptor.java)
...
public class WEB3FuturesChangeClosingContractInputServiceInterceptor implements Interceptor 
{
    ...
    public Object onCall(Method l_method, Object[] l_serviceParam) 
    {
        ...
        try
        {
            ...
            log.debug("銘柄ＩＤを取得しました。ProductId = " + l_ProductId);
            //先物OP銘柄マネージャを取得する   
        ...
        {
            log.error("業務アプリケーションで使用するシステムエラーの例外");
            throw new WEB3BaseRuntimeException(
                l_ex.getErrorInfo(),
                this.getClass().getName() + "." + STR_METHOD_NAME,                    
                l_ex.toString(),
