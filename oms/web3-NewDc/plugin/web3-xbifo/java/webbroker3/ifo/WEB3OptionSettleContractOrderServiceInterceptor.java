...
File Name        : OP返済注文サービスインタセプタ(WEB3OptionSettleContractOrderServiceInterceptor.java)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/06/24 張宝楠 (中訊) 新規作成
Revesion History : 2008/04/14 張騰宇(中訊) モデル849
*/
...
public class WEB3OptionSettleContractOrderServiceInterceptor implements Interceptor
{
     ...
     * <BR>
     * ３）　@リクエストデータの型が「株価指数オプション返済注文完了リクエスト」の場合のみ、<BR>
     * 口座をロックする。<BR>
