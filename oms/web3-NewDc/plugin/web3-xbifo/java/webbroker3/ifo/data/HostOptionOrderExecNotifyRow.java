...
filename	HostOptionOrderExecNotifyRow.java;
...
/** 
 * HostOptionOrderExecNotifyRowインタフェースは変更不可でリードオンリーである<em>host_option_order_exec_notify</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostOptionOrderExecNotifyRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostOptionOrderExecNotifyRow extends Row {


  /** 
   * この{@@link HostOptionOrderExecNotifyRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_option_order_exec_notify", "session" );
