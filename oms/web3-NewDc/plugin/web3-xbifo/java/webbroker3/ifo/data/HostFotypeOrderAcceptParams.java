...
filename	HostFotypeOrderAcceptParams.java;
...
/** 
 * host_fotype_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostFotypeOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostFotypeOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostFotypeOrderAcceptParams}が{@@link HostFotypeOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostFotypeOrderAcceptParams extends Params implements HostFotypeOrderAcceptRow {
  ...
  public static final RowType TYPE = HostFotypeOrderAcceptRow.TYPE;
  ...
  /** 
   * 値が未設定のHostFotypeOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostFotypeOrderAcceptParams() {
  ...
  /** 
   * 指定のHostFotypeOrderAcceptRowオブジェクトの値を利用してHostFotypeOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostFotypeOrderAcceptRowオブジェクト 
   */
  public HostFotypeOrderAcceptParams( HostFotypeOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostFotypeOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostFotypeOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostFotypeOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostFotypeOrderAcceptRow row )
  {
  ...
  {
    return new HostFotypeOrderAcceptPK(rowid);
  }
