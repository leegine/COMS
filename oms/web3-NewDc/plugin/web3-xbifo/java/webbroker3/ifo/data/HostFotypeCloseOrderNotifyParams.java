...
/** 
 * host_fotype_close_order_notifyテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostFotypeCloseOrderNotifyRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostFotypeCloseOrderNotifyParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostFotypeCloseOrderNotifyParams}が{@@link HostFotypeCloseOrderNotifyRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class HostFotypeCloseOrderNotifyParams extends Params implements HostFotypeCloseOrderNotifyRow {
  ...
  /** 
   * 値が未設定のHostFotypeCloseOrderNotifyParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のHostFotypeCloseOrderNotifyRowオブジェクトの値を利用してHostFotypeCloseOrderNotifyParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostFotypeCloseOrderNotifyRowオブジェクト 
   */
   ...
   * @@param row 比較対照のHostFotypeCloseOrderNotifyRow 
