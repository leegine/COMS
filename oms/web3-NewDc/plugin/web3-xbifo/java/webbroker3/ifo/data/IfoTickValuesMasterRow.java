...
filename	IfoTickValuesMasterRow.java;
...
/** 
 * IfoTickValuesMasterRowインタフェースは変更不可でリードオンリーである<em>ifo_tick_values_master</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link IfoTickValuesMasterRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface IfoTickValuesMasterRow extends Row {


  /** 
   * この{@@link IfoTickValuesMasterRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ifo_tick_values_master", "master" );
