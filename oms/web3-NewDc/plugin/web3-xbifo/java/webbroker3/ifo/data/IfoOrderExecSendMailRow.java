...
filename	IfoOrderExecSendMailRow.java;
...
/** 
 * IfoOrderExecSendMailRowインタフェースは変更不可でリードオンリーである<em>ifo_order_exec_send_mail</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link IfoOrderExecSendMailRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface IfoOrderExecSendMailRow extends Row {


  /** 
   * この{@@link IfoOrderExecSendMailRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ifo_order_exec_send_mail", "session" );
   ...
   * @@return intの値 
   */
  public int getExecutionConditionType();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getExecutionConditionTypeIsNull();
