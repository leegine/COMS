...
filename	IfoTickValuesMasterPK.java;
...
/** 
 * <b>IfoTickValuesMaster</b>データベーステーブルで一意である1つのレコードをあらわす<b>IfoTickValuesMaster</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>IfoTickValuesMaster</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class IfoTickValuesMasterPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: IfoTickValuesMasterRow. 
   */
   ...
   */
  public IfoTickValuesMasterPK( String p_targetProductCode, String p_futureOptionDiv, double p_lowPrice ) {
   ...
   */
  public static IfoTickValuesMasterPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    IfoTickValuesMasterPK pk = new IfoTickValuesMasterPK();
  ...
  {
    if ( other == null || !( other instanceof IfoTickValuesMasterPK) )
      return false;
    IfoTickValuesMasterPK o = (IfoTickValuesMasterPK) other;
