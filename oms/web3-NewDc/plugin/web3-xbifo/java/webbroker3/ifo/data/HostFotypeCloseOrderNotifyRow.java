...
filename	HostFotypeCloseOrderNotifyRow.java;
...
/** 
 * HostFotypeCloseOrderNotifyRowインタフェースは変更不可でリードオンリーである<em>host_fotype_close_order_notify</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostFotypeCloseOrderNotifyRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostFotypeCloseOrderNotifyRow extends Row {


  /** 
   * この{@@link HostFotypeCloseOrderNotifyRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_fotype_close_order_notify", "session" );
