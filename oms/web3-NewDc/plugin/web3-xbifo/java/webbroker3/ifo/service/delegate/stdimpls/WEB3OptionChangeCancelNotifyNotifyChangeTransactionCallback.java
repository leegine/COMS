...
filename	WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback.java;
...
File Name        : OP訂正取消通知訂正通知一件TransactionCallback(WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback.java)
...
/**
 * （OP訂正取消通知訂正通知一件TransactionCallback）。<BR>
 * <BR>
 * トランザクション処理を実施する内部クラス。<BR>
 * @@author 李志強
 * @@version 1.0
 */
public class WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback implements TransactionCallback
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback.class);
     ...
     */
    public WEB3OptionChangeCancelNotifyNotifyChangeTransactionCallback(
        ...
        throws DataQueryException, DataNetworkException, DataCallbackException
    {
        ...
        try
        {
            ...
            l_optionChangeCancelNotifyUnitService.notifyChange(
                l_orderUnit,
