...
filename	WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback.java;
...
File Name        : 先物訂正取消通知取消通知一件TransactionCallback(WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback.java)
...
/**
 * （先物訂正取消通知取消通知一件TransactionCallback）。<BR>
 * <BR>
 * トランザクション処理を実施する内部クラス。<BR>
 * @@author 李志強
 * @@version 1.0
 */
public class WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback implements TransactionCallback
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback.class);
     ...
     */
    public WEB3FuturesChangeCancelNotifyNotifyCancelTransactionCallback(
        ...
        throws DataQueryException, DataNetworkException, DataCallbackException
    {
        ...
        try
        {
            ...
            l_strStatus = l_futuresChangeCancelNotifyUnitService.notifyCancel(
                l_orderUnit,
