...
1.1
date	2011.03.14.03.39.30;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EqtypeContractParams.java;
...
/** 
 * eqtype_contractテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link EqtypeContractRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link EqtypeContractParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link EqtypeContractParams}が{@@link EqtypeContractRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class EqtypeContractParams extends Params implements EqtypeContractRow {
  ...
  public static final RowType TYPE = EqtypeContractRow.TYPE;
  ...
  /** 
   * <em>original_setup_fee</em>カラムの値 
   */
  public  double  original_setup_fee;
  ...
  /** 
   * <em>original_setup_fee_tax</em>カラムの値 
   */
  public  double  original_setup_fee_tax;
  ...
  private boolean original_setup_fee_is_set = false;
  private boolean original_setup_fee_is_modified = false;
  private boolean setup_fee_is_set = false;
  private boolean setup_fee_is_modified = false;
  private boolean original_setup_fee_tax_is_set = false;
  private boolean original_setup_fee_tax_is_modified = false;
  ...
  public String toString() {
    return "{"
      ...
      + "," + "original_setup_fee=" +original_setup_fee
      + "," + "setup_fee=" +setup_fee
      + "," + "original_setup_fee_tax=" +original_setup_fee_tax
  ...
  /** 
   * 値が未設定のEqtypeContractParamsオブジェクトを作成します。 
   */
  public EqtypeContractParams() {
  ...
  /** 
   * 指定のEqtypeContractRowオブジェクトの値を利用してEqtypeContractParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するEqtypeContractRowオブジェクト 
   */
  public EqtypeContractParams( EqtypeContractRow p_row )
  {
    ...
    original_setup_fee = p_row.getOriginalSetupFee();
    original_setup_fee_is_set = p_row.getOriginalSetupFeeIsSet();
    original_setup_fee_is_modified = p_row.getOriginalSetupFeeIsModified();
    setup_fee = p_row.getSetupFee();
    setup_fee_is_set = p_row.getSetupFeeIsSet();
    setup_fee_is_modified = p_row.getSetupFeeIsModified();
    original_setup_fee_tax = p_row.getOriginalSetupFeeTax();
    original_setup_fee_tax_is_set = p_row.getOriginalSetupFeeTaxIsSet();
    original_setup_fee_tax_is_modified = p_row.getOriginalSetupFeeTaxIsModified();
   ...
   */
    public void markAllValuesAsSet() {
      ...
      original_setup_fee_is_set = true;
      original_setup_fee_is_modified = true;
      setup_fee_is_set = true;
      setup_fee_is_modified = true;
      original_setup_fee_tax_is_set = true;
      original_setup_fee_tax_is_modified = true;
  ...
  {
    if ( !( other instanceof EqtypeContractRow ) )
       return false;
    return fieldsEqual( (EqtypeContractRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のEqtypeContractRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( EqtypeContractRow row )
  {
    ...
    if ( original_setup_fee != row.getOriginalSetupFee() )
      return false;
    if ( setup_fee != row.getSetupFee() )
      return false;
    if ( original_setup_fee_tax != row.getOriginalSetupFeeTax() )
      return false;
  ...
  public int hashCode() {
      return  ((int) contract_id)
        ...
        + ((int) original_setup_fee)
        + ((int) setup_fee)
        + ((int) original_setup_fee_tax)
        + ((int) setup_fee_tax)
   ...
   */
	public java.util.Map toInsertMap() {
		...
		if ( original_setup_fee_is_set )
			map.put("original_setup_fee",new Double(original_setup_fee));
		if ( setup_fee_is_set )
			map.put("setup_fee",new Double(setup_fee));
		if ( original_setup_fee_tax_is_set )
			map.put("original_setup_fee_tax",new Double(original_setup_fee_tax));
   ...
   */
	public java.util.Map toUpdateMap() {
		...
		if ( close_date_is_modified )
			map.put("close_date",close_date);
		if ( original_setup_fee_is_modified )
			map.put("original_setup_fee",new Double(original_setup_fee));
		if ( setup_fee_is_modified )
			map.put("setup_fee",new Double(setup_fee));
		if ( original_setup_fee_tax_is_modified )
			map.put("original_setup_fee_tax",new Double(original_setup_fee_tax));
  ...
  /** 
   * <em>original_setup_fee</em>カラムの値を取得します。
   * @@return doubleの値 
   */
  public final double getOriginalSetupFee()
  {
    return original_setup_fee;
  }


  /** 
   * <em>original_setup_fee</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOriginalSetupFeeIsSet() {
    return original_setup_fee_is_set;
  }


  /** 
   * <em>original_setup_fee</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOriginalSetupFeeIsModified() {
    return original_setup_fee_is_modified;
  }
  ...
  /** 
   * <em>original_setup_fee_tax</em>カラムの値を取得します。
   * @@return doubleの値 
   */
  public final double getOriginalSetupFeeTax()
  {
    return original_setup_fee_tax;
  }


  /** 
   * <em>original_setup_fee_tax</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOriginalSetupFeeTaxIsSet() {
    return original_setup_fee_tax_is_set;
  }


  /** 
   * <em>original_setup_fee_tax</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOriginalSetupFeeTaxIsModified() {
    return original_setup_fee_tax_is_modified;
  }
  ...
  {
    return new EqtypeContractPK(contract_id);
  }
  ...
  /** 
   * <em>original_setup_fee</em>カラムの値を設定します。 
   *
   * @@param p_originalSetupFee <em>original_setup_fee</em>カラムの値をあらわす18桁以下のdouble値で、その精度は6桁まで
   */
  public final void setOriginalSetupFee( double p_originalSetupFee )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    original_setup_fee = p_originalSetupFee;
    original_setup_fee_is_set = true;
    original_setup_fee_is_modified = true;
  }
  ...
  /** 
   * <em>original_setup_fee_tax</em>カラムの値を設定します。 
   *
   * @@param p_originalSetupFeeTax <em>original_setup_fee_tax</em>カラムの値をあらわす18桁以下のdouble値で、その精度は6桁まで
   */
  public final void setOriginalSetupFeeTax( double p_originalSetupFeeTax )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    original_setup_fee_tax = p_originalSetupFeeTax;
    original_setup_fee_tax_is_set = true;
    original_setup_fee_tax_is_modified = true;
  }
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                ...
                break;
            case 'f':
                if ( name.equals("first_open_date") ) {
            ...
            case 'o':
                ...
                else if ( name.equals("original_setup_fee") ) {
                    return new Double( original_setup_fee );
                }
                else if ( name.equals("original_setup_fee_tax") ) {
                    return new Double( original_setup_fee_tax );
                }
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'o':
                if ( name.equals("original_quantity") ) {
                    ...
                    if ( !(value instanceof Double) )
                        throw new IllegalArgumentException( "value for 'original_setup_fee' must be Double: '"+value+"' is not." );
                    this.original_setup_fee = ((Double) value).doubleValue();
                    if (this.original_setup_fee_is_set)
                        this.original_setup_fee_is_modified = true;
                    this.original_setup_fee_is_set = true;
                    return;
                }
                else if ( name.equals("original_setup_fee_tax") ) {
                    if ( !(value instanceof Double) )
                        throw new IllegalArgumentException( "value for 'original_setup_fee_tax' must be Double: '"+value+"' is not." );
                    this.original_setup_fee_tax = ((Double) value).doubleValue();
                    if (this.original_setup_fee_tax_is_set)
                        this.original_setup_fee_tax_is_modified = true;
                    this.original_setup_fee_tax_is_set = true;
                    return;
                }
                else if ( name.equals("other") ) {
                    if ( value != null )
