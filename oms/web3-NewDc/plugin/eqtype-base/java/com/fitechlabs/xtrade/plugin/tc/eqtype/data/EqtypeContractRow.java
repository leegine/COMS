...
1.1
date	2011.03.14.03.37.10;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EqtypeContractRow.java;
...
/** 
 * EqtypeContractRowインタフェースは変更不可でリードオンリーである<em>eqtype_contract</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EqtypeContractRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface EqtypeContractRow extends Row {


  /** 
   * この{@@link EqtypeContractRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "eqtype_contract", "account" );
   ...
   * @@return doubleの値 
   */
  public double getOriginalSetupFee();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalSetupFeeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalSetupFeeIsModified();
   ...
   * @@return doubleの値 
   */
  public double getOriginalSetupFeeTax();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalSetupFeeTaxIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalSetupFeeTaxIsModified();
