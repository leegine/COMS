...
1.1
date	2011.03.14.03.38.12;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * EqtypeOrderRowインタフェースは変更不可でリードオンリーである<em>eqtype_order</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EqtypeOrderRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see EqtypeOrderPK 
 */
public interface EqtypeOrderRow extends Row {


  /** 
   * この{@@link EqtypeOrderRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "eqtype_order", "account" );
