...
1.1
date	2011.03.14.03.38.45;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EqtypeClosingContractSpecRow.java;
...
/** 
 * EqtypeClosingContractSpecRowインタフェースは変更不可でリードオンリーである<em>eqtype_closing_contract_spec</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EqtypeClosingContractSpecRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface EqtypeClosingContractSpecRow extends Row {


  /** 
   * この{@@link EqtypeClosingContractSpecRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "eqtype_closing_contract_spec", "account" );
   ...
   */
  public  boolean  getClosingContractSpecIdIsSet();
   ...
   */
  public  boolean  getClosingContractSpecIdIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getClosingSerialNoIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getClosingSerialNoIsModified();
