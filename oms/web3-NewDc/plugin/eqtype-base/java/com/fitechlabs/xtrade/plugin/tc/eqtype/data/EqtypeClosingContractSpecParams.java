...
1.1
date	2011.03.14.03.38.57;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EqtypeClosingContractSpecParams.java;
...
/** 
 * eqtype_closing_contract_specテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link EqtypeClosingContractSpecRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link EqtypeClosingContractSpecParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link EqtypeClosingContractSpecParams}が{@@link EqtypeClosingContractSpecRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class EqtypeClosingContractSpecParams extends Params implements EqtypeClosingContractSpecRow {
  ...
  public static final RowType TYPE = EqtypeClosingContractSpecRow.TYPE;
  ...
  /** 
   * 値が未設定のEqtypeClosingContractSpecParamsオブジェクトを作成します。 
   */
  public EqtypeClosingContractSpecParams() {
  ...
  /** 
   * 指定のEqtypeClosingContractSpecRowオブジェクトの値を利用してEqtypeClosingContractSpecParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するEqtypeClosingContractSpecRowオブジェクト 
   */
  public EqtypeClosingContractSpecParams( EqtypeClosingContractSpecRow p_row )
  {
  ...
  {
    if ( !( other instanceof EqtypeClosingContractSpecRow ) )
       return false;
    return fieldsEqual( (EqtypeClosingContractSpecRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のEqtypeClosingContractSpecRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( EqtypeClosingContractSpecRow row )
  {
  ...
  {
    return new EqtypeClosingContractSpecPK(closing_contract_spec_id);
  }
