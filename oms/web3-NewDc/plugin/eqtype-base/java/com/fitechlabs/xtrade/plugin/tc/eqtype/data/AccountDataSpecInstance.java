...
1.1
date	2011.03.14.03.38.24;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public class AccountDataSpecInstance extends DataSpec {
  ...
  private static final ColumnSpec eqtype_fin_transaction_columns[] = {
    ...
    new ColumnSpec("order_id",java.sql.Types.NUMERIC,18,0,true,false,"eqtype_order","order_id"),
    new ColumnSpec("order_unit_id",java.sql.Types.NUMERIC,18,0,true,false,"eqtype_order_unit","order_unit_id"),
    new ColumnSpec("order_execution_id",java.sql.Types.NUMERIC,18,0,true,false,"eqtype_order_execution","order_execution_id"),
    ...
    new ColumnSpec("imported_name_transfer_fee",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("imported_name_transfer_fee_tax",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    ...
    new ColumnSpec("contract_id",java.sql.Types.NUMERIC,18,0,true,false,"eqtype_contract","contract_id"),
    ...
    new ColumnSpec("imported_pay_interest_fee",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("imported_pay_interest_fee_tax",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("imported_loan_equity_fee",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    new ColumnSpec("imported_other",java.sql.Types.DECIMAL,18,6,true,false,null,null),
    ...
    new ColumnSpec("capital_gain_status",java.sql.Types.VARCHAR,1,0,false,false,null,null),
  };
  private static final ColumnSpec eqtype_order_columns[] = {
  ...
  private static final ColumnSpec eqtype_order_unit_columns[] = {
    ...
    new ColumnSpec("order_id",java.sql.Types.NUMERIC,18,0,false,false,"eqtype_order","order_id"),
  ...
  private static final ColumnSpec eqtype_order_action_columns[] = {
    new ColumnSpec("order_action_id",java.sql.Types.NUMERIC,18,0,false,true,null,null),
    new ColumnSpec("account_id",java.sql.Types.NUMERIC,18,0,false,false,"sub_account","account_id"),
    new ColumnSpec("sub_account_id",java.sql.Types.NUMERIC,18,0,false,false,"sub_account","sub_account_id"),
    new ColumnSpec("trader_id",java.sql.Types.NUMERIC,18,0,true,false,"trader","trader_id"),
    new ColumnSpec("order_id",java.sql.Types.NUMERIC,18,0,false,false,"eqtype_order","order_id"),
    new ColumnSpec("order_unit_id",java.sql.Types.NUMERIC,18,0,false,false,"eqtype_order_unit","order_unit_id"),
    new ColumnSpec("market_id",java.sql.Types.NUMERIC,18,0,true,false,"market","market_id"),
    new ColumnSpec("order_type",java.sql.Types.NUMERIC,6,0,false,false,null,null),
  ...
  private static final ColumnSpec eqtype_order_execution_columns[] = {
  ...
  private static final ColumnSpec eqtype_locked_contract_details_columns[] = {
    new ColumnSpec("contract_id",java.sql.Types.NUMERIC,18,0,false,true,"eqtype_contract","contract_id"),
    new ColumnSpec("account_id",java.sql.Types.NUMERIC,18,0,false,false,"sub_account","account_id"),
    new ColumnSpec("sub_account_id",java.sql.Types.NUMERIC,18,0,false,false,"sub_account","sub_account_id"),
  ...
  private static final ColumnSpec eqtype_contract_columns[] = {
    ...
    new ColumnSpec("original_setup_fee",java.sql.Types.DECIMAL,18,6,false,false,null,null),
    new ColumnSpec("setup_fee",java.sql.Types.DECIMAL,18,6,false,false,null,null),
    new ColumnSpec("original_setup_fee_tax",java.sql.Types.DECIMAL,18,6,false,false,null,null),
  ...
  private static final ColumnSpec eqtype_closing_contract_spec_columns[] = {
  ...
  private static final TableSpec tables[] = {
    new TableSpec("eqtype_fin_transaction",eqtype_fin_transaction_columns,"inv=?.account_id"),
    new TableSpec("eqtype_order",eqtype_order_columns,"inv=?.account_id"),
    new TableSpec("eqtype_order_unit",eqtype_order_unit_columns,"inv=?.account_id"),
    new TableSpec("eqtype_order_action",eqtype_order_action_columns,"inv=?.account_id"),
    new TableSpec("eqtype_order_execution",eqtype_order_execution_columns,"inv=?.account_id"),
    new TableSpec("eqtype_locked_contract_details",eqtype_locked_contract_details_columns,"inv=?.account_id"),
    new TableSpec("eqtype_contract",eqtype_contract_columns,"inv=?.account_id"),
    new TableSpec("eqtype_closing_contract_spec",eqtype_closing_contract_spec_columns,"inv=?.account_id"),
  };
