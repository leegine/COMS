...
1.1
date	2011.03.14.03.37.35;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EqtypeProductRow.java;
...
/** 
 * EqtypeProductRowインタフェースは変更不可でリードオンリーである<em>eqtype_product</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EqtypeProductRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see EqtypeProductPK 
 */
public interface EqtypeProductRow extends Row {


  /** 
   * この{@@link EqtypeProductRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "eqtype_product", "master" );
   ...
   */
  public  boolean  getMiniStockLotSizeIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMiniStockLotSizeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMiniStockLotSizeIsModified();
   ...
   */
  public java.sql.Timestamp getYearlyBooksClosingDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getYearlyBooksClosingDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getYearlyBooksClosingDateIsModified();
   ...
   * @@return intの値 
   */
  public int getMarginSysTradeStop();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getMarginSysTradeStopIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMarginSysTradeStopIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMarginSysTradeStopIsModified();
   ...
   * @@return intの値 
   */
  public int getMarginGenTradeStop();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getMarginGenTradeStopIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMarginGenTradeStopIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMarginGenTradeStopIsModified();
   ...
   */
  public com.fitechlabs.xtrade.plugin.tc.gentrade.BooleanEnum getDecimalDevideFlag();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDecimalDevideFlagIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDecimalDevideFlagIsModified();
