...
/** 
 * ApManagementRowインタフェースは変更不可でリードオンリーである<em>ap_management</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link ApManagementRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see ApManagementPK 
 */
public interface ApManagementRow extends Row {


  /** 
   * この{@@link ApManagementRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ap_management", "master" );
   ...
   */
  public  boolean  getPtypeIsModified();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApNameIsModified();
   ...
   * @@return Stringの値 
   */
  public String getThreadNumberDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getThreadNumberDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getThreadNumberDivIsModified();
