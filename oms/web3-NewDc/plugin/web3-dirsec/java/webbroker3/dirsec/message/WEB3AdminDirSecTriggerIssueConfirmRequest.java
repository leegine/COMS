...
1.1
date	2011.03.14.05.12.48;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminDirSecTriggerIssueConfirmRequest.java;
...
File Name        : 管理者・トリガー発行処理確認リクエスト(WEB3AdminDirSecTriggerIssueConfirmRequest.java)
 ...
 * @@version 1.0
 */
public class WEB3AdminDirSecTriggerIssueConfirmRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminDirSecTriggerIssueConfirmRequest.class);

    /**
     * PTYPE<BR>
     */
    public static final String PTYPE = "admin_dir_sec_trigger_issue_confirm";

    /**
     * serialVersionUID<BR>
     */
    public static final long serialVersionUID = 200804171430L;
    ...
    /**
     * @@roseuid 4806E054011B
     */
    public WEB3AdminDirSecTriggerIssueConfirmRequest()
    {
    ...
    {
        return new WEB3AdminDirSecTriggerIssueConfirmResponse(this);
    }
}
@
