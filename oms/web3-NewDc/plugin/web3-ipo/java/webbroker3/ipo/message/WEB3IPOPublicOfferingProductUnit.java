...
1.1
date	2011.03.15.05.42.08;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3IPOPublicOfferingProductUnit.java;
...
File Name        : IPO公開銘柄明細メッセージデータ(WEB3IPOPublicOfferingProductUnit.java)
...
/**
 * IPO公開銘柄明細メッセージデータクラス
 *                                                                
 * @@author 張威
 * @@version 1.0
 */
public class WEB3IPOPublicOfferingProductUnit extends Message
{
    ...
    /**
     * デフォルトコンストラクタ
     * @@roseuid 40D2AE2C014F
     */
    public WEB3IPOPublicOfferingProductUnit() 
    {
