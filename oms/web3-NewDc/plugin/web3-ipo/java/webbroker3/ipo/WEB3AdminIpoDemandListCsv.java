...
1.1
date	2011.03.15.05.44.47;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminIpoDemandListCsv.java;
...
File Name        : ブックビルディング状況CSV(WEB3AdminIpoDemandListCsv.java)
 ...
 * @@version 1.0
 */
public class WEB3AdminIpoDemandListCsv extends WEB3GentradeCsvDataModel 
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3AdminIpoDemandListCsv.class);
    ...
    /**
     * @@roseuid 4112FAC3011F
     */
    public WEB3AdminIpoDemandListCsv() 
    {
     ...
     * 
     * @@roseuid 40E2386C0037
     */
    public WEB3AdminIpoDemandListCsv(WEB3IpoProductImpl l_ipoProduct) throws WEB3BaseException
    {
        super();
     ...
     * 　@項目ラベル：　@ブックビルディング状況CSV.部店コードラベル<BR>
     * 　@カラム番号： 0<BR>
     ...
     * －　@index = 1<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.扱者コードラベル<BR>
     * 　@カラム番号： 1<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_文字列<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 2<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.顧客コードラベル<BR>
     * 　@カラム番号： 2<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_文字列<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 3<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.顧客名ラベル<BR>
     * 　@カラム番号： 3<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_文字列<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 4<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.新規申告日時ラベル<BR>
     * 　@カラム番号： 4<BR>
     ...
     * －　@index = 5<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.申告数量ラベル<BR>
     * 　@カラム番号： 5<BR>
     ...
     * －　@index = 6<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.申告価格ラベル<BR>
     * 　@カラム番号： 6<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_数値（double）<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 7<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.指値／成行ラベル<BR>
     * 　@カラム番号： 7<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_文字列<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 8<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.基準値ラベル<BR>
     * 　@カラム番号： 8<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_数値（double）<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 9<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.申告相当額ラベル<BR>
     * 　@カラム番号： 9<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_数値（double）<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 10<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.出金余力ラベル<BR>
     * 　@カラム番号： 10<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_数値（double）<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 11<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.申告額保持者ラベル<BR>
     * 　@カラム番号： 11<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_文字列<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * －　@index = 12<BR>
     * 　@[CSVカラムモデル コンストラクタの引数]<BR>
     * 　@項目ラベル：　@ブックビルディング状況CSV.申告状態ラベル<BR>
     * 　@カラム番号： 12<BR>
     * 　@項目型：　@CSVカラムモデル.項目型_文字列<BR>
     * 　@日付フォーマット：　@null<BR>
     * <BR>
     * <BR>
     * @@roseuid 40E2584C02D7
     */
    private void createColumnHeader() 
    {
        ...
        WEB3GentradeCsvColumnModel[] columnHeader = new WEB3GentradeCsvColumnModel[13];
        ...
        columnHeader[5] = 
            new WEB3GentradeCsvColumnModel(ORDER_QUANTITY_LABEL, 5, WEB3GentradeCsvColumnModel.DOUBLETYPE, null);
        columnHeader[6] = 
        ...
        columnHeader[7] = 
            new WEB3GentradeCsvColumnModel(
                ...
                null);
        columnHeader[8] = 
            new WEB3GentradeCsvColumnModel(BASE_PRICE_LABEL, 8, WEB3GentradeCsvColumnModel.DOUBLETYPE, null);
        columnHeader[9] = 
            new WEB3GentradeCsvColumnModel(BOOKBUILDING_PRICE_LABEL, 9, WEB3GentradeCsvColumnModel.DOUBLETYPE, null);
        columnHeader[10] = 
            new WEB3GentradeCsvColumnModel(TRADING_POWER_LABEL, 10, WEB3GentradeCsvColumnModel.DOUBLETYPE, null);
        columnHeader[11] = 
            new WEB3GentradeCsvColumnModel(TRADING_POWER_CHECK, 11, WEB3GentradeCsvColumnModel.STRINGTYPE, null);
        columnHeader[12] = 
            new WEB3GentradeCsvColumnModel(ORDER_STATUS_LABEL, 12, WEB3GentradeCsvColumnModel.STRINGTYPE, null);
...
//			String l_strName = l_mainAccountRow.getFamilyName() + " " + l_mainAccountRow.getGivenName();
     ...
     * 　@カラム：　@１）で取得したカラムモデル<BR>
     * 　@値：　@<BR>
     * 　@　@（引数の指値 == 0）の場合、ブックビルディング状況CSV.成行表示。<BR>
     * 　@　@以外、ブックビルディング状況CSV.指値表示。<BR>
     * <BR>
     * @@param l_intLineNumber - 行番号を指定する。
     ...
     * 　@値：　@<BR>
     * 　@　@（申告相当額 <= 出金余力）の場合、<BR>
     * ブックビルディング状況CSV.申告額保持者_OK表示。<BR>
     * 　@　@以外、ブックビルディング状況CSV.申告額保持者_OK表示。<BR>
     * <BR>
     * @@param l_intLineNumber - 行番号を指定する。
     * @@param l_dblBookbuildingPrice - 申告相当額
     * @@param l_dblTradingPower - 出金余力
     ...
     * 　@値：　@<BR>
     * 　@　@（ブックビルディング申告状態 == 
     * OrderStatusEnum.ORDERED）の場合、<BR>ブックビルディング状況CSV.申告状態_新規表示。<BR>
     * 　@　@（ブックビルディング申告状態 == 
     * OrderStatusEnum.MODIFIED）の場合、<BR>ブックビルディング状況CSV.申告状態_訂正表示。<BR>
     * 　@　@（ブックビルディング申告状態 == 
     * OrderStatusEnum.CANCELLED）の場合、<BR>ブックビルディング状況CSV.申告状態_取消表示。<BR>
     * <BR>
     * @@param l_intLineNumber - 行番号を指定する。
     * @@param l_bookbuildingOrderStatus - ブックビルディング申告状態
