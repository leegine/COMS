...
1.1
date	2011.03.22.08.01.04;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3PointCommissionInfoReferenceServiceInterceptor.java;
...
File Name        : 株式手数料無料情報照会サービスインタセプタ(WEB3PointCommissionInfoReferenceServiceInterceptor.java)
...
/**
 * (株式手数料無料情報照会サービスインタセプタ)<BR>
 * 株式手数料無料情報照会サービスインタセプタクラス<BR>
 * 
 * @@author 張学剛
 * @@version 1.0
 */
public class WEB3PointCommissionInfoReferenceServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3PointCommissionInfoReferenceServiceInterceptor.class);

    /**
     * @@roseuid 421D7B3801F4
     */
    public WEB3PointCommissionInfoReferenceServiceInterceptor() 
    {
