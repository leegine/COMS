...
1.1
date	2011.03.22.08.01.17;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3PointExchangeApplyServiceInterceptor.java;
...
File Name        : ポイント交換申込サービスインタセプタ(WEB3PointExchangeApplyServiceInterceptor.java)
...
/**
 * (ポイント交換申込サービスインタセプタ)<BR>
 * ポイント交換申込サービスインタセプタクラス<BR>
 *
 * @@author 鄭海良
 * @@version 1.0
 */
public class WEB3PointExchangeApplyServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
            WEB3LogUtility.getInstance(WEB3PointExchangeApplyServiceInterceptor.class);
     ...
     * 　@取引カレンダコンテキスト.受付時間区分 = ”21：ポイントシステム” <BR>
    ...
    public Object onCall(Method l_method, Object[] l_serviceParams) 
    {
        ...
        try
        {
            ...
            //取引カレンダコンテキスト.受付時間区分 = ”21：ポイントシステム”
            l_context.setTradingTimeType(WEB3TradingTimeTypeDef.POINT_SYSTEM);
