...
1.1
date	2011.03.22.07.49.18;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	PointTradeDataRow.java;
...
/** 
 * PointTradeDataRowインタフェースは変更不可でリードオンリーである<em>point_trade_data</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link PointTradeDataRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface PointTradeDataRow extends Row {


  /** 
   * この{@@link PointTradeDataRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "point_trade_data", "master" );
   ...
   */
  public  boolean  getCommAmtIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getGetPointIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getGetPointIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getGetPointIsModified();
