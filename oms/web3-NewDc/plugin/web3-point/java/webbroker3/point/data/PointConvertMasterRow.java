...
1.1
date	2011.03.22.07.51.28;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	PointConvertMasterRow.java;
...
/** 
 * PointConvertMasterRowインタフェースは変更不可でリードオンリーである<em>point_convert_master</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link PointConvertMasterRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface PointConvertMasterRow extends Row {


  /** 
   * この{@@link PointConvertMasterRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "point_convert_master", "master" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTranTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTranTypeIsModified();
   ...
   */
  public  boolean  getConvertBaseIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getConvertBaseIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getConvertBaseIsModified();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getConvertValueIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getConvertValueIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getConvertValueIsModified();
   ...
   */
  public java.sql.Timestamp getSpecialTermStart();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialTermStartIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialTermStartIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getSpecialTermEnd();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialTermEndIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialTermEndIsModified();
   ...
   * @@return doubleの値 
   */
  public double getSpecialConvertBase();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getSpecialConvertBaseIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialConvertBaseIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialConvertBaseIsModified();
   ...
   * @@return doubleの値 
   */
  public double getSpecialConvertValue();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getSpecialConvertValueIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialConvertValueIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpecialConvertValueIsModified();
