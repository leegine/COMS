...
1.1
date	2011.03.22.07.49.14;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * PointApplyRowインタフェースは変更不可でリードオンリーである<em>point_apply</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link PointApplyRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see PointApplyPK 
 */
public interface PointApplyRow extends Row {


  /** 
   * この{@@link PointApplyRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "point_apply", "master" );
   ...
   */
  public  boolean  getApplyIdIsSet();
   ...
   */
  public  boolean  getApplyIdIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPremiumNoIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPremiumNoIsModified();
   ...
   */
  public  boolean  getUsedPointIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getUsedPointIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getUsedPointIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyTimestampIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyRootDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyRootDivIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyAcceptDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyAcceptDivIsModified();
   ...
   * @@return Stringの値 
   */
  public String getApplyAcceptUser();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyAcceptUserIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyAcceptUserIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getApplyAcceptTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyAcceptTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyAcceptTimestampIsModified();
   ...
   * @@return Stringの値 
   */
  public String getApplyCancelDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyCancelDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyCancelDivIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyCancelUserIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyCancelUserIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getApplyCancelTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyCancelTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getApplyCancelTimestampIsModified();
