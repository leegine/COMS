...
filename	HostFrgnMmfOrderAcceptParams.java;
...
/** 
 * host_frgn_mmf_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostFrgnMmfOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostFrgnMmfOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostFrgnMmfOrderAcceptParams}が{@@link HostFrgnMmfOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostFrgnMmfOrderAcceptParams extends Params implements HostFrgnMmfOrderAcceptRow {
  ...
  public static final String PTYPE = "host_frgn_mmf_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostFrgnMmfOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostFrgnMmfOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostFrgnMmfOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostFrgnMmfOrderAcceptParams() {
  ...
  /** 
   * 指定のHostFrgnMmfOrderAcceptRowオブジェクトの値を利用してHostFrgnMmfOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostFrgnMmfOrderAcceptRowオブジェクト 
   */
  public HostFrgnMmfOrderAcceptParams( HostFrgnMmfOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostFrgnMmfOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostFrgnMmfOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostFrgnMmfOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostFrgnMmfOrderAcceptRow row )
  {
  ...
  {
    return new HostFrgnMmfOrderAcceptPK(institution_code, branch_code, order_request_number);
  }
