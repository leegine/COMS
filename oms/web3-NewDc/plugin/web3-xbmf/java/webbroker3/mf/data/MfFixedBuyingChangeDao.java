...
/** 
 * {@@link MfFixedBuyingChangeDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link MfFixedBuyingChangeRow}インスタンスへ関連付けることができます。 
...
public class MfFixedBuyingChangeDao extends DataAccessObject {
  ...
  /** 
   * この{@@link MfFixedBuyingChangeDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link MfFixedBuyingChangeRow}と仮定される{@@link DataAccessObject}から新たに{@@link MfFixedBuyingChangeDao}を返します。 
         * @@return 指定のRowに結びつく{@@link MfFixedBuyingChangeDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link MfFixedBuyingChangeRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link MfFixedBuyingChangeRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link MfFixedBuyingChangeRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link MfFixedBuyingChangeRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link MfFixedBuyingChangeRow}オブジェクトから{@@link MfFixedBuyingChangeDao}オブジェクトを作成します。 
   * これは実際の{@@link MfFixedBuyingChangeRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link MfFixedBuyingChangeDao}取得のために指定の{@@link MfFixedBuyingChangeRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link MfFixedBuyingChangeDao}オブジェクト 
  ...
  /** 
   * {@@link MfFixedBuyingChangeRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link MfFixedBuyingChangeRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link MfFixedBuyingChangePK}やデータベースレコードとして挿入される{@@link MfFixedBuyingChangeParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link MfFixedBuyingChangeRow}を一意に特定する{@@link MfFixedBuyingChangePK}オブジェクトを生成します。 
   * このオブジェクトは{@@link MfFixedBuyingChangeRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link MfFixedBuyingChangeParams}オブジェクトの主キーとして利用可能な{@@link MfFixedBuyingChangePK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link MfFixedBuyingChangeRow}オブジェクトを検索します。 
   * 
   ...
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link MfFixedBuyingChangeRow} 
  ...
  /** 
   * 指定のMfFixedBuyingChangePKオブジェクトから{@@link MfFixedBuyingChangeRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するMfFixedBuyingChangePKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link MfFixedBuyingChangeRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String,String,String,java.sql.Timestamp)}および{@@link #forRow(MfFixedBuyingChangeRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(MfFixedBuyingChangePK)}および{@@link #forRow(MfFixedBuyingChangeRow)}を使用してください。 
   */
  ...
  /** 
   * p_institutionCode, p_branchCode, p_accountCode, p_productCode, p_validStartDate, and にて指定の値から一意の{@@link MfFixedBuyingChangeRow}オブジェクトを検索します。 
   ...
   * @@param p_validStartDate 検索対象であるp_validStartDateフィールドの値
   * 
   * @@return 引数指定のp_institutionCode, p_branchCode, p_accountCode, p_productCode, p_validStartDate, and の値と一致する{@@link MfFixedBuyingChangeRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByInstitutionCodeBranchCodeAccountCodeProductCodeValidStartDate(String, String, String, String, java.sql.Timestamp)}および{@@link #forRow(MfFixedBuyingChangeRow)}を使用してください。 
   */
