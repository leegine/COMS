...
filename	HostXbmfOrderAcceptParams.java;
...
/** 
 * host_xbmf_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostXbmfOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostXbmfOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostXbmfOrderAcceptParams}が{@@link HostXbmfOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostXbmfOrderAcceptParams extends Params implements HostXbmfOrderAcceptRow {
  ...
  public static final String PTYPE = "host_xbmf_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostXbmfOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostXbmfOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostXbmfOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostXbmfOrderAcceptParams() {
  ...
  /** 
   * 指定のHostXbmfOrderAcceptRowオブジェクトの値を利用してHostXbmfOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostXbmfOrderAcceptRowオブジェクト 
   */
  public HostXbmfOrderAcceptParams( HostXbmfOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostXbmfOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostXbmfOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostXbmfOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostXbmfOrderAcceptRow row )
  {
  ...
  {
    return new HostXbmfOrderAcceptPK(institution_code, branch_code, order_request_number);
  }
