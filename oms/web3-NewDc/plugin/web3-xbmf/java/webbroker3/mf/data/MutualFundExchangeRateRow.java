...
filename	MutualFundExchangeRateRow.java;
...
/** 
 * MutualFundExchangeRateRowインタフェースは変更不可でリードオンリーである<em>mutual_fund_exchange_rate</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link MutualFundExchangeRateRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface MutualFundExchangeRateRow extends Row {


  /** 
   * この{@@link MutualFundExchangeRateRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "mutual_fund_exchange_rate", "session" );
   ...
   * @@return doubleの値 
   */
  public double getExchangeCalcUnit();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getExchangeCalcUnitIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getExchangeCalcUnitIsModified();
