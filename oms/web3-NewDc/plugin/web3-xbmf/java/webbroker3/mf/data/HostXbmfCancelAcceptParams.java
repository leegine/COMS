...
filename	HostXbmfCancelAcceptParams.java;
...
/** 
 * host_xbmf_cancel_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostXbmfCancelAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostXbmfCancelAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostXbmfCancelAcceptParams}が{@@link HostXbmfCancelAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostXbmfCancelAcceptParams extends Params implements HostXbmfCancelAcceptRow {
  ...
  public static final String PTYPE = "host_xbmf_cancel_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostXbmfCancelAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostXbmfCancelAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostXbmfCancelAcceptParamsオブジェクトを作成します。 
   */
  public HostXbmfCancelAcceptParams() {
  ...
  /** 
   * 指定のHostXbmfCancelAcceptRowオブジェクトの値を利用してHostXbmfCancelAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostXbmfCancelAcceptRowオブジェクト 
   */
  public HostXbmfCancelAcceptParams( HostXbmfCancelAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostXbmfCancelAcceptRow ) )
       return false;
    return fieldsEqual( (HostXbmfCancelAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostXbmfCancelAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostXbmfCancelAcceptRow row )
  {
  ...
  {
    return new HostXbmfCancelAcceptPK(institution_code, branch_code, order_request_number);
  }
