...
/** 
 * host_xbmf_order_cancelテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostXbmfOrderCancelRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostXbmfOrderCancelParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostXbmfOrderCancelParams}が{@@link HostXbmfOrderCancelRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class HostXbmfOrderCancelParams extends Params implements HostXbmfOrderCancelRow {
  ...
  /** 
   * 値が未設定のHostXbmfOrderCancelParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のHostXbmfOrderCancelRowオブジェクトの値を利用してHostXbmfOrderCancelParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostXbmfOrderCancelRowオブジェクト 
   */
   ...
   * @@param row 比較対照のHostXbmfOrderCancelRow 
  ...
  /** 
   * <em>order_time</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>order_time</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>order_time</em>カラムの値を設定します。 
   *
   * @@param p_orderTime <em>order_time</em>カラムの値をあらわすjava.sql.Timestamp値
   */
  public final void setOrderTime( java.sql.Timestamp p_orderTime )  {
   ...
   /** 
   * 一般のjava.util.Dateオブジェクトを使って<em>order_time</em>カラムに値を設定します。 
   * @@param date 設定する値を含むjava.util.Date 
    */
