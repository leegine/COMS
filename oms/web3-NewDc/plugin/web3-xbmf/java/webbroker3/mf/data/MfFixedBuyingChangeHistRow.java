...
filename	MfFixedBuyingChangeHistRow.java;
...
/** 
 * MfFixedBuyingChangeHistRowインタフェースは変更不可でリードオンリーである<em>mf_fixed_buying_change_hist</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link MfFixedBuyingChangeHistRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface MfFixedBuyingChangeHistRow extends Row {


  /** 
   * この{@@link MfFixedBuyingChangeHistRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "mf_fixed_buying_change_hist", "session" );
