...
/** 
 * mf_fixed_buying_changeテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link MfFixedBuyingChangeRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link MfFixedBuyingChangeParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link MfFixedBuyingChangeParams}が{@@link MfFixedBuyingChangeRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class MfFixedBuyingChangeParams extends Params implements MfFixedBuyingChangeRow {
  ...
  /** 
   * 値が未設定のMfFixedBuyingChangeParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のMfFixedBuyingChangeRowオブジェクトの値を利用してMfFixedBuyingChangeParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するMfFixedBuyingChangeRowオブジェクト 
   */
   ...
   * @@param row 比較対照のMfFixedBuyingChangeRow 
