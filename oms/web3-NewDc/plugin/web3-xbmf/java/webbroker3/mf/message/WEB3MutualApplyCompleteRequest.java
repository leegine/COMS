...
1.1
date	2011.03.16.02.59.47;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualApplyCompleteRequest.java;
...
File Name        : 投信募集注文完了リクエストクラス(WEB3MutualApplyCompleteRequest)
...
public class WEB3MutualApplyCompleteRequest extends WEB3MutualCommonRequest
{
    /**
     * PTYPE
     */
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualApplyCompleteRequest.class);
     ...
     *  ４－２)　@this.口座区分が以下の値のいずれかではない場合、例外をスローする。<BR> 
     *      ・”一般” <BR>
     *      ・”特定” <BR>
     *      class: WEB3BusinessLayerException <BR>
     ...
     *  ５－２)　@this.決済方法@が以下の値のいずれかではない場合、例外をスローする。 <BR>
     *      ・”円貨” <BR>
     *      ・”外貨”<BR>
     *      class: WEB3BusinessLayerException <BR>
    ...
    {
        return new WEB3MutualApplyCompleteResponse(this);
    } 
}
@
