...
File Name        : 投信銘柄カテゴリーコード２Comparator(WEB3MutualCategoryCode2Comparator)
...
/**
 * (投信銘柄カテゴリーコード２Comparator)<BR>
 *  投信銘柄カテゴリーコード２Comparator実装クラス
 * 
 * @@author 黄建(中訊)
 * @@version 1.0 
 */
...
public class WEB3MutualCategoryCode2Comparator implements Comparator 
{
    ...
    /**
     * (投信銘柄カテゴリーコード２Comparator)<BR>
     * 投信銘柄カテゴリーコード２Comparatorのコンストラクタ。<BR>
     * <BR>
    ...
    /**
     * (compare)<BR>
     * 昇順、降順の指定にもとづく投信銘柄カテゴリーコード２の比較を行う。<BR>
     * <BR>
     ...
     *    投信銘柄カテゴリーコード２について<BR>
     * <BR>
     *    昇順指定の場合、<BR>
     *    パラメータ.obj1の投信銘柄カテゴリーコード２が、<BR>
     *    パラメータ.obj2の投信銘柄カテゴリーコード２より小さい場合は負の整数、<BR>
     *    両方が等しい場合は0、<BR>
     *    パラメータ.obj1の投信銘柄カテゴリーコード２が、<BR>
     *    パラメータ.obj2の投信銘柄カテゴリーコード２より大きい場合<BR>
     *    は正の整数を返   却する<BR>
     * <BR>
     *    降順指定の場合、<BR>
     *    パラメータ.obj1の投信銘柄カテゴリーコード２が、<BR>
     *    パラメータ.obj2の投信銘柄カテゴリーコード２より小さい場合<BR>
     *    は正の整数、両方   が等しい場合は0、<BR>
     *    パラメータ.obj1の投信銘柄カテゴリーコード２が、<BR>
     *    パラメータ.obj2の投信銘柄カテゴリーコード２より大きい場合
     *    は負の整数を返   却する<BR>
     * <BR>
