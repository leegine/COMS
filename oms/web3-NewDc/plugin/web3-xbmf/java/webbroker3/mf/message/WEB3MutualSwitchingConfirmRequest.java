...
1.1
date	2011.03.16.03.08.39;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualSwitchingConfirmRequest.java;
...
File Name        : 投資信託乗換確認リクエストクラス(WEB3MutualSwitchingConfirmRequest)
 ...
 * @@version 1.0
 */
public class WEB3MutualSwitchingConfirmRequest extends WEB3MutualCommonRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualSwitchingConfirmRequest.class);
     ...
     */
    public WEB3MutualSwitchingConfirmRequest()
    {
     ...
     * <BR>
     * 投信乗換確認レスポンスオブジェクトを生成して返す。<BR>
     * @@return WEB3GenResponse
     * @@roseuid 40A8A1CE00E1
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3MutualSwitchingConfirmResponse(this);
    }
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        // ３）　@(乗換)数量チェック <BR>
        // 　@３－１）　@this.指定方法@が“全部”且つ、this.数量がnull以外の値
        if (WEB3SellDivDef.ALL_DESIGNATE.equals(this.specifyDiv))
        {
        ...
        {
            //３－２）　@this.指定方法@が“金額”または“口数”であり且つ、this.数量がnullである
