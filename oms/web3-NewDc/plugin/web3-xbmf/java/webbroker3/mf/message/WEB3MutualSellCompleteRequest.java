...
1.1
date	2011.03.16.02.59.57;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualSellCompleteRequest.java;
...
File Name        : 投資信託解約完了リクエストクラス(WEB3MutualSellCompleteRequest)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/08/11 黄建 (中訊) 新規作成
Revesion History : 2004/08/25 周勇 (中訊) レビュー  
Revesion History : 2004/12/07 于美麗 (中訊) 残対応
...
public class WEB3MutualSellCompleteRequest extends WEB3MutualCommonRequest 
{
    /**
     * PTYPE
     */
     ...
     * SerialVersionUID<BR>
     */
    public final static long serialVersionUID = 200408111540L; 
    ...
    /**
     * デフォルトコンストラクタ
     * @@roseuid 40A89C7B02BF
     */
    public WEB3MutualSellCompleteRequest() 
    {
     ...
     * <BR>
     * 投信解約完了レスポンスオブジェクトを生成して返す。<BR>
     * @@return WEB3GenResponse
     * @@roseuid 40A89C88004E
     */
    public WEB3GenResponse createResponse() 
    {
        return new WEB3MutualSellCompleteResponse(this);
    }
     ...
     * <BR>
     * ３）　@(解約)数量チェック <BR>
     * 　@３－１）　@this.指定方法@が“全部”且つ、this.数量!=nullの値の場合 <BR>
     * 　@　@　@　@　@である場合、 例外をスローする。 <BR>
     *        class: WEB3BusinessLayerException<BR>
    ...
    public void validate() throws WEB3BaseException
    {
            ...
            ((WEB3SellDivDef.COUNT_DESIGNATE).equals(this.specifyDiv)))) 
        {
            ...
            throw new WEB3BusinessLayerException(
                ...
                this.getClass().getName() + "." + STR_METHOD_NAME,
                "指定方法@が、“全部”、“金額”、“口数”以外です。");    
        }
        
        // ３）　@(解約)数量チェック 
        
        //３－１）this.指定方法@が“全部”且つ、
        //this.数量!=nullの値の場合、 例外をスローする。
        if ((((WEB3SellDivDef.ALL_DESIGNATE).equals(this.specifyDiv))) && 
        ...
        if (WEB3StringTypeUtility.isEmpty(WEB3DateUtility.formatDate(
                this.orderedDate, "yyyyMMdd")))
        {
            log.debug("発注日が未指定です。");
            throw new WEB3BusinessLayerException(
