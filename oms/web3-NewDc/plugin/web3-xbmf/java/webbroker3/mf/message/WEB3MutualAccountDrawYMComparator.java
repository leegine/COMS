...
File Name        : 口座引落年月Comparator(WEB3MutualAccountDrawYMComparator.java)
...
public class WEB3MutualAccountDrawYMComparator implements Comparator
{
    ...
    /**
     * 昇順、降順の指定にもとづく口座引落年月の比較を行う。<BR>
     * <BR>
     * １）パラメータを投信定時定額買付条件行クラスで引数をキャストする。 <BR>
     * <BR>
     * ２）比較 <BR>
     * <BR>
     * １）で判定したクラスのインスタンスobj1とobj2それぞれの口座引落年月について <BR>
     * <BR>
     * 昇順指定の場合、 <BR>
     * パラメータ.obj1の口座引落年月が、<BR>
     * パラメータ.obj2の口座引落年月より小さい場合は負の整数、 <BR>
     * 両方が等しい場合は0、 <BR>
     * パラメータ.obj1の口座引落年月が、<BR>
     * パラメータ.obj2の口座引落年月より大きい場合は<BR>
     * 正の整数を返却する <BR>
     * <BR>
     * 降順指定の場合、 <BR>
     * パラメータ.obj1の口座引落年月が、<BR>
     * パラメータ.obj2の口座引落年月より小さい場合は正の整数、 <BR>
     * 両方が等しい場合は0、 <BR>
     * パラメータ.obj1の口座引落年月が、<BR>
     * パラメータ.obj2の口座引落年月より大きい場合は負の整数を返却する <BR>
     * <BR>
    ...
    public int compare(Object l_obj1, Object l_obj2)
    {
        ...
        else
        {
            ...
            {
                //パラメータ.obj1の口座引落年月が、パラメータ.obj2の口座引落年月より小さい場合は負の整数
                ...
                //パラメータ.obj1の口座引落年月が、パラメータ.obj2の口座引落年月より大きい場合は正の整数を返却する
                else
                {
                    l_intReturn = 1;
                }
            ...
            {
                //パラメータ.obj1の口座引落年月が、パラメータ.obj2の口座引落年月より小さい場合は正の整数
                if(l_datVal1.compareTo(l_datVal2) < 0)
                {
                    l_intReturn = 1;
                }
                ...
                //パラメータ.obj1の口座引落年月が、パラメータ.obj2の口座引落年月より大きい場合は負の整数を返却する
                else
                {
                    l_intReturn = -1;
                }
