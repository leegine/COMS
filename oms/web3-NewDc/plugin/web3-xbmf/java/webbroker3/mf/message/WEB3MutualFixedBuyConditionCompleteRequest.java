...
1.1
date	2011.03.16.03.02.19;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualFixedBuyConditionCompleteRequest.java;
...
File Name        : 投信定時定額買付銘柄条件登録完了リクエスト(WEB3MutualFixedBuyConditionCompleteRequest.java)
...
/**
 * (投信定時定額買付銘柄条件登録完了リクエスト)<BR>
 * 投信定時定額買付銘柄条件登録完了リクエスト<BR>
 * <BR>
 * @@author 安陽
 * @@version 1.0
 */
public class WEB3MutualFixedBuyConditionCompleteRequest extends WEB3GenRequest
{
    /**
     * PTYPE<BR>
     */
     ...
     * SerialVersionUID<BR>
     */
    public final static long serialVersionUID = 200807101422L;

    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualFixedBuyConditionCompleteRequest.class);
     ...
     * (投信定時定額買付銘柄条件登録完了リクエスト)<BR>
     * デフォルトコンストラクタ<BR>
     * @@roseuid 484C81240084
     */
    public WEB3MutualFixedBuyConditionCompleteRequest()
    {
     ...
     * <BR>
     * 投信定時定額買付銘柄条件登録完了レスポンスオブジェクトを生成して返す。<BR>
     * @@return WEB3GenResponse
     * @@roseuid 484C814B01FC
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3MutualFixedBuyConditionCompleteResponse(this);
    }
