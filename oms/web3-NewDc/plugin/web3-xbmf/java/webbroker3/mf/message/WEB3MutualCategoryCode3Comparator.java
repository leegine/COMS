...
1.1
date	2011.03.16.03.03.17;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualCategoryCode3Comparator.java;
...
File Name        : 投信銘柄カテゴリーコード３Comparator(WEB3MutualCategoryCode3Comparator)
...
/**
 * (投信銘柄カテゴリーコード３Comparator)<BR>
 *  投信銘柄カテゴリーコード３Comparator実装クラス
 * 
 * @@author 黄建(中訊)
 * @@version 1.0 
 */

public class WEB3MutualCategoryCode3Comparator implements Comparator 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualCategoryCode3Comparator.class);
    ...
    /**
     * (投信銘柄カテゴリーコード３Comparator)<BR>
     * 投信銘柄カテゴリーコード３Comparatorのコンストラクタ。<BR>
     * <BR>
     ...
     * A：昇順<BR>
     * D：降順
     * @@roseuid 4153C2610085
     */
    public WEB3MutualCategoryCode3Comparator(String l_strOrderBy)
    {
        final String STR_METHOD_NAME =
            "WEB3MutualCategoryCode3Comparator(String l_strOrderBy)";
    ...
    /**
     * (compare)<BR>
     * 昇順、降順の指定にもとづく投信銘柄カテゴリーコード３の比較を行う。<BR>
     * <BR>
     ...
     *     投信銘柄カテゴリーコード３について<BR>
     * <BR>
     *     昇順指定の場合、<BR>
     *     パラメータ.obj1の投信銘柄カテゴリーコード３が、<BR>
     *     パラメータ.obj2の投信銘柄カテゴリーコード３より小さい場合は負の整数、<BR>
     *     両方が等しい場合は0、<BR>
     *     パラメータ.obj1の投信銘柄カテゴリーコード３が、<BR>
     *     パラメータ.obj2の投信銘柄カテゴリーコード３より大きい場合<BR>
     *     は正の整数を返却する<BR>
     * <BR>
     *    降順指定の場合、<BR>
     *    パラメータ.obj1の投信銘柄カテゴリーコード３が、<BR>
     *    パラメータ.obj2の投信銘柄カテゴリーコード３より小さい場合は正の整数、<BR>
     *    両方が等しい場合は0、<BR>
     *    パラメータ.obj1の投信銘柄カテゴリーコード３が、<BR>
     *    パラメータ.obj2の投信銘柄カテゴリーコード３より大きい<BR>
     *    場合は負の整数を返却する<BR>
     * <BR>
    ...
    public int compare(Object l_obj1, Object l_obj2)
    {
        ...
        {
            l_strVal1 = 
                ((WEB3MutualDisplayOrderGroup) l_obj1).categoryCode3;
            l_strVal2 = 
                ((WEB3MutualDisplayOrderGroup) l_obj2).categoryCode3;
        }
        else
        {
