...
1.1
date	2011.03.16.03.06.26;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3MutualBuyCompleteRequest.java;
...
File Name        : 投資信託買付注文完了リクエストクラス(WEB3MutualBuyCompleteRequest)
 ...
 * @@version 1.0
 */
public class WEB3MutualBuyCompleteRequest extends WEB3MutualCommonRequest
{
    /**
     * PTYPE
     */
     ...
     * (投信買付注文完了リクエスト)<BR>
     * デフォルトコンストラクタ
     * @@roseuid 40A882CC015F
     */
    public WEB3MutualBuyCompleteRequest()
    {
    }
     ...
     * <BR>
     * 投信買付注文完了レスポンスオブジェクトを生成して返す。
     * @@return WEB3GenResponse
     * @@roseuid 40A883360259
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3MutualBuyCompleteResponse(this);
    }
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualBuyCompleteRequest.class);
    ...
    public void validate() throws WEB3BusinessLayerException
    {
        ...
        {
            log.debug("this.決済方法@が以下のコード以外の場合");
            throw new WEB3BusinessLayerException(
