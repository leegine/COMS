...
filename	WEB3MutualBuyListServiceInterceptor.java;
...
File Name        : 投信買付一覧照会サービスインタセプタクラス(WEB3MutualBuyListServiceInterceptor)
...
/**
 * 投信買付一覧照会サービスインタセプタクラス
 * @@author 韋念瓊(中訊)
 * @@version 1.0
 */
public class WEB3MutualBuyListServiceInterceptor implements Interceptor 
{ 
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualBuyListServiceInterceptor.class);
     ...
     * 　@　@　@取引カレンダコンテキスト.注文受付トランザクション = "01:買付（新規建売）" <BR>
     * <BR>
    ...
    public Object onCall(Method l_method, Object[] l_serviceParam) 
    {
        ...
        try
        {
            ...
            // 取引カレンダコンテキスト.注文受付トランザクション = "01:買付（新規建売）"
