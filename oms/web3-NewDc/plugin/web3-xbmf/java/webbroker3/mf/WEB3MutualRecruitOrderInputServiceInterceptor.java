...
filename	WEB3MutualRecruitOrderInputServiceInterceptor.java;
...
File Name        : 投資信託募集注文入力サービスインタセプタ(WEB3MutualRecruitOrderInputServiceInterceptor)
...
/**
 * 投資信託募集注文入力サービスインタセプタ<BR>
 * 
 * @@author 黄建(中訊)
 * @@version 1.0
 */

public class WEB3MutualRecruitOrderInputServiceInterceptor implements Interceptor 
{
    /**
     *  ログユーティリティ<BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
        WEB3MutualRecruitOrderInputServiceInterceptor.class);    
    /**
