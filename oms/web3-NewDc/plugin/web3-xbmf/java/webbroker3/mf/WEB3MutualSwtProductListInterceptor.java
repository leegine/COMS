...
filename	WEB3MutualSwtProductListInterceptor.java;
...
File Name        : 投信乗換先銘柄一覧照会サービスインタセプタ (WEB3MutualSwtProductListInterceptor)
...
/**
 * 投信乗換先銘柄一覧照会サービスインタセプタ 
 * 
 * @@author 韋念瓊(中訊)
 * @@version 1.0
 */
public class WEB3MutualSwtProductListInterceptor implements Interceptor 
{     
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualSwtProductListInterceptor.class);
