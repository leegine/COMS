...
filename	WEB3MutualFixedBuyApplyServiceInterceptor.java;
...
File Name        : 投信定時定額買付新規申込サービスインタセプタ(WEB3MutualFixedBuyApplyServiceInterceptor.java)
...
/**
 * 投信定時定額買付新規申込サービスインタセプタクラス<BR>
 * 
 * @@author 肖志偉(中訊)
 * @@version 1.0
 */
public class WEB3MutualFixedBuyApplyServiceInterceptor implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3MutualFixedBuyApplyServiceInterceptor.class);
