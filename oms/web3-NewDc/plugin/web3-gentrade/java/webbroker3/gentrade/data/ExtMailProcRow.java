...
1.1
date	2011.03.14.05.24.41;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * ExtMailProcRowインタフェースは変更不可でリードオンリーである<em>ext_mail_proc</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link ExtMailProcRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see ExtMailProcPK 
 */
public interface ExtMailProcRow extends Row {


  /** 
   * この{@@link ExtMailProcRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ext_mail_proc", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getItemContentsIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getItemContentsIsModified();
