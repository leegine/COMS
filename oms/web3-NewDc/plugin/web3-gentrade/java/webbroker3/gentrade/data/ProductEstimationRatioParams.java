...
/** 
 * product_estimation_ratioテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link ProductEstimationRatioRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link ProductEstimationRatioParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link ProductEstimationRatioParams}が{@@link ProductEstimationRatioRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class ProductEstimationRatioParams extends Params implements ProductEstimationRatioRow {
  ...
  /** 
   * <em>securities_collateral_flag</em>カラムの値 
   */
  ...
  /** 
   * 値が未設定のProductEstimationRatioParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のProductEstimationRatioRowオブジェクトの値を利用してProductEstimationRatioParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するProductEstimationRatioRowオブジェクト 
   */
   ...
   * @@param row 比較対照のProductEstimationRatioRow 
  ...
  /** 
   * <em>securities_collateral_flag</em>カラムの値を取得します。
   * @@return Stringの値 
   */
  ...
  /** 
   * <em>securities_collateral_flag</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>securities_collateral_flag</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>securities_collateral_flag</em>カラムの値を設定します。 
   *
   * @@param p_securitiesCollateralFlag <em>securities_collateral_flag</em>カラムの値をあらわす1桁以下のString値 
   */
