...
/** 
 * {@@link IfoDepositDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link IfoDepositRow}インスタンスへ関連付けることができます。 
...
public class IfoDepositDao extends DataAccessObject {
  ...
  /** 
   * この{@@link IfoDepositDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link IfoDepositRow}と仮定される{@@link DataAccessObject}から新たに{@@link IfoDepositDao}を返します。 
         * @@return 指定のRowに結びつく{@@link IfoDepositDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link IfoDepositRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link IfoDepositRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link IfoDepositRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link IfoDepositRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link IfoDepositRow}オブジェクトから{@@link IfoDepositDao}オブジェクトを作成します。 
   * これは実際の{@@link IfoDepositRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link IfoDepositDao}取得のために指定の{@@link IfoDepositRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link IfoDepositDao}オブジェクト 
  ...
  /** 
   * {@@link IfoDepositRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link IfoDepositRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link IfoDepositPK}やデータベースレコードとして挿入される{@@link IfoDepositParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link IfoDepositRow}を一意に特定する{@@link IfoDepositPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link IfoDepositRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link IfoDepositParams}オブジェクトの主キーとして利用可能な{@@link IfoDepositPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link IfoDepositRow}オブジェクトを検索します。 
   * 
   ...
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link IfoDepositRow} 
  ...
  /** 
   * 指定のIfoDepositPKオブジェクトから{@@link IfoDepositRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するIfoDepositPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link IfoDepositRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String,String,java.sql.Timestamp)}および{@@link #forRow(IfoDepositRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(IfoDepositPK)}および{@@link #forRow(IfoDepositRow)}を使用してください。 
   */
  ...
  /** 
   * p_institutionCode, p_branchCode, p_accountCode, p_calcDate, and にて指定の値から一意の{@@link IfoDepositRow}オブジェクトを検索します。 
   ...
   * @@param p_calcDate 検索対象であるp_calcDateフィールドの値
   * 
   * @@return 引数指定のp_institutionCode, p_branchCode, p_accountCode, p_calcDate, and の値と一致する{@@link IfoDepositRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByInstitutionCodeBranchCodeAccountCodeCalcDate(String, String, String, java.sql.Timestamp)}および{@@link #forRow(IfoDepositRow)}を使用してください。 
   */
