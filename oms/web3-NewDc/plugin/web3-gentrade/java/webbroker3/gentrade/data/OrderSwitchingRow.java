...
1.1
date	2011.03.14.05.43.49;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OrderSwitchingRow.java;
...
/** 
 * OrderSwitchingRowインタフェースは変更不可でリードオンリーである<em>order_switching</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OrderSwitchingRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OrderSwitchingRow extends Row {


  /** 
   * この{@@link OrderSwitchingRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "order_switching", "master" );
   ...
   * @@return Stringの値 
   */
  public String getChangeCancelEnableFlag();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getChangeCancelEnableFlagIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getChangeCancelEnableFlagIsModified();
   ...
   * @@return Stringの値 
   */
  public String getSubmitMqTrigger();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubmitMqTriggerIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubmitMqTriggerIsModified();
   ...
   * @@return Stringの値 
   */
  public String getOrderEngineDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderEngineDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderEngineDivIsModified();
