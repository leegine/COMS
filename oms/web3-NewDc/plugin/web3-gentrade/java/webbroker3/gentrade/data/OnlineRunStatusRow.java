...
1.1
date	2011.03.14.05.27.39;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OnlineRunStatusRow.java;
...
/** 
 * OnlineRunStatusRowインタフェースは変更不可でリードオンリーである<em>online_run_status</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OnlineRunStatusRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OnlineRunStatusRow extends Row {


  /** 
   * この{@@link OnlineRunStatusRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "online_run_status", "session" );
   ...
   * @@return Stringの値 
   */
  public String getOnlineServiceDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOnlineServiceDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOnlineServiceDivIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRunStatusDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getRunStatusDivIsModified();
