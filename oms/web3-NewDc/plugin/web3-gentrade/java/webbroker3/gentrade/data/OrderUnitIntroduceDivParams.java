...
1.1
date	2011.03.14.05.24.37;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OrderUnitIntroduceDivParams.java;
...
/** 
 * order_unit_introduce_divテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link OrderUnitIntroduceDivRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link OrderUnitIntroduceDivParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link OrderUnitIntroduceDivParams}が{@@link OrderUnitIntroduceDivRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class OrderUnitIntroduceDivParams extends Params implements OrderUnitIntroduceDivRow {
  ...
  public static final RowType TYPE = OrderUnitIntroduceDivRow.TYPE;
  ...
  /** 
   * <em>introduce_branch_div</em>カラムの値 
   */
  public  String  introduce_branch_div;
  ...
  private boolean introduce_branch_div_is_set = false;
  private boolean introduce_branch_div_is_modified = false;
  ...
  public String toString() {
    return "{"
      ...
      + "," + "introduce_branch_div=" +introduce_branch_div
  ...
  /** 
   * 値が未設定のOrderUnitIntroduceDivParamsオブジェクトを作成します。 
   */
  public OrderUnitIntroduceDivParams() {
  ...
  /** 
   * 指定のOrderUnitIntroduceDivRowオブジェクトの値を利用してOrderUnitIntroduceDivParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するOrderUnitIntroduceDivRowオブジェクト 
   */
  public OrderUnitIntroduceDivParams( OrderUnitIntroduceDivRow p_row )
  {
    ...
    introduce_branch_div = p_row.getIntroduceBranchDiv();
    introduce_branch_div_is_set = p_row.getIntroduceBranchDivIsSet();
    introduce_branch_div_is_modified = p_row.getIntroduceBranchDivIsModified();
   ...
   */
    public void markAllValuesAsSet() {
      ...
      introduce_branch_div_is_set = true;
      introduce_branch_div_is_modified = true;
  ...
  {
    if ( !( other instanceof OrderUnitIntroduceDivRow ) )
       return false;
    return fieldsEqual( (OrderUnitIntroduceDivRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のOrderUnitIntroduceDivRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( OrderUnitIntroduceDivRow row )
  {
    ...
    if ( introduce_branch_div == null ) {
      if ( row.getIntroduceBranchDiv() != null )
        return false;
    } else if ( !introduce_branch_div.equals( row.getIntroduceBranchDiv() ) ) {
        return false;
    }
  ...
  public int hashCode() {
      return  ((int) order_unit_id)
        ...
        + (introduce_branch_div!=null? introduce_branch_div.hashCode(): 0) 
   ...
   */
	public java.util.Map toInsertMap() {
		...
		if ( introduce_branch_div != null )
			map.put("introduce_branch_div",introduce_branch_div);
		if ( introduce_branch_code != null )
   ...
   */
	public java.util.Map toUpdateMap() {
		...
		if ( account_id_is_modified )
			map.put("account_id",new Long(account_id));
		if ( introduce_branch_div_is_modified )
			map.put("introduce_branch_div",introduce_branch_div);
   ...
   * @@return Stringの値 
   */
  public final String getIntroduceBranchDiv()
  {
    return introduce_branch_div;
  }
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getIntroduceBranchDivIsSet() {
    return introduce_branch_div_is_set;
  }
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getIntroduceBranchDivIsModified() {
    return introduce_branch_div_is_modified;
  }
  ...
  {
    return new OrderUnitIntroduceDivPK(order_unit_id, product_type);
  }
  ...
  /** 
   * <em>introduce_branch_div</em>カラムの値を設定します。 
   *
   * @@param p_introduceBranchDiv <em>introduce_branch_div</em>カラムの値をあらわす1桁以下のString値 
   */
  public final void setIntroduceBranchDiv( String p_introduceBranchDiv )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    introduce_branch_div = p_introduceBranchDiv;
    introduce_branch_div_is_set = true;
    introduce_branch_div_is_modified = true;
  }
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                ...
                break;
            case 'i':
                if ( name.equals("introduce_branch_div") ) {
                    return this.introduce_branch_div;
                }
                ...
                if ( name.equals("introduce_branch_div") ) {
                    if ( value != null )
                      if ( !(value instanceof String) )
                        throw new IllegalArgumentException( "value for 'introduce_branch_div' must be String: '"+value+"' is not." );
                    this.introduce_branch_div = (String) value;
                    if (this.introduce_branch_div_is_set)
                        this.introduce_branch_div_is_modified = true;
                    this.introduce_branch_div_is_set = true;
                    return;
                }
                else if ( name.equals("introduce_branch_code") ) {
                    if ( value != null )
