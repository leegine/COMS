...
1.1
date	2011.03.14.05.39.24;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * DirectDebitRowインタフェースは変更不可でリードオンリーである<em>direct_debit</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link DirectDebitRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see DirectDebitPK 
 */
public interface DirectDebitRow extends Row {


  /** 
   * この{@@link DirectDebitRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "direct_debit", "master" );
   ...
   */
  public java.sql.Timestamp getSonarLastUpdatedTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSonarLastUpdatedTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSonarLastUpdatedTimestampIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getSonarCreatedTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSonarCreatedTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSonarCreatedTimestampIsModified();
