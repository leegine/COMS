...
1.1
date	2011.03.14.05.19.27;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * MailProcRowインタフェースは変更不可でリードオンリーである<em>mail_proc</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link MailProcRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see MailProcPK 
 */
public interface MailProcRow extends Row {


  /** 
   * この{@@link MailProcRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "mail_proc", "session" );
