...
1.1
date	2011.03.14.05.33.15;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * FeqCalendarRowインタフェースは変更不可でリードオンリーである<em>feq_calendar</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link FeqCalendarRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see FeqCalendarPK 
 */
public interface FeqCalendarRow extends Row {


  /** 
   * この{@@link FeqCalendarRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "feq_calendar", "master" );
