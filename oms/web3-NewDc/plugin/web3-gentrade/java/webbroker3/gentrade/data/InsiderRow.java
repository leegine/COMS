...
1.1
date	2011.03.14.05.30.49;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * InsiderRowインタフェースは変更不可でリードオンリーである<em>insider</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link InsiderRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see InsiderPK 
 */
public interface InsiderRow extends Row {


  /** 
   * この{@@link InsiderRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "insider", "account" );
   ...
   */
  public java.sql.Timestamp getSonarCreatedDate();
