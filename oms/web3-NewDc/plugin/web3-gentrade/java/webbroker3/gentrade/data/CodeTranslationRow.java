...
1.1
date	2011.03.14.05.41.24;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CodeTranslationRow.java;
...
/** 
 * CodeTranslationRowインタフェースは変更不可でリードオンリーである<em>code_translation</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CodeTranslationRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface CodeTranslationRow extends Row {


  /** 
   * この{@@link CodeTranslationRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "code_translation", "master" );
   ...
   */
  public  boolean  getCodeTypeIsSet();
   ...
   */
  public  boolean  getCodeTypeIsModified();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCodeIsModified();
