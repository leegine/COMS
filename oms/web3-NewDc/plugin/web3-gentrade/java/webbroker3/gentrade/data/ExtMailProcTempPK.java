...
1.1
date	2011.03.14.05.17.13;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	ExtMailProcTempPK.java;
...
/** 
 * <b>ExtMailProcTemp</b>データベーステーブルで一意である1つのレコードをあらわす<b>ExtMailProcTemp</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>ExtMailProcTemp</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 */
public class ExtMailProcTempPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: ExtMailProcTempRow. 
   */
   ...
   */
  public ExtMailProcTempPK( String p_institutionCode, String p_branchCode, String p_sendmailDiv, String p_discernmentId, String p_accountCode, long p_mailId, String p_itemName ) {
   ...
   */
  public static ExtMailProcTempPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    ExtMailProcTempPK pk = new ExtMailProcTempPK();
  ...
  {
    if ( other == null || !( other instanceof ExtMailProcTempPK) )
      return false;
    ExtMailProcTempPK o = (ExtMailProcTempPK) other;
