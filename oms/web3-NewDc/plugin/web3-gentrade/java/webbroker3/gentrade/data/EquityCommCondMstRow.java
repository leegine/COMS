...
1.1
date	2011.03.14.05.29.55;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	EquityCommCondMstRow.java;
...
/** 
 * EquityCommCondMstRowインタフェースは変更不可でリードオンリーである<em>equity_comm_cond_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link EquityCommCondMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface EquityCommCondMstRow extends Row {


  /** 
   * この{@@link EquityCommCondMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "equity_comm_cond_mst", "master" );
   ...
   */
  public  boolean  getMaxCommissionIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMaxCommissionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMaxCommissionIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMinCommissionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMinCommissionIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getShareTypeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getShareTypeIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getReferenceColumnIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getReferenceColumnIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getSpcStartDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcStartDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcStartDateIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getSpcEndDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcEndDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcEndDateIsModified();
   ...
   * @@return doubleの値 
   */
  public double getSpcChargeRatio();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getSpcChargeRatioIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcChargeRatioIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcChargeRatioIsModified();
   ...
   * @@return doubleの値 
   */
  public double getSpcMaxCommission();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getSpcMaxCommissionIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcMaxCommissionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcMaxCommissionIsModified();
   ...
   * @@return doubleの値 
   */
  public double getSpcMinCommission();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getSpcMinCommissionIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcMinCommissionIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSpcMinCommissionIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getFinalModDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFinalModDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFinalModDateIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFinalModTimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getFinalModTimeIsModified();
