...
1.1
date	2011.03.14.05.16.31;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	LastClosingPriceRow.java;
...
/** 
 * LastClosingPriceRowインタフェースは変更不可でリードオンリーである<em>last_closing_price</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link LastClosingPriceRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface LastClosingPriceRow extends Row {


  /** 
   * この{@@link LastClosingPriceRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "last_closing_price", "master" );
   ...
   */
  public  boolean  getTokyoClosingPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getOosakaClosingPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getNagoyaClosingPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getOtherClosingPriceIsNull();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getPrimaryClosingPriceIsNull();
