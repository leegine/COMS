...
1.1
date	2011.03.14.05.15.57;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * TaxRateTableRowインタフェースは変更不可でリードオンリーである<em>tax_rate_table</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link TaxRateTableRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see TaxRateTablePK 
 */
public interface TaxRateTableRow extends Row {


  /** 
   * この{@@link TaxRateTableRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "tax_rate_table", "master" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTaxRateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTaxRateIsModified();
