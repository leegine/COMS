...
1.1
date	2011.03.14.05.37.07;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	DocDeliveryManagementHistRow.java;
...
/** 
 * DocDeliveryManagementHistRowインタフェースは変更不可でリードオンリーである<em>doc_delivery_management_hist</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link DocDeliveryManagementHistRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface DocDeliveryManagementHistRow extends Row {


  /** 
   * この{@@link DocDeliveryManagementHistRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "doc_delivery_management_hist", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDeleteUserIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDeleteUserIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDocumentCategoryIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDocumentCategoryIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getDeemedDeliveryDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDeemedDeliveryDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDeemedDeliveryDateIsModified();
