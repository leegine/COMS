...
1.1
date	2011.03.14.05.42.05;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * <b>MailProcTemp</b>データベーステーブルで一意である1つのレコードをあらわす<b>MailProcTemp</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>MailProcTemp</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
 ...
 * @@see MailProcTempRow 
 */
public class MailProcTempPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: MailProcTempRow. 
   */
   ...
   */
  public MailProcTempPK( String p_institutionCode, String p_branchCode, String p_sendmailDiv, String p_discernmentId, String p_accountCode, long p_mailId ) {
   ...
   */
  public static MailProcTempPK fromString( String pkValueString ) 
      throws NumberFormatException
  {
    MailProcTempPK pk = new MailProcTempPK();
  ...
  {
    if ( other == null || !( other instanceof MailProcTempPK) )
      return false;
    MailProcTempPK o = (MailProcTempPK) other;
