...
/** 
 * {@@link BatoInstBranchPrefDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link BatoInstBranchPrefRow}インスタンスへ関連付けることができます。 
...
public class BatoInstBranchPrefDao extends DataAccessObject {
  ...
  /** 
   * この{@@link BatoInstBranchPrefDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link BatoInstBranchPrefRow}と仮定される{@@link DataAccessObject}から新たに{@@link BatoInstBranchPrefDao}を返します。 
         * @@return 指定のRowに結びつく{@@link BatoInstBranchPrefDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link BatoInstBranchPrefRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link BatoInstBranchPrefRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link BatoInstBranchPrefRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link BatoInstBranchPrefRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link BatoInstBranchPrefRow}オブジェクトから{@@link BatoInstBranchPrefDao}オブジェクトを作成します。 
   * これは実際の{@@link BatoInstBranchPrefRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link BatoInstBranchPrefDao}取得のために指定の{@@link BatoInstBranchPrefRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link BatoInstBranchPrefDao}オブジェクト 
  ...
  /** 
   * {@@link BatoInstBranchPrefRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link BatoInstBranchPrefRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link BatoInstBranchPrefPK}やデータベースレコードとして挿入される{@@link BatoInstBranchPrefParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link BatoInstBranchPrefRow}を一意に特定する{@@link BatoInstBranchPrefPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link BatoInstBranchPrefRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link BatoInstBranchPrefParams}オブジェクトの主キーとして利用可能な{@@link BatoInstBranchPrefPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link BatoInstBranchPrefRow}オブジェクトを検索します。 
   * 
   * @@param p_institutionCode 検索対象であるp_institutionCodeフィールドの値
   * @@param p_branchCode 検索対象であるp_branchCodeフィールドの値
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link BatoInstBranchPrefRow} 
  ...
  /** 
   * 指定のBatoInstBranchPrefPKオブジェクトから{@@link BatoInstBranchPrefRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するBatoInstBranchPrefPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link BatoInstBranchPrefRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String)}および{@@link #forRow(BatoInstBranchPrefRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(BatoInstBranchPrefPK)}および{@@link #forRow(BatoInstBranchPrefRow)}を使用してください。 
   */
  ...
  /** 
   * p_institutionCode, p_branchCode, and にて指定の値から一意の{@@link BatoInstBranchPrefRow}オブジェクトを検索します。 
   * 該当するオブジェクトがない場合はnullを返します。
   * 
   * @@param p_institutionCode 検索対象であるp_institutionCodeフィールドの値
   * @@param p_branchCode 検索対象であるp_branchCodeフィールドの値
   * 
   * @@return 引数指定のp_institutionCode, p_branchCode, and の値と一致する{@@link BatoInstBranchPrefRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByInstitutionCodeBranchCode(String, String)}および{@@link #forRow(BatoInstBranchPrefRow)}を使用してください。 
   */
