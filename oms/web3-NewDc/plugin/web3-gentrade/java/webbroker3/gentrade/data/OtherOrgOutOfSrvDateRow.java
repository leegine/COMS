...
1.1
date	2011.03.14.05.28.12;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OtherOrgOutOfSrvDateRow.java;
...
/** 
 * OtherOrgOutOfSrvDateRowインタフェースは変更不可でリードオンリーである<em>other_org_out_of_srv_date</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OtherOrgOutOfSrvDateRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OtherOrgOutOfSrvDateRow extends Row {


  /** 
   * この{@@link OtherOrgOutOfSrvDateRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "other_org_out_of_srv_date", "master" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSuspensionDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSuspensionDateIsModified();
