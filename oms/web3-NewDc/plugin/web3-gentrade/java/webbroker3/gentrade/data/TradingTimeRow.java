...
1.1
date	2011.03.14.05.38.09;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
/** 
 * TradingTimeRowインタフェースは変更不可でリードオンリーである<em>trading_time</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link TradingTimeRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see TradingTimePK 
 */
public interface TradingTimeRow extends Row {


  /** 
   * この{@@link TradingTimeRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "trading_time", "master" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubmitMarketTriggerIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSubmitMarketTriggerIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBizdateCalcParameterIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getBizdateCalcParameterIsModified();
