...
1.1
date	2011.03.14.05.24.54;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	TaxRateTableParams.java;
...
/** 
 * tax_rate_tableテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link TaxRateTableRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link TaxRateTableParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link TaxRateTableParams}が{@@link TaxRateTableRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 * @@see TaxRateTableRow 
 */
public class TaxRateTableParams extends Params implements TaxRateTableRow {
  ...
  public static final RowType TYPE = TaxRateTableRow.TYPE;
  ...
  private boolean tax_rate_is_set = false;
  private boolean tax_rate_is_modified = false;
  ...
  /** 
   * 値が未設定のTaxRateTableParamsオブジェクトを作成します。 
   */
  public TaxRateTableParams() {
  ...
  /** 
   * 指定のTaxRateTableRowオブジェクトの値を利用してTaxRateTableParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するTaxRateTableRowオブジェクト 
   */
  public TaxRateTableParams( TaxRateTableRow p_row )
  {
    ...
    tax_rate = p_row.getTaxRate();
    tax_rate_is_set = p_row.getTaxRateIsSet();
    tax_rate_is_modified = p_row.getTaxRateIsModified();
   ...
   */
    public void markAllValuesAsSet() {
      ...
      tax_rate_is_set = true;
      tax_rate_is_modified = true;
  ...
  {
    if ( !( other instanceof TaxRateTableRow ) )
       return false;
    return fieldsEqual( (TaxRateTableRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のTaxRateTableRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( TaxRateTableRow row )
  {
   ...
   */
	protected void assertValidForInsert() throws IllegalArgumentException {
		...
		if ( !tax_rate_is_set )
			throw new IllegalArgumentException("non-nullable field 'tax_rate' must be set before inserting.");
	}
   ...
   */
	public java.util.Map toInsertMap() {
		...
		map.put("tax_rate",new Double(tax_rate));
  ...
  /** 
   * <em>tax_rate</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getTaxRateIsSet() {
    return tax_rate_is_set;
  }


  /** 
   * <em>tax_rate</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getTaxRateIsModified() {
    return tax_rate_is_modified;
  }
  ...
  {
    return new TaxRateTablePK(institution_code, tax_type, appli_start_date);
  }
  ...
  /** 
   * <em>tax_rate</em>カラムの値を設定します。 
   *
   * @@param p_taxRate <em>tax_rate</em>カラムの値をあらわす18桁以下のdouble値で、その精度は6桁まで
   */
  public final void setTaxRate( double p_taxRate )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    tax_rate = p_taxRate;
    tax_rate_is_set = true;
            ...
            case 't':
                if ( name.equals("tax_type") ) {
                    ...
                    if ( !(value instanceof Double) )
                        throw new IllegalArgumentException( "value for 'tax_rate' must be Double: '"+value+"' is not." );
                    this.tax_rate = ((Double) value).doubleValue();
                    if (this.tax_rate_is_set)
                        this.tax_rate_is_modified = true;
                    this.tax_rate_is_set = true;
                    return;
                }
                break;
        }
