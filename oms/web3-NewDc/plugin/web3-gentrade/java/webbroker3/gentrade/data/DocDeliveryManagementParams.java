...
1.1
date	2011.03.14.05.26.25;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	DocDeliveryManagementParams.java;
...
/** 
 * doc_delivery_managementテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link DocDeliveryManagementRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link DocDeliveryManagementParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link DocDeliveryManagementParams}が{@@link DocDeliveryManagementRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class DocDeliveryManagementParams extends Params implements DocDeliveryManagementRow {
  ...
  public static final RowType TYPE = DocDeliveryManagementRow.TYPE;
  ...
  /** 
   * 値が未設定のDocDeliveryManagementParamsオブジェクトを作成します。 
   */
  public DocDeliveryManagementParams() {
  ...
  /** 
   * 指定のDocDeliveryManagementRowオブジェクトの値を利用してDocDeliveryManagementParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するDocDeliveryManagementRowオブジェクト 
   */
  public DocDeliveryManagementParams( DocDeliveryManagementRow p_row )
  {
  ...
  {
    if ( !( other instanceof DocDeliveryManagementRow ) )
       return false;
    return fieldsEqual( (DocDeliveryManagementRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のDocDeliveryManagementRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( DocDeliveryManagementRow row )
  {
  ...
  {
    return new DocDeliveryManagementPK(account_id, document_div, product_code, delivery_date, document_category);
  }
