...
1.1
date	2011.03.14.05.23.47;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountInfoMstRow.java;
...
/** 
 * AccountInfoMstRowインタフェースは変更不可でリードオンリーである<em>account_info_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AccountInfoMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AccountInfoMstRow extends Row {


  /** 
   * この{@@link AccountInfoMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "account_info_mst", "account" );
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getOccupationUpdatedTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOccupationUpdatedTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOccupationUpdatedTimestampIsModified();
