...
1.1
date	2011.03.14.05.26.37;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CommCodeChgMstRow.java;
...
/** 
 * CommCodeChgMstRowインタフェースは変更不可でリードオンリーである<em>comm_code_chg_mst</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CommCodeChgMstRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface CommCodeChgMstRow extends Row {


  /** 
   * この{@@link CommCodeChgMstRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "comm_code_chg_mst", "master" );
   ...
   * @@return Stringの値 
   */
  public String getInitialSetDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getInitialSetDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getInitialSetDivIsModified();
