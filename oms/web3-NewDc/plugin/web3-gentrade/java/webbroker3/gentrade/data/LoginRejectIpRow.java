...
1.1
date	2011.03.14.05.28.08;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	LoginRejectIpRow.java;
...
/** 
 * LoginRejectIpRowインタフェースは変更不可でリードオンリーである<em>login_reject_ip</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link LoginRejectIpRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see LoginRejectIpPK 
 */
public interface LoginRejectIpRow extends Row {


  /** 
   * この{@@link LoginRejectIpRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "login_reject_ip", "session" );
   ...
   */
  public  boolean  getLoginRejectIdIsSet();
   ...
   */
  public  boolean  getLoginRejectIdIsModified();
   ...
   */
  public java.sql.Timestamp getAppliStartTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliStartTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliStartTimestampIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getAppliEndTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliEndTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAppliEndTimestampIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getUpdatedDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getUpdatedDivIsModified();
