...
1.1
date	2011.03.14.05.38.46;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountInfoMstParams.java;
...
/** 
 * account_info_mstテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link AccountInfoMstRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link AccountInfoMstParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link AccountInfoMstParams}が{@@link AccountInfoMstRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class AccountInfoMstParams extends Params implements AccountInfoMstRow {
  ...
  public static final String PTYPE = "account_info_mst";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = AccountInfoMstRow.TYPE;
  ...
  /** 
   * <em>occupation_updated_timestamp</em>カラムの値 
   */
  public  java.sql.Timestamp  occupation_updated_timestamp;
  ...
  private boolean occupation_updated_timestamp_is_set = false;
  private boolean occupation_updated_timestamp_is_modified = false;
  ...
  public String toString() {
    return "{"
      ...
      + "," + "occupation_updated_timestamp=" +occupation_updated_timestamp
      + "," + "fax=" +fax
  ...
  /** 
   * 値が未設定のAccountInfoMstParamsオブジェクトを作成します。 
   */
  public AccountInfoMstParams() {
  ...
  /** 
   * 指定のAccountInfoMstRowオブジェクトの値を利用してAccountInfoMstParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するAccountInfoMstRowオブジェクト 
   */
  public AccountInfoMstParams( AccountInfoMstRow p_row )
  {
    ...
    occupation_updated_timestamp = p_row.getOccupationUpdatedTimestamp();
    occupation_updated_timestamp_is_set = p_row.getOccupationUpdatedTimestampIsSet();
    occupation_updated_timestamp_is_modified = p_row.getOccupationUpdatedTimestampIsModified();
    fax = p_row.getFax();
   ...
   */
    public void markAllValuesAsSet() {
      ...
      occupation_updated_timestamp_is_set = true;
      occupation_updated_timestamp_is_modified = true;
      fax_is_set = true;
  ...
  {
    if ( !( other instanceof AccountInfoMstRow ) )
       return false;
    return fieldsEqual( (AccountInfoMstRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のAccountInfoMstRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( AccountInfoMstRow row )
  {
    ...
    if ( occupation_updated_timestamp == null ) {
      if ( row.getOccupationUpdatedTimestamp() != null )
        return false;
    } else if ( !occupation_updated_timestamp.equals( row.getOccupationUpdatedTimestamp() ) ) {
        return false;
    }
    if ( fax == null ) {
      if ( row.getFax() != null )
  ...
  public int hashCode() {
      return  ((int) account_id)
        ...
        + (occupation_updated_timestamp!=null? occupation_updated_timestamp.hashCode(): 0) 
   ...
   */
	public java.util.Map toInsertMap() {
		...
		if ( occupation_updated_timestamp != null )
			map.put("occupation_updated_timestamp",occupation_updated_timestamp);
		if ( fax != null )
			map.put("fax",fax);
		if ( annual_income_div != null )
   ...
   */
	public java.util.Map toUpdateMap() {
		...
		if ( nationality_other_is_modified )
			map.put("nationality_other",nationality_other);
		if ( occupation_updated_timestamp_is_modified )
			map.put("occupation_updated_timestamp",occupation_updated_timestamp);
		if ( fax_is_modified )
			map.put("fax",fax);
  ...
  /** 
   * <em>occupation_updated_timestamp</em>カラムの値を取得します。
   * @@return java.sql.Timestampの値 
   */
  public final java.sql.Timestamp getOccupationUpdatedTimestamp()
  {
    return occupation_updated_timestamp;
  }


  /** 
   * <em>occupation_updated_timestamp</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOccupationUpdatedTimestampIsSet() {
    return occupation_updated_timestamp_is_set;
  }


  /** 
   * <em>occupation_updated_timestamp</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getOccupationUpdatedTimestampIsModified() {
    return occupation_updated_timestamp_is_modified;
  }
  ...
  {
    return new AccountInfoMstPK(account_id);
  }
  ...
  /** 
   * <em>occupation_updated_timestamp</em>カラムの値を設定します。 
   *
   * @@param p_occupationUpdatedTimestamp <em>occupation_updated_timestamp</em>カラムの値をあらわすjava.sql.Timestamp値
   */
  public final void setOccupationUpdatedTimestamp( java.sql.Timestamp p_occupationUpdatedTimestamp )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object cann't be modified. Use copy contructor to create a new Params object for modification.");
    occupation_updated_timestamp = p_occupationUpdatedTimestamp;
    occupation_updated_timestamp_is_set = true;
    occupation_updated_timestamp_is_modified = true;
  }
   ...
   /** 
   * 一般のjava.util.Dateオブジェクトを使って<em>occupation_updated_timestamp</em>カラムに値を設定します。 
   * @@param date 設定する値を含むjava.util.Date 
    */
  public final void setOccupationUpdatedTimestamp( java.util.Date date )  {
    if(!mutable())
      throw new UnsupportedOperationException("This Params object can't be modified. Use copy contructor to create a new Params object for modification.");
    occupation_updated_timestamp = (date==null? null: new java.sql.Timestamp( date.getTime() ));
    occupation_updated_timestamp_is_set = true;
    occupation_updated_timestamp_is_modified = true;
  }
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'c':
                ...
                break;
            case 'd':
                if ( name.equals("director_family_name") ) {
            ...
            case 'o':
                ...
                else if ( name.equals("occupation_updated_timestamp") ) {
                    return this.occupation_updated_timestamp;
                }
                break;
            case 'p':
                if ( name.equals("post") ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'o':
                if ( name.equals("occupation_div") ) {
                    ...
                    if ( value != null )
                      if ( !(value instanceof java.sql.Timestamp) )
                        throw new IllegalArgumentException( "value for 'occupation_updated_timestamp' must be java.sql.Timestamp: '"+value+"' is not." );
                    this.occupation_updated_timestamp = (java.sql.Timestamp) value;
                    if (this.occupation_updated_timestamp_is_set)
                        this.occupation_updated_timestamp_is_modified = true;
                    this.occupation_updated_timestamp_is_set = true;
                    return;
                }
                break;
            case 'p':
