...
1.1
date	2011.03.14.05.41.57;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	MarketMarginRatioRow.java;
...
/** 
 * MarketMarginRatioRowインタフェースは変更不可でリードオンリーである<em>market_margin_ratio</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link MarketMarginRatioRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface MarketMarginRatioRow extends Row {


  /** 
   * この{@@link MarketMarginRatioRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "market_margin_ratio", "master" );
   ...
   * @@return Stringの値 
   */
  public String getSecuritiesEstimationDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSecuritiesEstimationDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getSecuritiesEstimationDivIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPriorityIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getPriorityIsModified();
