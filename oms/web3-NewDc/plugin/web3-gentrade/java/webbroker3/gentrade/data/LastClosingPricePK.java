...
/** 
 * <b>LastClosingPrice</b>データベーステーブルで一意である1つのレコードをあらわす<b>LastClosingPrice</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>LastClosingPrice</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
...
public class LastClosingPricePK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: LastClosingPriceRow. 
   */
