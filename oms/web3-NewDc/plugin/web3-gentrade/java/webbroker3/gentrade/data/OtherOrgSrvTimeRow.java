...
1.1
date	2011.03.14.05.19.52;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OtherOrgSrvTimeRow.java;
...
/** 
 * OtherOrgSrvTimeRowインタフェースは変更不可でリードオンリーである<em>other_org_srv_time</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OtherOrgSrvTimeRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OtherOrgSrvTimeRow extends Row {


  /** 
   * この{@@link OtherOrgSrvTimeRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "other_org_srv_time", "master" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceStartTimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceStartTimeIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceEndTimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceEndTimeIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceDivIsModified();
   ...
   * @@return Stringの値 
   */
  public String getServiceDateDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceDateDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getServiceDateDivIsModified();
