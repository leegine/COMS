...
1.1
date	2011.03.14.05.33.56;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	StockSecuredLoanRow.java;
...
/** 
 * StockSecuredLoanRowインタフェースは変更不可でリードオンリーである<em>stock_secured_loan</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link StockSecuredLoanRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface StockSecuredLoanRow extends Row {


  /** 
   * この{@@link StockSecuredLoanRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "stock_secured_loan", "account" );
   ...
   * @@return Stringの値 
   */
  public String getStockLoanAccountCode();
   ...
   */
  public  boolean  getStockLoanAccountCodeIsSet();
   ...
   */
  public  boolean  getStockLoanAccountCodeIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccountOpenStatusIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAccountOpenStatusIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getOrderDataReceptionDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderDataReceptionDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOrderDataReceptionDateIsModified();
   ...
   * @@return java.sql.Timestampの値 
   */
  public java.sql.Timestamp getCancelDataReceptionDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCancelDataReceptionDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCancelDataReceptionDateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getYCustomerData();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getYCustomerDataIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getYCustomerDataIsModified();
