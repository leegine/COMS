...
1.1
date	2011.03.14.05.22.54;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AdministratorRow.java;
...
/** 
 * AdministratorRowインタフェースは変更不可でリードオンリーである<em>administrator</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AdministratorRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see AdministratorPK 
 */
public interface AdministratorRow extends Row {


  /** 
   * この{@@link AdministratorRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "administrator", "master" );
   ...
   */
  public  boolean  getAdministratorIdIsSet();
   ...
   */
  public  boolean  getAdministratorIdIsModified();
