...
1.1
date	2011.03.14.05.41.32;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AccountMailAddressRow.java;
...
/** 
 * AccountMailAddressRowインタフェースは変更不可でリードオンリーである<em>account_mail_address</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AccountMailAddressRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AccountMailAddressRow extends Row {


  /** 
   * この{@@link AccountMailAddressRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "account_mail_address", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAddressDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getAddressDivIsModified();
