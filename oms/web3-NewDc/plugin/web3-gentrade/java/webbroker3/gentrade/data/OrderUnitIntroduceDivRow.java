...
1.1
date	2011.03.14.05.21.18;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	OrderUnitIntroduceDivRow.java;
...
/** 
 * OrderUnitIntroduceDivRowインタフェースは変更不可でリードオンリーである<em>order_unit_introduce_div</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link OrderUnitIntroduceDivRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface OrderUnitIntroduceDivRow extends Row {


  /** 
   * この{@@link OrderUnitIntroduceDivRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "order_unit_introduce_div", "account" );
  ...
  /** 
   * <em>introduce_branch_div</em>カラムの値を取得します。
   * @@return Stringの値 
   */
  ...
  /** 
   * <em>introduce_branch_div</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getIntroduceBranchDivIsSet();


  /** 
   * <em>introduce_branch_div</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getIntroduceBranchDivIsModified();
