...
1.1
date	2011.03.14.05.33.23;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	FeqBranchMarketDealtCondParams.java;
...
/** 
 * feq_branch_market_dealt_condテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link FeqBranchMarketDealtCondRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link FeqBranchMarketDealtCondParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link FeqBranchMarketDealtCondParams}が{@@link FeqBranchMarketDealtCondRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class FeqBranchMarketDealtCondParams extends Params implements FeqBranchMarketDealtCondRow {
  ...
  public static final String PTYPE = "feq_branch_market_dealt_cond";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = FeqBranchMarketDealtCondRow.TYPE;
  ...
  public RowType getRowType() {
    return FeqBranchMarketDealtCondRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のFeqBranchMarketDealtCondParamsオブジェクトを作成します。 
   */
  public FeqBranchMarketDealtCondParams() {
  ...
  /** 
   * 指定のFeqBranchMarketDealtCondRowオブジェクトの値を利用してFeqBranchMarketDealtCondParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するFeqBranchMarketDealtCondRowオブジェクト 
   */
  public FeqBranchMarketDealtCondParams( FeqBranchMarketDealtCondRow p_row )
  {
  ...
  {
    if ( !( other instanceof FeqBranchMarketDealtCondRow ) )
       return false;
    return fieldsEqual( (FeqBranchMarketDealtCondRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のFeqBranchMarketDealtCondRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( FeqBranchMarketDealtCondRow row )
  {
  ...
  {
    return new FeqBranchMarketDealtCondPK(institution_code, branch_code, market_code);
  }
