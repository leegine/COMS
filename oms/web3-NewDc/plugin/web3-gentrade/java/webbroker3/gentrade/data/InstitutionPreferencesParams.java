...
1.1
date	2011.03.14.05.42.55;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	InstitutionPreferencesParams.java;
...
/** 
 * institution_preferencesテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link InstitutionPreferencesRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link InstitutionPreferencesParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link InstitutionPreferencesParams}が{@@link InstitutionPreferencesRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class InstitutionPreferencesParams extends Params implements InstitutionPreferencesRow {
  ...
  public static final RowType TYPE = InstitutionPreferencesRow.TYPE;
  ...
  /** 
   * 値が未設定のInstitutionPreferencesParamsオブジェクトを作成します。 
   */
  public InstitutionPreferencesParams() {
  ...
  /** 
   * 指定のInstitutionPreferencesRowオブジェクトの値を利用してInstitutionPreferencesParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するInstitutionPreferencesRowオブジェクト 
   */
  public InstitutionPreferencesParams( InstitutionPreferencesRow p_row )
  {
  ...
  {
    if ( !( other instanceof InstitutionPreferencesRow ) )
       return false;
    return fieldsEqual( (InstitutionPreferencesRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のInstitutionPreferencesRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( InstitutionPreferencesRow row )
  {
  ...
  {
    return new InstitutionPreferencesPK(institution_id, name, name_serial_no);
  }
