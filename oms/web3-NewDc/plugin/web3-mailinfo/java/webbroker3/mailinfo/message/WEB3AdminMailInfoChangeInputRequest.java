...
1.1
date	2011.03.15.05.13.49;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminMailInfoChangeInputRequest.java;
...
File Name        : メール情報変更入力画面リクエスト(WEB3AdminMailInfoChangeInputRequest.java)
...
/**
 * (メール情報変更入力画面リクエスト)<BR>
 * メール情報変更入力画面リクエストクラス<BR>
 * 
 * @@author 魏馨
 * @@version 1.0
 */
public class WEB3AdminMailInfoChangeInputRequest extends WEB3GenRequest
{
    /**
    * ログ出力ユーティリティ。
    */
    ...
    /**
     * @@roseuid 416F1DCE0222
     */
    public WEB3AdminMailInfoChangeInputRequest()
    {
     ...
     * @@roseuid 413D53B2005E
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AdminMailInfoChangeInputResponse(this);
    }
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        //例外をスローする。
        if(!WEB3StringTypeUtility.isSingle(this.discernId))
        {
            log.exiting(STR_METHOD_NAME);
