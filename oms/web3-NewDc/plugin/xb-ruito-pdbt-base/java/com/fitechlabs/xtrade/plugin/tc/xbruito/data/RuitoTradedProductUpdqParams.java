...
1.1
date	2011.03.22.09.17.41;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RuitoTradedProductUpdqParams.java;
...
/** 
 * ruito_traded_product_updqテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link RuitoTradedProductUpdqRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link RuitoTradedProductUpdqParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link RuitoTradedProductUpdqParams}が{@@link RuitoTradedProductUpdqRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class RuitoTradedProductUpdqParams extends Params implements RuitoTradedProductUpdqRow {
  ...
  public static final RowType TYPE = RuitoTradedProductUpdqRow.TYPE;
  ...
  /** 
   * 値が未設定のRuitoTradedProductUpdqParamsオブジェクトを作成します。 
   */
  public RuitoTradedProductUpdqParams() {
  ...
  /** 
   * 指定のRuitoTradedProductUpdqRowオブジェクトの値を利用してRuitoTradedProductUpdqParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するRuitoTradedProductUpdqRowオブジェクト 
   */
  public RuitoTradedProductUpdqParams( RuitoTradedProductUpdqRow p_row )
  {
  ...
  {
    if ( !( other instanceof RuitoTradedProductUpdqRow ) )
       return false;
    return fieldsEqual( (RuitoTradedProductUpdqRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のRuitoTradedProductUpdqRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( RuitoTradedProductUpdqRow row )
  {
  ...
  {
    return new RuitoTradedProductUpdqPK(traded_product_id, valid_for_biz_date);
  }
