...
1.1
date	2011.03.22.09.16.26;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RuitoOrderActionRow.java;
...
/** 
 * RuitoOrderActionRowインタフェースは変更不可でリードオンリーである<em>ruito_order_action</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link RuitoOrderActionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface RuitoOrderActionRow extends Row {


  /** 
   * この{@@link RuitoOrderActionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ruito_order_action", "account" );
