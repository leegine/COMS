...
1.1
date	2011.03.22.09.17.58;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	RuitoOrderExecutionRow.java;
...
/** 
 * RuitoOrderExecutionRowインタフェースは変更不可でリードオンリーである<em>ruito_order_execution</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link RuitoOrderExecutionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface RuitoOrderExecutionRow extends Row {


  /** 
   * この{@@link RuitoOrderExecutionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "ruito_order_execution", "account" );
