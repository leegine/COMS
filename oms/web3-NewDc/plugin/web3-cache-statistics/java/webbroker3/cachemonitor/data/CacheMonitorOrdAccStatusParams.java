...
1.1
date	2011.03.14.03.43.58;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CacheMonitorOrdAccStatusParams.java;
...
/** 
 * cache_monitor_ord_acc_statusテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link CacheMonitorOrdAccStatusRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link CacheMonitorOrdAccStatusParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link CacheMonitorOrdAccStatusParams}が{@@link CacheMonitorOrdAccStatusRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class CacheMonitorOrdAccStatusParams extends Params implements CacheMonitorOrdAccStatusRow {
  ...
  public static final RowType TYPE = CacheMonitorOrdAccStatusRow.TYPE;
  ...
  /** 
   * 値が未設定のCacheMonitorOrdAccStatusParamsオブジェクトを作成します。 
   */
  public CacheMonitorOrdAccStatusParams() {
  ...
  /** 
   * 指定のCacheMonitorOrdAccStatusRowオブジェクトの値を利用してCacheMonitorOrdAccStatusParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するCacheMonitorOrdAccStatusRowオブジェクト 
   */
  public CacheMonitorOrdAccStatusParams( CacheMonitorOrdAccStatusRow p_row )
  {
  ...
  {
    if ( !( other instanceof CacheMonitorOrdAccStatusRow ) )
       return false;
    return fieldsEqual( (CacheMonitorOrdAccStatusRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のCacheMonitorOrdAccStatusRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( CacheMonitorOrdAccStatusRow row )
  {
  ...
  {
    return new CacheMonitorOrdAccStatusPK(institution_code, branch_code, order_acc_product, order_acc_transaction);
  }
