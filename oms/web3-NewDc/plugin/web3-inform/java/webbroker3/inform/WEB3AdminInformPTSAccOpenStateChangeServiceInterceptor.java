...
1.1
date	2011.03.15.04.54.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor.java;
...
File Name           : 管理者PTS口座開設状況変更サービスインタセプタ(WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor.java)
...
/**
 * 管理者PTS口座開設状況変更サービスインタセプタ<BR>
 * <BR>
 * @@author 柴双紅
 * @@version 1.0
 */
public class WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor.class);

    /**
     * @@roseuid 47C522D311EA
     */
    public WEB3AdminInformPTSAccOpenStateChangeServiceInterceptor()
    {
