...
1.1
date	2011.03.15.04.50.48;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliDeleteConfRequest.java;
...
File Name        : 管理者・口座切替・電子交付申込取消確認リクエスト(WEB3AdminInformAccSwElecDeliDeleteConfRequest.java)
...
public class WEB3AdminInformAccSwElecDeliDeleteConfRequest extends WEB3GenRequest
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminInformAccSwElecDeliDeleteConfRequest.class);
     ...
     * 管理者・口座切替・電子交付申込取消確認リクエスト<BR>
     */
    public WEB3AdminInformAccSwElecDeliDeleteConfRequest()
    {
    ...
    {
        return new WEB3AdminInformAccSwElecDeliDeleteConfResponse(this);
    }
}
@
