...
1.1
date	2011.03.15.04.49.37;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliApplyRefRequest.java;
...
File Name        : 管理者・口座切替・電子交付申込参照リクエスト(WEB3AdminInformAccSwElecDeliApplyRefRequest.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/09/18 孫洪江 (中訊) 新規作成 仕様変更モデル110
*/
...
/**
 * (管理者・口座切替・電子交付申込参照リクエスト)<BR>
 * 管理者・口座切替・電子交付申込参照リクエストクラス<BR>
 *
 * @@author 孫洪江
 * @@version 1.0
 */
public class WEB3AdminInformAccSwElecDeliApplyRefRequest extends WEB3GenRequest
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminInformAccSwElecDeliApplyRefRequest.class);
     ...
     * SerialVersionUID<BR>
     */
    public final static long serialVersionUID = 200709191014L;
    ...
    public WEB3AdminInformAccSwElecDeliApplyRefRequest()
    {
    ...
    {
        return new WEB3AdminInformAccSwElecDeliApplyRefResponse(this);
    }
}
@
