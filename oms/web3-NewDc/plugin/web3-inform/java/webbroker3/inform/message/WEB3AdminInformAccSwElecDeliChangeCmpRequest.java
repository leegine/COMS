...
1.1
date	2011.03.15.04.47.52;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliChangeCmpRequest.java;
...
File Name        : 管理者・口座切替・電子交付申込変更完了リクエスト（WEB3AdminInformAccSwElecDeliChangeCmpRequest.java）
...
/**
 * (管理者・口座切替・電子交付申込変更完了リクエスト)<BR>
 * 管理者・口座切替・電子交付申込変更完了リクエスト<BR>
 * <BR>
 * @@author トウ鋒鋼
 * @@version 1.0
 */
public class WEB3AdminInformAccSwElecDeliChangeCmpRequest extends WEB3GenRequest
{
    /**
     * (ログ出力ユーティリティ)
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminInformAccSwElecDeliChangeCmpRequest.class);
     ...
     * SerialVersionUID<BR>
     */
    public static final long serialVersionUID = 200709191119L;
    ...
    /**
     * @@roseuid 46F0900C0392
     */
    public WEB3AdminInformAccSwElecDeliChangeCmpRequest()
    {
    ...
    {
        return new WEB3AdminInformAccSwElecDeliChangeCmpResponse(this);
    }
