...
1.1
date	2011.03.15.04.49.49;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminInformAccSwElecDeliApplyConfRequest.java;
...
File Name        : 管理者・口座切替・電子交付申込確認リクエスト(WEB3AdminInformAccSwElecDeliApplyConfRequest.java)
...
/**
 * (管理者・口座切替・電子交付申込確認リクエスト)<BR>
 * 管理者・口座切替・電子交付申込確認リクエストクラス<BR>
 *
 * @@author 孫洪江
 * @@version 1.0
 */
public class WEB3AdminInformAccSwElecDeliApplyConfRequest extends WEB3GenRequest
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminInformAccSwElecDeliApplyConfRequest.class);
     ...
     * SerialVersionUID<BR>
     */
    public final static long serialVersionUID = 200707182144L;
    ...
    public WEB3AdminInformAccSwElecDeliApplyConfRequest()
    {
    ...
    {
        return new WEB3AdminInformAccSwElecDeliApplyConfResponse(this);
    }
}
@
