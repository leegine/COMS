...
1.1
date	2011.03.15.04.53.38;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3InformAccSwElecDeliApplyServiceInterceptor.java;
...
File Name        : 口座切替・電子交付申込サービスインタセプタ(WEB3InformAccSwElecDeliApplyServiceInterceptor.java)
...
/**
 * (口座切替・電子交付申込サービスインタセプタ)<BR>
 * 口座切替・電子交付申込サービスインタセプタ<BR>
 * <BR>
 * @@author 栄イ(中訊)
 * @@version 1.0
 */
public class WEB3InformAccSwElecDeliApplyServiceInterceptor implements Interceptor
{
    /**
     * (ログ出力ユーティリティ)
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3InformAccSwElecDeliApplyServiceInterceptor.class);

    /**
     * @@roseuid 4663A9D50148
     */
    public WEB3InformAccSwElecDeliApplyServiceInterceptor()
    {
