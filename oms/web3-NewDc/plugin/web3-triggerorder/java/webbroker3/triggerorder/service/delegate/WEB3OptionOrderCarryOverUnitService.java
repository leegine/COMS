...
1.1
date	2011.03.15.02.02.52;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3OptionOrderCarryOverUnitService.java;
...
File Name        : OP注文繰越UnitService(WEB3OptionOrderCarryOverUnitService.java)
...
/**
 * (OP注文繰越UnitService)<BR>
 * OP注文繰越１件サービスインタフェイス<BR>
 * <BR>
 * １件ごとの注文繰越処理を実施する。<BR>
 *                                                                    
 * @@author 張威
 * @@version 1.0
 */
public interface WEB3OptionOrderCarryOverUnitService extends Service
{
