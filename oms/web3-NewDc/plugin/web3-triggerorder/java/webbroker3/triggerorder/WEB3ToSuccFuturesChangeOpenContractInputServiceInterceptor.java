...
1.1
date	2011.03.15.01.54.56;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3ToSuccFuturesChangeOpenContractInputServiceInterceptor.java;
...
File Name        : （連続）先物訂正新規建入力サービスインタセプタ（WEB3ToSuccFuturesChangeOpenContractInputServiceInterceptor.java）
...
/**
 * (（連続）先物訂正新規建入力サービスインタセプタ)<BR>
 * （連続）株価指数先物訂正新規建入力サービスインタセプタ<BR>
 *
 * @@author トウ鋒鋼
 * @@value 1.0
 */
public class WEB3ToSuccFuturesChangeOpenContractInputServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3ToSuccFuturesChangeOpenContractInputServiceInterceptor.class);

    /**
     * @@roseuid 47D6593201B5
     */
    public WEB3ToSuccFuturesChangeOpenContractInputServiceInterceptor()
    {
     ...
     * @@param l_method - (メソッドサービス)<BR>
     * メソッドサービス<BR>
     * @@param l_serviceParams - (サービスメソッド引数)<BR>
     * サービスメソッド引数<BR>
     * @@return Object
     * @@roseuid 47C2728A0029
     */
    public Object onCall(Method l_method, Object[] l_serviceParams)
    {
        ...
        try
        {
            ...
            {
                WEB3SuccFuturesOpenChangeInputRequest l_inputRequest =
