...
1.1
date	2011.03.15.01.46.55;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccMarginCloseCompleteRequest.java;
...
File Name        : （連続）信用取引返済注文完了リクエストクラス(WEB3SuccMarginCloseCompleteRequest.java)
...
/**
 * (連続）信用取引返済注文完了リクエストクラス)<BR>
 * （連続）信用取引返済注文完了リクエストクラス<BR>
 * 
 * @@author 鄭徳懇
 * @@version 1.0 
 */
public class WEB3SuccMarginCloseCompleteRequest extends WEB3MarginCloseMarginCompleteRequest 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SuccMarginCloseCompleteRequest.class);
    ...
    /**
     * @@roseuid 4369CC0C03A9
     */
    public WEB3SuccMarginCloseCompleteRequest() 
    {
    ...
    {
        return new WEB3SuccMarginCloseCompleteResponse(this);
    }
