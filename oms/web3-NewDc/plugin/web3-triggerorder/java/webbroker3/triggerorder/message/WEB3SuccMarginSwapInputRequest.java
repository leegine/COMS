...
1.1
date	2011.03.15.01.41.04;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccMarginSwapInputRequest.java;
...
File Name        : （連続）信用取引現引現渡注文入力リクエストクラス(WEB3SuccMarginSwapInputRequest.java)
...
/**
 * (（連続）信用取引現引現渡注文入力リクエストクラス)<BR>
 * （連続）信用取引現引現渡注文入力リクエストクラス<BR>
 * 
 * @@author 鄭徳懇
 * @@version 1.0
 */
public class WEB3SuccMarginSwapInputRequest extends WEB3MarginSwapMarginInputRequest 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SuccMarginSwapInputRequest.class);
    ...
    /**
     * @@roseuid 4369CBEB003E
     */
    public WEB3SuccMarginSwapInputRequest() 
    {
    ...
    {
        return new WEB3SuccMarginSwapInputResponse(this);
    }
