...
1.1
date	2011.03.15.01.44.16;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccFuturesOpenConfirmRequest.java;
...
@/**
 ...
 File Name        :（連続）株価指数先物新規建注文確認リクエスト(WEB3SuccFuturesOpenConfirmRequest.java)
 ...
 * （連続）株価指数先物新規建注文確認リクエストクラス<BR>
 * <BR>
 * @@author 楊夫志
 * @@version 1.0
 */
public class WEB3SuccFuturesOpenConfirmRequest extends WEB3FuturesOpenMarginConfirmRequest
{

    /**
     * (ログ出力ユーティリティ)。<BR>
     */
    public static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3SuccFuturesOpenConfirmRequest.class);

    /**
     * serialVersionUID<BR>
     */
    public static final long serialVersionUID = 200803121856L;
    ...
    /**
     * @@roseuid 47D6593700CB
     */
    public WEB3SuccFuturesOpenConfirmRequest()
    {
    ...
    {
        return new WEB3SuccFuturesOpenConfirmResponse(this);
    }
