...
1.1
date	2011.03.15.01.42.19;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccFuturesCloseCompleteRequest.java;
...
@/**
 ...
 File Name        :（連続）株価指数先物返済注文完了リクエスト(WEB3SuccFuturesCloseCompleteRequest.java)
...
/**
 * (（連続）株価指数先物返済注文完了リクエスト)<BR>
 * （連続）株価指数先物返済注文完了リクエストクラス<BR>
 * <BR>
 * @@author 楊夫志
 * @@version 1.0
 */
public class WEB3SuccFuturesCloseCompleteRequest extends WEB3FuturesCloseMarginCompleteRequest
{

    /**
     * (ログ出力ユーティリティ)。<BR>
     */
    public static WEB3LogUtility log = WEB3LogUtility.getInstance(WEB3SuccFuturesCloseCompleteRequest.class);

    /**
     * serialVersionUID<BR>
     */
    public static final long serialVersionUID = 200803121806L;
    ...
    /**
     * @@roseuid 47D659390000
     */
    public WEB3SuccFuturesCloseCompleteRequest()
    {
    ...
    {
        return new WEB3SuccFuturesCloseCompleteResponse(this);
    }
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        if (WEB3ReserveOrderTradingTypeDef.SETTLE_FUTURE_ASSUMPTION_ORDER.equals(this.succCommonInfo.succTradingType)
            && (this.closingOrder == null || WEB3ClosingOrderDef.OPEN_DATE.equals(this.closingOrder)))
        {
