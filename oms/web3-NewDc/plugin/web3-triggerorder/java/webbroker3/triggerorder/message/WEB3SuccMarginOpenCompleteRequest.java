...
1.1
date	2011.03.15.01.43.59;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccMarginOpenCompleteRequest.java;
...
File Name        : （連続）信用取引新規建注文完了リクエストクラス(WEB3SuccMarginOpenCompleteRequest.java)
...
/**
 * (（連続）信用取引新規建注文完了リクエストクラス)<BR>
 * （連続）信用取引新規建注文完了リクエストクラス<BR>
 * 
 * @@author 鄭徳懇
 * @@version 1.0
 */
public class WEB3SuccMarginOpenCompleteRequest extends WEB3MarginOpenMarginCompleteRequest 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SuccMarginOpenCompleteRequest.class);
    ...
    /**
     * @@roseuid 4369CBF7000F
     */
    public WEB3SuccMarginOpenCompleteRequest() 
    {
    ...
    {
        return new WEB3SuccMarginOpenCompleteResponse(this);
    }
