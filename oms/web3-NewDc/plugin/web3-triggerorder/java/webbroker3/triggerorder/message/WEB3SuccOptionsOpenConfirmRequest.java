...
1.1
date	2011.03.15.01.41.21;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccOptionsOpenConfirmRequest.java;
...
File Name        : （連続）株価指数オプション新規建注文確認リクエスト(WEB3SuccOptionsOpenConfirmRequest.java)
 ...
 * （連続）株価指数オプション新規建注文確認リクエストクラス<BR>
 * <BR>
 * @@author 金シュ
 * @@version 1.0
 */
public class WEB3SuccOptionsOpenConfirmRequest extends WEB3OptionsOpenMarginConfirmRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SuccOptionsOpenConfirmRequest.class);

    /**
     * serialVersionUID<BR>
     */
    public static final long serialVersionUID = 200803141603L;
    ...
    /**
     * @@roseuid 47D9F2CA0367
     */
    public WEB3SuccOptionsOpenConfirmRequest()
    {
    ...
    {
        return new WEB3SuccOptionsOpenConfirmResponse(this);
    }
