...
1.1
date	2011.03.15.01.45.19;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccOptionsCloseConfirmRequest.java;
...
File Name        : （連続）株価指数オプション返済注文確認リクエスト(WEB3SuccOptionsCloseConfirmRequest.java)
...
/**
 * (（連続）株価指数オプション返済注文確認リクエスト)<BR>
 * （連続）株価指数オプション返済注文確認リクエストクラス<BR>
 * <BR>
 * @@author 金シュ
 * @@version 1.0
 */
public class WEB3SuccOptionsCloseConfirmRequest extends WEB3OptionsCloseMarginConfirmRequest
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SuccOptionsCloseConfirmRequest.class);

    /**
     * serialVersionUID<BR>
     */
    public static final long serialVersionUID = 200803141501L;
    ...
    /**
     * @@roseuid 47D9F2C903E4
     */
    public WEB3SuccOptionsCloseConfirmRequest()
    {
    ...
    {
        return new WEB3SuccOptionsCloseConfirmResponse(this);
    }
