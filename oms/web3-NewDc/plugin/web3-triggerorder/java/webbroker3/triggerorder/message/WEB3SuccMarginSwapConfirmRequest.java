...
1.1
date	2011.03.15.01.45.23;	author che-jin;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SuccMarginSwapConfirmRequest.java;
...
File Name        : （連続）信用取引現引現渡注文確認リクエストクラス(WEB3SuccMarginSwapConfirmRequest.java)
...
/**
 * (（連続）信用取引現引現渡注文確認リクエストクラス)<BR>
 * （連続）信用取引現引現渡注文確認リクエストクラス<BR>
 * 
 * @@author 鄭徳懇
 * @@version 1.0
 */
public class WEB3SuccMarginSwapConfirmRequest extends WEB3MarginSwapMarginConfirmRequest 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SuccMarginSwapConfirmRequest.class);
    ...
    /**
     * @@roseuid 4369CC4203B9
     */
    public WEB3SuccMarginSwapConfirmRequest() 
    {
    ...
    {
        return new WEB3SuccMarginSwapConfirmResponse(this);
    }
