...
1.2
date	2011.06.27.06.09.52;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CreateAccountInfoCodec.java;

1.1
date	2011.03.15.02.40.52;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class CreateAccountInfoCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "CreateAccountInfo" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.CreateAccountInfo";
  ...
  //schema  name = ['http://soap-api.gftforex.com']:AccountTemplateId
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","AccountTemplateId",null),
  ...
  //class   name = double
  //java    type = double
  //schema  name = ['http://soap-api.gftforex.com']:InitialDeposit
  //schema  type = ['http://soap-api.gftforex.com']:RoundSafeAmount
  //array: false primitive: true  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","InitialDeposit",null),
  ...
  //schema  type = ['http://soap-api.gftforex.com']:CreateAccountInfo__profiles__ArrayAnonType
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","Profiles",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","CreateAccountInfo__profiles__ArrayAnonType",null),
                                                            "profiles",
                                                            long[].class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.CreateAccountInfo();
  }
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.CreateAccountInfo typed_obj = (com.gftforex.soap.api.CreateAccountInfo) my_obj;

    switch(idx) {

    case 0:
      return typed_obj._isSetAccountTemplateId();
    case 1:
      return typed_obj._isSetCanTrade();
    case 2:
      return typed_obj._isSetInitialDeposit();
    case 3:
      return typed_obj._isSetBaseCurrency();
    case 4:
      return typed_obj._isSetLotSize();
    case 5:
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.CreateAccountInfo my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = my_obj.getAccountTemplateId();
      break;
    case 1:
      obj = my_obj.getCanTrade();
      break;
    case 2:
      obj = new java.lang.Double(my_obj.getInitialDeposit());
      break;
    case 3:
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.CreateAccountInfo my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setAccountTemplateId((java.lang.String)setter_arg);
      break;
    case 1:
      my_obj.setCanTrade((com.gftforex.soap.api.CanTrade)setter_arg);
      break;
    case 2:
      my_obj.setInitialDeposit(((java.lang.Number)setter_arg).doubleValue());
      break;
    case 3:
