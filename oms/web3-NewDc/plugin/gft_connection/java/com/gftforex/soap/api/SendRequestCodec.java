...
1.2
date	2011.06.27.06.06.34;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	SendRequestCodec.java;

1.1
date	2011.03.15.02.45.46;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class SendRequestCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "sendRequest" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.SendRequest";
  ...
  //class   name = [Lcom.gftforex.soap.api.CommandBase;
  //java    type = [Lcom.gftforex.soap.api.CommandBase;
  //schema  name = ['http://soap-api.gftforex.com']:commands
  //schema  type = ['http://soap-api.gftforex.com']:sendRequest__commands__ArrayAnonType
  //array: true primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","commands",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","sendRequest__commands__ArrayAnonType",null),
                                                            "commands",
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.SendRequest();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.SendRequest typed_obj = (com.gftforex.soap.api.SendRequest) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.SendRequest my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.SendRequest my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setCommands((com.gftforex.soap.api.CommandBase[])setter_arg);
      break;
    case 1:
