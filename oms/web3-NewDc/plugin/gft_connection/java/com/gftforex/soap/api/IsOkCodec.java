...
1.2
date	2011.06.27.06.13.17;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	IsOkCodec.java;

1.1
date	2011.03.15.02.44.39;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:isOk


public final class IsOkCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "isOk" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.IsOk";
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.IsOk();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.IsOk typed_obj = (com.gftforex.soap.api.IsOk) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.IsOk my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.IsOk my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
