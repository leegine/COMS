...
1.2
date	2011.06.27.06.02.32;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CreateAccountInfoProfilesArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.44.34;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:CreateAccountInfo__profiles__ArrayAnonType

// from array_deserialzer.j

public final class CreateAccountInfoProfilesArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
