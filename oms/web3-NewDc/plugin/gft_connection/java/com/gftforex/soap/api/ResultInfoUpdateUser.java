...
1.2
date	2011.06.27.06.03.57;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	ResultInfoUpdateUser.java;

1.1
date	2011.03.15.02.41.55;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public  class ResultInfoUpdateUser 
  extends com.gftforex.soap.api.ResultInfoBase
  implements java.io.Serializable
{

  public ResultInfoUpdateUser() {}

  public ResultInfoUpdateUser(java.lang.String p_commandID
,     int p_statusCode
...
,     java.lang.String p_minorStatusMessage) 
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof ResultInfoUpdateUser) {
      if (!super.equals(__other__)) return false;

      ResultInfoUpdateUser __obj__ =  (ResultInfoUpdateUser) __other__;
