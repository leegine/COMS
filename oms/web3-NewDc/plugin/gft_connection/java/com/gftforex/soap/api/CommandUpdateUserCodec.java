...
1.2
date	2011.06.27.06.10.54;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CommandUpdateUserCodec.java;

1.1
date	2011.03.15.02.41.17;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class CommandUpdateUserCodec 
  extends com.gftforex.soap.api.CommandBaseCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "CommandUpdateUser" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.CommandUpdateUser";
  ...
  //class   name = UpdateUserInfo
  //java    type = com.gftforex.soap.api.UpdateUserInfo
  //schema  name = ['http://soap-api.gftforex.com']:NewUserInfo
  //schema  type = ['http://soap-api.gftforex.com']:UpdateUserInfo
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","NewUserInfo",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","UpdateUserInfo",null),
                                                            "newUserInfo",
                                                            com.gftforex.soap.api.UpdateUserInfo.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.CommandUpdateUser();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.CommandUpdateUser typed_obj = (com.gftforex.soap.api.CommandUpdateUser) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.CommandUpdateUser my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.CommandUpdateUser my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      ...
      break;
    case 1:
      my_obj.setNewUserInfo((com.gftforex.soap.api.UpdateUserInfo)setter_arg);
      break;
