...
1.2
date	2011.06.27.06.07.52;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CreateUserInfoAccountsArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.42.08;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:CreateUserInfo__accounts__ArrayAnonType

// from array_deserialzer.j

public final class CreateUserInfoAccountsArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
