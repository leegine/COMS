...
1.2
date	2011.06.27.06.11.19;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	GetResponseCodec.java;

1.1
date	2011.03.15.02.41.47;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class GetResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "getResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.GetResponse";
  ...
  //class   name = long
  //java    type = long
  //schema  name = ['http://soap-api.gftforex.com']:maxCommands
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:unsignedInt
  //array: false primitive: true  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","maxCommands",null),
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.GetResponse();
  }
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.GetResponse typed_obj = (com.gftforex.soap.api.GetResponse) my_obj;

    switch(idx) {

    case 0:
      return typed_obj._isSetMaxCommands();
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.GetResponse my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = new java.lang.Long(my_obj.getMaxCommands());
      break;
    case 1:
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.GetResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setMaxCommands(((java.lang.Number)setter_arg).longValue());
      break;
    case 1:
