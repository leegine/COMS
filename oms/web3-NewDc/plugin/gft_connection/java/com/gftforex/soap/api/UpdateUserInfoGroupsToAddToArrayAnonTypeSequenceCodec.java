...
1.2
date	2011.06.27.06.12.46;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	UpdateUserInfoGroupsToAddToArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.39.41;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:UpdateUserInfo__groupsToAddTo__ArrayAnonType

// from array_deserialzer.j

public final class UpdateUserInfoGroupsToAddToArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","GroupsToAddTo",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "groupsToAddTo", elementClass, false, true);
