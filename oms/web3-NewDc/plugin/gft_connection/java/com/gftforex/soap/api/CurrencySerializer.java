...
1.2
date	2011.06.27.06.10.17;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CurrencySerializer.java;

1.1
date	2011.03.15.02.42.29;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:Currency


public final class CurrencySerializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDTokenSerializer
{
  ...
  protected java.lang.String getContentFromObject(java.lang.Object obj, 
	...
	try {
          CurrencyDeserializer.validate(obj);
