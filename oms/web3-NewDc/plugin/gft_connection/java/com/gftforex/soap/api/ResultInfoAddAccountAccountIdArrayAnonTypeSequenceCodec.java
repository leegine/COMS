...
1.2
date	2011.06.27.06.11.32;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	ResultInfoAddAccountAccountIdArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.45.29;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:ResultInfoAddAccount__accountId__ArrayAnonType

// from array_deserialzer.j

public final class ResultInfoAddAccountAccountIdArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","AccountId",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "accountId", elementClass, false, true);
