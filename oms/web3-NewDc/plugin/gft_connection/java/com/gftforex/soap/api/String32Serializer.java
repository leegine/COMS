...
1.2
date	2011.06.27.06.12.59;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	String32Serializer.java;

1.1
date	2011.03.15.02.46.53;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class String32Serializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDStringSerializer
{
  ...
  protected java.lang.String getContentFromObject(java.lang.Object obj, 
	...
	try {
          String32Deserializer.validate(obj);
