...
1.2
date	2011.06.27.06.05.40;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	GetResponseResponseSequenceCodec.java;

1.1
date	2011.03.15.02.45.20;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:getResponseResponse

// from array_deserialzer.j

public final class GetResponseResponseSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  private static final  weblogic.xml.stream.XMLName XML_TYPE =
    weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","getResponseResponse",null);
  ...
  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","getResponseResult",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "getResponseResult", elementClass, false, true);
