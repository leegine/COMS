...
1.2
date	2011.06.27.06.03.23;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CommandTransferBaseCodec.java;

1.1
date	2011.03.15.02.40.31;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public  class CommandTransferBaseCodec 
  extends com.gftforex.soap.api.CommandBaseCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "CommandTransferBase" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.CommandTransferBase";
  ...
  //class   name = double
  //java    type = double
  //schema  name = ['http://soap-api.gftforex.com']:Amount
  //schema  type = ['http://soap-api.gftforex.com']:RoundSafeAmount
  //array: false primitive: true  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","Amount",null),
  ...
  //schema  name = ['http://soap-api.gftforex.com']:Currency
  //schema  type = ['http://soap-api.gftforex.com']:Currency
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","Currency",null),
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.CommandTransferBase();
  }
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.CommandTransferBase typed_obj = (com.gftforex.soap.api.CommandTransferBase) my_obj;

    switch(idx) {

    case 2:
      return typed_obj._isSetCurrency();
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.CommandTransferBase my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      ...
      break;
    case 1:
      obj = new java.lang.Double(my_obj.getAmount());
      break;
    case 2:
      obj = my_obj.getCurrency();
      break;
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.CommandTransferBase my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      ...
      break;
    case 1:
      my_obj.setAmount(((java.lang.Number)setter_arg).doubleValue());
      break;
    case 2:
      my_obj.setCurrency((java.lang.String)setter_arg);
      break;
