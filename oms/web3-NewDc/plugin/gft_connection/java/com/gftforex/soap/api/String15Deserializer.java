...
1.2
date	2011.06.27.06.09.58;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	String15Deserializer.java;

1.1
date	2011.03.15.02.41.42;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class String15Deserializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDStringDeserializer
{
    ...
    throws weblogic.xml.schema.binding.DeserializationException
  {
    ...
    weblogic.xml.schema.binding.FacetUtils.checkMaxLengthFacet(__typed_obj,15L);
