...
1.2
date	2011.06.27.06.04.39;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	UpdateAccountInfoProfilesToRemoveArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.42.41;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:UpdateAccountInfo__profilesToRemove__ArrayAnonType

// from array_deserialzer.j

public final class UpdateAccountInfoProfilesToRemoveArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","ProfilesToRemove",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "profilesToRemove", elementClass, false, true);
