...
1.2
date	2011.06.27.06.08.06;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	LookupUserInfoCodec.java;

1.1
date	2011.03.15.02.44.59;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class LookupUserInfoCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "LookupUserInfo" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.LookupUserInfo";
  ...
  //package name = com.gftforex.soap.api
  //class   name = [Lcom.gftforex.soap.api.LookupAccountInfo;
  //java    type = [Lcom.gftforex.soap.api.LookupAccountInfo;
  //schema  name = ['http://soap-api.gftforex.com']:Accounts
  //schema  type = ['http://soap-api.gftforex.com']:LookupUserInfo__accounts__ArrayAnonType
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","Accounts",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","LookupUserInfo__accounts__ArrayAnonType",null),
                                                            "accounts",
                                                            com.gftforex.soap.api.LookupAccountInfo[].class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.LookupUserInfo();
  }
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.LookupUserInfo typed_obj = (com.gftforex.soap.api.LookupUserInfo) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.LookupUserInfo my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.LookupUserInfo my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 1:
      ...
      break;
    case 2:
      my_obj.setAccounts((com.gftforex.soap.api.LookupAccountInfo[])setter_arg);
      break;
