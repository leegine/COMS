...
1.2
date	2011.06.27.06.07.47;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	ResultInfoDeposit.java;

1.1
date	2011.03.15.02.40.06;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public  class ResultInfoDeposit 
  extends com.gftforex.soap.api.ResultInfoBase
  implements java.io.Serializable
{

  public ResultInfoDeposit() {}

  public ResultInfoDeposit(java.lang.String p_commandID
,     int p_statusCode
...
,     java.lang.String p_minorStatusMessage) 
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof ResultInfoDeposit) {
      if (!super.equals(__other__)) return false;

      ResultInfoDeposit __obj__ =  (ResultInfoDeposit) __other__;
