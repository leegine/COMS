...
1.2
date	2011.06.27.06.02.53;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	SendRequestResponseRejectedCommandArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.45.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:sendRequestResponse__rejectedCommand__ArrayAnonType

// from array_deserialzer.j

public final class SendRequestResponseRejectedCommandArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "rejectedCommand", elementClass, false, true);
