...
1.2
date	2011.06.27.06.08.25;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	UserSystemInfoProfilesArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.41.09;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:UserSystemInfo__profiles__ArrayAnonType

// from array_deserialzer.j

public final class UserSystemInfoProfilesArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
