...
1.2
date	2011.06.27.06.09.45;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	ResultInfoUpdateUserCodec.java;

1.1
date	2011.03.15.02.40.14;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:ResultInfoUpdateUser


public final class ResultInfoUpdateUserCodec 
  extends com.gftforex.soap.api.ResultInfoBaseCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "ResultInfoUpdateUser" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.ResultInfoUpdateUser";
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.ResultInfoUpdateUser();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.ResultInfoUpdateUser typed_obj = (com.gftforex.soap.api.ResultInfoUpdateUser) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.ResultInfoUpdateUser my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.ResultInfoUpdateUser my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
