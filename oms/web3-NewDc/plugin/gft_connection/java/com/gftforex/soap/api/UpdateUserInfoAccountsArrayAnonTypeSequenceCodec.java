...
1.2
date	2011.06.27.06.10.11;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	UpdateUserInfoAccountsArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.44.22;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:UpdateUserInfo__accounts__ArrayAnonType

// from array_deserialzer.j

public final class UpdateUserInfoAccountsArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementType =
    weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","UpdateAccountInfo",null);
