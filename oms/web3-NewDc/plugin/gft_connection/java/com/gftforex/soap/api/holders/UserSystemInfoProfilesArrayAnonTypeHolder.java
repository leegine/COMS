...
1.1
date	2011.03.15.02.35.55;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	UserSystemInfoProfilesArrayAnonTypeHolder.java;
...
public final class UserSystemInfoProfilesArrayAnonTypeHolder 
  implements weblogic.xml.schema.binding.Holder
{

  public long[] value;

  public UserSystemInfoProfilesArrayAnonTypeHolder() {}

  public UserSystemInfoProfilesArrayAnonTypeHolder(long[] value) {
    this.value = value;
  } 
