...
1.2
date	2011.06.27.06.08.20;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	ResultInfoLookupUserCodec.java;

1.1
date	2011.03.15.02.40.27;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class ResultInfoLookupUserCodec 
  extends com.gftforex.soap.api.ResultInfoBaseCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "http://soap-api.gftforex.com" , "ResultInfoLookupUser" );

  private static final java.lang.String JAVA_TYPE = 
     "com.gftforex.soap.api.ResultInfoLookupUser";
  ...
  //class   name = LookupUserInfo
  //java    type = com.gftforex.soap.api.LookupUserInfo
  //schema  name = ['http://soap-api.gftforex.com']:UserInfo
  //schema  type = ['http://soap-api.gftforex.com']:LookupUserInfo
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","UserInfo",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("http://soap-api.gftforex.com","LookupUserInfo",null),
                                                            "userInfo",
                                                            com.gftforex.soap.api.LookupUserInfo.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new com.gftforex.soap.api.ResultInfoLookupUser();
  }
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    com.gftforex.soap.api.ResultInfoLookupUser typed_obj = (com.gftforex.soap.api.ResultInfoLookupUser) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(com.gftforex.soap.api.ResultInfoLookupUser my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(com.gftforex.soap.api.ResultInfoLookupUser my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setUserInfo((com.gftforex.soap.api.LookupUserInfo)setter_arg);
      break;
