...
1.2
date	2011.06.27.06.09.13;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CommandWithdraw.java;

1.1
date	2011.03.15.02.40.48;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
  ...
  implements java.io.Serializable
{
  ...
  public CommandWithdraw(java.lang.String p_commandID
,     long p_accountID
,     double p_amount
,     java.lang.String p_currency) 
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof CommandWithdraw) {
      if (!super.equals(__other__)) return false;

      CommandWithdraw __obj__ =  (CommandWithdraw) __other__;
