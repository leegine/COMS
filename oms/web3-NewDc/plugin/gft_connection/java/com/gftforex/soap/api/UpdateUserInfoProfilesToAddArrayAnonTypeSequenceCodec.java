...
1.2
date	2011.06.27.06.13.11;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	UpdateUserInfoProfilesToAddArrayAnonTypeSequenceCodec.java;

1.1
date	2011.03.15.02.44.18;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:UpdateUserInfo__profilesToAdd__ArrayAnonType

// from array_deserialzer.j

public final class UpdateUserInfoProfilesToAddArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
