...
1.2
date	2011.06.27.06.03.33;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	String64Deserializer.java;

1.1
date	2011.03.15.02.44.01;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:String64


public final class String64Deserializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDStringDeserializer
{
    ...
    throws weblogic.xml.schema.binding.DeserializationException
  {
    ...
    weblogic.xml.schema.binding.FacetUtils.checkMaxLengthFacet(__typed_obj,64L);
