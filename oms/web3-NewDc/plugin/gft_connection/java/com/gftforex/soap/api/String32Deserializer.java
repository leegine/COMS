...
1.2
date	2011.06.27.06.08.15;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	String32Deserializer.java;

1.1
date	2011.03.15.02.41.34;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
// original type: ['http://soap-api.gftforex.com']:String32


public final class String32Deserializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDStringDeserializer
{
    ...
    throws weblogic.xml.schema.binding.DeserializationException
  {
    ...
    weblogic.xml.schema.binding.FacetUtils.checkMaxLengthFacet(__typed_obj,32L);
