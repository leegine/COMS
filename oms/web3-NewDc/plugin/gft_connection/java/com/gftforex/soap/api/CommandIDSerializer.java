...
1.2
date	2011.06.27.06.11.13;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	CommandIDSerializer.java;

1.1
date	2011.03.15.02.46.36;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class CommandIDSerializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDTokenSerializer
{
  ...
  protected java.lang.String getContentFromObject(java.lang.Object obj, 
	...
	try {
          CommandIDDeserializer.validate(obj);
