...
1.2
date	2011.06.27.06.07.37;	author zhang-tengyu;	state dead;
branches;
next	1.1;
deltatype	text;
kopt	kv;
...
filename	String1024Serializer.java;

1.1
date	2011.03.15.02.40.19;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
public final class String1024Serializer 
  extends weblogic.xml.schema.binding.internal.builtin.XSDStringSerializer
{
  ...
  protected java.lang.String getContentFromObject(java.lang.Object obj, 
	...
	try {
          String1024Deserializer.validate(obj);
