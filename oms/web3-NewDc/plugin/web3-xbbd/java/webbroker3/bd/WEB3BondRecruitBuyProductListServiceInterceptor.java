...
filename	WEB3BondRecruitBuyProductListServiceInterceptor.java;
...
File Name        : 債券応募/買付銘柄一覧サービスインタセプタ(WEB3BondRecruitBuyProductListServiceInterceptor.java)
...
/**
 * (債券応募/買付銘柄一覧サービスインタセプタ)<BR>
 * 債券応募/買付銘柄一覧サービスインタセプタ
 *   
 * @@author 郭英
 * @@version 1.0
 */
public class WEB3BondRecruitBuyProductListServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log = 
        WEB3LogUtility.getInstance(WEB3BondRecruitBuyProductListServiceInterceptor.class);   
    
    /**
     * @@roseuid 44FBFD3802CE
     */
    public WEB3BondRecruitBuyProductListServiceInterceptor() 
    {
