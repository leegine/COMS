...
filename	WEB3AdminBondDomesticProductRegistServiceInterceptor.java;
...
File Name        : 管理者国内債券銘柄登録インタセプタ(WEB3AdminBondDomesticProductRegistServiceInterceptor.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/07/09 何文敏(中訊) 新規作成 仕様変更・モデルNo.193
Revision History : 2007/07/10 柴双紅(中訊) 仕様変更・モデルNo.198
*/
...
/**
 * (管理者国内債券銘柄登録インタセプタ)<BR>
 * 管理者国内債券銘柄登録インタセプタ<BR>
 * <BR>
 * @@author 何文敏
 * @@version 1.0
 */
public class WEB3AdminBondDomesticProductRegistServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminBondDomesticProductRegistServiceInterceptor.class);

    /**
     * @@roseuid 4691D3AE0065
     */
    public WEB3AdminBondDomesticProductRegistServiceInterceptor()
    {
