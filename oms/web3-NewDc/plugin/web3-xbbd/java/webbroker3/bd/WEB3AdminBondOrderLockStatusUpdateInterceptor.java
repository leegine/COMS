...
File Name        : 債券管理者注文ロック区分更新インタセプタ(WEB3AdminBondOrderLockStatusUpdateInterceptor.java)
...
public class WEB3AdminBondOrderLockStatusUpdateInterceptor implements Interceptor 
{
     ...
     * 　@　@拡張債券注文マネージャ.get債券注文単位()をコールして債券注文単位オブジェクトを取得する。 <BR>
     * 　@　@[引数]  <BR>
     * 　@　@　@注文ID： 引数.注文ID<BR>
    ...
    public Object onCall(Method l_method, Object[] l_serviceParam) 
    {
        ...
        {
            // １）債券注文単位オブジェクトの取得 
            //     拡張債券注文マネージャ.get債券注文単位()をコールして債券注文単位オブジェクトを取得する。 
            //        [引数]  
            //        注文ID： 引数.注文ID
