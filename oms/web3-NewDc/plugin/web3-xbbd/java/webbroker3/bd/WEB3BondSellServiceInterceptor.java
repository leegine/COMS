...
filename	WEB3BondSellServiceInterceptor.java;
...
File Name        : 債券売却サービスインタセプタ(WEB3BondSellServiceInterceptor.java)
 ...
 * @@version 1.0
 */
public class WEB3BondSellServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3BondSellServiceInterceptor.class);
    
    /**
     * @@roseuid 44FCD0BB0242
     */
    public WEB3BondSellServiceInterceptor() 
    {
     ...
     * <BR>
     * ３）　@リクエストデータの型が「債券売却完了リクエスト」の場合のみ、<BR>
     * 　@　@　@口座をロックする。<BR>
    ...
    public java.lang.Object onCall(Method l_method, Object[] l_serviceParam) 
    {
        ...
        try
        {
            ...
            //３）　@リクエストデータの型が「債券売却完了リクエスト」の場合のみ、口座をロックする。 
            //　@－拡張アカウントマネージャ.lock口座(証券会社コード, 部店コード, 口座コード)をコールする。 
            //　@　@※引数はOpLoginSecurityServiceより編集。
            if (l_serviceParam[0] instanceof WEB3BondSellCompleteRequest)
            {
