...
filename	WEB3BondExecuteReferenceServiceInterceptor.java;
...
File Name        : 債券注文約定照会サービスインタセプタ (WEB3BondExecuteReferenceInterceptor.java)
...
/**
 * (債券注文約定照会サービスインタセプタ)<BR>
 * 債券注文約定照会サービスインタセプタ
 * 
 * @@author 周捷
 * @@version 1.0
 */
public class WEB3BondExecuteReferenceServiceInterceptor implements Interceptor 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3BondExecuteReferenceServiceInterceptor.class);
    /**
     * @@roseuid 44E352420242
     */
    public WEB3BondExecuteReferenceServiceInterceptor() 
    {
