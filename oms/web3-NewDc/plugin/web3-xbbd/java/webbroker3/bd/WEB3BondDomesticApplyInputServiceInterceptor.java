...
filename	WEB3BondDomesticApplyInputServiceInterceptor.java;
...
File Name        : 国内債券応募入力サービスインタセプタ(WEB3BondDomesticApplyInputServiceInterceptor.java)
 ...
 * @@version 1.0
 */
public class WEB3BondDomesticApplyInputServiceInterceptor implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3BondDomesticApplyInputServiceInterceptor.class);

    /**
     * @@roseuid 46A473FC0138
     */
    public WEB3BondDomesticApplyInputServiceInterceptor()
    {
