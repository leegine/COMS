...
/** 
 * <b>Custodian</b>データベーステーブルで一意である1つのレコードをあらわす<b>Custodian</b>インスタンスを特定する主キーオブジェクトです。 
 * <p> 
 * これは通常メモリ内に構築され、<b>Custodian</b>テーブルから特定のレコードを検索するため{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor} 
 * クエリメソッドへ引数として渡されます。 
 * 
...
public class CustodianPK implements PrimaryKey {
   ...
   * @@return この主キーに紐付くテーブルのRowType: CustodianRow. 
   */
  ...
  /**
   * <em>custodian_code</em>カラムの値をあらわす2桁以下のString値 
   */
