...
filename	BondProductCouponParams.java;
...
/** 
 * bond_product_couponテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link BondProductCouponRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link BondProductCouponParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link BondProductCouponParams}が{@@link BondProductCouponRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class BondProductCouponParams extends Params implements BondProductCouponRow {
  ...
  public static final RowType TYPE = BondProductCouponRow.TYPE;
  ...
  /** 
   * 値が未設定のBondProductCouponParamsオブジェクトを作成します。 
   */
  public BondProductCouponParams() {
  ...
  /** 
   * 指定のBondProductCouponRowオブジェクトの値を利用してBondProductCouponParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するBondProductCouponRowオブジェクト 
   */
  public BondProductCouponParams( BondProductCouponRow p_row )
  {
  ...
  {
    if ( !( other instanceof BondProductCouponRow ) )
       return false;
    return fieldsEqual( (BondProductCouponRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のBondProductCouponRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( BondProductCouponRow row )
  {
  ...
  {
    return new BondProductCouponPK(product_id, interest_payment_day);
  }
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            case 'c':
                ...
                break;
            case 'i':
                if ( name.equals("interest_payment_day") ) {
