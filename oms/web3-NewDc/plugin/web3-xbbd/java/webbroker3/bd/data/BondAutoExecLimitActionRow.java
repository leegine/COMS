...
filename	BondAutoExecLimitActionRow.java;
...
/** 
 * BondAutoExecLimitActionRowインタフェースは変更不可でリードオンリーである<em>bond_auto_exec_limit_action</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link BondAutoExecLimitActionRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface BondAutoExecLimitActionRow extends Row {


  /** 
   * この{@@link BondAutoExecLimitActionRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "bond_auto_exec_limit_action", "master" );
   ...
   */
  public java.sql.Timestamp getExecutionUpdateDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getExecutionUpdateDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getExecutionUpdateDateIsModified();
   ...
   * @@return Stringの値 
   */
  public String getOnlineDispDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOnlineDispDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOnlineDispDivIsModified();
