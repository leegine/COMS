...
File Name        : 外株口座への振替取消サービスインタセプタクラス(WEB3FEqConTransferCancelServiceInterceptor)
...
/**
 * (外株口座への振替取消サービスインタセプタ)<BR>
 * 外株口座への振替取消サービスインタセプタクラス
 * 
 * @@author 韋念瓊(中訊)
 * @@version 1.0
 */
public class WEB3FEqConTransferCancelServiceInterceptor implements Interceptor 
{
     ...
     * <BR>
     * ３）　@リクエストデータの型が「外株口座への振替取消完了リクエスト」の場合のみ、<BR>
     *      口座をロックする。 <BR>
    ...
    public Object onCall(Method l_method, Object[] l_serviceParams) 
    {
        ...
        try
        {
            ...
            //３）　@リクエストデータの型が「外株口座への振替取消完了リクエスト」の場合のみ、口座をロックする。 
