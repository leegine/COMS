...
1.1
date	2011.03.16.02.34.44;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinSettleErrorServiceInterceptor.java;
...
File Name        : 決済エラーサービスインタセプタクラス(WEB3AioCashinSettleErrorServiceInterceptor.java)
...
/**
 * (決済エラーサービスインタセプタ)<BR>
 * 決済エラーサービスインタセプタクラス<BR>
 *
 * @@author 王蘭芬(中訊)
 * @@version 1.0
 */
public class WEB3AioCashinSettleErrorServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinSettleErrorServiceInterceptor.class);

    /**
     * @@roseuid 415A781A0035
     */
    public WEB3AioCashinSettleErrorServiceInterceptor() 
    {
