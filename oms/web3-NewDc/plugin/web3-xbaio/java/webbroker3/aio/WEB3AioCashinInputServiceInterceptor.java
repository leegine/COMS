...
1.1
date	2011.03.16.02.24.12;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinInputServiceInterceptor.java;
...
File Name        : オンライン入金入力サービスインタセプタクラス(WEB3AioCashinInputServiceInterceptor)
...
/**
 * (オンライン入金入力サービスインタセプタ)<BR>
 * オンライン入金入力サービスインタセプタクラス<BR>
 * 
 * @@author 屈陽(中訊)
 * @@version 1.0
 */
public class WEB3AioCashinInputServiceInterceptor implements Interceptor 
{
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinInputServiceInterceptor.class);   
