...
1.1
date	2011.03.16.02.28.12;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioSLRepayApplyInputServiceInterceptor.java;
...
File Name        : 証券担保ローン返済申込入力サービスインタセプタ(WEB3AioSLRepayApplyInputServiceInterceptor.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/09/12 柴双紅 (中訊) 新規作成 仕様変更 モデルNo.757
*/
...
/**
 * (証券担保ローン返済申込入力サービスインタセプタ)<BR>
 * 証券担保ローン返済申込入力サービスインタセプタクラス<BR>
 * <BR>
 * @@author 柴双紅
 * @@version 1.0
 */
public class WEB3AioSLRepayApplyInputServiceInterceptor implements Interceptor
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioSLRepayApplyInputServiceInterceptor.class);

    /**
     * @@roseuid 46E8908203D5
     */
    public WEB3AioSLRepayApplyInputServiceInterceptor()
    {
