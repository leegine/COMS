...
1.1
date	2011.03.16.02.30.27;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFXAccOpenManagementServiceInterceptor.java;
...
File Name        : 管理者FX口座開設管理サービスインタセプタ(WEB3AdminFXAccOpenManagementServiceInterceptor.java)
...
/**
 * (管理者FX口座開設管理サービスインタセプタ) <BR>
 * 管理者FX口座開設管理サービスインタセプタ
 * 
 * @@author 于美麗(中訊)
 * @@version 1.0
 */
public class WEB3AdminFXAccOpenManagementServiceInterceptor implements
    Interceptor
{
    /**
     * ログユーティリティ<BR>
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFXAccOpenManagementServiceInterceptor.class);
