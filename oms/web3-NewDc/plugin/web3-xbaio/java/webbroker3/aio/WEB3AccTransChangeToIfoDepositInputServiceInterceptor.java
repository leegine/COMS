...
1.1
date	2011.03.16.02.24.43;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AccTransChangeToIfoDepositInputServiceInterceptor.java;
...
File Name        : 証拠金への振替入力サービスインタセプタ(WEB3AccTransChangeToIfoDepositInputServiceInterceptor)
...
/**
 * (証拠金への振替入力サービスインタセプタ)<BR>
 * 証拠金への振替入力サービスインタセプタクラス<BR>
 * 
 * @@author 于美麗(中訊)
 * @@version 1.0
 */
public class WEB3AccTransChangeToIfoDepositInputServiceInterceptor
    implements Interceptor
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AccTransChangeToIfoDepositInputServiceInterceptor.class);
