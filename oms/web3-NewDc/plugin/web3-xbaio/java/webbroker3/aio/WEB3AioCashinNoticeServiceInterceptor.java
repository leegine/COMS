...
1.1
date	2011.03.16.02.30.40;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinNoticeServiceInterceptor.java;
...
File Name        : 入金連絡サービスインタセプタクラス(WEB3AioCashinNoticeServiceInterceptor)
 ...
 * @@version 1.0
 */
public class WEB3AioCashinNoticeServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinNoticeServiceInterceptor.class);
