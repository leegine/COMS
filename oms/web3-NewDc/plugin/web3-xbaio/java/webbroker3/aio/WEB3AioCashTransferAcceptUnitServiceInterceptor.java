...
1.1
date	2011.03.16.02.29.58;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashTransferAcceptUnitServiceInterceptor.java;
...
File Name        : 入出金受付UnitServiceインタセプタクラス(WEB3AioCashTransferAcceptUnitServiceInterceptor)
...
/**
 * (入出金受付UnitServiceインタセプタ)<BR>
 * 入出金受付UnitServiceインタセプタクラス
 */
public class WEB3AioCashTransferAcceptUnitServiceInterceptor implements Interceptor 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashTransferAcceptUnitServiceInterceptor.class);
