...
1.1
date	2011.03.16.02.23.02;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAioSLProductRegistServiceInterceptor.java;
...
File Name        : 担保銘柄登録サービスインタセプタ(WEB3AdminSLProductRegistServiceInterceptor.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/09/14 趙林鵬(中訊) 新規作成 モデルNo.760
Revision History : 2007/10/10 金傑（中訊）モデルNo.804
*/
...
public class WEB3AdminAioSLProductRegistServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。 <BR>
     */
    private static WEB3LogUtility log = WEB3LogUtility.getInstance(
        WEB3AdminAioSLProductRegistServiceInterceptor.class);

    /**
     * 担保銘柄登録サービスインタセプタ<BR>
     */
    public WEB3AdminAioSLProductRegistServiceInterceptor()
    {
