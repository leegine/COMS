...
1.1
date	2011.03.16.02.23.37;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinSettleCompleteServiceInterceptor.java;
...
File Name        : 決済完了サービスインタセプタクラス(WEB3AioCashinSettleCompleteServiceInterceptor)
...
/**
 * (決済完了サービスインタセプタ)<BR>
 * 決済完了サービスインタセプタクラス<BR>
 * 
 * @@author 屈陽(中訊)
 * @@version 1.0
 */
public class WEB3AioCashinSettleCompleteServiceInterceptor implements Interceptor 
{
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinSettleCompleteServiceInterceptor.class);   
