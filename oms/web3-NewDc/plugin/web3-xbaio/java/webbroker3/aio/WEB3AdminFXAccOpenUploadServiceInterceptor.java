...
1.1
date	2011.03.16.02.21.39;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFXAccOpenUploadServiceInterceptor.java;
...
File Name        : 管理者FX口座開設アップロードサービスインタセプタ(WEB3AdminFXAccOpenUploadServiceInterceptor.java)
Author Name      : Daiwa Institute of Research
Revesion History : 2006/02/17 鄭徳懇(中訊) 新規作成
                 : 2006/03/06 情野（SRA） 仕様変更・モデル514
*/
...
/**
 * (管理者FX口座開設アップロードサービスインタセプタ)<BR>
 * 管理者FX口座開設アップロードサービスインタセプタ<BR>
 * 
 * @@author 鄭徳懇
 * @@version 1.0
 */
public class WEB3AdminFXAccOpenUploadServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFXAccOpenUploadServiceInterceptor.class);
    
    /**
     * @@roseuid 43F49D5D01A5
     */
    public WEB3AdminFXAccOpenUploadServiceInterceptor() 
    {
     ...
     * 　@(サービス利用申込)(為替保証金口座開設)” <BR>
     * <BR>
     * 　@－ThreadLocalSystemAttributesRegistry.setAttribute( )にて取引時間コンテキスト<BR>
     * 　@　@をセットする。 <BR>
