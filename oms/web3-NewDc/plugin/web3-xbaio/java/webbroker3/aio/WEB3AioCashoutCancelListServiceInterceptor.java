...
1.1
date	2011.03.16.02.26.29;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashoutCancelListServiceInterceptor.java;
...
File Name        : 出金取消一覧サービスインタセプタ(WEB3AioCashoutCancelListServiceInterceptor)
...
/**
 * (出金取消一覧サービスインタセプタ)<BR>
 * 出金取消一覧サービスインタセプタクラス<BR>
 * 
 * @@author 黄建(中訊)
 * @@version 1.0  
 */

public class WEB3AioCashoutCancelListServiceInterceptor implements Interceptor 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AioCashoutCancelListServiceInterceptor.class);
