...
1.1
date	2011.03.16.02.31.42;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FXAccOpenInputServiceInterceptor.java;
...
File Name        : FX口座開設入力サービスインタセプタ(WEB3FXAccOpenInputServiceInterceptor)
Author Name      : Daiwa Institute of Research
Revesion History : 2005/1/26 周勇 (中訊) 新規作成
Revesion History : 2008/09/22 武波 (中訊) 仕様変更・モデル1014,1022,1033,1068,1079
Revesion History : 2009/03/18 車進 (中訊) 仕様変更・モデル1119
*/
...
/**
 * (FX口座開設入力サービスインタセプタ) <BR>
 * FX口座開設入力サービスインタセプタ <BR>
 * @@author 周勇(中訊)
 * @@version 1.0 
 */
public class WEB3FXAccOpenInputServiceInterceptor implements Interceptor
{
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3FXAccOpenInputServiceInterceptor.class);
    
    /**
     * @@roseuid 41E783E30186
     */
    public WEB3FXAccOpenInputServiceInterceptor()
    {
    }
    ...
    public Object onCall(Method l_method, Object[] l_serviceParam)
    {
        ...
        {
            l_strFxSystemCode =
                ((WEB3FXAccOpenTradeAgreementRequest) l_request).fxSystemCode;
        }
        else if (l_request instanceof WEB3FXAccOpenInputRequest)
        {
            l_strFxSystemCode =
                ((WEB3FXAccOpenInputRequest) l_request).fxSystemCode;
        }
