...
/** 
 * {@@link UwgAccountOpenStatusDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link UwgAccountOpenStatusRow}インスタンスへ関連付けることができます。 
...
public class UwgAccountOpenStatusDao extends DataAccessObject {
  ...
  /** 
   * この{@@link UwgAccountOpenStatusDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link UwgAccountOpenStatusRow}と仮定される{@@link DataAccessObject}から新たに{@@link UwgAccountOpenStatusDao}を返します。 
         * @@return 指定のRowに結びつく{@@link UwgAccountOpenStatusDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link UwgAccountOpenStatusRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link UwgAccountOpenStatusRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link UwgAccountOpenStatusRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link UwgAccountOpenStatusRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link UwgAccountOpenStatusRow}オブジェクトから{@@link UwgAccountOpenStatusDao}オブジェクトを作成します。 
   * これは実際の{@@link UwgAccountOpenStatusRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link UwgAccountOpenStatusDao}取得のために指定の{@@link UwgAccountOpenStatusRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link UwgAccountOpenStatusDao}オブジェクト 
  ...
  /** 
   * {@@link UwgAccountOpenStatusRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link UwgAccountOpenStatusRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link UwgAccountOpenStatusPK}やデータベースレコードとして挿入される{@@link UwgAccountOpenStatusParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link UwgAccountOpenStatusRow}を一意に特定する{@@link UwgAccountOpenStatusPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link UwgAccountOpenStatusRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link UwgAccountOpenStatusParams}オブジェクトの主キーとして利用可能な{@@link UwgAccountOpenStatusPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link UwgAccountOpenStatusRow}オブジェクトを検索します。 
   * 
   * @@param p_institutionCode 検索対象であるp_institutionCodeフィールドの値
   * @@param p_branchCode 検索対象であるp_branchCodeフィールドの値
   * @@param p_orderRequestNumber 検索対象であるp_orderRequestNumberフィールドの値
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link UwgAccountOpenStatusRow} 
  ...
  /** 
   * 指定のUwgAccountOpenStatusPKオブジェクトから{@@link UwgAccountOpenStatusRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するUwgAccountOpenStatusPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link UwgAccountOpenStatusRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String,String)}および{@@link #forRow(UwgAccountOpenStatusRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(UwgAccountOpenStatusPK)}および{@@link #forRow(UwgAccountOpenStatusRow)}を使用してください。 
   */
  ...
  /** 
   * p_institutionCode, p_branchCode, p_orderRequestNumber, and にて指定の値から一意の{@@link UwgAccountOpenStatusRow}オブジェクトを検索します。 
   ...
   * @@param p_orderRequestNumber 検索対象であるp_orderRequestNumberフィールドの値
   * 
   * @@return 引数指定のp_institutionCode, p_branchCode, p_orderRequestNumber, and の値と一致する{@@link UwgAccountOpenStatusRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByInstitutionCodeBranchCodeOrderRequestNumber(String, String, String)}および{@@link #forRow(UwgAccountOpenStatusRow)}を使用してください。 
   */
