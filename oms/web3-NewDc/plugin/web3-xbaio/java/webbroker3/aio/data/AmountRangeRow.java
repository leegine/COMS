...
/** 
 * AmountRangeRowインタフェースは変更不可でリードオンリーである<em>amount_range</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AmountRangeRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see AmountRangePK 
 */
public interface AmountRangeRow extends Row {


  /** 
   * この{@@link AmountRangeRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "amount_range", "master" );
   ...
   */
  public  boolean  getMaxAmountIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMaxAmountIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMaxAmountIsModified();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getMinAmountIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMinAmountIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMinAmountIsModified();
