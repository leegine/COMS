...
/** 
 * uwg_account_open_statusテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link UwgAccountOpenStatusRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link UwgAccountOpenStatusParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link UwgAccountOpenStatusParams}が{@@link UwgAccountOpenStatusRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class UwgAccountOpenStatusParams extends Params implements UwgAccountOpenStatusRow {
  ...
  /** 
   * 値が未設定のUwgAccountOpenStatusParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のUwgAccountOpenStatusRowオブジェクトの値を利用してUwgAccountOpenStatusParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するUwgAccountOpenStatusRowオブジェクト 
   */
   ...
   * @@param row 比較対照のUwgAccountOpenStatusRow 
   ...
   *
   * @@param p_password <em>password</em>カラムの値をあらわす32桁以下のString値 
   */
   ...
   *
   * @@param p_accountOpenStatusDiv <em>account_open_status_div</em>カラムの値をあらわす1桁以下のString値 
   */
