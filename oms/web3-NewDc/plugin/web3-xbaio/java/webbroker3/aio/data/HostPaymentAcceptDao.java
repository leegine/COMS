...
/** 
 * {@@link HostPaymentAcceptDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link HostPaymentAcceptRow}インスタンスへ関連付けることができます。 
...
public class HostPaymentAcceptDao extends DataAccessObject {
  ...
  /** 
   * この{@@link HostPaymentAcceptDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link HostPaymentAcceptRow}と仮定される{@@link DataAccessObject}から新たに{@@link HostPaymentAcceptDao}を返します。 
         * @@return 指定のRowに結びつく{@@link HostPaymentAcceptDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link HostPaymentAcceptRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link HostPaymentAcceptRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link HostPaymentAcceptRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link HostPaymentAcceptRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link HostPaymentAcceptRow}オブジェクトから{@@link HostPaymentAcceptDao}オブジェクトを作成します。 
   * これは実際の{@@link HostPaymentAcceptRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link HostPaymentAcceptDao}取得のために指定の{@@link HostPaymentAcceptRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link HostPaymentAcceptDao}オブジェクト 
  ...
  /** 
   * {@@link HostPaymentAcceptRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link HostPaymentAcceptRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link HostPaymentAcceptPK}やデータベースレコードとして挿入される{@@link HostPaymentAcceptParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link HostPaymentAcceptRow}を一意に特定する{@@link HostPaymentAcceptPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link HostPaymentAcceptRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link HostPaymentAcceptParams}オブジェクトの主キーとして利用可能な{@@link HostPaymentAcceptPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link HostPaymentAcceptRow}オブジェクトを検索します。 
   * 
   ...
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link HostPaymentAcceptRow} 
  ...
  /** 
   * 指定のHostPaymentAcceptPKオブジェクトから{@@link HostPaymentAcceptRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するHostPaymentAcceptPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link HostPaymentAcceptRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String,String,String,String,String)}および{@@link #forRow(HostPaymentAcceptRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(HostPaymentAcceptPK)}および{@@link #forRow(HostPaymentAcceptRow)}を使用してください。 
   */
  ...
  /** 
   * p_requestCode, p_institutionCode, p_branchCode, p_accountCode, p_orderRequestNumber, and にて指定の値から一意の{@@link HostPaymentAcceptRow}オブジェクトを検索します。 
   ...
   * @@param p_orderRequestNumber 検索対象であるp_orderRequestNumberフィールドの値
   * 
   * @@return 引数指定のp_requestCode, p_institutionCode, p_branchCode, p_accountCode, p_orderRequestNumber, and の値と一致する{@@link HostPaymentAcceptRow}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByRequestCodeInstitutionCodeBranchCodeAccountCodeOrderRequestNumber(String, String, String, String, String)}および{@@link #forRow(HostPaymentAcceptRow)}を使用してください。 
   */
  ...
  /** 
   * p_requestCode, p_status, and にて指定の値に一致する{@@link HostPaymentAcceptRow}オブジェクトを{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param p_requestCode 検索対象であるp_requestCodeフィールドの値
   * @@param p_status 検索対象であるp_statusフィールドの値
   * 
   * @@return 引数指定のp_requestCode, p_status, and の値と一致する{@@link HostPaymentAcceptRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByRequestCodeStatus(String, String)}および{@@link #forRow(HostPaymentAcceptRow)}を使用してください。 
   */
