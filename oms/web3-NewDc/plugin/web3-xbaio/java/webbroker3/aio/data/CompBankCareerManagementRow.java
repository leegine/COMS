...
1.1
date	2011.03.16.05.37.22;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	CompBankCareerManagementRow.java;
...
/** 
 * CompBankCareerManagementRowインタフェースは変更不可でリードオンリーである<em>comp_bank_career_management</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link CompBankCareerManagementRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface CompBankCareerManagementRow extends Row {


  /** 
   * この{@@link CompBankCareerManagementRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "comp_bank_career_management", "master" );
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getMgFlgIsModified();
