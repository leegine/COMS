...
/** 
 * {@@link HostCashTransferDao}は{@@link com.fitechlabs.xtrade.kernel.data.DataAccessObject}のサブクラスで{@@link HostCashTransferRow}インスタンスへ関連付けることができます。 
...
public class HostCashTransferDao extends DataAccessObject {
  ...
  /** 
   * この{@@link HostCashTransferDao}に関連する型指定のRowオブジェクト 
   */
   ...
   */
    public static final Factory FACTORY = new Factory() {
        ...
        /** 
         * 指定の{@@link HostCashTransferRow}と仮定される{@@link DataAccessObject}から新たに{@@link HostCashTransferDao}を返します。 
         * @@return 指定のRowに結びつく{@@link HostCashTransferDao}インスタンス 
         * @@exception java.lang.IllegalArgumentException 指定のRowオブジェクトが{@@link HostCashTransferRow}のタイプと一致しない場合 
         */
  ...
  /** 
   * {@@link HostCashTransferRow}を引数に取るコンストラクタです。これはファ@クトリおよびそのサブクラスのみにより利用されます。 
   * @@param row Daoにデータを提供する{@@link HostCashTransferRow}オブジェクト 
    */
  ...
  /** 
   * このDaoに結びついている{@@link HostCashTransferRow}オブジェクトを取得します。
   */
  ...
  /** 
   * 指定の{@@link HostCashTransferRow}オブジェクトから{@@link HostCashTransferDao}オブジェクトを作成します。 
   * これは実際の{@@link HostCashTransferRow}クラスインスタンスをベースに戻り値として適切なDaoオブジェクトを 
   * ポリモルフィックに作成します。 
   * 
   * @@param row 必要な{@@link HostCashTransferDao}取得のために指定の{@@link HostCashTransferRow}オブジェクト 
   * @@return 指定のrowオブジェクトに対応する{@@link HostCashTransferDao}オブジェクト 
  ...
  /** 
   * {@@link HostCashTransferRow}を一意に特定するlong型の値を生成します。 
   * この値は{@@link HostCashTransferRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return 新しい{@@link HostCashTransferPK}やデータベースレコードとして挿入される{@@link HostCashTransferParams}インスタンスの主キーとして利用可能なlong型の値 
  ...
  /** 
   * {@@link HostCashTransferRow}を一意に特定する{@@link HostCashTransferPK}オブジェクトを生成します。 
   * このオブジェクトは{@@link HostCashTransferRow}のオブジェクトタイプに対応するものです。 
   * 
   * @@return データベースへ挿入する新たな{@@link HostCashTransferParams}オブジェクトの主キーとして利用可能な{@@link HostCashTransferPK}オブジェクト 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
  ...
  /** 
   * 指定の主キーの値から{@@link HostCashTransferRow}オブジェクトを検索します。 
   * 
   * @@param p_rowid 検索対象であるp_rowidフィールドの値
   * 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link HostCashTransferRow} 
  ...
  /** 
   * 指定のHostCashTransferPKオブジェクトから{@@link HostCashTransferRow}オブジェクトを検索します。 
   * 
   * @@param pk 検索キーとして利用するHostCashTransferPKオブジェクト 
   * @@return 引数指定のIDと一致する主キーを持つ{@@link HostCashTransferRow} 
   * @@exception DataFindException クエリ自体は実行されたが、指定の主キーにて検索のオブジェクトが見つからなかった場合 
   * @@exception DataQueryException クエリ自体は実行されたが、検索キーが一意でないなど何らかのデータ関連の理由で検索に失敗した場合 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(String)}および{@@link #forRow(HostCashTransferRow)}を使用してください。 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowByPk(HostCashTransferPK)}および{@@link #forRow(HostCashTransferRow)}を使用してください。 
   */
  ...
  /** 
   * p_requestCode, p_status, and にて指定の値に一致する{@@link HostCashTransferRow}オブジェクトを{@@link List}として返します。 
   * 該当するオブジェクトがない場合は空のリストを返します。 
   * 
   * @@param p_requestCode 検索対象であるp_requestCodeフィールドの値
   * @@param p_status 検索対象であるp_statusフィールドの値
   * 
   * @@return 引数指定のp_requestCode, p_status, and の値と一致する{@@link HostCashTransferRow}オブジェクトの{@@link List} 
   * @@exception DataNetworkException ネットワークまたはその他インフラ関係の障害でクエリが実行できなかった場合 
   * @@exception DataQueryException クエリが実行されても何らかのデータ関連の理由から失敗した場合 
   */
  ...
  /** 
   * @@deprecated 代わりに{@@link #findRowsByRequestCodeStatus(String, String)}および{@@link #forRow(HostCashTransferRow)}を使用してください。 
   */
