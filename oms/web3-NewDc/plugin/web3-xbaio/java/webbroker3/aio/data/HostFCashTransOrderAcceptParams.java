...
1.1
date	2011.03.16.05.38.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostFCashTransOrderAcceptParams.java;
...
/** 
 * host_f_cash_trans_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostFCashTransOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostFCashTransOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostFCashTransOrderAcceptParams}が{@@link HostFCashTransOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostFCashTransOrderAcceptParams extends Params implements HostFCashTransOrderAcceptRow {
  ...
  public static final String PTYPE = "host_f_cash_trans_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostFCashTransOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostFCashTransOrderAcceptRow.TYPE;
  }
  ...
  private boolean accept_div_is_set = false;
  private boolean accept_div_is_modified = false;
  ...
  /** 
   * 値が未設定のHostFCashTransOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostFCashTransOrderAcceptParams() {
  ...
  /** 
   * 指定のHostFCashTransOrderAcceptRowオブジェクトの値を利用してHostFCashTransOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostFCashTransOrderAcceptRowオブジェクト 
   */
  public HostFCashTransOrderAcceptParams( HostFCashTransOrderAcceptRow p_row )
  {
    ...
    accept_div_is_set = p_row.getAcceptDivIsSet();
    accept_div_is_modified = p_row.getAcceptDivIsModified();
   ...
   */
    public void markAllValuesAsSet() {
      ...
      accept_div_is_set = true;
      accept_div_is_modified = true;
  ...
  {
    if ( !( other instanceof HostFCashTransOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostFCashTransOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostFCashTransOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostFCashTransOrderAcceptRow row )
  {
   ...
   */
	protected void assertValidForInsert() throws IllegalArgumentException {
		...
		if ( !accept_div_is_set )
			throw new IllegalArgumentException("non-nullable field 'accept_div' must be set before inserting.");
		if ( !status_is_set )
  ...
  /** 
   * <em>accept_div</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public final boolean getAcceptDivIsSet() {
    return accept_div_is_set;
  }


  /** 
   * <em>accept_div</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public final boolean getAcceptDivIsModified() {
    return accept_div_is_modified;
  }
  ...
  {
    return new HostFCashTransOrderAcceptPK(request_code, institution_code, branch_code, account_code, order_request_number);
  }
  ...
  /** 
   * <em>accept_div</em>カラムの値を設定します。 
   *
   * @@param p_acceptDiv <em>accept_div</em>カラムの値をあらわす1桁以下のString値 
   */
        ...
        switch ( name.charAt(0) ) {
            case 'a':
                if ( name.equals("account_code") ) {
                    ...
                    if (this.accept_div_is_set)
                        this.accept_div_is_modified = true;
                    this.accept_div_is_set = true;
                    return;
                }
                break;
            case 'b':
