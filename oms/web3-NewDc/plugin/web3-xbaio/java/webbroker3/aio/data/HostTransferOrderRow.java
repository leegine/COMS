...
1.1
date	2011.03.16.05.37.32;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostTransferOrderRow.java;
...
/** 
 * HostTransferOrderRowインタフェースは変更不可でリードオンリーである<em>host_transfer_order</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostTransferOrderRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostTransferOrderRow extends Row {


  /** 
   * この{@@link HostTransferOrderRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_transfer_order", "session" );
   ...
   * @@return intの値 
   */
  public int getTransferAmountDebitor();
   ...
   */
  public  boolean  getTransferAmountDebitorIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransferAmountDebitorIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransferAmountDebitorIsModified();
   ...
   * @@return intの値 
   */
  public int getTransferAmountCreditor();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getTransferAmountCreditorIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransferAmountCreditorIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransferAmountCreditorIsModified();
   ...
   * @@return Stringの値 
   */
  public String getInvoluntaryTransfer();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getInvoluntaryTransferIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getInvoluntaryTransferIsModified();
   ...
   * @@return Stringの値 
   */
  public String getOriginalTransferDate();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalTransferDateIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getOriginalTransferDateIsModified();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransferTimeIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTransferTimeIsModified();
