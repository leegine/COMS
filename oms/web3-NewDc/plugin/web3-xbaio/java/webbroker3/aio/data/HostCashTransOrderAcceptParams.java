...
filename	HostCashTransOrderAcceptParams.java;
...
/** 
 * host_cash_trans_order_acceptテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostCashTransOrderAcceptRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostCashTransOrderAcceptParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostCashTransOrderAcceptParams}が{@@link HostCashTransOrderAcceptRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostCashTransOrderAcceptParams extends Params implements HostCashTransOrderAcceptRow {
  ...
  public static final String PTYPE = "host_cash_trans_order_accept";


  /** クエリ内で利用される場合にrowをあらわすRowType */
  public static final RowType TYPE = HostCashTransOrderAcceptRow.TYPE;
  ...
  public RowType getRowType() {
    return HostCashTransOrderAcceptRow.TYPE;
  }
  ...
  /** 
   * 値が未設定のHostCashTransOrderAcceptParamsオブジェクトを作成します。 
   */
  public HostCashTransOrderAcceptParams() {
  ...
  /** 
   * 指定のHostCashTransOrderAcceptRowオブジェクトの値を利用してHostCashTransOrderAcceptParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostCashTransOrderAcceptRowオブジェクト 
   */
  public HostCashTransOrderAcceptParams( HostCashTransOrderAcceptRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostCashTransOrderAcceptRow ) )
       return false;
    return fieldsEqual( (HostCashTransOrderAcceptRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostCashTransOrderAcceptRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostCashTransOrderAcceptRow row )
  {
  ...
  {
    return new HostCashTransOrderAcceptPK(request_code, institution_code, branch_code, account_code, order_request_number);
  }
