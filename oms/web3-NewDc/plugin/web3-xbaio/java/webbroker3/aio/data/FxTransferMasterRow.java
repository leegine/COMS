...
1.1
date	2011.03.16.05.46.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	FxTransferMasterRow.java;
...
/** 
 * FxTransferMasterRowインタフェースは変更不可でリードオンリーである<em>fx_transfer_master</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link FxTransferMasterRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface FxTransferMasterRow extends Row {


  /** 
   * この{@@link FxTransferMasterRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "fx_transfer_master", "master" );
   ...
   * @@return Stringの値 
   */
  public String getDeliveryDateDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDeliveryDateDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDeliveryDateDivIsModified();
