...
1.1
date	2011.03.16.02.44.22;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	BankDepositErrorHistoryRow.java;
...
/** 
 * BankDepositErrorHistoryRowインタフェースは変更不可でリードオンリーである<em>bank_deposit_error_history</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link BankDepositErrorHistoryRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface BankDepositErrorHistoryRow extends Row {


  /** 
   * この{@@link BankDepositErrorHistoryRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "bank_deposit_error_history", "session" );
   ...
   * @@return longの値 
   */
  public long getBankDepositErrorHistoryId();
   ...
   */
  public  boolean  getBankDepositErrorHistoryIdIsSet();
   ...
   */
  public  boolean  getBankDepositErrorHistoryIdIsModified();
