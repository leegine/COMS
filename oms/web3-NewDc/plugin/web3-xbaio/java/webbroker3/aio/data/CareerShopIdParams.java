...
/** 
 * career_shop_idテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link CareerShopIdRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link CareerShopIdParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link CareerShopIdParams}が{@@link CareerShopIdRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
...
public class CareerShopIdParams extends Params implements CareerShopIdRow {
  ...
  /** 
   * 値が未設定のCareerShopIdParamsオブジェクトを作成します。 
   */
  ...
  /** 
   * 指定のCareerShopIdRowオブジェクトの値を利用してCareerShopIdParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するCareerShopIdRowオブジェクト 
   */
   ...
   * @@param row 比較対照のCareerShopIdRow 
  ...
  /** 
   * <em>pf_url</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>pf_url</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>return_url</em>カラムに値が設定されているかどうか調べます。
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>return_url</em>カラムの値が変更されているかどうか調べます。
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  ...
  /** 
   * <em>pf_url</em>カラムの値を設定します。 
   *
   * @@param p_pfUrl <em>pf_url</em>カラムの値をあらわす200桁以下のString値 
   */
  ...
  /** 
   * <em>return_url</em>カラムの値を設定します。 
   *
   * @@param p_returnUrl <em>return_url</em>カラムの値をあらわす200桁以下のString値 
   */
