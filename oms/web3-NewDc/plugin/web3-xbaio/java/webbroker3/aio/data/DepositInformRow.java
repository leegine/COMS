...
filename	DepositInformRow.java;
...
/** 
 * DepositInformRowインタフェースは変更不可でリードオンリーである<em>deposit_inform</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link DepositInformRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 * @@see DepositInformPK 
 */
public interface DepositInformRow extends Row {


  /** 
   * この{@@link DepositInformRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "deposit_inform", "session" );
