...
1.1
date	2011.03.16.02.38.38;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	AioDepositInformSendMailRow.java;
...
/** 
 * AioDepositInformSendMailRowインタフェースは変更不可でリードオンリーである<em>aio_deposit_inform_send_mail</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link AioDepositInformSendMailRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface AioDepositInformSendMailRow extends Row {


  /** 
   * この{@@link AioDepositInformSendMailRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "aio_deposit_inform_send_mail", "session" );
   ...
   */
  public java.sql.Timestamp getWorkedTimestamp();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getWorkedTimestampIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getWorkedTimestampIsModified();
