...
1.1
date	2011.03.16.02.37.42;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostCashTransferParams.java;
...
/** 
 * host_cash_transferテーブルのデータベースレコードの値変更に利用するパラメータを作成するユーティリティクラスです。 
 * <p> 
 * 通常、コンストラクタのうちの1つを利用して既存の{@@link HostCashTransferRow}オブジェクトからパラメータを作成します。 
 * 続いて、setterメソッドを利用して希望するフィールドの値を変更します。 
 * そして、{@@link HostCashTransferParams}オブジェクトを引数として渡し、新しいレコードを作成または存在するレコードを更新します。 
 * <p> 
 * {@@link HostCashTransferParams}が{@@link HostCashTransferRow}インタフェースを実装するので、このクラスでは各フィールドに対しgetterおよびsetterメソッドを提供しています。 
 * <p> 
 ...
 */
public class HostCashTransferParams extends Params implements HostCashTransferRow {
  ...
  public static final RowType TYPE = HostCashTransferRow.TYPE;
  ...
  /** 
   * 値が未設定のHostCashTransferParamsオブジェクトを作成します。 
   */
  public HostCashTransferParams() {
  ...
  /** 
   * 指定のHostCashTransferRowオブジェクトの値を利用してHostCashTransferParamsオブジェクトを作成します。 
   * @@param p_row テンプレートとして利用するHostCashTransferRowオブジェクト 
   */
  public HostCashTransferParams( HostCashTransferRow p_row )
  {
  ...
  {
    if ( !( other instanceof HostCashTransferRow ) )
       return false;
    return fieldsEqual( (HostCashTransferRow) other );
  }


  /** 
   * 指定のRowオブジェクトとフィールド値がすべて一致しているかどうか調べます。 
   * @@param row 比較対照のHostCashTransferRow 
   * @@return すべてのフィールド値が一致の場合true、そうでなければfalse 
   */
  public boolean fieldsEqual( HostCashTransferRow row )
  {
  ...
  {
    return new HostCashTransferPK(rowid);
  }
    ...
    public Object getColumn( String name ) {
        ...
        switch ( name.charAt(0) ) {
            ...
            case 'b':
                ...
                break;
            case 'c':
                if ( name.equals("cash_trans_date") ) {
