...
1.1
date	2011.03.16.05.44.07;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostForeignCashTransOrderRow.java;
...
/** 
 * HostForeignCashTransOrderRowインタフェースは変更不可でリードオンリーである<em>host_foreign_cash_trans_order</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostForeignCashTransOrderRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostForeignCashTransOrderRow extends Row {


  /** 
   * この{@@link HostForeignCashTransOrderRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_foreign_cash_trans_order", "session" );
   ...
   * @@return longの値 
   */
  public long getDebitConvertAmount();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getDebitConvertAmountIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDebitConvertAmountIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDebitConvertAmountIsModified();
   ...
   * @@return longの値 
   */
  public long getCreditConvertAmount();
   ...
   * @@return 対象のデータベースカラムの値がnullの場合はtrue 
   */
  public  boolean  getCreditConvertAmountIsNull();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCreditConvertAmountIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getCreditConvertAmountIsModified();
   ...
   * @@return Stringの値 
   */
  public String getCashTransDate();
