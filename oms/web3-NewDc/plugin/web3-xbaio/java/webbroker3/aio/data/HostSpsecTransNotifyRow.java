...
1.1
date	2011.03.16.02.49.34;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostSpsecTransNotifyRow.java;
...
/** 
 * HostSpsecTransNotifyRowインタフェースは変更不可でリードオンリーである<em>host_spsec_trans_notify</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostSpsecTransNotifyRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostSpsecTransNotifyRow extends Row {


  /** 
   * この{@@link HostSpsecTransNotifyRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_spsec_trans_notify", "session" );
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTitleDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getTitleDivIsModified();
