...
1.1
date	2011.03.16.02.36.51;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	HostTransferReceiptRow.java;
...
/** 
 * HostTransferReceiptRowインタフェースは変更不可でリードオンリーである<em>host_transfer_receipt</em>データベーステーブルレコードのスナップショットを表現します。 
 * <p> 
 * 通常、{@@link com.fitechlabs.xtrade.kernel.data.QueryProcessor}オブジェクトのメソッドを利用して{@@link HostTransferReceiptRow}インタフェースの実装オブジェクトを検索します。 
 * 
 ...
 */
public interface HostTransferReceiptRow extends Row {


  /** 
   * この{@@link HostTransferReceiptRow}クラスに紐付くテーブルをあらわす{@@link com.fitechlabs.dbind.RowType}オブジェクト 
   */
   public static final RowType TYPE = new RowType( "host_transfer_receipt", "session" );
   ...
   * @@return Stringの値 
   */
  public String getDepositTypeDiv();
   ...
   * @@return 値が既に設定されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDepositTypeDivIsSet();
   ...
   * @@return 値が既に変更されている場合はtrue、そうでなければfalse 
   */
  public  boolean  getDepositTypeDivIsModified();
   ...
   */
  public  boolean  getTransferAmountIsNull();
