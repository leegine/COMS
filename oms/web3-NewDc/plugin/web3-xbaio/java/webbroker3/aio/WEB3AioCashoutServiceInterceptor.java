...
1.1
date	2011.03.16.02.34.00;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashoutServiceInterceptor.java;
...
File Name        : 出金申込サービスインタセプタ(WEB3AioCashoutServiceInterceptor)
...
/**
 * (出金申込サービスインタセプタ)<BR>
 * 出金申込サービスインタセプタクラス<BR>
 * 
 * @@author 黄建(中訊)
 * @@version 1.0  
 */

public class WEB3AioCashoutServiceInterceptor implements Interceptor 
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AioCashoutServiceInterceptor.class);
     ...
     * <BR>
     * ３）　@リクエストデータの型が「出金申込完了リクエスト」の場合のみ、口座をロックする。<BR> 
