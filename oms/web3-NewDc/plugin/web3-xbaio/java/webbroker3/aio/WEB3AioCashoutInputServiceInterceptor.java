...
filename	WEB3AioCashoutInputServiceInterceptor.java;
...
File Name        : 出金申込入力サービスインタセプタ(WEB3AioCashoutInputServiceInterceptor)
...
/**
 * (出金申込入力サービスインタセプタ)<BR>
 * (出金申込入力サービスインタセプタクラス)<BR>
 * 
 * @@author 黄建(中訊)
 * @@version 1.0  
 */

public class WEB3AioCashoutInputServiceInterceptor implements Interceptor 
{   
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(
            WEB3AioCashoutInputServiceInterceptor.class);
