...
1.1
date	2011.03.16.02.31.36;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinSelectServiceInterceptor.java;
...
File Name        : オンライン入金選択サービスインタセプタクラス(WEB3AioCashinSelectServiceInterceptor)
Author Name      : Daiwa Institute of Research
Revesion History : 2004/10/13 屈陽 (中訊) 新規作成
...
/**
 * (オンライン入金選択サービスインタセプタ)<BR>
 * オンライン入金選択サービスインタセプタクラス<BR>
 * 
 * @@author 屈陽(中訊)
 * @@version 1.0
 */
public class WEB3AioCashinSelectServiceInterceptor implements Interceptor 
{
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinSelectServiceInterceptor.class);   
