...
1.1
date	2011.03.16.02.32.36;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinNoticeInputServiceInterceptor.java;
...
File Name        : 入金連絡入力サービスインタセプタクラス(WEB3AioCashinNoticeInputServiceInterceptor)
 ...
 * @@version 1.0
 */
public class WEB3AioCashinNoticeInputServiceInterceptor implements Interceptor 
{
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinNoticeInputServiceInterceptor.class);
    ...
    public Object onCall(Method l_method, Object[] l_serviceParams) 
    {
        ...
        try
        {
            ...
            log.debug("WEB3AioCashinNoticeInputServiceInterceptor::BranchCode = " + l_strBranchCode);
