...
1.1
date	2011.03.16.02.21.17;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminFEqConAccountMngServiceInterceptor.java;
...
@/**
 ...
 File Name        : 外株口座管理サービスインタセプタクラス(WEB3AdminFEqConAccountMngServiceInterceptor)
...
public class WEB3AdminFEqConAccountMngServiceInterceptor implements Interceptor 
{
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminFEqConAccountMngServiceInterceptor.class);
