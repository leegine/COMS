...
1.1
date	2011.03.16.02.32.10;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAioVirtualAccCashinULServiceInterceptor.java;
...
File Name        : バーチャル口座入金ULサービスインタセプタ(WEB3AdminAioVirtualAccCashinULServiceInterceptor)
...
/**
 * (バーチャル口座入金ULサービスインタセプタ)<BR>
 * 
 * @@author 周捷(中訊)
 * @@version 1.0
 */

public class WEB3AdminAioVirtualAccCashinULServiceInterceptor implements Interceptor
{
    /**
     * ログ出力ユーティリティ。
     */
     ...
     * 　@取引カレンダコンテキスト.TRADING_CALENDAR_TAG<BR><BR>
     * <BR>
     * @@param l_context - onCallリターン値
     * @@param l_returnValue - サービスメソッドリターン値
     * @@roseuid 41BD55F000A8
	 */
