...
1.1
date	2011.03.16.04.47.47;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioTransferDetailMessageDef.java;
...
File Name        : 定数定義インタフェイス(WEB3AioTransferDetailMessageDef)
...
/**
 * FX振替明細 のメッセージ  定数定義インタフェイス
 *                                                                     
 * @@author 屈陽
 * @@version 1.0
 */

public interface WEB3AioTransferDetailMessageDef
{
    /**
     * 10000000 : 決済中 
     */
     ...
     * 00000911：受渡日エラー
     */
    public static final String ACCEPT_RESULT_CODE_00000911 = "00000911";
