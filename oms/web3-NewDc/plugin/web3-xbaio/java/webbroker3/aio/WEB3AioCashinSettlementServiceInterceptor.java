...
1.1
date	2011.03.16.02.24.38;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AioCashinSettlementServiceInterceptor.java;
...
File Name        : 決済依頼サービスインタセプタクラス(WEB3AioCashinSettlementServiceInterceptor)
...
/**
 * (決済依頼サービスインタセプタ)<BR>
 * 決済依頼サービスインタセプタクラス<BR>
 * 
 * @@author 屈陽(中訊)
 * @@version 1.0
 */
public class WEB3AioCashinSettlementServiceInterceptor implements Interceptor 
{
    /**
     * ログユーティリティ
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AioCashinSettlementServiceInterceptor.class);       
