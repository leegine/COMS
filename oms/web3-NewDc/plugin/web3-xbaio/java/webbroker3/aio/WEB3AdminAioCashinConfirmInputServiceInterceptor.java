...
1.1
date	2011.03.16.02.21.04;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminAioCashinConfirmInputServiceInterceptor.java;
...
File Name        : 入金連絡確認入力サービスインタセプタクラス(WEB3AdminAioCashinConfirmInputServiceInterceptor)
...
/**
 * (入金連絡確認入力サービスインタセプタ)<BR>
 * 入金連絡確認入力サービスインタセプタクラス<BR>
 * 
 * @@author 韋念瓊(中訊)
 * @@version 1.0
 */
public class WEB3AdminAioCashinConfirmInputServiceInterceptor implements Interceptor 
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminAioCashinConfirmInputServiceInterceptor.class);
