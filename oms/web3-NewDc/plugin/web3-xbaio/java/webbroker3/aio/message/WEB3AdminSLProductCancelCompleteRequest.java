...
1.1
date	2011.03.16.04.56.36;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSLProductCancelCompleteRequest.java;
...
File Name        : 担保銘柄登録取消完了リクエスト(WEB3AdminSLProductCancelCompleteRequest.java)
...
/**
 * (担保銘柄登録取消完了リクエスト)<BR>
 * 担保銘柄登録取消完了リクエストクラス<BR>
 *
 * @@author 孫洪江
 * @@version 1.0
 */
public class WEB3AdminSLProductCancelCompleteRequest extends WEB3GenRequest
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSLProductCancelCompleteRequest.class);
     ...
     * SerialVersionUID<BR>
     */
    public final static long serialVersionUID = 200709141346L;
    ...
    /**
     * @@roseuid 46E89085021F
     */
    public WEB3AdminSLProductCancelCompleteRequest()
    {
    ...
    {
        return new WEB3AdminSLProductCancelCompleteResponse(this);
    }
}
@
