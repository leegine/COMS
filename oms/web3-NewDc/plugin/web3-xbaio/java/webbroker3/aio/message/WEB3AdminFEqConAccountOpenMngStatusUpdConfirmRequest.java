...
File Name        : 外株口座開設管理ステータス更新確認リクエスト(WEB3AdminFEqConAccountOpenMngStatusUpdConfirmRequest)
...
/**
 * (外株口座開設管理ステータス更新確認リクエスト)<BR>
 * 外株口座開設管理ステータス更新確認リクエストクラス
 * 
 * @@author 周勇(中訊)
 * @@version 1.0
 */
    ...
    extends WEB3AdminFEqConAccountMngStateChangeCommonRequest 
{
     ...
     * <BR>
     * 外株口座開設管理ステータス更新確認レスポンスオブジェクトを返却する。
