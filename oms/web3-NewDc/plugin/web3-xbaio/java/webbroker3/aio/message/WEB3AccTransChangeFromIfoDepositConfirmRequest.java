...
1.1
date	2011.03.16.04.58.14;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AccTransChangeFromIfoDepositConfirmRequest.java;
...
File Name        : 証拠金から振替確認リクエストクラス(WEB3AccTransChangeFromIfoDepositConfirmRequest)
 ...
 * @@version 1.0
 */
public class WEB3AccTransChangeFromIfoDepositConfirmRequest
    extends WEB3GenRequest
{
    ...
    /**
     * @@roseuid 4158E8E202A5
     */
    public WEB3AccTransChangeFromIfoDepositConfirmRequest()
    {
     ...
     * １）振替金額チェック<BR>
     * １－１）<BR>
     *    リクエストデータ.振替金額 = null  の場合、例外をスローする。<BR>
     * <BR>
     ...
     * <BR>
     * １－２）<BR>
     *    リクエストデータ.振替金額 <= 0   の場合、例外をスローする。<BR>
     * <BR>
     *         class: WEB3BusinessLayerException<BR>
     ...
     * <BR>
     * １－３）<BR>
     *    リクエストデータ.振替金額length() > 9   の場合、例外をスローする。<BR>
     * <BR>
     *         class: WEB3BusinessLayerException<BR>
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        // １－３）リクエストデータ.振替金額length() > 9   の場合、例外をスローする
        if (this.changeAmt.length() > 9)
        {
            ...
            throw new WEB3BusinessLayerException(
                ...
                this.getClass().getName() + "." + STR_METHOD_NAME,
                "リクエストデータ.振替金額.length() > 9, " +
                "リクエストデータ.振替金額.length() = " + this.changeAmt.length());
        }
     ...
     * <BR>
     * 証拠金から振替確認レスポンスオブジェクトを生成して返す。 <BR>
     * @@return WEB3GenResponse
     * @@roseuid 4158E8E202B9
     */
    public WEB3GenResponse createResponse()
    {
        return new WEB3AccTransChangeFromIfoDepositConfirmResponse(this);
    }
}
@
