...
File Name        : 証拠金から振替完了リクエストクラス(WEB3AccTransChangeFromIfoDepositCompleteRequest)
...
public class WEB3AccTransChangeFromIfoDepositCompleteRequest extends WEB3GenRequest 
{
     ...
     * <BR>
     * １－４）<BR>
     *    リクエストデータ.振替金額に数字以外の文字が含まれる   の場合、<BR>
     * 例外をスローする。<BR>
     * <BR>
     *         class: WEB3BusinessLayerException<BR>
    ...
    public void validate() throws WEB3BaseException 
    {
        ...
        // １－３）リクエストデータ.振替金額.length() > 9の場合、例外をスローする
     ...
     * <BR>
     * 証拠金から振替完了レスポンスオブジェクトを生成して返す。 <BR>
