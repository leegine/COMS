...
1.1
date	2011.03.16.04.53.30;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3AdminSLProductChangeCompleteRequest.java;
...
File Name        : 担保銘柄登録変更完了リクエスト(WEB3AdminSLProductChangeCompleteRequest.java)
Author Name      : Daiwa Institute of Research
Revision History : 2007/09/14 トウ鋒鋼(中訊) 新規作成 仕様変更モデル760
Revision History : 2007/10/10 孫洪江(中訊) 仕様変更モデル800 モデル801 モデル802
*/
...
/**
 * (担保銘柄登録変更完了リクエスト)<BR>
 * 担保銘柄登録変更完了リクエストクラス<BR>
 * <BR>
 * @@author トウ鋒鋼
 * @@version 1.0
 */
public class WEB3AdminSLProductChangeCompleteRequest extends WEB3GenRequest
{
    /**
     * ログ出力ユーティリティ。
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminSLProductChangeCompleteRequest.class);
    ...
    /**
     * @@roseuid 46E890850144
     */
    public WEB3AdminSLProductChangeCompleteRequest()
    {
     ...
     * 　@　@　@　@　@　@　@tag  : BUSINESS_ERROR_01444<BR>
     * <BR>
     * 　@２－９）　@リクエスト.変更後銘柄登録情報.適用期間to != nullの場合<BR>
     * 　@　@　@　@　@　@　@リクエスト.変更後銘柄登録情報.適用期間from ><BR>
    ...
    public void validate() throws WEB3BaseException
    {
        ...
        // 　@２－９）　@リクエスト.変更後銘柄登録情報.適用期間to != nullの場合
        // 　@　@　@　@　@　@　@リクエスト.変更後銘柄登録情報.適用期間from >
    ...
    {
        return new WEB3AdminSLProductChangeCompleteResponse(this);
    }
}
@
