...
1.1
date	2011.03.16.05.17.35;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3SLRepayApplyCommonRequest.java;
...
File Name        : 証券担保ローン返済申込共通リクエスト(WEB3SLRepayApplyCommonRequest.java)
 ...
 * @@version 1.0
 */
public class WEB3SLRepayApplyCommonRequest extends WEB3GenRequest
{
    /**
     * ログユーティリティ<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3SLRepayApplyCommonRequest.class);
     ...
     */
    public WEB3SLRepayApplyCommonRequest()
    {
    ...
    {
        return new WEB3SLRepayApplyCommonResponse(this);
    }
}
@
