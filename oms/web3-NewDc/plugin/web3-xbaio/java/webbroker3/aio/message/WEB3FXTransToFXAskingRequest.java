...
1.1
date	2011.03.16.04.58.40;	author zhang-tengyu;	state Exp;
branches;
next	;
deltatype	text;
kopt	kv;
...
filename	WEB3FXTransToFXAskingRequest.java;
...
File Name        : FXへの振替依頼リクエスト(WEB3FXTransToFXAskingRequest)
 ...
 * @@version 1.0
 */
public class WEB3FXTransToFXAskingRequest extends WEB3FXAskingCommonRequest
{
    /**
     * PTYPE <BR>
     */
    ...
    /**
     * @@roseuid 41E7693303B9
     */
    public WEB3FXTransToFXAskingRequest()
    {
    }
    ...
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3FXTransToFXAskingRequest.class);
    ...
    {
        return new WEB3FXTransToFXAskingResponse(this);
    }
}@
