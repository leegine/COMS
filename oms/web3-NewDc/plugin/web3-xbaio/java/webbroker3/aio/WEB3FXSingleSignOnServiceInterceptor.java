...
File Name        : シングルサインオンサービスインタセプタ(WEB3FXTransToFXServiceInterceptor)
Author Name      : Daiwa Institute of Research
Revesion History : 2005/8/29 韋念瓊 (中訊) 新規作成   
*/
...
/**
 * (シングルサインオンサービスインタセプタ) <BR>
 * シングルサインオンサービスインタセプタクラス <BR>
 * 
 * @@author 韋念瓊(中訊)
 * @@version 1.0
 */
public class WEB3FXSingleSignOnServiceInterceptor implements Interceptor
{
     ...
     * 　@取引カレンダコンテキスト.受付時間区分 = ”28：シングルサインオン”  <BR> 
     * 　@取引カレンダコンテキスト.商品コード = ”0：DEFAULT”  <BR> 
     * 　@取引カレンダコンテキスト.注文受付商品 = ”29：シングルサインオン”  <BR> 
     * 　@取引カレンダコンテキスト.注文受付トランザクション = ”01”  <BR> 
     * 
