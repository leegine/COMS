...
filename	WEB3AdminIfoDepAccountCodeComparator.java;
...
File Name        : (証拠金)顧客コードComparator(WEB3AdminIfoDepAccountCodeComparator.java)
Author Name      : Daiwa Institute of Research
Revision History : 2009/02/27 李玉玲(中訊) 新規作成 モデルNo.004,No.011
*/
...
/**
 * ((証拠金)顧客コードComparator)<BR>
 * (証拠金)顧客コードComparatorクラス<BR>
 * <BR>
 * @@author 李玉玲(中訊)
 * @@version 1.0
 */
public class WEB3AdminIfoDepAccountCodeComparator implements Comparator
{
    /**
     * ログ出力ユーティリティ。<BR>
     */
    private static WEB3LogUtility log =
        WEB3LogUtility.getInstance(WEB3AdminIfoDepAccountCodeComparator.class);
    ...
    /**
     * @@roseuid 49A7485502FD
     */
    public WEB3AdminIfoDepAccountCodeComparator()
    {
     ...
     * orderBy<BR>
     * @@roseuid 4999159E01EF
     */
    public WEB3AdminIfoDepAccountCodeComparator(String l_strOrderBy)
    {
        final String STR_METHOD_NAME = "WEB3AdminIfoDepAccountCodeComparator(String)";
    ...
    public int compare(Object l_unit1, Object l_unit2)
    {
        ...
        {
            l_strVal1 = ((WEB3IfoDepShortageInfo)l_unit1).accountCode;
            l_strVal2 = ((WEB3IfoDepShortageInfo)l_unit2).accountCode;
        }
        else
        {
            log.exiting(STR_METHOD_NAME);
        ...
        //比較
        //でキャストした明細1、明細2の顧客コードを比較し、結果を返却する。
        int l_intReturn = 0;
