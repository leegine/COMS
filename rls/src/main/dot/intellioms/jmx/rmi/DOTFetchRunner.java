...
File Name        : WEB3FetchRunnerクラス(DOTFetchRunner.java)
 ...
 * フェッチサービスを開始するように指示するJMX-RMIクライアントクラス。<BR>
 * <BR>
 * ルールエンジンのJMX-MRIポート番号を指定する場合は以下のようにパラメータを指定する。<BR>
 * <BR>
 * java DOTFetchRunner -rmi <JMX-RMIポート番号><BR>
 * <BR>
