...
File Name        : WEB3ObserverPriceStopperクラス(DOTObserverPriceStopper.java)
 ...
 * 逆指値監視サービスを終了するように指示するJMX-RMIクライアントクラス。<BR>
 * <BR>
 * ルールエンジンのJMX-MRIポート番号を指定する場合は以下のようにパラメータを指定する。<BR>
 * <BR>
 * java DOTObserverPriceStopper -mri <JMX-RMIポート番号><BR>
 * <BR>
 ...
 * @version 1.0
 */
public class DOTObserverPriceStopper
{
     ...
     * コンストラクタ
     */
    public DOTObserverPriceStopper()
    {
        super();
    }
