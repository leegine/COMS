...
File Name        : WEB3FetchStopperクラス(DOTFetchStopper.java)
 ...
 * フェッチサービスを終了するように指示するJMX-RMIクライアントクラス。<BR>
 * <BR>
 * ルールエンジンのJMX-MRIポート番号を指定する場合は以下のようにパラメータを指定する。<BR>
 * <BR>
 * java DOTFetchStopper -mri <JMX-RMIポート番号><BR>
 * <BR>
 ...
 * @version 1.0
 */
public class DOTFetchStopper
{
    
    /** 実行するMBeanオブジェクトのオブジェクト名 */
    public static final String OBJECT_NAME = "WEB3IntelliOMS:name=Fetch";
