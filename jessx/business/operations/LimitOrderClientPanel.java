...
public class LimitOrderClientPanel extends JPanel implements ClientInputPanel {
  ...
  private void jbInit() {
    ...
    jToggleButtonBuy.setEnabled(false);
    jToggleButtonBuy.setFont(new java.awt.Font("Verdana", 0, 12));
    ...
    jToggleButtonBuy.setOpaque(false);
    ...
    jToggleButtonSell.setEnabled(false);
    jToggleButtonSell.setFont(new java.awt.Font("Verdana", 0, 12));
    ...
    jToggleButtonSell.setOpaque(false);
    ...
    jButtonSendOrder.setEnabled(false);
    jButtonSendOrder.setFont(new java.awt.Font("Verdana", 1, 12));
    jButtonSendOrder.setForeground(Color.red);
    jButtonSendOrder.setOpaque(false);
 ...
 /*   if (this.jToggleButtonSell.isSelected()) {
  ...
  void desactivateSellButton() {
    ...
    this.jToggleButtonSell.setFont(new Font("Verdana",Font.PLAIN,12));
  ...
  void desactivateBuyButton() {
    ...
    this.jToggleButtonBuy.setFont(new Font("Verdana",Font.PLAIN,12));
  ...
  void activateSellButton() {
    ...
    this.jToggleButtonSell.setFont(new Font("Verdana",Font.BOLD,12));
  ...
  void activateBuyButton() {
    ...
    this.jToggleButtonBuy.setFont(new Font("Verdana",Font.BOLD,12));
