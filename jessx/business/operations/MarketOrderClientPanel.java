...
public class MarketOrderClientPanel extends JPanel implements ClientInputPanel {
  ...
  private void jbInit() {
    ...
    jToggleButtonBuyMarketOrder.setEnabled(false);
    jToggleButtonBuyMarketOrder.setFont(new java.awt.Font("Verdana", 0, 14));
    ...
    jToggleButtonSellMarketOrder.setEnabled(false);
    jToggleButtonSellMarketOrder.setFont(new java.awt.Font("Verdana", 0, 14));
    ...
    jButtonSendOrderMarketOrder.setEnabled(false);
    jButtonSendOrderMarketOrder.setFont(new java.awt.Font("Verdana", 1, 14));
  ...
  void desactivateSellButton() {
    ...
    this.jToggleButtonSellMarketOrder.setFont(new Font("Verdana",Font.PLAIN,14));
  ...
  void desactivateBuyButton() {
    ...
    this.jToggleButtonBuyMarketOrder.setFont(new Font("Verdana",Font.PLAIN,14));
  ...
  void activateSellButton() {
    ...
    this.jToggleButtonSellMarketOrder.setFont(new Font("Verdana",Font.BOLD,14));
  ...
  void activateBuyButton() {
    ...
    this.jToggleButtonBuyMarketOrder.setFont(new Font("Verdana",Font.BOLD,14));
