...
public class BestLimitOrderClientPanel extends JPanel implements ClientInputPanel {
  ...
  private void jbInit() {
    ...
    jToggleButtonBuyBestLimitOrder.setBackground(new java.awt.Color(145, 255,
        200));
    jToggleButtonBuyBestLimitOrder.setEnabled(false);
    jToggleButtonBuyBestLimitOrder.setFont(new java.awt.Font("Verdana", 0, 14));
    ...
    jToggleButtonSellBestLimitOrder.setBackground(new java.awt.Color(13, 219,
        242));
    jToggleButtonSellBestLimitOrder.setEnabled(false);
    jToggleButtonSellBestLimitOrder.setFont(new java.awt.Font("Verdana", 0, 14));
    ...
    jButtonSendOrderBestLimitOrder.setEnabled(false);
    jButtonSendOrderBestLimitOrder.setFont(new java.awt.Font("Verdana", 1, 14));
  ...
  void desactivateSellButton() {
    ...
    this.jToggleButtonSellBestLimitOrder.setFont(new Font("Verdana",Font.PLAIN,14));
  ...
  void desactivateBuyButton() {
    ...
    this.jToggleButtonBuyBestLimitOrder.setFont(new Font("Verdana",Font.PLAIN,14));
  ...
  void activateSellButton() {
    ...
    this.jToggleButtonSellBestLimitOrder.setFont(new Font("Verdana",Font.BOLD,14));
  ...
  void activateBuyButton() {
    ...
    this.jToggleButtonBuyBestLimitOrder.setFont(new Font("Verdana",Font.BOLD,14));
