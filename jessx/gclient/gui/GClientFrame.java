 ...
 * <p>Description: </p>
 * @author Thierry Curtil, Julien Terrier,Christophe Grosjean, Charles Montez, Rémi Quilliet
 * @see tutorials used:
...
public class GClientFrame extends JFrame
  ...
  private int indexcomm1 = 0;
  private int indexcomm2 = 1;
  JPanel contentPaneGeneral;
  JTabbedPane jTabbedPaneGeneral = new JTabbedPane();
  ...
  JTextArea jTextAreaCommunication2 = new JTextArea();
  ...
  JScrollPane jScrollPaneCommunication2 = new JScrollPane();
  ...
  JTabbedPane jTabbedPaneServerComm = new JTabbedPane();
  JPanel jPanelCommunication2 = new JPanel();


  JLabel jTextFieldTimer = new JLabel();
  ...
  private int lastIndexPanel4= -1;
  private int lastIndexPanelComm= -1;
  ...
  public void experimentBegins() {
    jTextFieldTimer.setFont(new java.awt.Font("Verdana", 1, 12));
  ...
  /*  jTextFieldTimer.setText("");
    jTextFieldTimer.setFont(new java.awt.Font("Verdana", 1, 12));
    jTextFieldTimer.setText("> trading session closed, please shut off this application <");
  ...
  public void periodBegins() {
    ...
    jTextFieldTimer.setFont(new java.awt.Font("Verdana", 1, 18));
  ...
  public void objectReceived(Document xmlDoc) {
    ...
    if (xmlDoc.getRootElement().getName().equals("Initialisation")) {
     ...
     // jCards1.removeAll();
      ...
      jTextAreaCommunication2.setText("");
    }
    ...
    if (xmlDoc.getRootElement().getName().equals("Deal")) {
     ...
     /* TRUC
      ...
      jScrollPaneCommunication.getVerticalScrollBar().setValue(jScrollPaneCommunication.getVerticalScrollBar().getMaximum());

      NewMessageCommTimer timerMessage = new NewMessageCommTimer(jTabbedPaneServerComm,
              indexcomm1);
      timerMessage.start();
 */
// TRUC
  for (Iterator it_pane = this.serverCommList.iterator(); it_pane.hasNext();) {
    ((PanelServerComm) it_pane.next()).messageReceived(xmlDoc.getRootElement().getText());
  }
//TRUC
     /* if (jTabbedPaneServerComm.getSelectedIndex() == 0)
             jTabbedPaneServerComm.setForegroundAt(indexcomm1, Color.black);
     else jTabbedPaneServerComm.setForegroundAt(indexcomm1, Color.red);*/
     ...
     /* TRUC this.jTextAreaCommunication2.append("\n===============================\n" +
                                         //timer.getText()+"\n"+
                                         xmlDoc.getRootElement().getText());
     ...
     jScrollPaneCommunication2.getVerticalScrollBar().setValue(jScrollPaneCommunication2.getVerticalScrollBar().getMaximum());



     NewMessageCommTimer timerMessage2 = new NewMessageCommTimer(jTabbedPaneServerComm,
               indexcomm2);
       timerMessage2.start();
      */
     // TRUC
...
//TRUC
       ...
       /*if (jTabbedPaneServerComm.getSelectedIndex() == 1)
           jTabbedPaneServerComm.setForegroundAt(indexcomm2, Color.black);
         else jTabbedPaneServerComm.setForegroundAt(indexcomm2, Color.red);*/
  ...
  public void jbInit() throws Exception  {
    ...
    titledBorder16 = new TitledBorder(BorderFactory.createEmptyBorder(6,0,0,0),"",TitledBorder.DEFAULT_JUSTIFICATION,TitledBorder.DEFAULT_POSITION,FONT_CLIENT_TITLE_BORDER);
    border13 = BorderFactory.createEmptyBorder();


    titledBorder17 = new TitledBorder(BorderFactory.createEmptyBorder(6,0,0,0),"",TitledBorder.DEFAULT_JUSTIFICATION,TitledBorder.DEFAULT_POSITION,FONT_CLIENT_TITLE_BORDER);
    ...
    jPanelCommunication2.setBorder(titledBorder17);
    jPanelCommunication2.setMinimumSize(new Dimension(20, 100));
    jPanelCommunication2.setPreferredSize(new Dimension(150, 100));
    jPanelCommunication2.setLayout(gridBagLayoutCommunication);
    ...
    jTextAreaCommunication.setBackground(new Color(203,230,211));
    ...
    jTextAreaCommunication2.setBackground(new Color(203,230,211));
    jTextAreaCommunication2.setEnabled(true);
    jTextAreaCommunication2.setBorder(BorderFactory.createLoweredBevelBorder());
    jTextAreaCommunication2.setEditable(false);
    jTextAreaCommunication2.setSelectedTextColor(Color.white);
    jTextAreaCommunication2.setLineWrap(true);
    jTextAreaCommunication2.setWrapStyleWord(true);
    jTextAreaCommunication2.setFont(FONT_CLIENT_TEXTAREA);
    ...
    jPanelTransactionsProperties.setFont(new java.awt.Font("Verdana", 1, 13));
  ...
  //  jTableManagedAssets.setRowSelectionAllowed(false);
    ...
    jSplitPaneInfoComm.setBottomComponent(jTabbedPaneServerComm);
    ...
    jTextFieldTimer.setEnabled(true);
    jTextFieldTimer.setFont(new java.awt.Font("Verdana", 1, 18));
    ...
    jTextFieldConnect.setPreferredSize(new Dimension(110, 20));
    jTextFieldConnect.setMaximumSize(new Dimension(110, 20));
    jTextFieldConnect.setMinimumSize(new Dimension(110, 20));
 ...
 // JLabelRenderer());
  //  jTableManagedAssets.setRowHeight(18);
    ...
    //jCards1.setMinimumSize(new Dimension(100, 200));
   ...
   // jTabbedPane2.addChangeListener(new GClientFrame_jTabbedPane2_changeAdapter(this));
    ...
    jTabbedPaneServerComm.addChangeListener(new GClientFrame_jTabbedPaneServerComm_changeAdapter(this));
    jTabbedPaneGeneral.addChangeListener(new GClientFrame_jTabbedPaneGeneral_changeAdapter(this));


    jPaneMarketProperties.addChangeListener(new GClientFrame_jPaneMarketProperties_changeAdapter(this));
    contentPaneGeneral.add(jTabbedPaneGeneral,        new GridBagConstraints(0, 2, 3, 1, 1.0, 1.0
    ...
    jTabbedPaneGeneral.add("General",jSplitPane2);
    ...
    jPanelCommunication2.add(jScrollPaneCommunication2,  new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
        ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 4, 2, 4), 0, 0));
    jScrollPaneCommunication2.getViewport().add(jTextAreaCommunication2, null);
  ...
  //  jScrollPaneManagedAssets.getViewport().add(jTableManagedAssets, null);
    ...
    //ici c'était jTabbedPane2 à la place
    jPanelAssetInfo.add(jTabbedPane2,  new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
        ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));



    jTabbedPaneServerComm.add(jPanelCommunication,"Financial Information", indexcomm1);


    jTabbedPaneServerComm.add(jPanelCommunication2,"Press Review", indexcomm2);



    jSplitPaneInfoComm.add(jTabbedPaneServerComm, JSplitPane.BOTTOM);
   ...
   // jSplitPane3.add(jCards1, JSplitPane.TOP);
...
//TRUC
  private java.util.List operationPaneList= new ArrayList();
  private java.util.List serverCommList = new ArrayList();
  private java.util.List managedAssetsList = new ArrayList();
  ...
  public void newOperator(Operator op) {
    ...
    if (op != null) {
      ...
      JPanel jPanelAssetInfo2 = new JPanel();

  JPanel jPanelTransactionsProperties2 = new JPanel();
  //JPanel jPaneMarketProperties2 = new JPanel();
  JSplitPane NewPane = new JSplitPane();
  JPanel jPanelWest2 = new JPanel();
  JPanel jPanelEast2 = new JPanel();
  JSplitPane jSplitPane32 = new JSplitPane();
  JSplitPane jSplitPaneInfoComm2 = new JSplitPane();



    jPanelAssetInfo2.setAlignmentX((float) 0.5);
        ...
        jPanelAssetInfo2.setLayout(gridBagLayoutAssetInfo);




        jPanelTransactionsProperties2.setFont(new java.awt.Font("Verdana", 1, 13));
        jPanelTransactionsProperties2.setBorder(titledBorder10);
        jPanelTransactionsProperties2.setLayout(gridBagLayoutTransactionsProperties);
        /*
         jPaneMarketProperties2.setBorder(titledBorder11);
        jPaneMarketProperties2.setMinimumSize(new Dimension(16, 10));
    jPaneMarketProperties2.setPreferredSize(new Dimension(291, 169));*/
    NewPane.setOrientation(JSplitPane.HORIZONTAL_SPLIT);
        ...
        jPanelWest2.setLayout(gridBagLayout1);
        jPanelEast2.setLayout(gridBagLayout2);
        ...
        jSplitPaneInfoComm2.setOrientation(JSplitPane.VERTICAL_SPLIT);
        jSplitPaneInfoComm2.setPreferredSize(new Dimension(152, 100));


        PanelServerComm serverCommPane = new PanelServerComm();
    ...
    NewPane.add(jPanelWest2, JSplitPane.TOP);
    NewPane.add(jPanelEast2, JSplitPane.BOTTOM);


    OperationPane opPane = new OperationPane(op);
    this.operationPaneList.add(opPane);

    MarketEvolutionGraph paneEvolutionGraph = new MarketEvolutionGraph();
    marketMap.put(op.getInstitution(),paneEvolutionGraph);
    paneEvolutionGraph.addAssetEvolution(op.getInstitution());
    paneEvolutionGraph.initGraphic();

    ManagedAssets PanelManagedAssets = new ManagedAssets();

    jPanelTransactionsProperties2.add(opPane,   new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        jPanelWest2.add(PanelManagedAssets,         new GridBagConstraints(0, 1, 1, 1, 1.0, 0.1
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 0, 0, 0), 0, 0));

        jPanelWest2.add(jSplitPaneInfoComm2,        new GridBagConstraints(0, 2, 1, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        jPanelWest2.add(jPanelTransactionsProperties2,     new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
            ,GridBagConstraints.NORTHEAST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jSplitPaneInfoComm2.add(jPanelAssetInfo2, JSplitPane.TOP);
    jPanelAssetInfo2.add(new InstitutionInfoPane(op.getCompleteName()),  new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));



 /*       this.evolutionGraphFactories.put(op.getInstitution(), new MarketEvolutionGraph());
        jPaneMarketProperties2.add(((MarketEvolutionGraph)evolutionGraphFactories.get(op.getInstitution())),op.getInstitution());


*/


       jSplitPaneInfoComm2.add(serverCommPane, JSplitPane.BOTTOM);

        jPanelEast2.add(jSplitPane32,     new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        jSplitPane32.add(paneEvolutionGraph, JSplitPane.BOTTOM);


        jSplitPane32.add(ClientCore.getInstitution(op.getInstitution()).
                       getClientPanel(op), JSplitPane.TOP);
   jSplitPaneInfoComm2.setDividerLocation(150);
       NewPane.setDividerLocation(450);
    jSplitPane32.setDividerLocation(400);
    jTabbedPaneGeneral.remove(jSplitPane2);
    jTabbedPaneGeneral.add(op.getInstitution(),NewPane);
  ...
  public void startEdition() {
   ...
   // }
   // TRUC
   for(Iterator it_pane = this.operationPaneList.iterator(); it_pane.hasNext(); ) {
  ...
  void jTabbedPaneGeneral_stateChanged(ChangeEvent e) {
    int newIndex = jTabbedPaneGeneral.getSelectedIndex();
    if (lastIndexPanel4 != newIndex && newIndex >= 0 && lastIndexPanel4 >= 0) {
      jTabbedPaneGeneral.setForegroundAt(lastIndexPanel4, Color.black);
      jTabbedPaneGeneral.setForegroundAt(newIndex, Color.red);
      this.lastIndexPanel4 = newIndex;
    }
    if (lastIndexPanel4 == -1) {
      jTabbedPaneGeneral.setForegroundAt(newIndex, Color.red);
      this.lastIndexPanel4 = newIndex;
    }
   }
  ...
  void jTabbedPaneServerComm_stateChanged(ChangeEvent e) {
    int newIndex = jTabbedPaneServerComm.getSelectedIndex();
    jTabbedPaneServerComm.setForegroundAt(newIndex, Color.black);
    }
...
class GClientFrame_jTabbedPaneServerComm_changeAdapter implements javax.swing.event.ChangeListener {
  GClientFrame adaptee;

  GClientFrame_jTabbedPaneServerComm_changeAdapter(GClientFrame adaptee) {
    this.adaptee = adaptee;
  }

  public void stateChanged(ChangeEvent e) {
    adaptee.jTabbedPaneServerComm_stateChanged(e);
  }
}

class GClientFrame_jTabbedPaneGeneral_changeAdapter implements javax.swing.event.ChangeListener {
  GClientFrame adaptee;

  GClientFrame_jTabbedPaneGeneral_changeAdapter(GClientFrame adaptee) {
    this.adaptee = adaptee;
  }

  public void stateChanged(ChangeEvent e) {
    adaptee.jTabbedPaneGeneral_stateChanged(e);
  }
}
